...
//These are food unit measurement so assuming shelled is the default unless a crop where shell_unshelled not applicable (e.g. cabbage))//These are food unit measurement so assuming shelled is the default unless a crop where shell_unshelled not applicable (e.g. cabbage))
clear
...
save `food_cf'
	...
	*********************************
use "${Malawi_IHPS_W2_raw_data}\ihs_treeconversion_factor_2020.dta", replace
recode crop_code (1=49)(2=50)(3=51)(4=52)(5=53)(6=54)(7=55)(8=56)(9=57)(10=58)(11=59)(12=60)(13=61)(14=62)(15=63)(16=64)(17=65)(18=48) //For W3 and W4 (18=1800)(19=1900)(20=2000)(21=48) //creating unique crop codes for tree and perm crops so that they do not overlap with seasonal crop codes; see value labels added after the append (below)
	...
	*       TEMPORARY CROPS         *
	*********************************
use "${Malawi_IHPS_W2_raw_data}/IHS Agricultural Conversion Factor Database.dta", clear
...
save "${Malawi_IHPS_W2_created_data}\Malawi_IHS_W2_cf.dta", replace
