...
* 1. PREPARE RAW DATA
	* Use tree/perm crop file and align crop_code so that it is consistent to what is in the conversion factor file and across all other waves:
		...
		*Waves 3 and 4: recode crop_code (1=49)(2=50)(3=51)(4=52)(5=53)(6=54)(7=55)(8=56)(9=57)(10=58)(11=59)(12=60)(13=61)(14=62)(15=63)(16=64)(17=65)(18=66)(19=67)(20=68)(21=48)
...
*2. MERGE IN CONVERSION FACTOR FILE
	*merge m:1 region crop_code_long unit condition using "${MWI_IHS_IHPS_W4_created_data}\MWI_IHS_IHPS_W4_cf.dta" //NOTE THAT WE MERGE ON CROP_CODE_LONG INTENTIONALLY
...
save `food_cf'
	...
	*********************************
use "${MWI_IHS_IHPS_W4_raw_data}\ihs_treeconversion_factor_2020.dta", replace
recode crop_code (1=49)(2=50)(3=51)(4=52)(5=53)(6=54)(7=55)(8=56)(9=57)(10=58)(11=59)(12=60)(13=61)(14=62)(15=63)(16=64)(17=65)(18=1800)(19=1900)(20=2000)(21=48) //creating unique crop codes for tree and perm crops so that they do not overlap with seasonal crop codes; see value labels added after the append (below)
