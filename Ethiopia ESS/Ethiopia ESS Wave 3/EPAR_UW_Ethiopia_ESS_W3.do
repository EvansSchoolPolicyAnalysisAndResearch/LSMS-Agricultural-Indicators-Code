...
* SEED SOURCES *
********************************************************************************
 use "${Ethiopia_ESS_W3_temp_data}/sectnr_pp_w3.dta", clear
	...
	use "${Ethiopia_ESS_W3_temp_data}\sect5_pp_w3.dta", clear
	...
	keep hhid network_cd pp_s5q00 pp_snrq02
	ren pp_s5q00 crop_code
	drop if crop_code==. | pp_snrq02==.
	collapse (max) pp_snrq02, by (hhid crop_code network_cd)
 
 //generating global for sources and crop_codes
 ...
 preserve
	...
	save "${Ethiopia_ESS_W3_created_data}\Ethiopia_ESS_W3_purchasedsources_long.dta", replace
 restore
...
merge 1:1 hhid using "${Ethiopia_ESS_W3_created_data}\Ethiopia_ESS_W3_hhids.dta", nogen keep(2 3)
save "${Ethiopia_ESS_W3_created_data}\Ethiopia_ESS_W3_purchasedsources.dta", replace 
...
preserve
	...
	merge 1:1 hhid crop_code using "${Ethiopia_ESS_W3_created_data}\Ethiopia_ESS_W3_purchasedsources_long.dta", nogen
	...
	* reconcile shares if households only report using seeds from a single source but dont report actual quantity of seed used
	...
	save "${Ethiopia_ESS_W3_created_data}/Ethiopia_ESS_W3_seed_sources_long.dta", replace
restore
...
merge 1:1 hhid using "${Ethiopia_ESS_W3_created_data}\Ethiopia_ESS_W3_hhids.dta", nogen keep(2 3)
merge 1:1 hhid using "${Ethiopia_ESS_W3_created_data}\Ethiopia_ESS_W3_purchasedsources.dta", nogen
...
save "${Ethiopia_ESS_W3_created_data}/Ethiopia_ESS_W3_seed_sources.dta", replace 
...
merge 1:1 hhid using "${Ethiopia_ESS_W3_created_data}/Ethiopia_ESS_W3_seed_sources.dta", nogen keep(1 3)
