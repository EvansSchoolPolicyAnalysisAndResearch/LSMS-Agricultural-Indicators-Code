...
saveold "${Ethiopia_ESS_W1_final_data}/Ethiopia_ESS_W1_field_variables.dta", replace
...
global final_data_household  "${Ethiopia_ESS_W1_final_data}/Ethiopia_ESS_W1_household_variables.dta"  
global final_data_individual "${Ethiopia_ESS_W1_final_data}/Ethiopia_ESS_W1_individual_variables.dta"
global final_data_plot       "${Ethiopia_ESS_W1_final_data}/Ethiopia_ESS_W1_field_variables.dta"
global final_outputfile      "$Ethiopia_ESS_W1_final_data\Ethiopia_ESS_W1_summary_stats_`c(current_date)'.xlsx" //update date
...
foreach p of varlist $monetary_vars {
	...
	lab var `p' "`l`p'' (ETB)"  
	gen w_`p'_1ppp = (1+$Ethiopia_ESS_W1_inflation) * w_`p' / $Ethiopia_ESS_W1_cons_ppp_dollar 
	gen w_`p'_2ppp = (1+$Ethiopia_ESS_W1_inflation) * w_`p' / $Ethiopia_ESS_W1_gdp_ppp_dollar 
	gen w_`p'_usd = (1+$Ethiopia_ESS_W1_inflation) * w_`p' / $Ethiopia_ESS_W1_exchange_rate 
	gen w_`p'_loc = (1+$Ethiopia_ESS_W1_inflation) * w_`p'
	local lw_`p' : var lab w_`p'
	lab var w_`p'_1ppp "`lw_`p'' (2016 $ Private Consumption PPP)"
