...
saveold "${Ethiopia_ESS_W2_final_data}/Ethiopia_ESS_W2_field_variables.dta", replace
...
rename household_id2 hhid
preserve
saveold "${Ethiopia_ESS_W2_final_data}/Ethiopia_ESS_W2_household_variables.dta", clear
keep hhid ag_hh
tempfile ag_hh
save `ag_hh'
restore
...
global final_data_household  "${Ethiopia_ESS_W2_final_data}/Ethiopia_ESS_W2_household_variables.dta"  
global final_data_individual "${Ethiopia_ESS_W2_final_data}/Ethiopia_ESS_W2_individual_variables.dta"
global final_data_plot       "${Ethiopia_ESS_W2_final_data}/Ethiopia_ESS_W2_field_variables.dta"
global final_outputfile      "$Ethiopia_ESS_W2_final_data/Ethiopia_ESS_W2_summary_stats_`c(current_date)'.xlsx" 
...
foreach p of varlist $monetary_vars {
	...
	lab var `p' "`l`p'' (ETB)"  
	gen w_`p'_1ppp = (1+$Ethiopia_ESS_W2_inflation) * w_`p' / $Ethiopia_ESS_W2_cons_ppp_dollar 
	gen w_`p'_2ppp = (1+$Ethiopia_ESS_W2_inflation) * w_`p' / $Ethiopia_ESS_W2_gdp_ppp_dollar 
	gen w_`p'_usd = (1+$Ethiopia_ESS_W2_inflation) * w_`p' / $Ethiopia_ESS_W2_exchange_rate 
	gen w_`p'_loc = (1+$Ethiopia_ESS_W2_inflation) * w_`p' 
	local lw_`p' : var lab w_`p'
	lab var w_`p'_1ppp "`lw_`p'' (2016 $ Private Consumption PPP)"
