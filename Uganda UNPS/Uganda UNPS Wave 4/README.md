# README File - Uganda National Panel Survey 2013-2014 (Wave IV)

## PREREQUISITES
Link to download data from the World Bank: https://microdata.worldbank.org/index.php/catalog/2663
dta` Files downloaded must be compiled in a raw folder -  global Uganda_NPS_W4_raw_data in the Master Do-file. Also, you need to create a temporary folder where datasets that have been processed -  cleaned, curated and/or transformed -, and a final folder where final indicators are summarized at different units of analysis (e.g., household, individual, plot level).
Additionally, in the temporary file you need to save the following datasets that can be found in (???):
...
- **DESCRIPTION:** This section sets global variables for use later in the script, including:
  ...
  * Population estimates from: https://databank.worldbank.org/source/world-development-indicators# 
    * UGA_W4_pop_tot Total population in 2014 (World Bank)
    * UGA_W4_pop_rur Rural population in 2014 (World Bank)
    * UGA_W4_pop_urb - Urban population in 2014 (World Bank)
  * Species
  ...
  * Exchange Rates
    * UGA_W4_exchange_rate - USD-Uganda shilling conversion Year: 2014 (Last year survey was conducted)
    * UGA_W4_gdp_ppp_dollar - GDP-based purchasing power parity conversion, World Bank Indicator PA.NUS.PPP Year: 2017
    * UGA_W4_cons_ppp_dollar - Private-consumption-based purchasing power parity conversion, World Bank Indicator PA.NUS.PRVT.P Year: 2017
    * UGA_W4_inflation - inflation between 2014-2017 CPI_SURVEY_YEAR/CPI_2017 - > CPI_2014/CPI_2017
  * Poverty Thresholds
    * UGA_W4_poverty_215 - The updated $2.15 2017 PPP poverty line currently used by the world bank, converted to local currency
    * UGA_W4_poverty_threshold - Calculation for World Bank's previous $1.90 (PPP) poverty threshold. This controls the indicator poverty_under_1_9; change the 1.9 to get results for a different threshold. This is based on the 2011 PPP conversion.
...
### SUMMARY STATISTICS
- **DESCRIPTION:** This section uses an external Do-file "378_Uganda_Wave4_summarystats.do" available in the created_file folder which creates a final summary statistics excel spreadsheet using the household, individual, and plot datasets. 
- **OUTPUT:** `Uganda_NPS_W4_field_plot_variables.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
