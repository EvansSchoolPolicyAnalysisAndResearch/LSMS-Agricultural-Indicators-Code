# README File -  Uganda National Panel Survey 2011-2012, Wave III
...
Additionally, in the temporary file you need to save the following datasets that can be found in the Created DTA Files:
...
- **DESCRIPTION:** This section sets global variables for use later in the script, including:
  ...
  * Population estimates from: https://databank.worldbank.org/source/world-development-indicators# 
    * NPS_LSMS_ISA_W3_pop_tot- Total population in 2012 (World Bank)
    * NPS_LSMS_ISA_W3_pop_rur- Rural population in 2012 (World Bank)
    * NPS_LSMS_ISA_W3_pop_urb- Urban population in 2012 (World Bank)
  * Species
  ...
  * Exchange Rates
    * NPS_LSMS_ISA_W3_exchange_rate - USD-Uganda shilling conversion Year: 2012 (Last year survey was conducted)
    * NPS_LSMS_ISA_W3_gdp_ppp_dollar - GDP-based purchasing power parity conversion, World Bank Indicator PA.NUS.PPP Year: 2017
    * NPS_LSMS_ISA_W3_cons_ppp_dollar - Private-consumption-based purchasing power parity conversion, World Bank Indicator PA.NUS.PRVT.P Year: 2017
    * NPS_LSMS_ISA_W3_inflation - inflation between 2012-2017 CPI_SURVEY_YEAR/CPI_2017 - > CPI_2012/CPI_2017
  * Poverty Thresholds
    * UGS_W3_poverty_215- The updated $2.15 2017 PPP poverty line currently used by the world bank, converted to local currency
    * UGS_W3_poverty_threshold- Calculation for World Bank's previous $1.90 (PPP) poverty threshold. This controls the indicator poverty_under_1_9; change the 1.9 to get results for a different threshold. This is based on the 2011 PPP conversion.
