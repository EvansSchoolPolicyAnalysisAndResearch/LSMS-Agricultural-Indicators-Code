# Uganda National Panel Survey (2011-2012) Wave 3
...
- **DESCRIPTION:** This section sets global variables for use later in the script, including:
  ...
  * Population estimates from: https://databank.worldbank.org/source/world-development-indicators# 
    * Uganda_NPS_W3_pop_tot - Total population in 2012 (World Bank)
    * Uganda_NPS_W3_pop_rur - Rural population in 2012 (World Bank)
    * Uganda_NPS_W3_pop_urb - Urban population in 2012 (World Bank)
  * Species
  ...
  * Exchange Rates
Uganda_NPS_W3_exchange_rate: Exchange rate to USD from the second survey year.
Uganda_NPS_W3_gdp_ppp_dollar: Puchasing power parity conversion using GDP, from https://data.worldbank.org/indicator/PA.NUS.PPP
Uganda_NPS_W3_cons_ppp_dollar: Purchasing power parity conversion using private consumption, from https://data.worldbank.org/indicator/PA.NUS.PRVT.PP
Uganda_NPS_W3_inflation: Inflation conversion factor taken as the ratio of the CPI from the second survey year to the CPI from 2017, the current base year, from https://data.worldbank.org/indicator/FP.CPI.TOTL
Uganda_NPS_W3_poverty_190: The poverty threshold in local currency using the old World Bank $1.90 in 2011 PPP threshold.
Uganda_NPS_W3_poverty_npl: The poverty threshold in local currency using the national poverty line, literature citation to source in do file.
Uganda_NPS_W3_poverty_215: The poverty threshold in local currency using the new World Bank $2.15 in 2017 PPP threshold
...
- **OUTPUT:** `Uganda_NPS_W3_hhids.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
...
- **OUTPUT:** `Uganda_NPS_W3_person_ids.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section. 
...
- **OUTPUT:** `Uganda_NPS_W3_hhsize.dta`
	      `Uganda_NPS_W3_weights.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section. 
...
- **OUTPUT:** `Uganda_NPS_W3_plot_areas.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section. 
...
- **OUTPUT:** `Uganda_NPS_W3_plot_decision_makers.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section. 
...
- **OUTPUT:** `Uganda_NPS_W3_land_rights_hh.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section. 
...
- **OUTPUT:** `Uganda_NPS_W3_all_plots.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section. 
...
- **OUTPUT:** `Uganda_NPS_W3_hh_crop_values_production.dta`
...
- **OUTPUT:** Uganda_NPS_W3_hh_cost_inputs
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section. 
...
- **OUTPUT:** `Uganda_NPS_W3_`cn'_monocrop_hh_area.dta`, `cn' represents each priority crop
	      `Uganda_NPS_W3_inputs_`cn'.dta` , `cn' represents each priority crop
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section. 
...
- **OUTPUT:** `Uganda_NPS_W3_tlu_all_animals.dta`
	      `Uganda_NPS_W3_TLU_Coefficients.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section. 
...
- **OUTPUT:** `Uganda_NPS_W3_wage_income.dta`
...
- **OUTPUT:** `Uganda_NPS_W3_family_hired_labor.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section. 
...
- **OUTPUT:** `Uganda_NPS_W3_vaccine.dta`
	      `Uganda_NPS_W3_farmer_vaccine.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
...
- **OUTPUT:** `Uganda_NPS_W3_livestock_feed_water_house.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
...
- **OUTPUT:** `Uganda_NPS_W3_fert_use.dta`
	      `Uganda_NPS_W3_farmer_fert_use.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
...
- **OUTPUT:** `Uganda_NPS_W3_improvedseed_use.dta`
	      `Uganda_NPS_W3_farmer_improvedseed_use.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.

### PLOT MANAGER
- **DESCRIPTION:** This section combines the use of inorganic fertilizer and improved seeds sections into one. 
- **OUTPUT:** `Uganda_NPS_W3_farmer_fert_use.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
...
- **OUTPUT:** `Uganda_NPS_W3_any_ext.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
...
- **OUTPUT:** `Uganda_NPS_W3_mobile_own.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
...
- **OUTPUT:** `Uganda_NPS_W3_milk_animals.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
...
- **OUTPUT:** `Uganda_NPS_W3_eggs_animals.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** The questions used in this section were framed differently across waves, therefore the indicators found in this section are not comparable across waves. 
...
- **OUTPUT:** `Uganda_NPS_W3_cropcosts.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section. 
...
- **OUTPUT:** `Uganda_NPS_W3_fertilizer_application.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
...
- **OUTPUT:** `Uganda_NPS_W3_household_diet.dta`
	          `Uganda_NPS_W3_fcs.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
...
- **OUTPUT:** `Uganda_NPS_W3_control_income.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
...
- **OUTPUT:** `Uganda_NPS_W3_make_ag_decision.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
...
- **OUTPUT:** `Uganda_NPS_W3_ownasset.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
...
- **OUTPUT:** `Uganda_NPS_W3_ag_wage.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
...
- **OUTPUT:** `Uganda_NPS_W3_yield_hh_crop_level.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.. 
...
- **OUTPUT:** `Uganda_NPS_W3_shannon_diversity_index.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
...
- **OUTPUT:** `Uganda_NPS_W3_consumption.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
...
- **OUTPUT:** `Uganda_NPS_W3_food_cons.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
...
- **OUTPUT:** `Uganda_NPS_W3_field_plot_variables.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
...
- **OUTPUT:** `Uganda_NPS_W3_summary_stats.xlsx`, `Uganda_NPS_W3_summary_stats_with_labels.dta`
- **CODING STATUS:** ![COMPLETE](https://placehold.co/15x15/c5f015/c5f015.png) `COMPLETE`
- **KNOWN ISSUES:** No issues in this section.
