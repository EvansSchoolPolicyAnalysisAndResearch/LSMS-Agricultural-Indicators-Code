...
rename conv_factor_harv conv_fact_harv
keep HHID /*crop_name*/ crop_code condition_harv unit_code conv_fact_harv condition_sold sold_unit_code region weight /*district county subcounty parish ea*/
gen wave="wave 2" 
keep if crop_code!=.
tempfile wave2 
save `wave2'
restore
*I.3. Uganda Wave 3 (Missing Sold Conversion Factor)
preserve
...
drop if unit_code==. 
save "R:\Project\EPAR\Working Files\378 - LSMS Burkina Faso, Malawi, Uganda\uganda-standard-conversion-factor-table\UG_Conv_fact_harvest_table.dta", replace
restore
...
*label value condition_harv a5aq6b
drop if unit_code==. 
save "R:\Project\EPAR\Working Files\378 - LSMS Burkina Faso, Malawi, Uganda\uganda-standard-conversion-factor-table\UG_Conv_fact_harvest_table_national.dta", replace
restore
...
save "R:\Project\EPAR\Working Files\378 - LSMS Burkina Faso, Malawi, Uganda\uganda-standard-conversion-factor-table\UG_Conv_fact_sold_table.dta", replace
restore
...
drop if sold_unit_code==.
save "R:\Project\EPAR\Working Files\378 - LSMS Burkina Faso, Malawi, Uganda\uganda-standard-conversion-factor-table\UG_Conv_fact_sold_table_national.dta", replace
