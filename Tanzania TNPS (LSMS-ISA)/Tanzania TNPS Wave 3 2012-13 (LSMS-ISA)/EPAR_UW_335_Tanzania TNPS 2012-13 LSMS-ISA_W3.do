...
*Using data files from within the "Tanzania TNPS - LSMS-ISA - Wave 3 (2013-14)" folder within the "Raw DTA files" folder, 
*the do.file first constructs common and intermediate variables, saving dta files when appropriate 
*in the folder "\Tanzania TNPS - LSMS-ISA - Wave 3 (2012-13)\created_data" within the "Final DTA files" folder.
*These variables are then brought together at the household, plot, or individual level, saving dta files at each level when available 
*in the folder "Tanzania TNPS - LSMS-ISA - Wave 3 (2012-13)" within the "Final DTA files" folder.
...
*The results are outputted in the excel file "Tanzania_NPS_LSMS_ISA_W3_summary_stats.xlsx" in the "Tanzania TNPS - LSMS-ISA - Wave 3 (2012-13)" within the "Final DTA files" folder.
...
*-------------------------------------------------------------------------------------
*HOUSEHOLD IDS						Tanzania_NPS_LSMS_ISA_W3_hhids.dta
*INDIVIDUAL IDS						Tanzania_NPS_LSMS_ISA_W3_person_ids.dta
*HOUSEHOLD SIZE						Tanzania_NPS_LSMS_ISA_W3_hhsize.dta
*PARCEL AREAS						Tanzania_NPS_LSMS_ISA_W3_plot_areas.dta
*PLOT-CROP DECISION MAKERS			Tanzania_NPS_LSMS_ISA_W3_plot_decision_makers.dta
*TLU (Tropical Livestock Units)		Tanzania_NPS_LSMS_ISA_W3_TLU_Coefficients.dta

*GROSS CROP REVENUE					Tanzania_NPS_LSMS_ISA_W3_tempcrop_harvest.dta
									Tanzania_NPS_LSMS_ISA_W3_tempcrop_sales.dta
									Tanzania_NPS_LSMS_ISA_W3_permcrop_harvest.dta
									Tanzania_NPS_LSMS_ISA_W3_permcrop_sales.dta
									Tanzania_NPS_LSMS_ISA_W3_hh_crop_production.dta
									Tanzania_NPS_LSMS_ISA_W3_plot_cropvalue.dta
									Tanzania_NPS_LSMS_ISA_W3_parcel_cropvalue.dta
									Tanzania_NPS_LSMS_ISA_W3_crop_residues.dta
									Tanzania_NPS_LSMS_ISA_W3_hh_crop_prices.dta
									Tanzania_NPS_LSMS_ISA_W3_crop_losses.dta
*CROP EXPENSES						Tanzania_NPS_LSMS_ISA_W3_wages_mainseason.dta
									Tanzania_NPS_LSMS_ISA_W3_wages_shortseason.dta
									
									Tanzania_NPS_LSMS_ISA_W3_fertilizer_costs.dta
									Tanzania_NPS_LSMS_ISA_W3_seed_costs.dta
									Tanzania_NPS_LSMS_ISA_W3_land_rental_costs.dta
									Tanzania_NPS_LSMS_ISA_W3_asset_rental_costs.dta
									Tanzania_NPS_LSMS_ISA_W3_transportation_cropsales.dta
									
*CROP INCOME						Tanzania_NPS_LSMS_ISA_W3_crop_income.dta
									
*LIVESTOCK INCOME					Tanzania_NPS_LSMS_ISA_W3_livestock_products.dta
									Tanzania_NPS_LSMS_ISA_W3_livestock_expenses.dta
									Tanzania_NPS_LSMS_ISA_W3_hh_livestock_products.dta
									Tanzania_NPS_LSMS_ISA_W3_livestock_sales.dta
									Tanzania_NPS_LSMS_ISA_W3_TLU.dta
									Tanzania_NPS_LSMS_ISA_W3_livestock_income.dta

*FISH INCOME						Tanzania_NPS_LSMS_ISA_W3_fishing_expenses_1.dta
									Tanzania_NPS_LSMS_ISA_W3_fishing_expenses_2.dta
									Tanzania_NPS_LSMS_ISA_W3_fish_income.dta
																	
*SELF-EMPLOYMENT INCOME				Tanzania_NPS_LSMS_ISA_W3_self_employment_income.dta
									Tanzania_NPS_LSMS_ISA_W3_agproducts_profits.dta
									Tanzania_NPS_LSMS_ISA_W3_fish_trading_revenue.dta
									Tanzania_NPS_LSMS_ISA_W3_fish_trading_other_costs.dta
									Tanzania_NPS_LSMS_ISA_W3_fish_trading_income.dta
									
*WAGE INCOME						Tanzania_NPS_LSMS_ISA_W3_wage_income.dta
									Tanzania_NPS_LSMS_ISA_W3_agwage_income.dta
*OTHER INCOME						Tanzania_NPS_LSMS_ISA_W3_other_income.dta
									Tanzania_NPS_LSMS_ISA_W3_land_rental_income.dta

*FARM SIZE / LAND SIZE				Tanzania_NPS_LSMS_ISA_W3_land_size.dta
									Tanzania_NPS_LSMS_ISA_W3_farmsize_all_agland.dta
									Tanzania_NPS_LSMS_ISA_W3_land_size_all.dta
*FARM LABOR							Tanzania_NPS_LSMS_ISA_W3_farmlabor_mainseason.dta
									Tanzania_NPS_LSMS_ISA_W3_farmlabor_shortseason.dta
									Tanzania_NPS_LSMS_ISA_W3_family_hired_labor.dta
*VACCINE USAGE						Tanzania_NPS_LSMS_ISA_W3_vaccine.dta
*USE OF INORGANIC FERTILIZER		Tanzania_NPS_LSMS_ISA_W3_fert_use.dta
*USE OF IMPROVED SEED				Tanzania_NPS_LSMS_ISA_W3_improvedseed_use.dta

*REACHED BY AG EXTENSION			Tanzania_NPS_LSMS_ISA_W3_any_ext.dta
*USE OF FORMAL FINANACIAL SERVICES	Tanzania_NPS_LSMS_ISA_W3_fin_serv.dta
*GENDER PRODUCTIVITY GAP 			Tanzania_NPS_LSMS_ISA_W3_gender_productivity_gap.dta
*MILK PRODUCTIVITY					Tanzania_NPS_LSMS_ISA_W3_milk_animals.dta
*EGG PRODUCTIVITY					Tanzania_NPS_LSMS_ISA_W3_eggs_animals.dta

*CROP PRODUCTION COSTS PER HECTARE	Tanzania_NPS_LSMS_ISA_W3_hh_cost_land.dta
									Tanzania_NPS_LSMS_ISA_W3_hh_cost_inputs_lrs.dta
									Tanzania_NPS_LSMS_ISA_W3_hh_cost_inputs_srs.dta
									Tanzania_NPS_LSMS_ISA_W3_hh_cost_seed_lrs.dta
									Tanzania_NPS_LSMS_ISA_W3_hh_cost_seed_srs.dta		
									Tanzania_NPS_LSMS_ISA_W3_cropcosts_perha.dta

*RATE OF FERTILIZER APPLICATION		Tanzania_NPS_LSMS_ISA_W3_fertilizer_application.dta
*HOUSEHOLD'S DIET DIVERSITY SCORE	Tanzania_NPS_LSMS_ISA_W3_household_diet.dta
*WOMEN'S CONTROL OVER INCOME		Tanzania_NPS_LSMS_ISA_W3_control_income.dta
*WOMEN'S AG DECISION-MAKING			Tanzania_NPS_LSMS_ISA_W3_make_ag_decision.dta
*WOMEN'S ASSET OWNERSHIP			Tanzania_NPS_LSMS_ISA_W3_ownasset.dta
*AGRICULTURAL WAGES					Tanzania_NPS_LSMS_ISA_W3_ag_wage.dta
*CROP YIELDS						Tanzania_NPS_LSMS_ISA_W3_yield_hh_crop_level.dta
*CONSUMPTION						Tanzania_NPS_LSMS_ISA_W3_consumption.dta

*FINAL FILES						MAIN FILES CREATED
*-------------------------------------------------------------------------------------
*HOUSEHOLD VARIABLES				Tanzania_NPS_LSMS_ISA_W3_household_variables.dta
*INDIVIDUAL-LEVEL VARIABLES			Tanzania_NPS_LSMS_ISA_W3_individual_variables.dta	
*PLOT-LEVEL VARIABLES				Tanzania_NPS_LSMS_ISA_W3_gender_productivity_gap.dta
*SUMMARY STATISTICS					Tanzania_NPS_LSMS_ISA_W3_summary_stats.xlsx
*/
...
global TZA_W3_raw_data 	"\\netid.washington.edu\wfs\EvansEPAR\Project\EPAR\Working Files\335 - Ag Team Data Support\Waves\Tanzania\Tanzania TNPS Wave 3 2012-13 (LSMS-ISA)\Raw DTA files\Tanzania TNPS - LSMS-ISA Wave 3 (2012-13)" 
global TZA_W3_created_data "\\netid.washington.edu\wfs\EvansEPAR\Project\EPAR\Working Files\335 - Ag Team Data Support\Waves\Tanzania\Tanzania TNPS Wave 3 2012-13 (LSMS-ISA)\Final DTA files\created_data" 
global TZA_W3_final_data  	"\\netid.washington.edu\wfs\EvansEPAR\Project\EPAR\Working Files\335 - Ag Team Data Support\Waves\Tanzania\Tanzania TNPS Wave 3 2012-13 (LSMS-ISA)\Final DTA files"

************************
*EXCHANGE RATE AND INFLATION FOR CONVERSION IN SUD IDS
************************
global NPS_LSMS_ISA_W3_exchange_rate 2158
global NPS_LSMS_ISA_W3_gdp_ppp_dollar 686.367  // https://data.worldbank.org/indicator/PA.NUS.PPP
global NPS_LSMS_ISA_W3_cons_ppp_dollar 809.32 // https://data.worldbank.org/indicator/PA.NUS.PRVT.PP
global NPS_LSMS_ISA_W3_inflation 0.178559272
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hhids.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_person_ids.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hhsize.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_areas.dta", replace
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_gender_merge.dta", replace
...
merge m:1 y3_hhid personid using  "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_gender_merge.dta", gen(dm1_merge) keep(1 3)	
...
merge m:1 y3_hhid personid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_gender_merge.dta", gen(dm2_merge) keep(1 3)
gen dm2_female = female
drop female personid
*Third
gen personid = ag3a_08_3
replace personid =ag3b_08_3 if personid==. &  ag3b_08_3!=.
merge m:1 y3_hhid personid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_gender_merge.dta", gen(dm3_merge) keep(1 3)
...
merge m:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hhsize.dta", nogen 				
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_decision_makers.dta", replace
...
merge m:1 y3_hhid plot_id using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_plot_areas.dta", nogen assert(2 3) keep(3)
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_`cn'_monocrop.dta", replace
}
...
local c : word `k' of $topcrop_area
local cn : word `k' of $topcropname_area
use "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_`cn'_monocrop.dta", clear
merge m:1 y3_hhid plot_id using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_decision_makers.dta"
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_`cn'_monocrop_hh_area.dta", replace
}
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_TLU_Coefficients.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_tempcrop_harvest.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_tempcrop_sales.dta", replace
...
lab var kgs_harvest "Kgs harvested of this crop, summed over main and short season"
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_permcrop_harvest.dta", replace
...
gen price_kg = value_sold / quantity_sold
lab var price_kg "Price per kg sold"
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_permcrop_sales.dta", replace

*Prices of permanent and tree crops need to be imputed from sales.
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_permcrop_sales.dta", clear
append using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_tempcrop_sales.dta"
recode price_kg (0=.) 
merge m:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hhids.dta"
drop if _merge==2
drop _merge
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_sales.dta", replace

use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_prices_ea.dta", replace
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_prices_ward.dta", replace
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_prices_district.dta", replace
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_prices_region.dta", replace
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_prices_country.dta", replace

*Pull prices into harvest estimates
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_tempcrop_harvest.dta", clear
append using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_permcrop_harvest.dta"
merge m:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hhids.dta"
drop if _merge==2
drop _merge
merge m:1 y3_hhid crop_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_sales.dta"
drop _merge
merge m:1 region district ward ea crop_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_prices_ea.dta"
drop _merge
merge m:1 region district ward crop_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_prices_ward.dta"
drop _merge
merge m:1 region district crop_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_prices_district.dta"
drop _merge
merge m:1 region crop_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_prices_region.dta"
drop _merge
merge m:1 crop_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_prices_country.dta"
drop _merge
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_values_tempfile.dta", replace 
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_crop_values_production.dta", replace
restore
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_crop_production.dta", replace

*Plot value of crop production
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_values_tempfile.dta", clear
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_cropvalue.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_residues.dta", replace


*Crop values for inputs in agricultural product processing (self-employment)
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_tempcrop_harvest.dta", clear
append using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_permcrop_harvest.dta"
merge m:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hhids.dta", nogen keep(1 3)
merge m:1 y3_hhid crop_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_sales.dta", nogen
merge m:1 region district ward ea crop_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_prices_ea.dta", nogen
merge m:1 region district ward crop_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_prices_ward.dta", nogen
merge m:1 region district crop_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_prices_district.dta", nogen
merge m:1 region crop_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_prices_region.dta", nogen
merge m:1 crop_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_prices_country.dta", nogen
replace price_kg = price_kg_median_ea if price_kg==. & obs_ea >= 10 & crop_code!=998 
replace price_kg = price_kg_median_ward if price_kg==. & obs_ward >= 10 & crop_code!=998
replace price_kg = price_kg_median_district if price_kg==. & obs_district >= 10 & crop_code!=998
replace price_kg = price_kg_median_region if price_kg==. & obs_region >= 10 & crop_code!=998
...
duplicates drop
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_crop_prices.dta", replace
...
merge 1:1 y3_hhid crop_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_crop_values_production.dta"
drop if _merge==2
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_losses.dta", replace
...
preserve
	...
	*Merge in monocropped plots
	merge m:1 y3_hhid plot_id short using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_`cn'_monocrop.dta", nogen assert(1 3) keep(3)
	...
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_wages_mainseason_`cn'.dta", replace
restore
} 

collapse (sum) wages_paid_main, by (y3_hhid)
lab var wages_paid_main  "Wages paid for hired labor (crops) in main growing season"
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_wages_mainseason.dta", replace
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_wages_shortseason_`cn'.dta", replace
restore
} 
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_wages_shortseason.dta", replace
...
preserve
	...
	merge m:1 y3_hhid indidy3 using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_person_ids.dta", nogen keep(3)	
...
preserve
	...
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_land_rights_ind.dta", replace
restore	
...
preserve
	...
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_land_rights_hh.dta", replace
restore
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_fertilizer_costs_`cn'.dta", replace
restore
}
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_fertilizer_costs.dta", replace
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_seed_costs_`cn'.dta", replace
restore
}

collapse (sum) cost_seed, by (y3_hhid)
lab var cost_seed "Expenditures on seed for temporary crops"
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_seed_costs.dta", replace
...
preserve
	...
	*disaggregate by gender of plot manager
	merge m:1 y3_hhid plot_id using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_decision_makers.dta"
	*Merge in monocropped plots
	merge 1:1 y3_hhid plot_id short using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_`cn'_monocrop.dta", nogen assert(1 3) keep(3)	
	...
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_land_rental_costs_`cn'.dta", replace
restore
}

collapse (sum) rental_cost_land, by (y3_hhid)
lab var rental_cost_land "Rental costs paid for land"
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_land_rental_costs.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_asset_rental_costs.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_transportation_cropsales.dta", replace


*Crop costs 
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_asset_rental_costs.dta", clear
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_land_rental_costs.dta", nogen
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_seed_costs.dta", nogen
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_fertilizer_costs.dta", nogen
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_wages_shortseason.dta", nogen
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_wages_mainseason.dta", nogen
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_transportation_cropsales.dta", nogen
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_income.dta", replace
...
preserve 
	...
	save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_lrum_expenses", replace
restore
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_expenses", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products_milk", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products_other", replace

use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products_milk", clear
append using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products_other"
merge m:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hhids.dta"
drop if _merge==2
drop _merge
replace price_per_unit = . if price_per_unit == 0 
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products", replace

use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products", clear
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products_prices_ea.dta", replace
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products_prices_ward.dta", replace
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products_prices_dist.dta", replace
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products_prices_region.dta", replace
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products_prices_country.dta", replace

use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products", clear
merge m:1 region district ward ea livestock_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products_prices_ea.dta", nogen
merge m:1 region district ward livestock_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products_prices_ward.dta", nogen
merge m:1 region district livestock_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products_prices_dist.dta", nogen
merge m:1 region livestock_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products_prices_region.dta", nogen
merge m:1 livestock_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_products_prices_country.dta", nogen
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_livestock_products", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_dung.dta", replace
...
merge m:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hhids.dta", nogen keep(1 3)
keep y3_hhid weight region district ward ea livestock_code number_sold income_live_sales number_slaughtered income_slaughtered price_per_animal value_livestock_purchases
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_livestock_sales", replace

*Implicit prices
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_livestock_sales", clear
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_prices_ea.dta", replace
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys region district ward livestock_code: egen obs_ward = count(observation)
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_prices_ward.dta", replace
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys region district livestock_code: egen obs_district = count(observation)
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_prices_district.dta", replace
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys region livestock_code: egen obs_region = count(observation)
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_prices_region.dta", replace
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys livestock_code: egen obs_country = count(observation)
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_prices_country.dta", replace

use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_livestock_sales", clear
merge m:1 region district ward ea livestock_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_prices_ea.dta", nogen
merge m:1 region district ward livestock_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_prices_ward.dta", nogen
merge m:1 region district livestock_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_prices_district.dta", nogen
merge m:1 region livestock_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_prices_region.dta", nogen
merge m:1 livestock_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_prices_country.dta", nogen
...
replace value_slaughtered = income_slaughtered if (value_slaughtered < income_slaughtered) & number_slaughtered!=0 
gen value_livestock_sales = value_sold + value_slaughtered
collapse (sum) value_livestock_sales value_livestock_purchases, by (y3_hhid)
drop if y3_hhid==""
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_sales", replace
...
preserve
	*Now to household level
	collapse (firstnm) share_imp_herd_cows (sum) number_today number_1yearago animals_lost12months number_today_exotic lvstck_holding=number_today, by(y3_hhid species)
	egen mean_12months = rowmean(number_today number_1yearago)
    ...
    *Total livestock holding for large ruminants, small ruminants, and poultry
	...
	save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_herd_characteristics", replace
restore
...
drop if y3_hhid==""
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_TLU.dta", replace


*Livestock income
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_sales", clear
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_livestock_products", nogen
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_dung.dta", nogen
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_expenses", nogen
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_TLU.dta", nogen
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_TLU_Coefficients.dta", nogen
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_income", replace
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_weeks_fishing.dta", replace
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_fishing_expenses_1.dta", replace

use "${TZA_W3_raw_data}\Livestock and Fisheries\LF_SEC_11B.dta", clear
merge m:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_weeks_fishing.dta"
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_fishing_expenses_2.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_fish_prices.dta", replace
...
merge m:1 fish_code unit using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_fish_prices.dta"
drop if _merge==2
drop _merge
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_fish_income.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_self_employment_income.dta", replace
...
merge m:1 y3_hhid crop_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_crop_prices.dta", nogen
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_agproducts_profits.dta", replace
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_weeks_fish_trading.dta", replace
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_fish_trading_revenue.dta", replace
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_fish_trading_other_costs.dta", replace

use "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_weeks_fish_trading.dta", clear
merge 1:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_fish_trading_revenue.dta" , nogen
merge 1:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_fish_trading_other_costs.dta", nogen
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_fish_trading_income.dta", replace
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_off_farm_hours.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_wage_income.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_agwage_income.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_other_income.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_land_rental_income.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_parcels_cultivated.dta", replace

use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_parcels_cultivated.dta", clear
merge 1:1 y3_hhid plot_id using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_areas.dta"
drop if _merge==2
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_land_size.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_parcels_agland.dta", replace

use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_parcels_agland.dta", clear
merge 1:1 y3_hhid plot_id using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_areas.dta"
drop if _merge==2
replace area_acres_meas=. if area_acres_meas<0
replace area_acres_meas = area_acres_est if area_acres_meas==. 
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_farmsize_all_agland.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_parcels_held.dta", replace

use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_parcels_held.dta", clear
merge 1:1 y3_hhid plot_id using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_areas.dta"
drop if _merge==2
replace area_acres_meas=. if area_acres_meas<0
replace area_acres_meas = area_acres_est if area_acres_meas==. 
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_land_size_all.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_farmlabor_mainseason.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_farmlabor_shortseason.dta", replace

*Labor
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_farmlabor_mainseason.dta", clear
merge 1:1 y3_hhid plot_id using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_farmlabor_shortseason.dta" , nogen
recode days*  (.=0)
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_family_hired_labor.dta", replace
recode labor_*  (.=0)
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_family_hired_labor.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_vaccine.dta", replace
...
drop if personid==.
merge 1:1 y3_hhid personid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_gender_merge.dta", nogen 
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_farmer_vaccine.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_fert_use.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_farmer_fert_use.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_improvedseed_use.dta", replace   
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_farmer_improvedseed_use_temp.dta", replace

*Use of seed by crop 
forvalues k=1/15 {
	use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_farmer_improvedseed_use_temp.dta", clear 
	local c : word `k' of $topcrop_area
	local cn : word `k' of $topcropname_area
	*Adding adoption of improved seeds
	...
	save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_farmer_improvedseed_use_temp_`cn'.dta", replace
}

*Combining all crop disaggregated files together
foreach v in $topcropname_area {
	merge 1:1 y3_hhid farmerid all_imprv_seed_use using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_farmer_improvedseed_use_temp_`v'.dta", nogen
}
...
recode farm_manager (.=0)
lab var farm_manager "1=Indvidual is listed as a manager for at least one plot" 
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_farmer_improvedseed_use.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_any_ext.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_fin_serv.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_milk_animals.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_eggs_animals.dta", replace
...
ren plotnum plot_id
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_plot_area_lrs.dta", replace
*Getting plot rental rate
use "${TZA_W3_raw_data}/Agriculture/AG_SEC_3A.dta", clear
ren plotnum plot_id
merge 1:1 plot_id y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_plot_area_lrs.dta" , nogen	
drop if plot_id==""
gen cultivated = ag3a_03==1
merge m:1 y3_hhid plot_id using  "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_decision_makers.dta", nogen keep (1 3)
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_rent_nomiss_lrs.dta", replace				
...
preserve
	...
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_rental_rate_lrs.dta", replace
restore
...
preserve
	...
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_rental_rate_hhid_lrs.dta", replace
restore
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_rental_rate_lrs.dta", replace
...
keep plot_ha plotnum y3_hhid
ren plotnum plot_id
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_plot_area_srs.dta", replace
*Getting plot rental rate
use "${TZA_W3_raw_data}/Agriculture/AG_SEC_3B.dta", clear
drop if plotnum==""
gen cultivated = ag3b_03==1
ren  plotnum plot_id
merge m:1 y3_hhid plot_id using  "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_decision_makers.dta", nogen 
merge 1:1 plot_id y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_plot_area_lrs.dta", nogen					
merge 1:1 plot_id y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_plot_area_srs.dta", nogen update replace		
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_rent_nomiss_srs.dta", replace
preserve // NKQ: added labels here 
	...
	lab var value_rented_land_mixed "Value of rented land (mixed-managed plot)	
	collapse (sum) value_rented_land_* value_rented_land = plot_rental_rate, by(y3_hhid)
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_rental_rate_srs.dta", replace
restore
gen ha_rental_rate_hh = plot_rental_rate/plot_ha
preserve
	keep if plot_rental_rate!=. & plot_rental_rate!=0			
	...
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_rental_rate_hhid_srs.dta", replace
restore
*Merging in geographic variables
merge m:1 y3_hhid using "${TZA_W3_raw_data}/Household/HH_SEC_A.dta", nogen assert(2 3) keep(3)	
*Geographic medians
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_rental_rate_srs.dta", replace


*Now getting total ha of all plots that were cultivated at least once
use "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_rent_nomiss_lrs.dta", clear
append using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_rent_nomiss_srs.dta"
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_cultivated_plots_ha.dta", replace

use "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_rental_rate_lrs.dta", clear
append using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_rental_rate_srs.dta"
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_rental_rate.dta", replace
...
drop if plotnum==""
ren  plotnum plot_id
merge m:1 y3_hhid plot_id using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_rent_nomiss_lrs.dta", nogen keep(1 3)
*First rescaling
...
merge m:1 plot_id y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_plot_area_lrs", nogen assert(2 3) keep(3)		
...
merge m:1 hh_a01_1 hh_a02_1 hh_a03_1 hh_a04_1 using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_rental_rate_lrs", nogen assert(2 3) keep(3)			
*Now merging in rental costs of individual plots
merge m:1 y3_hhid plot_id using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_rent_nomiss_lrs.dta", nogen keep(1 3)
*Now merging in household rental rate
merge m:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_rental_rate_hhid_lrs.dta", nogen keep(1 3)
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_cost_land_lrs.dta", replace
...
drop if plotnum==""
ren plotnum plot_id 
merge m:1 y3_hhid plot_id using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_rent_nomiss_lrs.dta", nogen keep(1 3) keepusing(dm_gender)
merge m:1 y3_hhid plot_id using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_rent_nomiss_srs.dta", nogen keep(1 3) keepusing(dm_gender) update
*First rescaling
...
merge m:1 plot_id y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_plot_area_lrs", nogen keep(1 3) keepusing(plot_ha)						
merge m:1 plot_id y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_plot_area_srs", nogen keepusing(plot_ha) update							
gen ha_planted = percent_plot*plot_ha
gen ha_planted_male = ha_planted if dm_gender==1
gen ha_planted_female = ha_planted if dm_gender==2
gen ha_planted_mixed = ha_planted if dm_gender==3
...
merge m:1 hh_a01_1 hh_a02_1 hh_a03_1 hh_a04_1 using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_rental_rate_lrs", nogen keep(1 3) 
*Now merging in rental costs actually incurred by household
merge m:1 y3_hhid plot_id using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_rent_nomiss_lrs.dta", nogen keep(1 3)
*Now merging in household rental rate
merge m:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_rental_rate_hhid_lrs.dta", nogen keep(1 3)		
merge m:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_rental_rate_hhid_srs.dta", nogen	update			
gen value_owned_land = ha_planted*ha_rental_rate if ag3a_33==0 | ag3a_33==.		
replace value_owned_land = ha_planted*ha_rental_hh_lrs if ha_rental_hh_lrs!=0 & ha_rental_hh_lrs!=. & (ag3a_33==0 | ag3a_33==.)		
*Now creating gender value
gen value_owned_land_male = ha_planted*ha_rental_rate if (ag3a_33==0 | ag3a_33==.) & dm_gender==1
...
collapse (sum) value_owned_land* ha_planted*, by(y3_hhid plot_id)			
append using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_cost_land_lrs.dta"		

preserve
	collapse (sum) ha_planted*, by(y3_hhid)
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_ha_planted_total.dta", replace
restore
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_cost_land.dta", replace
...
preserve
	...
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_fert_lrs.dta", replace
restore
...
preserve
	...
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_org_fert_lrs.dta", replace
restore
merge m:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_org_fert_lrs.dta", nogen
...
preserve
	...
	recode *wage* (0=.)			
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_wages_hh_lrs.dta", replace
restore
merge m:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_wages_hh_lrs.dta", nogen
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_cost_inputs_lrs.dta", replace
...
preserve
	...
	gen fert_inorg_kg_mixed = fert_inorg_kg if dm_gender==3
	collapse (sum) fert_org_kg fert_inorg_kg*, by(y3_hhid)
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_fert_srs.dta", replace
restore
...
preserve
	...
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_org_fert_srs.dta", replace
restore
merge m:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_org_fert_srs.dta", nogen
...
preserve
	...
	gen harv_wage_hh = harv_labor_costs/harv_labor
	recode *wage* (0=.)
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_wages_hh_srs.dta", replace
restore

merge m:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_wages_hh_srs.dta", nogen
...
collapse (sum) value_*, by(y3_hhid)
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_cost_inputs_srs.dta", replace

use  "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_cost_inputs_lrs.dta", clear
append using  "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_cost_inputs_srs.dta"
collapse (sum) value_*, by(y3_hhid)
...
preserve
	...
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_seeds_hh_lrs.dta", replace
restore
merge m:1 y3_hhid zaocode using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_seeds_hh_lrs.dta", nogen
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_cost_seed_lrs.dta", replace
...
preserve
	...
	recode seed_price_hh_crop (0=.) 
	save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_seeds_hh_srs.dta", replace
restore
merge m:1 y3_hhid zaocode using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_seeds_hh_srs.dta", nogen
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_cost_seed_srs.dta", replace
...
use "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_cost_land.dta", clear
append using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_rental_rate.dta"
append using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_cost_inputs_lrs.dta"
append using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_cost_inputs_srs.dta"
append using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_cost_seed_lrs.dta"
append using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_cost_seed_srs.dta"
append using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_asset_rental_costs.dta"
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_cropcosts_total.dta", replace

************
*RATE OF FERTILIZER APPLICATION
************
use "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_cost_land.dta", clear 
append using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_fert_lrs.dta"
append using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_fert_srs.dta"
collapse (sum) ha_planted* fert_org_kg* fert_inorg_kg*, by(y3_hhid)


merge m:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hhids.dta", keep (1 3) nogen
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_fertilizer_application.dta", replace
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_household_diet.dta", replace
...
merge 1:1 y3_hhid indidy3  using  "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_person_ids.dta", nogen 
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_control_income.dta", replace
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_make_ag_decision.dta", replace
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_ownasset.dta", replace
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_ag_wage.dta", replace
...
drop if plotnum==""
ren plotnum plot_id 
merge m:1 y3_hhid plot_id using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_areas.dta" , nogen keep(1 3)    
merge m:1 y3_hhid plot_id using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_decision_makers" , nogen keep(1 3)
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_plot_crop_area.dta", replace
...
merge m:1 y3_hhid plot_id zaocode using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_plot_crop_area.dta", nogen keep(1 3)			
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_area_planted_harvested_allcrops_LRS.dta", replace
restore

keep if inlist(zaocode, $comma_topcrop_area)
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_crop_harvest_area_yield_LRS.dta", replace
...
keep crop_area_planted* y3_hhid plot_id zaocode dm_* any_* pure_stand dm_gender  field_area us_* area_meas_hectares area_est_hectares
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_plot_crop_area_SRS.dta", replace
...
ren plotnum plot_id 
*Merging decision maker and intercropping variables
merge m:1 y3_hhid plot_id zaocode using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_plot_crop_area_SRS.dta", nogen keep(1 3)			
...
collapse (sum) all_area_harvested=area_harv all_area_planted=area_plan, by(y3_hhid)
replace all_area_harvested=all_area_planted if all_area_harvested>all_area_planted & all_area_harvested!=.
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_area_planted_harvested_allcrops_SRS.dta", replace
*Append LRS 
append using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_area_planted_harvested_allcrops_LRS.dta"
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_area_planted_harvested_allcrops.dta", replace
restore
...
keep if inlist( zaocode, $comma_topcrop_area)
gen season="SRS"
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_crop_harvest_area_yield_SRS.dta", replace


*Yield at the household level
use "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_crop_harvest_area_yield_LRS.dta", clear
preserve
gen season="LRS"
append using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_crop_harvest_area_yield_SRS.dta"
...
merge 1:1 y3_hhid crop_code using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_crop_values_production.dta", nogen keep(1 3)
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_yield_hh_crop_level.dta", replace
...
save "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_consumption.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_food_insecurity.dta", replace
...
save "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_assets.dta", replace 
...
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hhids.dta", clear
*Gross crop income 
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_crop_production.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_crop_losses.dta", nogen keep (1 3)
recode value_crop_production crop_value_lost (.=0)
*Crop costs
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_asset_rental_costs.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_land_rental_costs.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_seed_costs.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_fertilizer_costs.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_wages_shortseason.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_wages_mainseason.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_transportation_cropsales.dta", nogen keep (1 3)
recode rental_cost_animal_traction rental_cost_ag_asset rental_cost_tractor rental_cost_land cost_seed value_fertilizer /*
*/ value_herb_pest wages_paid_short wages_paid_main transport_costs_cropsales (.=0)
egen crop_production_expenses = rowtotal(rental_cost_animal_traction rental_cost_ag_asset rental_cost_tractor rental_cost_land cost_seed value_fertilizer /*
*/ value_herb_pest wages_paid_short wages_paid_main transport_costs_cropsales)
...
foreach c in $topcropname_area {
	merge 1:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_land_rental_costs_`c'.dta", nogen keep (1 3)
	merge 1:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_fertilizer_costs_`c'.dta", nogen keep (1 3)
	merge 1:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_`c'_monocrop_hh_area.dta", nogen keep (1 3)
}

*top crop costs that are only present in short season
foreach c in $topcropname_short{
	merge 1:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_wages_shortseason_`c'.dta", nogen keep (1 3)
}

*costs that only include annual crops (seed costs and mainseason wages)
foreach c in $topcropname_annual {
	merge 1:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_seed_costs_`c'.dta", nogen keep (1 3)
	merge 1:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_wages_mainseason_`c'.dta", nogen keep (1 3)
}
...
*Land rights
merge 1:1 y3_hhid using  "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_land_rights_hh.dta", nogen keep (1 3)
la var formal_land_rights_hh "Household has documentation of land rights (at least one plot)"

*Livestock income 
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_sales", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_livestock_products", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_dung.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_livestock_expenses", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_TLU.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_herd_characteristics", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_TLU_Coefficients.dta", nogen keep (1 3)
gen livestock_income = value_livestock_sales - value_livestock_purchases /*
*/ + (value_milk_produced + value_eggs_produced + value_other_produced + sales_dung) /*
*/ - (cost_hired_labor_livestock + cost_fodder_livestock + cost_vaccines_livestock + cost_water_livestock)
lab var livestock_income "Net livestock income"
gen livestock_expenses = cost_hired_labor_livestock + cost_fodder_livestock + cost_vaccines_livestock + cost_water_livestock
drop value_livestock_purchases value_other_produced sales_dung cost_hired_labor_livestock cost_fodder_livestock cost_vaccines_livestock cost_water_livestock
...
*Fish income
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_fish_income.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_fishing_expenses_1.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_fishing_expenses_2.dta", nogen keep (1 3)
...
*Self-employment income
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_self_employment_income.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_fish_trading_income.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_agproducts_profits.dta", nogen keep (1 3)
...
*Wage income
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_wage_income.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_agwage_income.dta", nogen keep (1 3)
...
*Off-farm hours
merge 1:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_off_farm_hours.dta", nogen keep (1 3)

*Other income
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_other_income.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_land_rental_income.dta", nogen keep (1 3)
...
*Farm size
merge 1:1 y3_hhid using  "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_land_size.dta", nogen keep (1 3)
merge 1:1 y3_hhid using  "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_land_size_all.dta", nogen keep (1 3)
merge 1:1 y3_hhid using  "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_farmsize_all_agland.dta", nogen keep (1 3)
recode land_size (.=0)
...
*Labor
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_family_hired_labor.dta", nogen keep (1 3)
recode labor_hired labor_family (.=0) 

*Household size
merge 1:1 y3_hhid using  "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hhsize.dta", nogen keep (1 3)
 
*Rates of vaccine usage, improved seeds, etc.
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_vaccine.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_fert_use.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_improvedseed_use.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_any_ext.dta", nogen keep (1 3)
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_fin_serv.dta", nogen keep (1 3)
...
*Milk productivity
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_milk_animals.dta", nogen keep (1 3)
...
*Dairy costs 
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_lrum_expenses", nogen keep (1 3)
...
*Egg productivity
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_eggs_animals.dta", nogen keep (1 3)

*Costs of crop production per hectare
merge 1:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_cropcosts_total.dta", nogen keep (1 3)

*Rate of fertilizer application 
merge 1:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_fertilizer_application.dta", nogen keep (1 3)

*Agricultural wage rate
merge 1:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_ag_wage.dta", nogen keep (1 3)

*Crop yields 
merge 1:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_yield_hh_crop_level.dta", nogen keep (1 3)

*Total area planted and harvested accross all crops, plots, and seasons
merge 1:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_hh_area_planted_harvested_allcrops.dta", nogen keep (1 3)

*Household Diet 
merge 1:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_household_diet.dta", nogen keep (1 3)

*Consumption
merge 1:1 y3_hhid using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_consumption.dta", nogen keep (1 3)

*Household assets
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hh_assets.dta", nogen keep (1 3)

*Food insecurity
merge 1:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_food_insecurity.dta", nogen keep (1 3)
...
*/ off_farm_hours livestock_expenses crop_production_expenses value_assets cost_expli_hh  sales_livestock_products value_livestock_products value_livestock_sales
...
*/ lvstck_holding_tlu lvstck_holding_all lvstck_holding_lrum lvstck_holding_srum lvstck_holding_poultry /*DYA 2.6.18 adding */ value_livestock_sales sales_livestock_products (.=0) if rural==1 
...
drop *_inter_*
recode *costs_dairy_percow* (0=.)


//////////Identifier Variables ////////
*Add variables and rename household id so dta file can be appended with dta files from other instruments
gen hhid = y2_hhid if hh_split==1 // if this is the original household, use the old hhid
bys y2_hhid: gen household = _n
egen hhid_new = concat(y2_hhid household), punct(-) 
replace hhid=hhid_new if hhid=="" //IHS there are 8 duplicates. Need to determine which ones are really the original households and which ones actually split
...
save "${TZA_W3_final_data}/Tanzania_NPS_LSMS_ISA_W3_household_variables.dta", replace

**************
*INDIVIDUAL-LEVEL VARIABLES
**************
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_person_ids.dta", clear
merge m:1 y3_hhid   using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_household_diet.dta", nogen
merge 1:1 y3_hhid indidy3 using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_control_income.dta", nogen  keep(1 3)
merge 1:1 y3_hhid indidy3 using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_make_ag_decision.dta", nogen  keep(1 3)
merge 1:1 y3_hhid indidy3 using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_ownasset.dta", nogen  keep(1 3)
merge m:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hhsize.dta", nogen keep (1 3)
merge 1:1 y3_hhid indidy3 using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_farmer_fert_use.dta", nogen  keep(1 3)
merge 1:1 y3_hhid indidy3 using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_farmer_improvedseed_use.dta", nogen  keep(1 3)
merge 1:1 y3_hhid indidy3 using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_farmer_vaccine.dta", nogen  keep(1 3)
merge m:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hhids.dta", nogen keep (1 3)

*Adding land rights
merge 1:1 y3_hhid indidy3 using "${TZA_W3_created_data}/Tanzania_NPS_LSMS_ISA_W3_land_rights_ind.dta", nogen
...
preserve
use "${TZA_W3_final_data}/Tanzania_NPS_LSMS_ISA_W3_household_variables.dta", clear
keep hhid ag_hh
tempfile ag_hh
save `ag_hh'
restore
...
save "${TZA_W3_final_data}/Tanzania_NPS_LSMS_ISA_W3_individual_variables.dta", replace
...
use "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_cropvalue.dta", clear
merge 1:1 y3_hhid plot_id using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_areas.dta", keep (1 3) nogen
merge 1:1 y3_hhid plot_id  using  "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_decision_makers.dta", keep (1 3) nogen
merge m:1 y3_hhid using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_hhids.dta", keep (1 3) nogen
merge 1:1 y3_hhid plot_id using "${TZA_W3_created_data}\Tanzania_NPS_LSMS_ISA_W3_plot_family_hired_labor.dta", keep (1 3) nogen
...
save "${TZA_W3_final_data}\Tanzania_NPS_LSMS_ISA_W3_gender_productivity_gap.dta", replace
...
global final_data_household  "${TZA_W3_final_data}/Tanzania_NPS_LSMS_ISA_W3_household_variables.dta"  
global final_data_individual "${TZA_W3_final_data}/Tanzania_NPS_LSMS_ISA_W3_individual_variables.dta"
global final_data_plot       "${TZA_W3_final_data}\Tanzania_NPS_LSMS_ISA_W3_gender_productivity_gap.dta"
global final_outputfile      "$TZA_W3_final_data\Tanzania_NPS_LSMS_ISA_W3_summary_stats_100818.xlsx"
...
recode imprv_seed_wheat_fhh hybrid_seed_wheat_fhh imprv_seed_yam_fhh hybrid_seed_yam_fhh imprv_seed_banana_fhh hybrid_seed_banana_fhh  (.=0) 
...
foreach v of global household_indicators2a {
	...
	qui svyset clusterid [pweight=w_labor_weight], strata(strataid) singleunit(centered) 
	matrix semean2=(.)
...
foreach v of global household_indicators2b {
	...
	matrix temp2=r(StatTotal)'	
	qui svyset clusterid [pweight=w_land_weight], strata(strataid) singleunit(centered) 
	matrix semean2=(.)
	matrix colnames semean2=semean_wei
...
foreach v of global final_indicator3a {
	...
	svyset clusterid [pweight=w_aglabor_weight_`v'], strata(strataid) singleunit(centered) 
...
foreach v of global final_indicator4 {
	...
	matrix temp4=r(StatTotal)'
	qui svyset clusterid [pweight=ar_h_wgt_`v'], strata(strataid) singleunit(centered) 	
...
foreach v of global final_indicator4 {
	...
	matrix temp4=r(StatTotal)'
	qui svyset clusterid [pweight=ar_pl_wgt_`v'], strata(strataid) singleunit(centered) 	
...
qui svyset clusterid [pweight=weight_milk], strata(strataid) singleunit(centered) 	
matrix semean5=(.)
...
tabstat $eggvar [aw=weight_egg] if rural==1  & livestock_hh==1 , stat(mean sd p25 p50 p75  min max N) col(stat) save  
...
foreach v of global household_indicators7b {
	...
	qui svyset clusterid [pweight=w_ha_planted_weight], strata(strataid) singleunit(centered) 
	matrix semean7b=(.)
...
foreach v of global final_indicator9 {
	foreach x in $topcropname_area { 
		...
		qui svyset clusterid /*[pweight=area_weight_`v']*/ [pw=ar_pl_mono_wgt_`x'_`v'], strata(strataid) singleunit(centered) 
...
foreach v of global final_indicator9 {
	foreach x in $topcropname_area { 
		...
		qui svyset clusterid  [pw=kgs_harv_wgt_`x'_`v'], strata(strataid) singleunit(centered) 
...
foreach v of global final_indicator10a {
	...
	qui svyset clusterid [pweight=individual_weight], strata(strataid) singleunit(centered) 
	qui svy, subpop(if rural==1): mean  `v'
...
foreach v of global final_indicator10b {
	...
	matrix temp10=r(StatTotal)'
	qui svyset clusterid [pweight=adulteq_weight], strata(strataid) singleunit(centered) 
	qui svy, subpop(if rural==1): mean  `v'
...
foreach v in 1ppp 2ppp loc {
	...
	recode w_value_harv_banana_`v'_fhh (.=0) 
	recode w_value_sold_banana_`v'_fhh (.=0) 
}
foreach v in wheat yam banana {
...
foreach i in 1ppp 2ppp loc{
qui svyset clusterid [pweight=plot_labor_weight], strata(strataid) singleunit(centered) 
...
global household_indicators16 all_use_inorg_fert female_use_inorg_fert male_use_inorg_fert /*
*/ all_imprv_seed_use female_imprv_seed_use male_imprv_seed_use 
foreach v in $topcropname_area {
...
mata
fi_16=st_matrix("final_indicator16")
select((1..cols(fi_16)), colmin(fi_16 :>=8))
//fi_16
colmax(fi_16)
end
