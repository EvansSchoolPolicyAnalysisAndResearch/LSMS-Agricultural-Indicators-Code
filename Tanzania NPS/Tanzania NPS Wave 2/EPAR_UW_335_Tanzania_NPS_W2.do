...
global Tanzania_NPS_W2_raw_data 	    	"$directory/Tanzania NPS/Tanzania NPS Wave 2/Raw DTA Files/TZA_2010_NPS-R2_v02_M_STATA8"
...
saveold "${Tanzania_NPS_W2_final_data}/Tanzania_NPS_W2_gender_productivity_gap.dta", replace
...
global final_data_household  "${Tanzania_NPS_W2_final_data}/Tanzania_NPS_W2_household_variables.dta"  
global final_data_individual "${Tanzania_NPS_W2_final_data}/Tanzania_NPS_W2_individual_variables.dta"
global final_data_plot       "${Tanzania_NPS_W2_final_data}/Tanzania_NPS_W2_gender_productivity_gap.dta"
global final_outputfile      "${Tanzania_NPS_W2_final_data}/Tanzania_NPS_W2_summary_stats_`c(current_date)'.xlsx"
...
foreach p of varlist $monetary_vars {
	...
	lab var `p' "`l`p'' (TSH)"  
	gen w_`p'_1ppp = (1+$Tanzania_NPS_W2_inflation) * w_`p' / $Tanzania_NPS_W2_cons_ppp_dollar 
	gen w_`p'_2ppp = (1+$Tanzania_NPS_W2_inflation) * w_`p' / $Tanzania_NPS_W2_gdp_ppp_dollar 
	gen w_`p'_usd = (1+$Tanzania_NPS_W2_inflation) * w_`p' / $Tanzania_NPS_W2_exchange_rate 
	gen w_`p'_loc = (1+$Tanzania_NPS_W2_inflation) * w_`p' 
