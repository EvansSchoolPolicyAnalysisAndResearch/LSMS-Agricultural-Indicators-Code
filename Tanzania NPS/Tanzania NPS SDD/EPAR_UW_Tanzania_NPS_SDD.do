...
*Dataset Version: TZA_2019_NPD-SDD_v06_M_STATA12
----------------------------------------------------------------------------------------------------------------------------------------------------*/
...
*the do.file first constructs common and intermediate variables, saving dta files when appropriate in the Final DTA Files folder.
...
*The results are saved in the excel file "Tanzania_NPS_SDD_summary_stats.xlsx" in the "Final DTA files/final_data" folder within the "Tanzana NPS SDD" folder. .  // UPDATE
...
*-------------------------------------------------------------------------------------
*HOUSEHOLD IDS						Tanzania_NPS_SDD_hhids.dta
*INDIVIDUAL IDS						Tanzania_NPS_SDD_person_ids.dta
*HOUSEHOLD SIZE						Tanzania_NPS_SDD_hhsize.dta
*HEAD OF HOUSEHOLD					Tanzania_NPS_SDD_male_head.dta
*PARCEL AREAS						Tanzania_NPS_SDD_plot_areas.dta
*PLOT-CROP DECISION MAKERS			Tanzania_NPS_SDD_plot_decision_makers.dta
*PLOT-CROP PLANTING/HARVEST DATA	Tanzania_NPS_SDD_all_plots.dta
*GROSS CROP REVENUE					Tanzania_NPS_SDD_cropsales_value.dta
									Tanzania_NPS_SDD_hh_crop_values_production.dta
									Tanzania_NPS_SDD_hh_crop_production.dta
*CROP EXPENSES						Tanzania_NPS_SDD_hh_cost_labor.dta
									Tanzania_NPS_SDD_plot_cost_inputs.dta *Plot
									Tanzania_NPS_SDD_hh_cost_inputs.dta *Household
*TLU (Tropical Livestock Units)		Tanzania_NPS_SDD_TLU_Coefficients.dta
									Tanzania_NPS_SDD_herd_characteristics.dta
*LIVESTOCK INCOME					Tanzania_NPS_SDD_livestock_expenses.dta
									Tanzania_NPS_SDD_hh_livestock_products.dta
									Tanzania_NPS_SDD_livestock_sales.dta
									Tanzania_NPS_SDD_livestock_income.dta
*FISH INCOME						**Not available in W5							
*SELF-EMPLOYMENT INCOME				Tanzania_NPS_SDD_self_employment_income.dta
									Tanzania_NPS_SDD_agproduct_income.dta
*WAGE INCOME						Tanzania_NPS_SDD_wage_income.dta
									Tanzania_NPS_SDD_agwage_income.dta
*OTHER INCOME						Tanzania_NPS_SDD_remittance_income.dta
									Tanzania_NPS_SDD_other_income.dta
									Tanzania_NPS_SDD_land_rental_income.dta
*FARM SIZE / LAND SIZE				Tanzania_NPS_SDD_land_size.dta
									Tanzania_NPS_SDD_farmsize_all_agland.dta
									Tanzania_NPS_SDD_land_size_all.dta
*FARM LABOR							Tanzania_NPS_SDD_farmlabor_postplanting.dta
									Tanzania_NPS_SDD_farmlabor_postharvest
									Tanzania_NPS_SDD_family_hired_labor.dta *Imputed from W4 data, see module notes
*VACCINE USAGE						Tanzania_NPS_SDD_farmer_vaccine.dta
*ANIMAL HEALTH						Tanzania_NPS_SDD_livestock_diseases
*INPUT USE BY MANAGERS/HOUSEHOLDS	Tanzania_NPS_SDD_farmer_fert_use.dta
									Tanzania_NPS_SDD_input_use.dta
*REACHED BY AG EXTENSION			Tanzania_NPS_SDD_any_ext.dta
*MOBILE PHONE OWNERSHIP				Tanzania_NPS_SDD_mobile_own.dta
*USE OF FORMAL FINANACIAL SERVICES	Tanzania_NPS_SDD_fin_serv.dta
*LIVESTOCK PRODUCTIVITY				Tanzania_NPS_SDD_milk_animals.dta
									Tanzania_NPS_SDD_egg_animals.dta
*CROP PRODUCTION COSTS PER HECTARE	Tanzania_NPS_SDD_cropcosts.dta
*FERTILIZER APPLICATION RATES		Tanzania_NPS_SDD_fertilizer_application.dta 
*HOUSEHOLD'S DIET DIVERSITY SCORE	Tanzania_NPS_SDD_household_diet.dta
*WOMEN'S CONTROL OVER INCOME		Tanzania_NPS_SDD_control_income.dta
*WOMEN'S AG DECISION-MAKING			Tanzania_NPS_SDD_make_ag_decision.dta
*WOMEN'S ASSET OWNERSHIP			Tanzania_NPS_SDD_make_ownasset.dta
*SHANNON DIVERSITY INDEX			Tanzania_NPS_SDD_shannon_diversity_index
*CONSUMPTION						Tanzania_NPS_SDD_consumption.dta 
*ASSETS								Tanzania_NPS_SDD_hh_assets.dta
*GENDER PRODUCTIVITY GAP 			Tanzania_NPS_SDD_gender_productivity_gap.dta

*FINAL FILES						MAIN FILES CREATED
*-------------------------------------------------------------------------------------
*HOUSEHOLD VARIABLES				Tanzania_NPS_SDD_household_variables.dta
*INDIVIDUAL-LEVEL VARIABLES			Tanzania_NPS_SDD_individual_variables.dta	
*PLOT-LEVEL VARIABLES				Tanzania_NPS_SDD_gender_productivity_gap.dta
*SUMMARY STATISTICS					Tanzania_NPS_SDD_summary_stats.xlsx
...
global Tanzania_NPS_SDD_raw_data 			"$directory/Tanzania NPS/Tanzania NPS SDD/Raw DTA Files/"
...
global Tanzania_NPS_SDD_pop_tot 58005463 //RH 4.30.21 - WDI data (2019) in "reference" folder. Pop total = 58005463
global Tanzania_NPS_SDD_pop_rur 37993578 // 37993578
global Tanzania_NPS_SDD_pop_urb 20011885 // 20011885
...
drop rnum
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_cropname_table.dta", replace 
********************************************************************************
*HOUSEHOLD IDS 
********************************************************************************
use "${Tanzania_NPS_SDD_raw_data}/HH_SEC_A.dta", clear
ren hh_a01_1 region 
...
keep sdd_hhid region district ward village ward_name village_name ea rural weight strataid clusterid
lab var rural "1=Household lives in a rural area"
save "${Tanzania_NPS_SDD_created_data}\Tanzania_NPS_SDD_hhids.dta", replace


********************************************************************************
*INDIVIDUAL IDS  
********************************************************************************
use "${Tanzania_NPS_SDD_raw_data}/hh_sec_b.dta", clear
keep sdd_hhid sdd_indid hh_b02 hh_b04 hh_b05
ren sdd_hhid sdd_hhid
ren sdd_indid indidysdd
gen female=hh_b02==2 
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_person_ids.dta", replace
...
collapse (sum) hh_members (max) fhh, by (sdd_hhid) // counting household members for each house with binary indicator for whether house is female-headed
lab var hh_members "Number of household members"
lab var fhh "1= Female-headed household"
*DYA.11.1.2020 Re-scaling survey weights to match population estimates
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hhids.dta", nogen
*Adjust to match total population
total hh_members [pweight=weight]
matrix temp =e(b)
gen weight_pop_tot=weight*${Tanzania_NPS_SDD_pop_tot}/el(temp,1,1) //scaling pweight to given total population rather than pop total calculated from survey weights
...
matrix temp =e(b)
gen weight_pop_rur=weight*${Tanzania_NPS_SDD_pop_rur}/el(temp,1,1) if rural==1
total hh_members [pweight=weight_pop_rur]  if rural==1

total hh_members [pweight=weight] if rural==0
matrix temp =e(b)
gen weight_pop_urb=weight*${Tanzania_NPS_SDD_pop_urb}/el(temp,1,1) if rural==0
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_weights.dta", replace


********************************************************************************
*PLOT AREAS 
********************************************************************************
use "${Tanzania_NPS_SDD_raw_data}/ag_sec_02.dta", clear	//AG sec 2a; 2b is gone.
* *ren plotnum plot_id 
gen area_acres_est = ag2a_04
gen area_acres_meas = ag2a_09
keep if area_acres_est !=. 
keep sdd_hhid plotnum area_acres_est area_acres_meas
ren sdd_hhid sdd_hhid
ren plotnum plot_id 
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_areas.dta", replace
...
replace cultivated = 1 if  ag3b_03==1 //if plot was described as cultivated in season but not long, assign cultivated = 1
...
ren plotnum plot_id 
keep sdd_hhid plot_id cultivated season person* 
reshape long personid, i(sdd_hhid plot_id cultivated season) j(personno) 
drop if personid==.
...
merge m:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_weights.dta", nogen keep(3)	keepusing(fhh)				
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_decision_makers.dta", replace
...
replace ag3a_28a = ag3b_28a if ag3a_28a==.	// replacing with values in season for missing long season observations
replace ag3a_28d = ag3b_28d if ag3a_28d==.	
gen formal_land_rights = ag3a_28a<=2 | (ag3a_28d>=1 & ag3a_28d<=7) | (ag3b_28d>=1 & ag3b_28d<=7) // Note: Prior code version only considered responses to ag3a_28d to determine formal_land rights, and included anything other than "no documents" as formal. Updated to include responses from ag3a_28a (type of legal certificate for plot) since many plots with legal certificates don't have other documents and were previously erroneously coded as not having formal land rights. I also explicitly am counting any additional document responses from both the long and season seasons as formal land rights to capture any households that answered no to having land certificates and additional long season documents, but answered yes to having additional documents in the season (only found one instance of this in data). In this case, the long season additional documents response would not be replaced by the season response, which itself qualifies the plot for formal land rights. (HI 11.10.21)

*Individual level (for women)
ren ag3a_29_* personid1*
ren ag3b_29_* personid2*
keep sdd_hhid formal_land_rights person*
gen dummy=_n
reshape long personid, i(sdd_hhid formal_land_rights dummy) j(personno) //Can drop
drop personno dummy
ren personid indidysdd
merge m:1 sdd_hhid indidysdd using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_person_ids.dta", nogen keep(3)
gen formal_land_rights_f = formal_land_rights==1 & female==1
preserve
collapse (max) formal_land_rights_f, by(sdd_hhid indidysdd)		
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_land_rights_ind.dta", replace
restore	
collapse (max) formal_land_rights_hh=formal_land_rights, by(sdd_hhid)		// taking max at household level; equals one if they have official documentation for at least one plot
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_land_rights_hh.dta", replace




* Quantity and value of all crops (main and season aggregated)	
use "${Tanzania_NPS_SDD_raw_data}/ag_sec_5a.dta", clear
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_7a.dta"
gen season=0
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_5b.dta"
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_7b.dta"
recode season(.=1)
ren sdd_hhid sdd_hhid
...
collapse (sum) quantity_sold value_sold, by (sdd_hhid crop_code)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_crop_sales.dta", replace

merge m:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_weights.dta", nogen keep(1 3) keepusing(region district ward ea weight_pop_rururb)
gen weight=quantity_sold*weight_pop_rururb
gen obs=price_kg !=. & weight!=.
foreach i in region district ward ea sdd_hhid {
preserve
...
use "${Tanzania_NPS_SDD_raw_data}/ag_sec_4a.dta", clear //crops by plot, long rainy season
	append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_6a.dta" //permanent crops, long rainy season
	gen season=0
	append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_4b.dta" //season
	append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_6b.dta" //season
recode season (.=1)
ren sdd_hhid sdd_hhid
 *ren plotnum plot_id 
ren cropid crop_code
...
sort sdd_hhid plotnum crop_code
bys sdd_hhid plotnum season : gen cropid = _n //Get number of crops grown on each plot in each season
bys sdd_hhid plotnum season : egen num_crops = max(cropid)
...
bys sdd_hhid plotnum season : egen total_prop_planted=sum(prop_planted)
bys sdd_hhid plotnum : egen max_prop_planted=max(total_prop_planted) //Used for tree crops
...
ren plotnum plot_id
merge m:1 sdd_hhid plot_id using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_areas.dta", nogen keep(1 3) keepusing(area_est_hectares area_meas_hectares)
...
bys sdd_hhid plot_id : egen anypermcrop=max(permcrop)
bys sdd_hhid plot_id : egen n_permcrops = sum(permcrop)
bys sdd_hhid plot_id : egen n_trees=sum(number_trees_planted)
...
bys sdd_hhid plot_id season : egen total_ha_planted=total(ha_planted)
//bys sdd_hhid plot_id season : egen max_ha_planted=max(total_ha_planted) 
//replace total_ha_planted=max_ha_planted
//drop max_ha_planted
bys sdd_hhid plot_id season purestand : egen total_purestand_ha = total(ha_planted)
gen total_mono_ha = total_purestand_ha if purestand==1
gen total_inter_ha = total_purestand_ha if purestand==0
recode total_*_ha (.=0)
bys sdd_hhid plot_id season : egen mono_ha = max(total_mono_ha)
bys sdd_hhid plot_id season : egen inter_ha = max(total_inter_ha)
...
merge m:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hhids.dta", nogen keep(1 3)
gen plotweight=ha_planted*weight
foreach i in region district ward village ea sdd_hhid {
preserve
...
*/
	...
	merge m:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hhids.dta", nogen keep(1 3) keepusing(region district ward ea)
foreach i in region district ward ea sdd_hhid {
	merge m:1 `i' crop_code using `val_kg_`i'_median', nogen keep(1 3)
}
merge m:1 crop_code using `val_kg_country_median',nogen keep(1 3)
...
preserve
	...
	collapse (sum) value_harvest /*(max) month_harv*/, by(sdd_hhid plot_id season)

	save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_value_prod.dta", replace //Needed to estimate plot rent values
restore
...
gen n_crops=1
	...
	collapse (max) no_harvest  (sum) kg_harvest value_harvest* ha_planted ha_harvest number_trees_planted n_crops (min) purestand, by(region district season ward ea sdd_hhid plot_id crop_code field_size total_ha_planted) 
   ...
   drop no_harvest
	save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_all_plots.dta",replace

	collapse (sum) ha_planted, by(sdd_hhid season plot_id) //Use planted area for hh-level expenses 
	save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_planted_area.dta", replace

********************************************************************************
* CROP EXPENSES * - ALT updated 7/21
********************************************************************************
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_all_plots.dta",clear
collapse (sum) ha_planted, by(sdd_hhid plot_id season)
...
use "${Tanzania_NPS_SDD_raw_data}/ag_sec_4a.dta", clear
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_4b.dta"
	ren sdd_hhid sdd_hhid
	ren plotnum plot_id 
...
gen valseedimp0 =.
gen valseedimp1 =.*/ 
collapse (sum) val*, by(sdd_hhid plot_id)
tempfile seeds
save `seeds'
...
use "${Tanzania_NPS_SDD_raw_data}/ag_sec_3a.dta", clear
merge 1:1 sdd_hhid plotnum using "${Tanzania_NPS_SDD_raw_data}/ag_sec_3b.dta", nogen keep(1 3)
	ren sdd_hhid sdd_hhid
	 ren plotnum plot_id 
merge 1:1 sdd_hhid plot_id using `seeds', nogen
merge m:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hhids.dta", nogen keep(1 3) keepusing(weight)
merge m:1 sdd_hhid plot_id using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_areas.dta", nogen keep(1 3) keepusing(area_meas_hectares area_est_hectares)
ren area_meas_hectares field_size
replace field_size = area_est_hectares if field_size==.
drop area_est_hectares
	...
	egen hh_labor0= rowtotal(ag3a_74_*) //total days of labor performed by all household members, by season
	egen hh_labor1 = rowtotal(ag3b_74_*)
preserve 
	keep sdd_hhid plot_id wages*
	reshape long wagesexp, i(sdd_hhid plot_id) j(season)
	rename wagesexp val
...
restore
preserve
	keep sdd_hhid plot_id hh_labor*
	reshape long hh_labor, i(sdd_hhid plot_id) j(season)
	ren hh_labor val
	gen input = "hh_labor"
	...
	sort sdd_hhid plot_id season input //changed y1 to y2_hhid
	tempfile labor
	save `labor'
restore 
...
ren ag3a_65b_1 qtypestexp0 //0-1 designators for long/season growing seasons.
ren ag3a_65b_2 unitpestexp0
ren ag3a_65c valpestexp0
ren ag3b_65b_1 qtypestexp1 //The label says long season, but I'm pretty sure these are season inputs?
...
gen input=ag3a_48
replace input = ag3b_48 if input==.
replace input = ag3a_55 if input==.
replace input = ag3b_55 if input==.
label define input 1 "DAP" 2 "urea" 3 "TSP" 4 "CAN" 5 "SA" 6 "npk_fert" 7 "mrp" 9 "Unknown"
label values input "input"
decode input, gen (input_inorg) 
gen qty = ag3a_49
replace qty = ag3b_49 if qty==. 
replace qty = ag3a_56 if qty==. 
replace qty = ag3b_56 if qty==.
...
collapse (sum) *kg, by(sdd_hhid plot_id)
tempfile fert_units
save `fert_units'
restore
...
The separation between season and long in the dta files and instruments implies that the whole country has two growing seasons, but, in fact, the country is divided
into two regions: unimodal (one long rainy season - Msiumu) and bimodal (two seasoner rainy seasons - Vuli and Masika). 
...
The regional variation is highly visible in the data - 31/33 plots in Kagera and 22/31 in Geita were cultivated during the season rainy season of 2018, and 0/21 in Shinyanga, 0/41 in Pwani, and 0/48 in Morogoro were cultivated.
...
preserve
	...
	keep sdd_hhid plot_id months* prop* val* field_size
	reshape long monthslandrent vallandrentexp propinkindpaid, i(sdd_hhid plot_id) j(season)
	la val season //Remove value labels from the season variable - not sure why they're getting applied
	merge 1:1 sdd_hhid plot_id season using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_value_prod.dta"
	gen pricelandrent = (vallandrentexp+(propinkindpaid*value_harvest))/monthslandrent/field_size 
	keep sdd_hhid plot_id pricelandrent season field_size
	reshape wide pricelandrent, i(sdd_hhid plot_id field_size) j(season) //82 total observations; there isn't a significant difference between season and long rainy season rents.
	...
	save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_land_rents.dta", replace
restore
merge 1:1 sdd_hhid plot_id using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_land_rents.dta", nogen keep(1 3)
...
keep sdd_hhid plot_id qty* val* unit*

unab vars1 : *1 //This is a seasoncut to get all stubs 
local stubs1 : subinstr local vars1 "1" "", all
//di "`stubs1'" //viewing macro stubs1
reshape long `stubs1', i(sdd_hhid plot_id) j(season)

unab vars2 : *exp
local stubs2 : subinstr local vars2 "exp" "", all
reshape long `stubs2', i(sdd_hhid plot_id season) j(exp) string
reshape long qty val unit, i(sdd_hhid plot_id season exp) j(input) string
...
preserve
	...
	keep if strmatch(input,"orgfert") | strmatch(input,"inorgfert") | strmatch(input,"pest")| strmatch(input,"herb") //Seed rates would also be doable if we have conversions for the nonstandard units
	...
	collapse (sum) qty_=qty, by(sdd_hhid plot_id input season)
	reshape wide qty_, i(sdd_hhid plot_id season) j(input) string
	...
	merge m:1 sdd_hhid plot_id using `fert_units', nogen
	save "${Tanzania_NPS_SDD_created_data }/Tanzania_NPS_SDD_input_quantities.dta", replace
restore
append using `labor'
collapse (sum) val, by (sdd_hhid plot_id input season exp) //Keeping exp in for compatibility with the AQ compilation script.
merge m:1 sdd_hhid plot_id season using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_decision_makers.dta",  keepusing(dm_gender) nogen keep(3) //Removes uncultivated plots
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_cost_inputs_long.dta",replace
preserve
collapse (sum) val, by(sdd_hhid input season exp)
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_cost_inputs_long.dta", replace
restore 
...
preserve
	...
	save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_cost_inputs.dta", replace //This gets used below.
restore
preserve
drop input
collapse (sum) val, by(sdd_hhid plot_id exp dm_gender season)
gen dm_gender2 = "male" if dm_gender==1
replace dm_gender2 = "female" if dm_gender==2
replace dm_gender2 = "mixed" if dm_gender==3
drop dm_gender
ren val* val*_
reshape wide val*, i(sdd_hhid plot_id dm_gender2 season) j(exp) string
ren val* val*_
merge m:1 sdd_hhid plot_id using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_areas.dta", nogen keep(1 3) keepusing(area_meas_hectares area_est_hectares) //do per-ha expenses at the same time
ren area_meas_hectares field_size
merge 1:1 plot_id sdd_hhid season using `planted_area', nogen keep(1 3)
reshape wide val*, i(sdd_hhid plot_id season) j(dm_gender2) string
collapse (sum) val* field_size* ha_planted*, by(sdd_hhid)
//Renaming variables to plug into later steps
foreach i in male female mixed {
gen cost_expli_`i' = val_exp_`i'
egen cost_total_`i' = rowtotal(val_exp_`i') //val_imp_`i' not enough information for implicit values 
}
...
use "${Tanzania_NPS_SDD_raw_data}/ag_sec_11.dta", clear
ren sdd_hhid sdd_hhid
...
collapse (sum) rental_cost_animal_traction rental_cost_ag_asset rental_cost_tractor, by (sdd_hhid)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_asset_rental_costs.dta", replace
//ALT: This is a little convoluted but I'm doing it to maintain the original file structure
ren rental_cost_* val*_rent
reshape long val, i(sdd_hhid) j(var) string
ren var input
...
collapse (sum) transport_costs_cropsales, by (sdd_hhid)
lab var transport_costs_cropsales "Expenditures on transportation for crop sales of temporary crops"
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_transportation_cropsales.dta", replace
ren transport_costs_cropsales val
gen input = "crop_transport"
tempfile trans_cost
save `trans_cost'

use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_cost_inputs_long.dta", clear
//back to wide
collapse (sum) val, by(sdd_hhid input)
append using `asset_rental'
append using `trans_cost'
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_cost_inputs_long.dta", replace //I don't think this gets used for anything but it's here in case we need it.
ren val val_
reshape wide val_, i(sdd_hhid) j(input) string
//merge 1:1 sdd_hhid  using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_asset_rental_costs.dta", nogen
//merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_transportation_cropsales.dta", nogen
...
preserve	
	...
	save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_`cn'_monocrop.dta", replace
	foreach i in `cn'_monocrop_ha kgs_harv_mono_`cn' val_harv_mono_`cn' `cn'_monocrop { 
		gen `i'_male = `i' if dm_gender==1
		gen `i'_female = `i' if dm_gender==2
		gen `i'_mixed = `i' if dm_gender==3
	}
	collapse (sum) *monocrop_ha* kgs_harv_mono* val_harv_mono* (max) `cn'_monocrop `cn'_monocrop_male `cn'_monocrop_female `cn'_monocrop_mixed, by(sdd_hhid)
	...
	save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_`cn'_monocrop_hh_area.dta", replace
	}
restore
}
...
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_cost_inputs_long.dta", clear
merge m:1 sdd_hhid plot_id season using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_decision_makers.dta", nogen keep(1 3) keepusing(dm_gender)
collapse (sum) val, by(sdd_hhid plot_id dm_gender input season)
levelsof input, clean l(input_names)
	ren val val_
	reshape wide val_, i(sdd_hhid plot_id dm_gender season) j(input) string
	gen dm_gender2 = "male" if dm_gender==1
	replace dm_gender2 = "female" if dm_gender==2
	replace dm_gender2 = "mixed" if dm_gender==3
...
preserve
	...
	//drop exp
	capture confirm file "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_`cn'_monocrop.dta"
	if !_rc {
	ren val* val*_`cn'_
	reshape wide val*, i(sdd_hhid plot_id season) j(dm_gender2) string
	merge 1:1 sdd_hhid plot_id season using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_`cn'_monocrop.dta", nogen keep(3)
	count
	if(r(N) > 0){
	collapse (sum) val*, by(sdd_hhid)
	foreach i in `input_names' {
		egen val_`i'_`cn'_hh = rowtotal(val_`i'_`cn'_male val_`i'_`cn'_female val_`i'_`cn'_mixed)
	}
	//To do: labels
	save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_inputs_`cn'.dta", replace
	}
	}
restore
}
...
********************************************************************************
use "${Tanzania_NPS_SDD_raw_data}/lf_sec_02.dta", clear
ren sdd_hhid sdd_hhid
...
recode tlu_* nb_* (.=0)
collapse (sum) tlu_* nb_*  , by (sdd_hhid)
...
drop if sdd_hhid==""
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_TLU_Coefficients.dta", replace
...
collapse (sum) value_harvest_imputed value_sold, by (sdd_hhid)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_crop_production.dta", replace
...
collapse (sum) value_cropresidue_sales, by (sdd_hhid)
lab var value_cropresidue_sales "Value of sales of crop residue (considered an agricultural byproduct)"
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_crop_residues.dta", replace

*Crops lost post-harvest
use "${Tanzania_NPS_SDD_raw_data}/ag_sec_7a.dta", clear
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_7b.dta"
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_5a.dta"
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_5b.dta" 
ren sdd_hhid sdd_hhid
ren cropid crop_code
...
*Expenses
use "${Tanzania_NPS_SDD_raw_data}/lf_sec_04.dta", clear
append using "${Tanzania_NPS_SDD_raw_data}/lf_sec_03.dta"
append using "${Tanzania_NPS_SDD_raw_data}/lf_sec_05.dta"
...
preserve
keep if lvstckid == 1
collapse (sum) cost_fodder_livestock cost_water_livestock cost_vaccines_livestock cost_hired_labor_livestock, by (sdd_hhid)
egen cost_lrum = rowtotal (cost_fodder_livestock cost_water_livestock cost_vaccines_livestock cost_hired_labor_livestock)
keep sdd_hhid cost_lrum
lab var cost_lrum "Livestock expenses for large ruminants"
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_lrum_expenses", replace
restore 
...
collapse (sum) cost_vaccines_livestock, by (sdd_hhid species) 
...
collapse (firstnm) *lrum *srum *pigs *equine *poultry, by(sdd_hhid)
...
drop ls_exp_vac
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_expenses_animal", replace
restore 
collapse (sum) cost_fodder_livestock cost_water_livestock cost_vaccines_livestock cost_hired_labor_livestock, by (sdd_hhid)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_expenses", replace

*Livestock products
use "${Tanzania_NPS_SDD_raw_data}/lf_sec_06.dta", clear
ren sdd_hhid sdd_hhid
ren lvstckid livestock_code 
...
keep sdd_hhid livestock_code milk_liters_produced price_per_liter price_per_unit quantity_produced earnings_milk_year
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products_milk", replace

use "${Tanzania_NPS_SDD_raw_data}/lf_sec_08.dta", clear
ren sdd_hhid sdd_hhid
...
keep sdd_hhid livestock_code quantity_produced price_per_unit earnings_sales
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products_other", replace

use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products_milk", clear
append using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products_other"
recode price_per_unit (0=.)
merge m:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hhids.dta"
drop if _merge==2
drop _merge
replace price_per_unit = . if price_per_unit == 0 
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products", replace

use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products", clear
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products_prices_ea.dta", replace
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products_prices_ward.dta", replace
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products_prices_district.dta", replace
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products_prices_region.dta", replace
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products_prices_country.dta", replace

use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products", clear
merge m:1 region district ward ea livestock_code using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products_prices_ea.dta", nogen
merge m:1 region district ward livestock_code using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products_prices_ward.dta", nogen
merge m:1 region district livestock_code using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products_prices_district.dta", nogen
merge m:1 region livestock_code using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products_prices_region.dta", nogen
merge m:1 livestock_code using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_products_prices_country.dta", nogen
...
collapse (sum) value_milk_produced value_eggs_produced value_other_produced sales_livestock_products, by (sdd_hhid)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_livestock_products", replace
 
use "${Tanzania_NPS_SDD_raw_data}/lf_sec_07.dta", clear
ren lf07_03 sales_dung
ren sdd_hhid sdd_hhid
recode sales_dung (.=0)
collapse (sum) sales_dung, by (sdd_hhid)
lab var sales_dung "Value of dung sold" 
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_dung.dta", replace
...
drop if _merge==2
drop _merge
keep sdd_hhid weight region district ward ea livestock_code number_sold income_live_sales number_slaughtered number_slaughtered_sold income_slaughtered price_per_animal value_livestock_purchases
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_livestock_sales", replace

*Implicit prices
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_livestock_sales", clear
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_prices_ea.dta", replace
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys region district ward livestock_code: egen obs_ward = count(observation)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_prices_ward.dta", replace
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys region district livestock_code: egen obs_district = count(observation)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_prices_district.dta", replace
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys region livestock_code: egen obs_region = count(observation)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_prices_region.dta", replace
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys livestock_code: egen obs_country = count(observation)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_prices_country.dta", replace

use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_livestock_sales", clear
merge m:1 region district ward ea livestock_code using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_prices_ea.dta", nogen
merge m:1 region district ward livestock_code using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_prices_ward.dta", nogen
merge m:1 region district livestock_code using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_prices_district.dta", nogen
merge m:1 region livestock_code using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_prices_region.dta", nogen
merge m:1 livestock_code using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_prices_country.dta", nogen
...
collapse (sum) value_livestock_sales value_livestock_purchases value_lvstck_sold value_slaughtered, by (sdd_hhid)
drop if sdd_hhid==""
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_sales", replace
...
collapse (firstnm) share_imp_herd_cows (sum) number_today number_1yearago animals_lost12months lost_disease number_today_exotic lvstck_holding=number_today, by(sdd_hhid species)
egen mean_12months = rowmean(number_today number_1yearago)
...
collapse (sum) number_today number_today_exotic (firstnm) *lrum *srum *pigs *equine *poultry share_imp_herd_cows, by(sdd_hhid)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_herd_characteristics", replace
restore
...
collapse (sum) tlu_1yearago tlu_today value_1yearago value_today, by (sdd_hhid)
lab var tlu_1yearago "Tropical Livestock Units as of 12 months ago"
lab var tlu_today "Tropical Livestock Units as of the time of survey"
...
drop if sdd_hhid==""
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_TLU.dta", replace

*Livestock income
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_sales", clear
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_livestock_products", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_dung.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_expenses", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_TLU.dta", nogen
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_income", replace
}
...
{
/*ARP worked on:*/
use "${Tanzania_NPS_SDD_raw_data}/hh_sec_n.dta", clear
ren sdd_hhid sdd_hhid
...
collapse (sum) annual_selfemp_profit, by (sdd_hhid)
lab var annual_selfemp_profit "Estimated annual net profit from self-employment over previous 12 months"
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_self_employment_income.dta", replace

*Processed crops 
use "${Tanzania_NPS_SDD_raw_data}/ag_sec_10.dta", clear
ren sdd_hhid sdd_hhid
...
merge m:1 sdd_hhid crop_code using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_crop_values_production.dta", keep(1 3) nogen /*ARP W5 flag for DYA: the crop_prices dta is not created anywhere in this do file - does the dta get added to created_data folder later in coding process?*/
...
collapse (sum) byproduct_profits, by (sdd_hhid)
lab var byproduct_profits "Net profit from sales of agricultural processed products or byproducts"
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_agproducts_profits.dta", replace

}
********************************************************************************
*NON-AG WAGE INCOME 
********************************************************************************
use "${Tanzania_NPS_SDD_raw_data}\HH_SEC_E1.dta"
merge 1:1 sdd_hhid sdd_indid using "${Tanzania_NPS_SDD_raw_data}\HH_SEC_E3.dta", ///
...
gen member_count = 1
preserve 
collapse (sum) nworker_* hrs_*  member_count, by(sdd_hhid)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_off_farm_hours.dta", replace
restore 
...
recode primary_salary_cash primary_salary_other (.=0)


preserve 
gen annual_salary = primary_salary_cash + primary_salary_other if agwage!=1
collapse (sum) annual_salary, by (sdd_hhid)
lab var annual_salary "Annual earnings from non-agricultural wage"
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_wage_income.dta", replace
restore 
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_agwage_income.dta", replace

/*
{
use "${Tanzania_NPS_SDD_raw_data}/hh_sec_e1.dta", clear
ren sdd_hhid sdd_hhid
ren hh_e03 wage_yesno
/*ARP W5 flag for DYA: -The above W5 variable (hh_e03) is for "last 7 days", while W4 var (hh_e04ab) was for "last 12 months"
                       -In W4, the var used above (hh_e04ab) includes UNPAID apprenticeships (in addition to different types of paid work); however in W5 the equivalent var (hh_e03) does not mention UNPAID apprenticeships*/
...
********************************************************************************
/*ARP worked on:*/
use "${Tanzania_NPS_SDD_raw_data}/hh_sec_q1.dta", clear
append using "${Tanzania_NPS_SDD_raw_data}/hh_sec_q2.dta"
append using "${Tanzania_NPS_SDD_raw_data}/hh_sec_o1.dta"
ren sdd_hhid sdd_hhid
...
collapse (sum) rental_income pension_income other_income remittance_income assistance_income, by (sdd_hhid)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_other_income.dta", replace

use "${Tanzania_NPS_SDD_raw_data}/ag_sec_3a.dta", clear
ren ag3a_04 land_rental_income_mainseason
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_3b.dta"
ren sdd_hhid sdd_hhid
ren ag3b_04 land_rental_income_seasonseason
recode land_rental_income_mainseason land_rental_income_season (.=0)
gen land_rental_income = land_rental_income_mainseason + land_rental_income_seasonseason
collapse (sum) land_rental_income, by (sdd_hhid)
lab var land_rental_income "Estimated income from renting out land over previous 12 months"
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_land_rental_income.dta", replace
...
gen crop_grown = 1 
collapse (max) crop_grown, by(sdd_hhid plot_id)
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_crops_grown.dta", replace
...
ren plotnum plot_id 
collapse (max) cultivated, by (sdd_hhid plot_id)
lab var cultivated "1= Parcel was cultivated in this data set"
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_parcels_cultivated.dta", replace

use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_parcels_cultivated.dta", clear
*ren plot_id plotnum 
merge 1:1 sdd_hhid plot_id using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_areas.dta", nogen keep(1 3)
*ren plotnum plot_id 
keep if cultivated==1
replace area_acres_meas=. if area_acres_meas<0 
replace area_acres_meas = area_acres_est if area_acres_meas==. 
collapse (sum) area_acres_meas, by (sdd_hhid)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_land_size.dta", replace
...
ren plotnum plot_id 
merge m:1 sdd_hhid plot_id using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_crops_grown.dta", nogen
*6,862 matched
*1,704 not matched (from master)
gen rented_out = (ag3a_03==2 | ag3a_03==3 | ag3b_03==2 | ag3b_03==3)
gen cultivated_season = (ag3b_03==1)
bys sdd_hhid plot_id: egen plot_cult_season = max(cultivated_season)
replace rented_out = 0 if plot_cult_season==1 // If cultivated in season season, not considered rented out in long season.
...
*907 obs dropped
collapse (max) agland, by (sdd_hhid plot_id)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_parcels_agland.dta", replace

use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_parcels_agland.dta", clear
*ren plot_id plotnum 
merge 1:1 sdd_hhid plot_id using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_areas.dta", keep(1 3) nogen
*ren plotnum plot_id   
replace area_acres_meas=. if area_acres_meas<0
replace area_acres_meas = area_acres_est if area_acres_meas==. 
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_farmsize_all_agland.dta", replace
...
drop if rented_out==1
gen plot_held = 1
collapse (max) plot_held, by (sdd_hhid plot_id)
lab var plot_held "1= Parcel was NOT rented out in the main season"
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_parcels_held.dta", replace

use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_parcels_held.dta", clear
*ren plot_id plotnum 
merge 1:1 sdd_hhid plot_id using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_areas.dta", nogen keep(1 3)
*ren plotnum plot_id 
replace area_acres_meas=. if area_acres_meas<0
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_land_size_all.dta", replace
...
ren sdd_hhid sdd_hhid
ren plotnum plot_id
merge m:1 sdd_hhid plot_id using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_areas.dta", nogen keep(1 3)
*ren plotnum plot_id 
replace area_acres_meas=. if area_acres_meas<0
replace area_acres_meas = area_acres_est if area_acres_meas==. 
replace area_acres_meas = area_acres_est if area_acres_meas==0 & (area_acres_est>0 & area_acres_est!=.)	
collapse (max) area_acres_meas, by(sdd_hhid plot_id)
ren area_acres_meas land_size_total
collapse (sum) land_size_total, by(sdd_hhid)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_land_size_total.dta", replace
...
/*ARP worked on:*/
use "${Tanzania_NPS_SDD_raw_data}/hh_sec_e1.dta", clear
merge 1:1 sdd_hhid sdd_indid using "${Tanzania_NPS_SDD_raw_data}\HH_SEC_E3.dta", keepusing(hh_e317 hh_e315) nogen //ARP W5 notes: in W5, HH_Sect_E is broken into 3 files (E1-E3). The two variables needed from E3 in this section are imported here.
...
ren ag3b_74_1d wage_landprep 
ren ag3b_74_2d wage_weeding
ren ag3b_74_3d wage_harvest 
//This hh has a strange conflation of wage and labor days here.

unab vars : *men *women *child
foreach var in `vars' {
replace `var'=. if strmatch(sdd_hhid, "0720-001-011") 
}
...
egen days_landprep = rowtotal(landprep_*)
egen days_weeding = rowtotal(weeding_*)
egen days_harvest = rowtotal(harvest_*)
gen labor_family = days_landprep + days_weeding + days_harvest 
...
collapse (sum) labor_* tot_aglabor_wage, by(sdd_hhid)
...
********************************************************************************
use "${Tanzania_NPS_SDD_raw_data}/lf_sec_03.dta", clear
ren sdd_hhid sdd_hhid
...
collapse (max) vac_animal*, by (sdd_hhid)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_vaccine.dta", replace
 
*vaccine use livestock keeper  
use "${Tanzania_NPS_SDD_raw_data}/lf_sec_03.dta", clear
merge 1:1 sdd_hhid lvstckid using "${Tanzania_NPS_SDD_raw_data}/lf_sec_05.dta", nogen keep (1 3)
ren sdd_hhid sdd_hhid
...
preserve
keep sdd_hhid lf05_01_1 all_vac_animal 
ren lf05_01_1 farmerid
tempfile farmer1
save `farmer1'
restore
preserve
keep sdd_hhid  lf05_01_2  all_vac_animal 
...
collapse (max) all_vac_animal , by(sdd_hhid farmerid)
gen indidysdd=farmerid
drop if indidysdd==.
merge 1:1 sdd_hhid indidysdd using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_person_ids.dta", nogen
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_farmer_vaccine.dta", replace
...
collapse (max) disease_*, by (sdd_hhid)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_diseases.dta", replace
...
collapse (max) feed_grazing* water_source* lvstck_housed*, by (sdd_hhid)
lab var feed_grazing "1=HH feeds only or mainly by grazing"
lab var water_source_nat "1=HH water livestock using natural source"
lab var water_source_const "1=HH water livestock using constructed source"
lab var water_source_cover "1=HH water livestock using covered source"
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_feed_water_house.dta", replace
...
collapse (max) imprv_seed_use, by(sdd_hhid plot_id crop_code season)
tempfile imprv_seed
save `imprv_seed' //Will use this in a minute
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_input_quantities.dta", clear
...
collapse (max) imprv_seed_, by(sdd_hhid crop_code)
...
drop crop_code 
reshape wide imprv_seed_ hybrid_seed_, i(sdd_hhid) j(crop_name) string
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_imprvseed_crop.dta", replace 
restore

//collapse (max) use*, by(sdd_hhid plot_id season)
merge m:m sdd_hhid plot_id season using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_dm_ids.dta"
preserve
ren imprv_seed_use all_imprv_seed_
gen all_hybrid_seed_ =.
collapse (max) all*, by(sdd_hhid indidysdd female crop_code)
merge m:1 crop_code using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_cropname_table.dta", nogen keep(3)
drop crop_code
gen farmer_=1
reshape wide all_imprv_seed_ all_hybrid_seed_ farmer_, i(sdd_hhid indidysdd female) j(crop_name) string
recode farmer_* (.=0)
ren farmer_* *_farmer
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_farmer_improvedseed_use.dta", replace
restore
collapse (max) use_* imprv_seed_use, by(sdd_hhid indidysdd female)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_farmer_input_use.dta", replace 
	collapse (max) use_inorg_fert imprv_seed_use use_org_fert use_pest, by (sdd_hhid)
	...
	save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_input_use.dta", replace 
	
********************************************************************************
*USE OF INORGANIC FERTILIZER (& other inputs) - ALT 07.06.21
********************************************************************************
*Part of plot manager
 

********************************************************************************
*REACHED BY AG EXTENSION //UPDATED 5.13.2021_TH
********************************************************************************
use "${Tanzania_NPS_SDD_raw_data}/ag_sec_12b.dta", clear
ren ag12b_08 receive_advice
preserve
use "${Tanzania_NPS_SDD_raw_data}/ag_sec_12a.dta", clear
...
collapse (max) ext_reach_* , by (sdd_hhid)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_any_ext.dta", replace
 

********************************************************************************
* MOBILE OWNERSHIP * //AM 05/07/2021 ADDED
********************************************************************************
use "${Tanzania_NPS_SDD_raw_data}/hh_sec_g3a.dta", clear
ren sdd_hhid sdd_hhid
...
collapse (max) mobile_owned, by(sdd_hhid)
keep sdd_hhid mobile_owned
save "${Tanzania_NPS_SDD_raw_data}/Tanzania_NPS_SDD_mobile_own", replace

 
********************************************************************************
*USE OF FORMAL FINANCIAL SERVICES //Updated 5.13.21_TH
********************************************************************************
use "${Tanzania_NPS_SDD_raw_data}/hh_sec_p.dta", clear
append using "${Tanzania_NPS_SDD_raw_data}/hh_sec_q1.dta" 
ren sdd_hhid sdd_hhid
...
collapse (max) use_fin_serv_*, by (sdd_hhid)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_fin_serv.dta", replace
...
keep sdd_hhid milk_animals months_milked liters_per_largeruminant 
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_milk_animals.dta", replace
...
collapse (sum) poultry_owned, by(sdd_hhid)
...
merge 1:1 sdd_hhid using  `eggs_animals_hh', nogen keep(1 3)			
keep sdd_hhid eggs_months eggs_per_month eggs_total_year poultry_owned 
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_eggs_animals.dta", replace


********************************************************************************
*TOTAL CROPCOSTS - Legacy
********************************************************************************
//ALT 07.21.21: Building legacy file for compatibility with later code.

use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_cost_inputs_long.dta", clear
collapse (sum) val, by(sdd_hhid plot_id input season)
ren val value_
reshape wide value_, i(sdd_hhid plot_id season) j(input) string
...
merge 1:1 sdd_hhid plot_id season using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_planted_area.dta", nogen keep(3)
merge m:1 sdd_hhid plot_id season using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_decision_makers.dta", nogen keep(1 3)
...
collapse (sum) value* ha*, by(sdd_hhid)
...
//merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_asset_rental_costs.dta", nogen keep(1 3)
...
//gen cost_total = .
//lab var cost_total "Not constructable for SDD"
...
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_cost_inputs.dta", nogen keepusing(val_ag_asset_rent val_tractor_rent val_animal_traction_rent val_crop_transport)
...
recode cost_total* (0=.)
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_cropcosts_total.dta", replace
...
ren  plotnum plot_id
merge 1:1 sdd_hhid plot_id season using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_planted_area.dta"
merge 1:1 sdd_hhid plot_id season using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_decision_makers.dta", nogen keep(1 3)
merge 1:1 sdd_hhid plot_id season using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_input_quantities.dta", nogen keep(1 3) 
...
drop _merge
reshape wide *_, i(sdd_hhid plot_id season) j(dm_gender2) string

collapse (sum) ha_planted_* *kg* ha_irr_*, by(sdd_hhid)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_fertilizer_application.dta", replace
...
use "${Tanzania_NPS_SDD_raw_data}/hh_sec_j1.dta" , clear
ren sdd_hhid sdd_hhid 
...
collapse (max) adiet_yes, by(sdd_hhid   Diet_ID) 
label define YesNo 1 "Yes" 0 "No"
label val adiet_yes YesNo
* Now, estimate the number of food groups eaten by each individual
collapse (sum) adiet_yes, by(sdd_hhid )
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_household_diet.dta", replace
...
use 		 "${Tanzania_NPS_SDD_raw_data}/ag_sec_4a", clear 
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_4b"
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_5a"
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_5b"
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_6a"
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_6b"
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_7a"
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_7b"
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_10"
append using "${Tanzania_NPS_SDD_raw_data}/lf_sec_02.dta"
append using "${Tanzania_NPS_SDD_raw_data}/lf_sec_05.dta" //*AM Added lf_05 "In principal, who is responsible for keeping [ANIMAL]?"
append using "${Tanzania_NPS_SDD_raw_data}/lf_sec_06.dta"
append using "${Tanzania_NPS_SDD_raw_data}/lf_sec_08.dta"
append using "${Tanzania_NPS_SDD_raw_data}/hh_sec_n.dta"
append using "${Tanzania_NPS_SDD_raw_data}/hh_sec_q2.dta"
append using "${Tanzania_NPS_SDD_raw_data}/hh_sec_o1.dta"
ren sdd_hhid sdd_hhid
gen type_decision="" 
...
keep sdd_hhid type_decision controller_income1 controller_income2
...
collapse (max) control_* , by(sdd_hhid controller_income )  //any decision
gen control_all_income=1 if  control_farmincome== 1 | control_nonfarmincome==1
recode 	control_all_income (.=0)															
ren controller_income indidysdd
*	Now merge with member characteristics
merge 1:1 sdd_hhid indidysdd  using  "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_person_ids.dta", nogen // * AM 05/06/2021 not yet generated
recode control_* (.=0)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_control_income.dta", replace
...
use "${Tanzania_NPS_SDD_raw_data}/ag_sec_3a", clear
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_3b"
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_4a"
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_4b"
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_5a"
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_5b"
append using "${Tanzania_NPS_SDD_raw_data}/ag_sec_6a"
...
keep sdd_hhid type_decision decision_maker*
...
keep sdd_hhid type_decision decision_maker1 decision_maker2 decision_maker3
preserve
keep sdd_hhid type_decision decision_maker2
...
bysort sdd_hhid decision_maker : egen nb_decision_participation=count(decision_maker)
...
collapse (max) make_decision_* , by(sdd_hhid decision_maker )  //any decision
ren decision_maker indidysdd 
* Now merge with member characteristics
merge 1:1 sdd_hhid indidysdd  using  "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_person_ids.dta", nogen //Person IDs not created yet
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_make_ag_decision.dta", replace
...
keep sdd_hhid type_asset asset_owner*
tempfile land2
save `land2'
restore
append using `land2'  
...
keep sdd_hhid type_asset asset_owner1 asset_owner2  
preserve
keep sdd_hhid type_asset asset_owner2
drop if asset_owner2==.
ren asset_owner2 asset_owner
tempfile asset_owner2
save `asset_owner2'
restore
keep sdd_hhid type_asset asset_owner1
drop if asset_owner1==.
ren asset_owner1 asset_owner
append using `asset_owner2'
gen own_asset=1 
collapse (max) own_asset, by(sdd_hhid asset_owner)
ren asset_owner indidysdd
* Now merge with member characteristics
merge 1:1 sdd_hhid indidysdd  using  "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_person_ids.dta", nogen // not yet created
* 3 member ID in assed files not is member list
recode own_asset (.=0)
lab var own_asset "1=invidual owns an assets (land or livestock)"
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_ownasset.dta", replace
...
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_all_plots.dta", clear
collapse (sum) number_trees_planted, by(sdd_hhid crop_code season)
tempfile trees
save `trees'
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_all_plots.dta", clear
...
collapse (sum) harvest* area* (max) no_harvest, by(sdd_hhid crop_code)
...
preserve
	...
	save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_crop_harvest_area_yield.dta", replace
restore
preserve
	collapse (sum) all_area_harvested=area_harv all_area_planted=area_plan, by(sdd_hhid)
	replace all_area_harvested=all_area_planted if all_area_harvested>all_area_planted & all_area_harvested!=.
	save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_area_planted_harvested_allcrops.dta", replace
restore
...
collapse (sum) area_plan area_harv, by(sdd_hhid crop_code)
ren area_plan total_planted_area
ren area_harv total_harv_area 
tempfile area_allseasons
save `area_allseasons'
restore
merge 1:1 sdd_hhid crop_code using `area_allseasons', nogen
...
merge 1:m sdd_hhid crop_code using `trees', nogen
...
collapse (sum) harvest* area_harv*  area_plan* total_planted_area* total_harv_area* kgs_harvest*   value_harv* value_sold* number_trees_planted*  , by(sdd_hhid) 
...
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_crop_values_production.dta", clear
...
preserve
collapse (sum) value_crop_production value_crop_sales, by( sdd_hhid commodity) 
...
collapse (sum) value_*, by(sdd_hhid)
foreach x of varlist value_* {
	lab var `x' "`l`x''"
}

drop value_pro value_sal
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_crop_values_production_grouped.dta", replace
restore

*type of commodity
collapse (sum) value_crop_production value_crop_sales, by( sdd_hhid type_commodity) 
ren value_crop_production value_pro
ren value_crop_sales value_sal
...
drop value_pro value_sal
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_crop_values_production_type_crop.dta", replace
*End DYA 9.13.2020 
...
********************************************************************************
*Area planted
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_crop_area_plan.dta", clear
...
collapse (sum) area_plan*, by(sdd_hhid crop_code)
*generating area planted of each crop as a proportion of the total area
preserve 
collapse (sum) area_plan_hh=area_plan area_plan_female_hh=area_plan_female area_plan_male_hh=area_plan_male area_plan_mixed_hh=area_plan_mixed, by(sdd_hhid)
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_crop_area_plan_shannon.dta", replace
restore
merge m:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_crop_area_plan_shannon.dta", nogen		//all matched
...
bysort sdd_hhid (sdi_crop_female) : gen allmissing_female = mi(sdi_crop_female[1])
bysort sdd_hhid (sdi_crop_male) : gen allmissing_male = mi(sdi_crop_male[1])
bysort sdd_hhid (sdi_crop_mixed) : gen allmissing_mixed = mi(sdi_crop_mixed[1])
*Generating number of crops per household
bysort sdd_hhid crop_code : gen nvals_tot = _n==1
...
num_crops_male=nvals_male num_crops_mixed=nvals_mixed (max) allmissing_female allmissing_male allmissing_mixed, by(sdd_hhid)
...
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_shannon_diversity_index.dta", replace


********************************************************************************
*CONSUMPTION -- RH complete 10/25/21
******************************************************************************** 
use "${Tanzania_NPS_SDD_raw_data}/consumptionsdd.dta", clear
...
keep sdd_hhid total_cons peraeq_cons percapita_cons daily_peraeq_cons daily_percap_cons adulteq
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_consumption.dta", replace

********************************************************************************
*HOUSEHOLD FOOD PROVISION* -- RH complete 6/25
********************************************************************************
use "${Tanzania_NPS_SDD_raw_data}/HH_SEC_H.dta", clear
ren sdd_hhid sdd_hhid 
...
keep sdd_hhid months_food_insec
lab var months_food_insec "Number of months of inadequate food provision"
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_food_insecurity.dta", replace


********************************************************************************
*HOUSEHOLD ASSETS* - AM UPDATED 07.06.21 
********************************************************************************
use "${Tanzania_NPS_SDD_raw_data}/hh_sec_m.dta", clear
ren sdd_hhid sdd_hhid
...
collapse (sum) value_assets=value_today, by(sdd_hhid)
la var value_assets "Value of household assets"
save "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_assets.dta", replace 
...
global empty_vars ""
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_weights.dta", clear

*Gross crop income 
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_crop_production.dta", nogen
* Production by group and type of crop
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_crop_losses.dta", nogen
...
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_crop_values_production_grouped.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_crop_values_production_type_crop.dta", nogen
recode value_pro* value_sal* (.=0)
*Crop costs
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_cost_inputs.dta", nogen
/* the file above contains all of these variables:
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_asset_rental_costs.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_land_rental_costs.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_seed_costs.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_fertilizer_costs.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_wages_seasonseason.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_wages_mainseason.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_transportation_cropsales.dta", nogen
*/
/*OUT DYA.10.30.2020*/
...
*/ value_herbicide value_pesticide wages_paid_season wages_paid_main transport_costs_cropsales (.=0)
...
*/ value_herbicide value_pesticide wages_paid_season wages_paid_main transport_costs_cropsales) */
...
foreach c in $topcropname_area {
	//merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_land_rental_costs_`c'.dta", nogen
	capture confirm file "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_inputs_`c'.dta" //No monocropped wheat in this wave
	if _rc==0 { 
	merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_inputs_`c'.dta", nogen //All expenses are in here now.
	merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_`c'_monocrop_hh_area.dta", nogen
	}
}
*/
...
*top crop costs that are only present in season season
foreach c in $topcropname_season{
	merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_wages_seasonseason_`c'.dta", nogen
}
*costs that only include annual crops (seed costs and mainseason wages)
foreach c in $topcropname_annual {
	merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_seed_costs_`c'.dta", nogen
	merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_wages_mainseason_`c'.dta", nogen
}
*/
/*OUT DYA.10.30.2020*/
...
global missing_vars wages_paid_season_sunflr wages_paid_season_pigpea wages_paid_season_wheat wages_paid_season_pmill cost_seed_cassav cost_seed_banana wages_paid_main_cassav wages_paid_main_banana
...
foreach c in $topcropname_area {
	capture confirm file "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_inputs_`c'.dta"
	if _rc==0 {
	merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_inputs_`c'.dta", nogen
	merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_`c'_monocrop_hh_area.dta", nogen
	}
}
...
*land rights
merge 1:1 sdd_hhid using  "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_land_rights_hh.dta", nogen
la var formal_land_rights_hh "Household has documentation of land rights (at least one plot)"

*Livestock income
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_sales", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_livestock_products", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_dung.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_expenses", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_TLU.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_herd_characteristics", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_TLU_Coefficients.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_expenses_animal.dta", nogen 
...
*Fish income
//ALT: Not available 
/*merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_fish_income.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_fishing_expenses_1.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_fishing_expenses_2.dta", nogen
/*OUT DYA.10.30.2020*/
...
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_self_employment_income.dta", nogen
//merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_fish_trading_income.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_agproducts_profits.dta", nogen
...
*Wage income
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_wage_income.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_agwage_income.dta", nogen
/*OUT DYA.10.30.2020*/
...
*Off-farm hours
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_off_farm_hours.dta", nogen

*Other income
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_other_income.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_land_rental_income.dta", nogen
...
*Farm size
merge 1:1 sdd_hhid using  "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_land_size.dta", nogen
merge 1:1 sdd_hhid using  "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_land_size_all.dta", nogen
merge 1:1 sdd_hhid using  "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_farmsize_all_agland.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_land_size_total.dta", nogen
...
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_family_hired_labor.dta", nogen
...
*Household size
//merge 1:1 sdd_hhid using  "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hhsize.dta", nogen

*Rates of vaccine usage, improved seeds, etc.
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_vaccine.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_input_use.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_imprvseed_crop.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_any_ext.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_fin_serv.dta", nogen
...
*Milk productivity
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_milk_animals.dta", nogen
...
*Dairy costs 
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_lrum_expenses", nogen
...
*Egg productivity
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_eggs_animals.dta", nogen
...
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_cost_inputs.dta", nogen
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_cropcosts_total.dta", nogen
*Rate of fertilizer application 
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_fertilizer_application.dta", nogen
*Agricultural wage rate
//merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_ag_wage.dta", nogen
*Crop yields 
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_yield_hh_crop_level.dta", nogen
*Total area planted and harvested accross all crops, plots, and seasons
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_area_planted_harvested_allcrops.dta", nogen
*Household diet
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_household_diet.dta", nogen
*Consumption
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_consumption.dta", nogen
*Household assets
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hh_assets.dta", nogen

*Food insecurity
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_food_insecurity.dta", nogen
...
*Livestock health
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_diseases.dta", nogen

*livestock feeding, water, and housing
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_livestock_feed_water_house.dta", nogen
 
*Shannon diversity index
merge 1:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_shannon_diversity_index.dta", nogen
...
global wins_var_top1_gender $wins_var_top1_gender cost_total cost_expli inorg_fert_kg org_fert_kg n_kg p_kg k_kg dap_kg ha_irr can_kg sa_kg mrp_kg n_org_kg npk_kg urea_kg pest_kg wage_paid_aglabor herb_kg
...
gen ccf_loc = (1/$Tanzania_NPS_SDD_infl_adj) 
lab var ccf_loc "currency conversion factor - 2017 $NGN"
gen ccf_usd = ccf_loc/$Tanzania_NPS_SDD_exchange_rate 
lab var ccf_usd "currency conversion factor - 2017 $USD"
gen ccf_1ppp = ccf_loc/$Tanzania_NPS_SDD_cons_ppp_dollar
lab var ccf_1ppp "currency conversion factor - 2017 $Private Consumption PPP"
gen ccf_2ppp = ccf_loc/$Tanzania_NPS_SDD_gdp_ppp_dollar
lab var ccf_2ppp "currency conversion factor - 2017 $GDP PPP"

gen poverty_under_190 = daily_percap_cons < $Tanzania_NPS_SDD_poverty_190
...
keep sdd_hhid fhh clusterid strataid *weight* *wgt* region region_name district district_name ward ward_name village village_name ea rural farm_size* *total_income* /*
...
saveold "${Tanzania_NPS_SDD_final_data}/Tanzania_NPS_SDD_household_variables.dta", replace

//stop
********************************************************************************
*INDIVIDUAL-LEVEL VARIABLES
********************************************************************************
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_person_ids.dta", clear
merge m:1 sdd_hhid   using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_household_diet.dta", nogen
merge 1:1 sdd_hhid indidysdd using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_control_income.dta", nogen  keep(1 3)
merge 1:1 sdd_hhid indidysdd using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_make_ag_decision.dta", nogen  keep(1 3)
merge 1:1 sdd_hhid indidysdd using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_ownasset.dta", nogen  keep(1 3)
merge m:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_weights.dta", nogen keep (1 3)
merge 1:1 sdd_hhid indidysdd using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_farmer_input_use.dta", nogen  keep(1 3) //ALT 07.22.21: fert -> input
merge 1:1 sdd_hhid indidysdd using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_farmer_improvedseed_use.dta", nogen  keep(1 3)
merge 1:1 sdd_hhid indidysdd using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_farmer_vaccine.dta", nogen  keep(1 3)

*land rights
merge 1:1 sdd_hhid indidysdd using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_land_rights_ind.dta", nogen
...
gen all_imprv_seed_wheat=.
gen wheat_farmer=.
gen all_hybrid_seed_wheat=.
...
ren sdd_hhid hhid
ren indidysdd indid
merge m:1 hhid using "${Tanzania_NPS_SDD_final_data}/Tanzania_NPS_SDD_household_variables.dta", nogen keep (1 3) keepusing(ag_hh)
...
saveold "${Tanzania_NPS_SDD_final_data}/Tanzania_NPS_SDD_individual_variables.dta", replace
...
/*use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_cropvalue.dta", clear
merge 1:1 sdd_hhid plot_id using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_areas.dta", keep (1 3) nogen
merge 1:1 sdd_hhid plot_id  using  "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_decision_makers.dta", keep (1 3) nogen
merge m:1 sdd_hhid using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_hhids.dta", keep (1 3) nogen
...
use "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_all_plots.dta", clear
collapse (sum) plot_value_harvest=value_harvest, by(dm_gender sdd_hhid plot_id field_size season)
merge m:1 sdd_hhid plot_id  season using "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_plot_family_hired_labor.dta", keep (1 3) nogen
...
rename v1 TNZ_wave5 
save   "${Tanzania_NPS_SDD_created_data}/Tanzania_NPS_SDD_gendergap.dta", replace
restore
...
*/ 81 "Niger ECVMA Wave 1" 82 "Niger ECVMA Wave 2"
label values instrument instrument	
saveold "${Tanzania_NPS_SDD_final_data}/Tanzania_NPS_SDD_field_plot_variables.dta", replace
...
*/ 
//Parameters
global list_instruments  "Tanzania_NPS_SDD"
do "$summary_stats"
