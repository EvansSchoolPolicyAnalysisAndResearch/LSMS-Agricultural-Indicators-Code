...
forvalues k=1(1)$nb_topcrops  {		
	...
	*not sure if we want to include this (perm and fruit crops). We can't calculate an area planted anyways which is the denominator for most of our indicators
	...
	merge m:1 y4_hhid plot_id using "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_plot_areas.dta", nogen assert(2 3) keep(3)
...
forvalues k=1(1)$nb_topcrops  {		
	local c : word `k' of $topcrop_area
	local cn : word `k' of $topcropname_area
	use "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_`cn'_monocrop.dta", clear
...
save "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_tempcrop_harvest.dta", replace
...
save "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_tempcrop_sales.dta", replace
...
lab var kgs_harvest "Kgs harvested of this crop, summed over main and short season"
save "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_permcrop_harvest.dta", replace
...
gen price_kg = value_sold / quantity_sold
lab var price_kg "Price per kg sold"
save "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_permcrop_sales.dta", replace

*Prices of permanent and tree crops need to be imputed from sales.
use "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_permcrop_sales.dta", clear
append using "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_tempcrop_sales.dta"
recode price_kg (0=.)
...
use "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_crop_sales.dta", clear
gen observation = 1
...
save "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_crop_prices_ea.dta", replace
use "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_crop_sales.dta", clear
gen observation = 1
...
save "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_crop_prices_ward.dta", replace
use "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_crop_sales.dta", clear
gen observation = 1
...
save "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_crop_prices_district.dta", replace
use "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_crop_sales.dta", clear
gen observation = 1
...
save "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_crop_prices_region.dta", replace
use "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_crop_sales.dta", clear
gen observation = 1
...
save "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_crop_prices_country.dta", replace

*Pull prices into harvest estimates
use "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_tempcrop_harvest.dta", clear
append using "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_permcrop_harvest.dta"
merge m:1 y4_hhid using "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_hhids.dta", nogen keep(1 3)
merge m:1 y4_hhid crop_code using "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_crop_sales.dta", nogen
merge m:1 region district ward ea crop_code using "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_crop_prices_ea.dta", nogen
merge m:1 region district ward crop_code using "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_crop_prices_ward.dta", nogen
merge m:1 region district crop_code using "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_crop_prices_district.dta", nogen
merge m:1 region crop_code using "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_crop_prices_region.dta", nogen
merge m:1 crop_code using "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_crop_prices_country.dta", nogen
...
duplicates drop
save "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_hh_crop_prices.dta", replace
...
merge 1:1 y4_hhid crop_code using "${Tanzania_NPS_W4_created_data}/Tanzania_NPS_W4_hh_crop_values_production.dta"
drop if _merge==2
...
saveold "${Tanzania_NPS_W4_final_data}/Tanzania_NPS_W4_gender_productivity_gap.dta", replace
...
global final_data_household  "${Tanzania_NPS_W4_final_data}/Tanzania_NPS_W4_household_variables.dta"  
global final_data_individual "${Tanzania_NPS_W4_final_data}/Tanzania_NPS_W4_individual_variables.dta"
global final_data_plot       "${Tanzania_NPS_W4_final_data}/Tanzania_NPS_W4_gender_productivity_gap.dta"
global final_outputfile      "$Tanzania_NPS_W4_final_data\Tanzania_NPS_W4_summary_stats_`c(current_date)'.xlsx"
