...
*Using data files from within the "Nigeria GHSP - LSMS-ISA - Wave 1 (2010-11)" folder within the "Raw DTA files" folder, 
*the do.file first constructs common and intermediate variables, saving dta files when appropriate 
*in the folder "\Nigeria GHSP - LSMS-ISA - Wave 1 (2010-11)\created_data" within the "Final DTA files" folder.
*These variables are then brought together at the household, plot, or individual level, saving dta files at each level when available 
*in the folder "Nigeria GHSP - LSMS-ISA - Wave 1 (2010-11)" within the "Final DTA files" folder.
...
*The results are outputted in the excel file "Nigeria_GHSP_LSMS_ISA_W1_summary_stats.xlsx" in the "Nigeria GHSP - LSMS-ISA - Wave 1 (2010-11)" within the "Final DTA files" folder.
...
*-------------------------------------------------------------------------------------
*HOUSEHOLD IDS						Nigeria_GHSP_LSMS_ISA_W1_hhids.dta
*INDIVIDUAL IDS						Nigeria_GHSP_LSMS_ISA_W1_person_ids.dta
*HOUSEHOLD SIZE						Nigeria_GHSP_LSMS_ISA_W1_hhsize.dta
*HEAD OF HOUSEHOLD					Nigeria_GHSP_LSMS_ISA_W1_male_head.dta
*PARCEL AREAS						Nigeria_GHSP_LSMS_ISA_W1_plot_areas.dta
*PLOT-CROP DECISION MAKERS			Nigeria_GHSP_LSMS_ISA_W1_plot_decision_makers.dta
*TLU (Tropical Livestock Units)		Nigeria_GHSP_LSMS_ISA_W1_TLU_Coefficients.dta
*GROSS CROP REVENUE					Nigeria_GHSP_LSMS_ISA_W1_cropsales_value.dta
									Nigeria_GHSP_LSMS_ISA_W1_hh_crop_production.dta
									Nigeria_GHSP_LSMS_ISA_W1_plot_cropvalue.dta
									
									Nigeria_GHSP_LSMS_ISA_W1_crop_losses.dta
*CROP EXPENSES						**Nigeria_GHSP_LSMS_ISA_W1_wages_postplanting.dta
									Nigeria_GHSP_LSMS_ISA_W1_wages_postharvest.dta									
									Nigeria_GHSP_LSMS_ISA_W1_fertilizer_costs.dta
									Nigeria_GHSP_LSMS_ISA_W1_chemical_costs.dta
									**Nigeria_GHSP_LSMS_ISA_W1_manure_costs.dta
									Nigeria_GHSP_LSMS_ISA_W1_seed_costs.dta
									Nigeria_GHSP_LSMS_ISA_W1_land_rental_costs.dta
									Nigeria_GHSP_LSMS_ISA_W1_asset_rental_costs.dta	
									
*CROP INCOME						Nigeria_GHSP_LSMS_ISA_W1_crop_income.dta
									Nigeria_GHSP_LSMS_ISA_W1_livestock_products.dta

*LIVESTOCK INCOME					Nigeria_GHSP_LSMS_ISA_W1_livestock_expenses.dta
									Nigeria_GHSP_LSMS_ISA_W1_hh_livestock_products.dta
									Nigeria_GHSP_LSMS_ISA_W1_livestock_sales.dta
									Nigeria_GHSP_LSMS_ISA_W1_TLU.dta
									Nigeria_GHSP_LSMS_ISA_W1_livestock_income.dta

*FISH INCOME						Nigeria_GHSP_LSMS_ISA_W1_fishing_expenses_1.dta
									Nigeria_GHSP_LSMS_ISA_W1_fishing_expenses_2.dta
									Nigeria_GHSP_LSMS_ISA_W1_fish_income.dta
																	
*SELF-EMPLOYMENT INCOME				Nigeria_GHSP_LSMS_ISA_W1_self_employment_income.dta
									********Nigeria_GHSP_LSMS_ISA_W1_agproduct_income.dta
									
*WAGE INCOME						Nigeria_GHSP_LSMS_ISA_W1_wage_income.dta
									Nigeria_GHSP_LSMS_ISA_W1_agwage_income.dta

*OTHER INCOME						Nigeria_GHSP_LSMS_ISA_W1_remittance_income.dta
									Nigeria_GHSP_LSMS_ISA_W1_other_income.dta
									Nigeria_GHSP_LSMS_ISA_W1_land_rental_income.dta

*FARM SIZE / LAND SIZE				Nigeria_GHSP_LSMS_ISA_W1_land_size.dta
									Nigeria_GHSP_LSMS_ISA_W1_farmsize_all_agland.dta
									Nigeria_GHSP_LSMS_ISA_W1_land_size_all.dta

*FARM LABOR							Nigeria_GHSP_LSMS_ISA_W1_farmlabor_postplanting.dta
									Nigeria_GHSP_LSMS_ISA_W1_farmlabor_postharvest
					
*VACCINE USAGE						Nigeria_GHSP_LSMS_ISA_W1_vaccine.dta
*USE OF INORGANIC FERTILIZER		Nigeria_GHSP_LSMS_ISA_W1_fert_use.dta
*USE OF IMPROVED SEED				Nigeria_GHSP_LSMS_ISA_W1_improvedseed_use.dta //no improved seed
*REACHED BY AG EXTENSION			Nigeria_GHSP_LSMS_ISA_W1_any_ext.dta
*USE OF FORMAL FINANACIAL SERVICES	Nigeria_GHSP_LSMS_ISA_W1_fin_serv.dta
*GENDER PRODUCTIVITY GAP 			Nigeria_GHSP_LSMS_ISA_W1_gender_productivity_gap.dta

*CROP PRODUCTION COSTS PER HECTARE	Nigeria_GHSP_LSMS_ISA_W1_hh_cost_land.dta
									**Nigeria_GHSP_LSMS_ISA_W1_hh_cost_prep_labor.dta
									**Nigeria_GHSP_LSMS_ISA_W1_hh_cost_mid_labor.dta
									Nigeria_GHSP_LSMS_ISA_W1_hh_cost_harv_labor.dta
									Nigeria_GHSP_LSMS_ISA_W1_hh_cost_seed.dta	
									Nigeria_GHSP_LSMS_ISA_W1_hh_cost_inputs.dta									
									Nigeria_GHSP_LSMS_ISA_W1_cropcosts_perha.dta

*RATE OF FERTILIZER APPLICATION		Nigeria_GHSP_LSMS_ISA_W1_fertilizer_application.dta
*HOUSEHOLD'S DIET DIVERSITY SCORE	Nigeria_GHSP_LSMS_ISA_W1_household_diet.dta
*WOMEN'S CONTROL OVER INCOME		Nigeria_GHSP_LSMS_ISA_W1_control_income.dta
*WOMEN'S AG DECISION-MAKING			Nigeria_GHSP_LSMS_ISA_W1_make_ag_decision.dta
*WOMEN'S ASSET OWNERSHIP			Nigeria_GHSP_LSMS_ISA_W1_make_ownasset.dta
*AGRICULTURAL WAGES					Nigeria_GHSP_LSMS_ISA_W1_ag_wage.dta
*CROP YIELDS						Nigeria_GHSP_LSMS_ISA_W1_yield_hh_level.dta
*CONSUMPTION						Nigeria_GHSP_LSMS_ISA_W1_consumption.dta


*FINAL FILES						MAIN FILES CREATED
*-------------------------------------------------------------------------------------
*HOUSEHOLD VARIABLES				Nigeria_GHSP_LSMS_ISA_W1_household_variables.dta
*INDIVIDUAL-LEVEL VARIABLES			Nigeria_GHSP_LSMS_ISA_W1_individual_variables.dta	
*PLOT-LEVEL VARIABLES				Nigeria_GHSP_LSMS_ISA_W1_gender_productivity_gap.dta
*SUMMARY STATISTICS					Nigeria_GHSP_LSMS_ISA_W1_summary_stats.xlsx
...
global NGA_W1_raw_data "\\netid.washington.edu\wfs\EvansEPAR\Project\EPAR\Working Files\335 - Ag Team Data Support\Waves\Nigeria\Nigeria GHSP Wave 1 2010-11 (LSMS-ISA)\Raw DTA Files"
global NGA_W1_created_data  "\\netid.washington.edu\wfs\EvansEPAR\Project\EPAR\Working Files\335 - Ag Team Data Support\Waves\Nigeria\Nigeria GHSP Wave 1 2010-11 (LSMS-ISA)\Final DTA Files\created_data"
global NGA_W1_final_data  "\\netid.washington.edu\wfs\EvansEPAR\Project\EPAR\Working Files\335 - Ag Team Data Support\Waves\Nigeria\Nigeria GHSP Wave 1 2010-11 (LSMS-ISA)\Final DTA Files"
    
  
************************
*EXCHANGE RATE AND INFLATION FOR CONVERSION IN USD
************************
global GHSP_LSMS_ISA_W1_exchange_rate 199.04975  		//2016
global GHSP_LSMS_ISA_W1_gdp_ppp_dollar 93.915			//2016 https://data.worldbank.org/indicator/PA.NUS
global GHSP_LSMS_ISA_W1_cons_ppp_dollar 123.639
global GHSP_LSMS_ISA_W1_inflation 0.6591				//2011 to 2016 local
...
use "${NGA_W1_raw_data}\Post Planting Wave 1\Household\secta_plantingw1.dta", clear
gen rural = (sector==2)
lab var rural "1= Rural"
keep hhid zone state lga ea wt_wave1 rural
rename wt_wave1 weight
save  "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hhids.dta", replace
...
keep hhid zone state lga ea wt_wave1 rural
rename wt_wave1 weight
save  "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_weights.dta", replace
...
* INDIVIDUAL IDS *
******************
use "${NGA_W1_raw_data}\Post Planting Wave 1\Household\sect1_plantingw1.dta", clear
ren s1q2 sex
ren s1q4 age
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_person_ids.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hhsize.dta", replace
...
save "$NGA_W1_created_data/Nigeria_GHSP_LSMS_ISA_W1_male_head.dta", replace
...
clear
use "${NGA_W1_raw_data}/Post Planting Wave 1/Agriculture/sect11a1_plantingw1"

*merging in planting section to get cultivated status
merge 1:1 hhid plotid using "${NGA_W1_raw_data}/Post Planting Wave 1/Agriculture/sect11b_plantingw1", nogen

*merging in harvest section to get areas for new plots
merge 1:1 hhid plotid using "${NGA_W1_raw_data}/Post Harvest Wave 1/Agriculture/secta1_harvestw1.dta", gen(plot_merge)
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_areas.dta", replace
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_gender_merge_temp.dta", replace

*adding in gender variables for plot manager from post-harvest
use "${NGA_W1_raw_data}/Post Harvest Wave 1/Household/sect1_harvestw1.dta", clear
gen female = s1q2==2 if s1q2!=.
gen age = s1q4

duplicates drop hhid indiv, force
merge 1:1 hhid indiv using "$NGA_W1_created_data/Nigeria_GHSP_LSMS_ISA_W1_gender_merge_temp.dta", nogen 	
keep hhid indiv female age
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_gender_merge.dta", replace

*Using planting data 	
use "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_plot_areas.dta", clear 
	
//Post-Planting
*First manager 
gen indiv = s11aq6
merge m:1 hhid indiv using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_gender_merge_temp.dta", gen(dm1_merge) keep(1 3) 
...
*First manager 
gen indiv = sa1q11
merge m:1 hhid indiv using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_gender_merge_temp.dta", gen(dm3_merge) keep(1 3)			
...
merge m:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hhsize.dta", nogen keep(1 3)
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_decision_makers.dta", replace


************************
*crop unit conversion factors
************************
use "${NGA_W1_raw_data}\w1agnsconversion", clear
ren agcropid crop_code
ren nscode unit_cd
ren conversion conv_national
sort crop_code unit_cd conv_national
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_ng1_cf.dta", replace
...
use "${NGA_W1_raw_data}\Post Harvest Wave 1\Agriculture\secta3_harvestw1.dta", clear
rename sa3q2 cropcode
merge 1:1 hhid plotid cropcode cropid using "${NGA_W1_raw_data}/Post Planting Wave 1/Agriculture/sect11f_plantingw1"
rename plotid plot_id
...
merge m:1 crop_code unit_cd using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_ng1_cf.dta", gen(cf_merge)
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_`cn'_monocrop.dta", replace


*merge in plot decision makers
merge m:1 hhid plot_id using  "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_decision_makers", keep(3)
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_`cn'_monocrop_hh_area.dta", replace
}
...
use "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11i_plantingw1.dta", clear
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_TLU_Coefficients.dta", replace
...
gen observation=1
merge m:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_weights.dta"
...
save  "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_crop_prices_median_state.dta", replace
...
rename quantity_harvested_unit unit
save  "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_crop_prices_median_zone.dta", replace
...
rename quantity_harvested_unit unit
save  "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_crop_prices_median_country.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_cropsales_value.dta", replace
...
merge m:1 state zone unit crop_code using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_crop_prices_median_state.dta", nogen keep(1 3) 
merge m:1 zone unit crop_code using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_crop_prices_median_zone.dta", nogen keep(1 3)  
merge m:1 unit crop_code using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_crop_prices_median_country.dta", nogen keep(1 3) 
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_crop_values_tempfile.dta", replace 

recode crop_code (2170=2030) //recoding plantains as bananas for Nigeria
collapse (sum) value_harvest , by (hhid crop_code)
save  "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hh_crop_values_production.dta", replace 
merge 1:1 hhid crop_code using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_cropsales_value.dta"
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hh_crop_production.dta", replace



*Generating value of crop production at plot level
use "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_crop_values_tempfile.dta", clear
rename plotid plot_id
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_cropvalue.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hh_crop_prices_for_wages.dta", replace


use "${NGA_W1_raw_data}\Post Harvest Wave 1\Agriculture\secta2_harvestw1.dta", clear
*Harvest
...
rename sa2q11c unit
merge m:1 hhid crop_code unit using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hh_crop_prices_for_wages.dta", nogen keep (1 3)
merge m:1 crop_code unit using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_crop_prices_median_country.dta", nogen keep (1 3)
...
preserve
	...
	*disaggregate by gender of plot manager
	merge m:1 plot_id hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_decision_makers", nogen keep(1 3) keepusing(dm_gender)
	...
	*Merge in monocropped plots
	merge m:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_`cn'_monocrop.dta", nogen assert(1 3) keep(3)
	...
	save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_wages_postharvest_`cn'.dta", replace
restore
}
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_wages_postharvest.dta", replace


*Expenses: Inputs
*fertilizer (organic and inorganic)
use "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11d_plantingw1.dta", clear
...
preserve
	...
	*Merge in monocropped plots
	merge 1:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_`cn'_monocrop.dta", nogen assert(1 3) keep(3)		
	...
	save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_fertilizer_costs_`cn'.dta", replace
restore
}
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_fertilizer_costs.dta", replace

*Other chemicals
use "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11c_plantingw1.dta", clear
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_chemical_costs_`cn'.dta", replace
restore
}
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_chemical_costs.dta", replace

*Seed 
use "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11e_plantingw1.dta", clear
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_seed_costs_`cn'.dta", replace
restore
}
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_seed_costs.dta", replace

*Land rental
use "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11b_plantingw1.dta", clear
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_land_rental_costs_`cn'.dta", replace
restore
}
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_land_rental_costs.dta", replace
...
rename plotid plot_id
merge 1:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_areas.dta" 
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_asset_rental_costs.dta", replace
...
*Expenses
use "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11j_plantingw1.dta", clear
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_livestock_expenses.dta", replace

use "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11k_plantingw1.dta", clear
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hh_livestock_products.dta", replace

use "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hh_livestock_products", clear
merge m:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_weights.dta"
drop if _merge==2
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_livestock_products_prices_country.dta", replace
...
merge m:1 livestock_code unit using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_livestock_products_prices_country.dta", nogen keep(1 3) 
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_livestock_products.dta", replace
...
merge m:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_weights.dta", nogen keep(1 3) 
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hh_livestock_sales", replace
*Note that we could have used respondent estimates of the value of their livestock.

*Implicit prices (based on observed sales)
use "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_livestock_prices_ea.dta", replace
use "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_livestock_prices_lga.dta", replace
use "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_livestock_prices_state.dta", replace
use "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_livestock_prices_zone.dta", replace
use "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_livestock_prices_country.dta", replace

use "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hh_livestock_sales", clear
merge m:1 zone state lga ea livestock_code using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_livestock_prices_ea.dta", nogen 
merge m:1 zone state lga livestock_code using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_livestock_prices_lga.dta", nogen 
merge m:1 zone state livestock_code using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_livestock_prices_state.dta", nogen 
merge m:1 zone livestock_code using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_livestock_prices_zone.dta", nogen 
merge m:1 livestock_code using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_livestock_prices_country.dta", nogen 
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_livestock_sales.dta", replace
...
preserve
	...
	*Now dropping these missing variables, which I only used to construct the labels above
	...
	save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_herd_characteristics", replace
restore
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_TLU.dta", replace
...
use "${NGA_W1_raw_data}\Post Harvest Wave 1\Agriculture\secta9a2_harvestw1.dta", clear
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_fish_prices_1.dta", replace /* Caught fish */
...
rename price_per_unit price_per_unit_median
replace price_per_unit_median = . if fish_code==5 /* "Other */
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_fish_prices_2.dta", replace /* Harvested fish */
...
merge m:1 fish_code unit using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_fish_prices_1.dta", nogen keep(1 3)
...
merge m:1 fish_code unit using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_fish_prices_2.dta", nogen keep(1 3)
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_fish_income.dta", replace

use "${NGA_W1_raw_data}\Post Harvest Wave 1\Agriculture\secta9b1_harvestw1.dta", clear
...
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_fish_income.dta"
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_fishing_expenses_1.dta", replace

use "${NGA_W1_raw_data}\Post Harvest Wave 1\Agriculture\secta9b2_harvestw1.dta", clear
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_fishing_expenses_2.dta", replace
...
use "${NGA_W1_raw_data}\Post Harvest Wave 1\Household\sect9_harvestw1.dta", clear
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_self_employment_income.dta", replace
...
gen price_per_unit = value_harvested / quantity_harvested
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hh_crop_unit_values.dta", replace


***************
*OFF-FARM HOURS
***************
use "${NGA_W1_raw_data}\Post Harvest Wave 1\Household\sect3a_harvestw1.dta", clear
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_off_farm_hours.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_wage_income.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_agwage_income.dta", replace 
...
use "${NGA_W1_raw_data}\Post Harvest Wave 1\Household\sect6_harvestw1.dta", clear 
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_remittance_income.dta", replace

use "${NGA_W1_raw_data}\Post Harvest Wave 1\Household\sect13_harvestw1.dta", clear
append using "${NGA_W1_raw_data}\Post Harvest Wave 1\Household\sect14_harvestw1.dta"
append using "${NGA_W1_raw_data}\Post Harvest Wave 1\Agriculture\secta42_harvestw1.dta"
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_other_income.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_land_rental_income.dta", replace
...
use "${NGA_W1_raw_data}\Post Harvest Wave 1\Agriculture\secta3_harvestw1.dta", clear
gen cultivated = 1
merge m:1 hhid plotid using "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11b_plantingw1.dta"
rename s11bq16 cultivated_this_year

preserve 
	use "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11g_plantingw1.dta", clear
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_parcels_cultivated.dta", replace

use "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_areas.dta", clear
merge m:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_parcels_cultivated.dta"
keep if cultivated==1
collapse (sum) field_size, by (hhid plot_id)
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_sizes.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_land_size.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_parcels_agland.dta", replace


use "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_areas.dta", clear
merge 1:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_parcels_agland.dta", nogen
keep if agland==1
collapse (sum) field_size, by (hhid)
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_farmsize_all_agland.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_parcels_held.dta", replace

use "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_areas.dta", clear
merge 1:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_parcels_held.dta", nogen
keep if plot_held==1
collapse (sum) field_size, by (hhid)
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_land_size_all.dta", replace 
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_farmlabor_postharvest.dta", replace 

*labor 
use "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_farmlabor_postharvest.dta", clear
recode days*  (.=0)
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_family_hired_labor.dta", replace
collapse (sum) labor_*, by(hhid)
lab var labor_total "Total labor days (family, hired, or other) allocated to the farm in the past year"
lab var labor_hired "Total labor days (hired) allocated to the farm in the past year"
lab var labor_family "Total labor days (family) allocated to the farm in the past year"
lab var labor_total "Total labor days (hired +family) allocated to the farm in the past year" 
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_family_hired_labor.dta", replace
...
lab var vac_animal "1= Household has an animal vaccinated"
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_vaccine.dta", replace
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_farmer_vaccine.dta", replace
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_fert_use.dta", replace 
...
gen indiv=farmerid
drop if indiv==.
merge 1:1 hhid indiv using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_gender_merge.dta", nogen
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_farmer_fert_use.dta", replace  
...
use "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11l1_plantingw1.dta", clear
ren s11lq1 receive_advice
ren s11lq2 sourceid
ren s11lq2b sourceid_other
preserve
use "${NGA_W1_raw_data}\Post Harvest Wave 1\Agriculture\secta5a_harvestw1.dta", clear
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_any_ext.dta", replace 
...
use "${NGA_W1_raw_data}\Post Planting Wave 1\Household\sect4_plantingw1.dta", clear
merge m:m hhid using "${NGA_W1_raw_data}\Post Harvest Wave 1\Household\sect9_harvestw1.dta", nogen
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_fin_serv.dta", replace 
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_milk_animals.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_egg_animals.dta", replace
...
use "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11b_plantingw1.dta", clear
ren plotid plot_id
merge 1:1 plot_id hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_areas", nogen keep(1 3)
merge 1:1 plot_id hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_decision_makers", nogen keep (1 3)
...
preserve
	...
	save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_rental_rate.dta", replace
restore
...
preserve
	...
	save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_cultivated_plots_ha.dta", replace
restore
...
preserve
	...
	drop field_size
	save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_rental_rate_hh.dta", replace	
restore
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_rental_rate.dta", replace


*Now getting area planted
use "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11f_plantingw1.dta", clear
ren plotid plot_id
*Merging in gender of plot manager
merge m:1 plot_id hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_plot_areas", nogen keep(1 3)
...
*Rescaling
merge m:1 plot_id hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_plot_areas", nogen keep(1 3)			
merge m:1 plot_id hhid using "$NGA_W1_created_data\Nigeria_GHSP_LSMS_ISA_W1_plot_decision_makers", nogen keep(1 3)
...
merge m:1 hhid plotid using "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11b_plantingw1.dta", nogen keep(1 3)		
egen plot_rent = rowtotal(s11bq9 s11bq10)										// total paid for rent (on plot)
merge m:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_rental_rate_hh.dta", nogen keep(1 3)			// household's average rental rate (total rent paid divided by total ha rented at household level)
merge m:1 zone state lga sector using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_rental_rate.dta", nogen keep(1 3)	// aggregate rental rates
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_cost_land.dta", replace
...
preserve
	...
	keep wage_*_hh hhid
	save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_wages_harv.dta", replace
restore
...
merge m:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_wages_harv.dta", nogen keep(1 3)	
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_cost_harv_labor.dta", replace
...
preserve
	use "${NGA_W1_raw_data}/w1agnsconversion.dta", clear
	ren agcropid crop_code
	tempfile conversion
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_cost_seed.dta", replace
...
preserve			// only doing for liters adn grams  (since majority free pesticide is reported)
	...
	save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_pest_price.dta", replace
restore
merge m:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_pest_price.dta", nogen
...
preserve
	...
	save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_herb_price.dta", replace
restore
merge m:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_herb_price.dta", nogen
drop value_herb_*
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_cost_inputs.dta", replace
...
preserve
	...
	save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_fert_price_hh.dta", replace
restore
*Merging prices back in immediately
merge m:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_fert_price_hh.dta", nogen assert(3)		// all matched
...
preserve
	...
	save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_org_fert_price_hh.dta", replace
restore
*Immediately merging back in
merge m:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_org_fert_price_hh.dta", nogen assert(3)
...
preserve
	...
	save "$NGA_W1_created_data/Nigeria_GHSP_LSMS_ISA_W1_hh_fert.dta", replace
restore
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_cost_fert.dta", replace


use "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_cost_land.dta", clear
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_rental_rate.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_cost_harv_labor.dta", nogen keep(1 3)		
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_cost_fert.dta", nogen keep(1 3)			
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_cost_inputs.dta", nogen keep(1 3)			
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_male_head.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_cost_seed.dta", nogen keep(1 3)
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_cropcosts.dta", replace
...
use "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_fert.dta", clear

merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hhids.dta", keep(1 3) nogen
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_fert_use.dta", keep(1 3) nogen
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_fertilizer_application.dta", replace
...
use "${NGA_W1_raw_data}\Post Planting Wave 1\Household\sect7b_plantingw1.dta" , clear
keep zone state lga sector ea hhid item_cd s7bq1
gen survey="PP"
preserve
use "${NGA_W1_raw_data}\Post Harvest Wave 1\Household\sect10b_harvestw1.dta" , clear
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_household_diet.dta", replace
...
use "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11h_plantingw1.dta", clear
append using "${NGA_W1_raw_data}\Post Harvest Wave 1\Household\sect9_harvestw1.dta"
append using "${NGA_W1_raw_data}\Post Planting Wave 1\Household\sect6_plantingw1.dta"
...
merge 1:1 hhid indiv using "${NGA_W1_raw_data}\Post Planting Wave 1\Household\sect1_plantingw1.dta", nogen
merge 1:1 hhid indiv using "${NGA_W1_raw_data}\Post Harvest Wave 1\Household\sect1_harvestw1.dta"
gen female2 = s1q2 ==2
recode control_* (.=0)
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_control_income.dta", replace
...
* planting_input	
use "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11a1_plantingw1.dta", clear
append using "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11b_plantingw1.dta" 
append using "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11e_plantingw1.dta" 
append using "${NGA_W1_raw_data}\Post Harvest Wave 1\Agriculture\secta1_harvestw1.dta" 
append using "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11d_plantingw1.dta" 
append using "${NGA_W1_raw_data}\Post Harvest Wave 1\Agriculture\secta3_harvestw1.dta"
append using "${NGA_W1_raw_data}\Post Harvest Wave 1\Agriculture\secta3_harvestw1.dta"
append using "${NGA_W1_raw_data}\Post Harvest Wave 1\Agriculture\secta8_harvestw1.dta"
append using "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11k_plantingw1.dta"
append using "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11i_plantingw1.dta"
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_make_ag_decision.dta", replace
...
append using "${NGA_W1_raw_data}\Post Harvest Wave 1\Agriculture\secta1_harvestw1.dta"
append using "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11i_plantingw1.dta"
append using "${NGA_W1_raw_data}\Post Harvest Wave 1\Agriculture\secta41_harvestw1.dta"
append using "${NGA_W1_raw_data}\Post Harvest Wave 1\Agriculture\secta42_harvestw1.dta"
append using "${NGA_W1_raw_data}\Post Planting Wave 1\Household\sect5b_plantingw1.dta"
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_make_ownasset.dta", replace
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_ag_wage.dta", replace
...
use "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11f_plantingw1", clear
ren plotid plot_id
...
rename crop_code cropcode
merge 1:1 hhid plotid cropid cropcode using "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11g_plantingw1", nogen keep(1 3)
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_crop_area_planted", replace
...
merge m:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_areas.dta", nogen keep(1 3)
*There is one household that does not list the cropid
duplicates drop hhid plot_id cropid, force
merge 1:1 hhid plot_id cropid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_crop_area_planted",nogen keep(1 3)
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_crop_kgs_harvest", replace	
restore

*merging in gender variables
merge m:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_decision_makers", gen(_merge_gender)
drop if quant_harv_kg==. 
drop area_harv
...
save "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hh_area_planted_harvested_allcrops.dta", replace
restore 


keep if inlist(crop_code, $comma_topcrop_area)

save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_crop_harvest_area_yield.dta", replace


*Yield at the household level
use "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_crop_harvest_area_yield.dta", clear
* Adding value of crop production
merge 1:1 hhid crop_code using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_crop_values_production.dta", nogen keep(1 3)
ren value_crop_production value_harv
ren value_crop_sales value_sold
merge 1:1 hhid crop_code using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_crop_kgs_harvest.dta", nogen keep(1 3)
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_yield_hh_crop_level.dta", replace
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_adulteq.dta", replace 

use "${NGA_W1_raw_data}\cons_agg_wave1_visit1.dta", clear
merge 1:1 hhid using "${NGA_W1_raw_data}/cons_agg_wave1_visit2.dta", nogen

merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_adulteq.dta"

rename totcons percapita_cons
gen total_cons = percapita_cons*hhsize
recode total_cons percapita_cons (.=0)
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_consumption.dta", replace
 

**************************
*HOUSEHOLD FOOD PROVISION*
**************************
use "${NGA_W1_raw_data}\Post Harvest Wave 1\Household\sect12_harvestw1.dta", clear
...
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_food_insecurity.dta", replace

******************
*HOUSEHOLD ASSETS*
******************
use "${NGA_W1_raw_data}\Post Planting Wave 1\Household\sect5b_plantingw1.dta", clear
ren s5q4 value_today
ren s5q3 age_item

collapse (sum) value_assets=value_today, by(hhid)
la var value_assets "Value of household assets"
save "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_assets.dta", replace 
...
use "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hhids.dta", clear

*Gross crop income 
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hh_crop_production.dta", nogen
recode value_crop_production  (.=0)
*Variables: value_crop_production 

*Crop costs
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_asset_rental_costs.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_land_rental_costs.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_seed_costs.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_chemical_costs.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_fertilizer_costs.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_wages_postharvest.dta", nogen
...
foreach c in $topcropname_area {
	merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_land_rental_costs_`c'.dta", nogen
	merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_seed_costs_`c'.dta", nogen
	merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_fertilizer_costs_`c'.dta", nogen
	merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_chemical_costs_`c'.dta", nogen
	merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_wages_postharvest_`c'.dta", nogen
	merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_`c'_monocrop_hh_area.dta", nogen
}
...
*Fish income
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_fish_income.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_fishing_expenses_1.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_fishing_expenses_2.dta", nogen
...
*Livestock income
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_livestock_sales.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_livestock_expenses.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_livestock_products.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_TLU.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_herd_characteristics", nogen
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_TLU_Coefficients.dta", nogen
...
*Self-employment income
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_self_employment_income.dta", nogen
...
*Wage income
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_agwage_income.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_wage_income.dta", nogen
...
*Off-farm hours
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_off_farm_hours.dta", nogen

*Other income
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_other_income.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_remittance_income.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_other_income.dta", nogen
...
*Farm size
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_land_size_all.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_farmsize_all_agland.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_land_size.dta", nogen
recode land_size (.=0)
...
*Labor
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_family_hired_labor.dta", nogen
recode labor_hired labor_family (.=0) 

*Household size
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hhsize.dta", nogen

*Rates of vaccine, improved seeds, inorganic fertilizer, extensions, and formal financial services 
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_vaccine.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_fert_use.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_any_ext.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_fin_serv.dta", nogen
...
*Milk productivity
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_milk_animals.dta", nogen
gen costs_dairy = 0
gen costs_dairy_percow = 0

*Egg productivity
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_egg_animals.dta", nogen
...
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_cropcosts.dta", nogen

*Rate of fertilizer application
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_fertilizer_application.dta", nogen

*Agricultural wage rate
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_ag_wage.dta", nogen

*Crop yields
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_yield_hh_crop_level.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_area_planted_harvested_allcrops.dta", nogen

*Household diet
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_household_diet.dta", nogen

*Consumption
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_consumption.dta", nogen

*Household assets
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_hh_assets.dta", nogen

*Food insecurity
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_food_insecurity.dta", nogen
...
foreach p of varlist $monetary_vars {
	gen `p'_1ppp = (1 + $GHSP_LSMS_ISA_W1_inflation ) * `p' / $GHSP_LSMS_ISA_W1_cons_ppp_dollar
	gen `p'_2ppp = (1 + $GHSP_LSMS_ISA_W1_inflation ) * `p' / $GHSP_LSMS_ISA_W1_gdp_ppp_dollar
	gen `p'_usd = (1+ $GHSP_LSMS_ISA_W1_inflation ) * `p' / $GHSP_LSMS_ISA_W1_exchange_rate   
	gen `p'_loc = (1+ $GHSP_LSMS_ISA_W1_inflation ) * `p'
	local l`p' : var lab `p' 
	...
	lab var `p' "`l`p'' (NGN)"  
	gen w_`p'_1ppp = (1 + $GHSP_LSMS_ISA_W1_inflation ) * w_`p' / $GHSP_LSMS_ISA_W1_cons_ppp_dollar
	gen w_`p'_2ppp = (1 + $GHSP_LSMS_ISA_W1_inflation ) * w_`p' / $GHSP_LSMS_ISA_W1_gdp_ppp_dollar
	gen w_`p'_usd = (1 + $GHSP_LSMS_ISA_W1_inflation ) * w_`p' / $GHSP_LSMS_ISA_W1_exchange_rate
	gen w_`p'_loc = (1 + $GHSP_LSMS_ISA_W1_inflation ) * `p'
...
gen poverty_under_1_9 = (daily_percap_cons<151.90421)
...
save "${NGA_W1_final_data}/Nigeria_GHSP_LSMS_ISA_W1_household_variables.dta", replace
...
**************
use "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_person_ids.dta", clear
use "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_gender_merge.dta", clear
merge 1:1 hhid indiv using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_control_income.dta", nogen  keep(1 3)
merge 1:1 hhid indiv using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_make_ag_decision.dta", nogen  keep(1 3)
merge 1:1 hhid indiv using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_make_ownasset.dta", nogen  keep(1 3)
merge m:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hhsize.dta", nogen keep (1 3)
merge 1:1 hhid indiv using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_farmer_fert_use.dta", nogen  keep(1 3)
merge 1:1 hhid indiv using "${NGA_W1_created_data}/Nigeria_GHSP_LSMS_ISA_W1_farmer_vaccine.dta", nogen  keep(1 3)
merge m:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_hhids.dta", nogen keep (1 3)


preserve
use "${NGA_W1_final_data}/Nigeria_GHSP_LSMS_ISA_W1_household_variables.dta", clear
keep hhid ag_hh
tempfile ag_hh
save `ag_hh'
restore
...
save "${NGA_W1_final_data}/Nigeria_GHSP_LSMS_ISA_W1_individual_variables.dta", replace
...
use "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_areas.dta", clear
merge m:1 hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_weights.dta", keep (1 3) nogen
merge 1:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_cropvalue.dta", keep (1 3) nogen
merge 1:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_decision_makers", keep (1 3) nogen // Bring in the gender file
merge 1:1 plot_id hhid using "${NGA_W1_created_data}\Nigeria_GHSP_LSMS_ISA_W1_plot_farmlabor_postharvest.dta", keep (1 3) nogen
keep if cultivate==1
...
foreach p of varlist $monetary_val {
	...
	gen `p'_2ppp = (1 + $GHSP_LSMS_ISA_W1_inflation ) * `p' / $GHSP_LSMS_ISA_W1_gdp_ppp_dollar
	gen `p'_usd = (1+ $GHSP_LSMS_ISA_W1_inflation ) * `p' / $GHSP_LSMS_ISA_W1_exchange_rate   
	gen `p'_loc = (1+ $GHSP_LSMS_ISA_W1_inflation ) 
	local l`p' : var lab `p' 
	lab var `p'_1ppp "`l`p'' (2016 $ Private Consumption PPP)"
	lab var `p'_2ppp "`l`p'' (2016 $ GDP PPP)"
	lab var `p'_usd "`l`p'' (2016 $ USD)"
	...
	gen w_`p'_2ppp = (1 + $GHSP_LSMS_ISA_W1_inflation ) * w_`p' / $GHSP_LSMS_ISA_W1_gdp_ppp_dollar
	gen w_`p'_usd = (1 + $GHSP_LSMS_ISA_W1_inflation ) * w_`p' / $GHSP_LSMS_ISA_W1_exchange_rate
	gen w_`p'_loc = (1 + $GHSP_LSMS_ISA_W1_inflation )
	local lw_`p' : var lab w_`p'
	lab var w_`p'_1ppp "`lw_`p'' (2016 $ Private Consumption PPP)"
	lab var w_`p'_2ppp "`lw_`p'' (2016 $ GDP PPP)"
	lab var w_`p'_usd "`lw_`p'' (2016 $ USD)"
...
save "${NGA_W1_final_data}\Nigeria_GHSP_LSMS_ISA_W1_gender_productivity_gap.dta", replace
...
global final_data_household  "${NGA_W1_final_data}/Nigeria_GHSP_LSMS_ISA_W1_household_variables.dta"  
global final_data_individual "${NGA_W1_final_data}/Nigeria_GHSP_LSMS_ISA_W1_individual_variables.dta"
global final_data_plot       "${NGA_W1_final_data}\Nigeria_GHSP_LSMS_ISA_W1_gender_productivity_gap.dta"
global final_outputfile      "${NGA_W1_final_data}/Nigeria_GHSP_LSMS_ISA_W1_summary_stats_XXXXXX.xlsx" //Update date
...
gen imprv_seed_`cn' =0 
gen hybrid_seed_`cn' = 0
}
gen use_fin_serv_digital =0
gen formal_land_rights_hh =0
...
foreach v of global household_vars1 {
 ...
 global no_var2 w_share_fishing4fish_hh_mhh
foreach v of global no_var2 {
	replace `v'=0
}
...
**no mixed managed plots in NGA
foreach v in $topcropname_area_full {
	replace w_yield_hv_mixed_`v'=0
	replace ar_hv_wgt_mixed_`v'=1
	replace w_yield_hv_pure_mixed_`v'=0	
	replace ar_hv_wgt_pure_mixed_`v'=1
	replace w_yield_pl_mixed_`v'=0
	replace w_yield_pl_pure_mixed_`v'=0
	replace ar_pl_wgt_mixed_`v'=1
	replace ar_pl_wgt_pure_mixed_`v'=1
	
}

*recoding variables that aren't present in this instrument and wave
recode w_yield_hv_female_wheat (.=0)
recode ar_hv_wgt_female_wheat (.=1)
recode w_yield_hv_pure_wheat (.=0)
recode ar_hv_wgt_pure_wheat (.=1)
recode w_yield_hv_pure_male_wheat  (.=0)
recode ar_hv_wgt_pure_male_wheat (.=1)
recode w_yield_hv_pure_female_wheat (.=0)
recode ar_hv_wgt_pure_female_wheat (.=1)
recode w_yield_hv_pure_female_soy (.=0)
recode ar_hv_wgt_pure_female_soy (.=1)

recode w_yield_pl_female_wheat (.=0)
recode ar_pl_wgt_female_wheat (.=1)
recode w_yield_pl_pure_wheat (.=0)
recode ar_pl_wgt_pure_wheat (.=1)
recode w_yield_pl_pure_male_wheat  (.=0)
recode ar_pl_wgt_pure_male_wheat (.=1)
recode w_yield_pl_pure_female_wheat (.=0)
recode ar_pl_wgt_pure_female_wheat (.=1)
recode w_yield_pl_pure_female_soy (.=0)
recode ar_pl_wgt_pure_female_soy (.=1)
...
gen w_liters_per_cow=0  /*not availlanle for NGA so all is set to 0*/
gen w_liters_per_buffalo=0 /*not availlanle for NGA so all is set to 0*/
gen w_egg_poultry_year=0 /*not availlanle for NGA so all is set to 0*/
...
foreach v in 1ppp 2ppp loc {
	replace w_value_milk_produced_`v'=. if w_value_milk_produced_`v'==0  
	replace w_value_eggs_produced_`v'=. if w_value_eggs_produced_`v'==0
}
...
global fert_mixed  mixed
foreach  v of global fert_mixed {
	replace  w_inorg_fert_rate_`v'=1
	gen  area_weight_`v'=1
	gen w_inorg_fert_rate_`v'use_fert=0
}

global fert_vars all male female
...
foreach i in 1ppp 2ppp loc {
	replace w_cost_expli_ha_mixed_`i'=0
	replace w_cost_expli_ha_mixed01Ha_`i' =0
	replace w_cost_expli_ha_mixed12Ha_`i' =0
	replace w_cost_expli_ha_mixed24Ha_`i' =0
	replace w_cost_expli_ha_mixed4Ha_`i' =0
}
...
*no beans 
gen ar_pl_mono_wgt_beans_all = 1 
gen kgs_harv_wgt_beans_all = 1 
foreach g in female male mixed {
	gen ar_pl_mono_wgt_beans_`g' = 1
	gen kgs_harv_wgt_beans_`g' = 1
}

foreach i in 1ppp 2ppp loc {
	gen w_beans_exp_`i'=0
	gen w_beans_exp_ha_`i'=0
	gen w_beans_exp_kg_`i'=0
		
	foreach g in female male mixed {
	gen w_beans_exp_`g'_`i'=0
	gen w_beans_exp_ha_`g'_`i'=0
	gen w_beans_exp_kg_`g'_`i'=0
...
foreach i in 1ppp 2ppp loc {
replace w_cost_total_ha_mixed_`i'=0

	foreach v in $topcropname_area_full {
	replace w_`v'_exp_mixed_`i'=0
	replace w_`v'_exp_ha_mixed_`i'=0
	replace w_`v'_exp_kg_mixed_`i'=0
	}
...
foreach i in 1ppp 2ppp loc {
	foreach x in $topcropname_area_full {
		recode w_`x'_exp_mixed_`i' (.=0)
		recode w_`x'_exp_ha_mixed_`i' (.=0)
		recode w_`x'_exp_kg_mixed_`i' (.=0)
		replace ar_pl_mono_wgt_`x'_mixed = 1
		replace kgs_harv_wgt_`x'_mixed = 1 
	}
}
...
foreach i in 1ppp 2ppp loc {
	foreach x in wheat {
		...
		replace ar_pl_mono_wgt_`x'_female = 1 
		replace kgs_harv_wgt_`x'_female = 1 
	}
}
...
*No beans
foreach i in 1ppp 2ppp loc {
	gen w_value_harv_beans_`i'=0 
	gen w_value_sold_beans_`i' =0
}

gen w_kgs_harvest_beans =0
gen w_total_planted_area_beans =0
gen w_total_harv_area_beans =0
...
foreach v in 1ppp 2ppp loc {
	...
	recode w_kgs_harvest_wheat_fhh (.=0)
	recode w_total_planted_area_wheat_fhh (.=0)
	recode w_total_harv_area_wheat_fhh (.=0)
}
...
qui svyset clusterid [pweight=plot_weight], strata(strataid) singleunit(centered) // get standard errors of the mean
tabstat w_plot_productivity_all_`i'   [aw=plot_weight]  if rural==1 & dm_gender!=.    , stat(mean sd p25 p50 p75  min max N) col(stat) save
matrix temp_all=r(StatTotal)'
qui svy, subpop(if rural==1 & dm_gender!=. ): mean w_plot_productivity_all_`i' 
...
recode w_plot_productivity_mixed_`i' (.=0)
...
gen w_plot_labor_weight= labor_total*weight

foreach i in 1ppp 2ppp loc { 
qui svyset clusterid [pweight=weight], strata(strataid) singleunit(centered) // get standard errors of the mean
tabstat w_plot_labor_prod_all_`i'   [aw=w_plot_labor_weight]   if rural==1   , stat(mean sd p25 p50 p75  min max N) col(stat) save
matrix temp_all=r(StatTotal)'
qui svy, subpop(if rural==1): mean w_plot_labor_prod_all_`i' 
matrix w_plot_labor_prod_all_`i' =temp_all,el(r(table),2,1)

tabstat w_plot_labor_prod_female_`i'   [aw=w_plot_labor_weight]   if rural==1 & dm_gender==2   , stat(mean sd p25 p50 p75  min max N) col(stat) save
matrix temp_female=r(StatTotal)'
...
tabstat w_plot_labor_prod_male_`i'   [aw=w_plot_labor_weight]   if rural==1  & dm_gender==1  , stat(mean sd p25 p50 p75  min max N) col(stat) save
matrix temp_male=r(StatTotal)'
...
recode w_plot_labor_prod_mixed_`i' (.=0)
tabstat w_plot_labor_prod_mixed_`i'  [aw=w_plot_labor_weight]   if rural==1 , stat(mean sd p25 p50 p75  min max N) col(stat) save
matrix temp_mixed=r(StatTotal)'
