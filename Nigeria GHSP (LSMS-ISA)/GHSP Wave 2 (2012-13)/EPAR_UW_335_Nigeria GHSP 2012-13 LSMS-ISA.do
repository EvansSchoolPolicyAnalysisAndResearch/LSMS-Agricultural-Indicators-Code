...
*in the folder "\Nigeria GHSP - LSMS-ISA - Wave 2 (2012-13)\created_data" within the "Final DTA files" folder.
...
*The results are outputted in the excel file "Nigeria_GHSP_LSMS_ISA_W2_summary_stats.xlsx" in the "Nigeria GHSP - LSMS-ISA - Wave 2 (2012-13)" within the "Final DTA files" folder.
...
*-------------------------------------------------------------------------------------
*HOUSEHOLD IDS						Nigeria_GHSP_LSMS_ISA_W2_hhids.dta
*INDIVIDUAL IDS						Nigeria_GHSP_LSMS_ISA_W2_person_ids.dta
*HOUSEHOLD SIZE						Nigeria_GHSP_LSMS_ISA_W2_hhsize.dta
*HEAD OF HOUSEHOLD					Nigeria_GHSP_LSMS_ISA_W2_male_head.dta
*PARCEL AREAS						Nigeria_GHSP_LSMS_ISA_W2_plot_areas.dta
*PLOT-CROP DECISION MAKERS			Nigeria_GHSP_LSMS_ISA_W2_plot_decision_makers.dta
*TLU (Tropical Livestock Units)		Nigeria_GHSP_LSMS_ISA_W2_TLU_Coefficients.dta
*GROSS CROP REVENUE					Nigeria_GHSP_LSMS_ISA_W2_cropsales_value.dta
									Nigeria_GHSP_LSMS_ISA_W2_hh_crop_production.dta
									Nigeria_GHSP_LSMS_ISA_W2_plot_cropvalue.dta
									Nigeria_GHSP_LSMS_ISA_W2_crop_losses.dta
*CROP EXPENSES						Nigeria_GHSP_LSMS_ISA_W2_wages_postplanting.dta
									Nigeria_GHSP_LSMS_ISA_W2_wages_postharvest.dta									
									Nigeria_GHSP_LSMS_ISA_W2_fertilizer_costs.dta
									Nigeria_GHSP_LSMS_ISA_W2_chemical_costs.dta
									Nigeria_GHSP_LSMS_ISA_W2_manure_costs.dta
									Nigeria_GHSP_LSMS_ISA_W2_seed_costs.dta
									Nigeria_GHSP_LSMS_ISA_W2_land_rental_costs.dta
									Nigeria_GHSP_LSMS_ISA_W2_asset_rental_costs.dta									
*CROP INCOME						Nigeria_GHSP_LSMS_ISA_W2_crop_income.dta
									Nigeria_GHSP_LSMS_ISA_W2_livestock_products.dta

*LIVESTOCK INCOME					Nigeria_GHSP_LSMS_ISA_W2_livestock_expenses.dta
									Nigeria_GHSP_LSMS_ISA_W2_hh_livestock_products.dta
									Nigeria_GHSP_LSMS_ISA_W2_livestock_sales.dta
									Nigeria_GHSP_LSMS_ISA_W2_TLU.dta
									Nigeria_GHSP_LSMS_ISA_W2_livestock_income.dta

*FISH INCOME						Nigeria_GHSP_LSMS_ISA_W2_fishing_expenses_1.dta
									Nigeria_GHSP_LSMS_ISA_W2_fishing_expenses_2.dta
									Nigeria_GHSP_LSMS_ISA_W2_fish_income.dta
																	
*SELF-EMPLOYMENT INCOME				Nigeria_GHSP_LSMS_ISA_W2_self_employment_income.dta
									Nigeria_GHSP_LSMS_ISA_W2_agproduct_income.dta
									
*WAGE INCOME						Nigeria_GHSP_LSMS_ISA_W2_wage_income.dta
									Nigeria_GHSP_LSMS_ISA_W2_agwage_income.dta

*OTHER INCOME						Nigeria_GHSP_LSMS_ISA_W2_remittance_income.dta
									Nigeria_GHSP_LSMS_ISA_W2_other_income.dta
									Nigeria_GHSP_LSMS_ISA_W2_land_rental_income.dta

*FARM SIZE / LAND SIZE				Nigeria_GHSP_LSMS_ISA_W2_land_size.dta
									Nigeria_GHSP_LSMS_ISA_W2_farmsize_all_agland.dta
									Nigeria_GHSP_LSMS_ISA_W2_land_size_all.dta

*FARM LABOR							Nigeria_GHSP_LSMS_ISA_W2_farmlabor_postplanting.dta
									Nigeria_GHSP_LSMS_ISA_W2_farmlabor_postharvest
					
*VACCINE USAGE						Nigeria_GHSP_LSMS_ISA_W2_vaccine.dta
*USE OF INORGANIC FERTILIZER		Nigeria_GHSP_LSMS_ISA_W2_fert_use.dta
*USE OF IMPROVED SEED				Nigeria_GHSP_LSMS_ISA_W2_improvedseed_use.dta
*REACHED BY AG EXTENSION			Nigeria_GHSP_LSMS_ISA_W2_any_ext.dta
*USE OF FORMAL FINANACIAL SERVICES	Nigeria_GHSP_LSMS_ISA_W2_fin_serv.dta
*GENDER PRODUCTIVITY GAP 			Nigeria_GHSP_LSMS_ISA_W2_gender_productivity_gap.dta

*CROP PRODUCTION COSTS PER HECTARE	Nigeria_GHSP_LSMS_ISA_W2_hh_cost_land.dta
									Nigeria_GHSP_LSMS_ISA_W2_hh_cost_prep_labor.dta
									Nigeria_GHSP_LSMS_ISA_W2_hh_cost_mid_labor.dta
									Nigeria_GHSP_LSMS_ISA_W2_hh_cost_harv_labor.dta
									Nigeria_GHSP_LSMS_ISA_W2_hh_cost_seed.dta	
									Nigeria_GHSP_LSMS_ISA_W2_hh_cost_inputs.dta									
									Nigeria_GHSP_LSMS_ISA_W2_cropcosts_perha.dta

*RATE OF FERTILIZER APPLICATION		Nigeria_GHSP_LSMS_ISA_W2_fertilizer_application.dta
*HOUSEHOLD'S DIET DIVERSITY SCORE	Nigeria_GHSP_LSMS_ISA_W2_household_diet.dta
*WOMEN'S CONTROL OVER INCOME		Nigeria_GHSP_LSMS_ISA_W2_control_income.dta
*WOMEN'S AG DECISION-MAKING			Nigeria_GHSP_LSMS_ISA_W2_make_ag_decision.dta
*WOMEN'S ASSET OWNERSHIP			Nigeria_GHSP_LSMS_ISA_W2_make_ownasset.dta
*AGRICULTURAL WAGES					Nigeria_GHSP_LSMS_ISA_W2_ag_wage.dta
*CROP YIELDS						Nigeria_GHSP_LSMS_ISA_W2_yield_hh_level.dta
*CONSUMPTION						Nigeria_GHSP_LSMS_ISA_W2_consumption.dta


*FINAL FILES						MAIN FILES CREATED
*-------------------------------------------------------------------------------------
*HOUSEHOLD VARIABLES				Nigeria_GHSP_LSMS_ISA_W2_household_variables.dta
*INDIVIDUAL-LEVEL VARIABLES			Nigeria_GHSP_LSMS_ISA_W2_individual_variables.dta	
*PLOT-LEVEL VARIABLES				Nigeria_GHSP_LSMS_ISA_W2_gender_productivity_gap.dta
*SUMMARY STATISTICS					Nigeria_GHSP_LSMS_ISA_W2_summary_stats.xlsx
...
global NGA_W2_raw_data "\\netid.washington.edu\wfs\EvansEPAR\Project\EPAR\Working Files\335 - Ag Team Data Support\Waves\Nigeria\Nigeria GHSP Wave 2 2012-13 (LSMS-ISA)\Raw DTA Files"
global NGA_W2_created_data  "\\netid.washington.edu\wfs\EvansEPAR\Project\EPAR\Working Files\335 - Ag Team Data Support\Waves\Nigeria\Nigeria GHSP Wave 2 2012-13 (LSMS-ISA)\Final DTA Files\created_data"
global NGA_W2_final_data  "\\netid.washington.edu\wfs\EvansEPAR\Project\EPAR\Working Files\335 - Ag Team Data Support\Waves\Nigeria\Nigeria GHSP Wave 2 2012-13 (LSMS-ISA)\Final DTA Files"
  

************************
*EXCHANGE RATE AND INFLATION FOR CONVERSION IN USD
************************
global GHSP_LSMS_ISA_W2_exchange_rate 199.04975
global GHSP_LSMS_ISA_W2_gdp_ppp_dollar 93.915
global GHSP_LSMS_ISA_W2_cons_ppp_dollar 123.639
global GHSP_LSMS_ISA_W2_inflation 0.362927552
...
use "${NGA_W2_raw_data}\HHTrack.dta", clear
merge m:1 hhid using "${NGA_W2_raw_data}\Post Planting Wave 2\Household\secta_plantingw2.dta"
gen rural = (sector==2)
lab var rural "1= Rural"
keep hhid zone state lga ea wt_wave2 rural
rename wt_wave2 weight
save  "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hhids.dta", replace
...
keep hhid zone state lga ea wt_wave2 rural
rename wt_wave2 weight
save  "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_weights.dta", replace
...
* INDIVIDUAL IDS *
******************
use "${NGA_W2_raw_data}\PTrack.dta", clear
keep hhid indiv sex age 
gen female= sex==2
la var female "1= individual is female"
la var age "Individual age"
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_person_ids.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hhsize.dta", replace
...
*Creating HOH gender
clear 
use "${NGA_W2_raw_data}/PTrack.dta"
gen female_head = 0
replace female_head =1 if (relat_w2v1==1 | relat_w2v2==1) & sex ==1
collapse (max) female_head, by(hhid)
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_male_head.dta", replace
...
clear
use "${NGA_W2_raw_data}/Post Planting Wave 2/Agriculture/sect11a1_plantingw2"

*merging in planting section to get cultivated status
merge 1:1 hhid plotid using "${NGA_W2_raw_data}/Post Planting Wave 2/Agriculture/sect11b1_plantingw2", nogen

*merging in harvest section to get areas for new plots
merge 1:1 hhid plotid using "${NGA_W2_raw_data}/Post Harvest Wave 2/Agriculture/secta1_harvestw2.dta", gen(plot_merge)
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_areas.dta", replace
...
use "${NGA_W2_raw_data}/Post Planting Wave 2/Household/sect1_plantingw2.dta", clear
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_gender_merge_temp.dta", replace

*adding in gender variables for plot manager from post-harvest
use "${NGA_W2_raw_data}/Post Harvest Wave 2/Household/sect1_harvestw2.dta", clear
gen female = s1q2==2 if s1q2!=.
gen age = s1q4

duplicates drop hhid indiv, force
drop s1q36 s1q37b                
merge 1:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_gender_merge_temp.dta", nogen 		
keep hhid indiv female age
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_gender_merge.dta", replace

*Using planting data 	
use "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_plot_areas.dta", clear 
	
//Post-Planting
*First manager 
gen indiv = s11aq6a
merge m:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_gender_merge_temp.dta", gen(dm1_merge) keep(1 3) 
gen dm1_female = female if s11aq6a!=.
drop indiv 

*Second manager 
gen indiv = s11aq6b
merge m:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_gender_merge_temp.dta", gen(dm2_merge) keep(1 3)			
...
*First manager 
gen indiv = sa1q11
merge m:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_gender_merge_temp.dta", gen(dm4_merge) keep(1 3)			
gen dm3_female = female & sa1q11!=.
drop indiv 

*Second manager 
gen indiv = sa1q11b
merge m:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_gender_merge_temp.dta", gen(dm5_merge) keep(1 3)			
...
merge m:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hhsize.dta", nogen keep(1 3)
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_decision_makers", replace


*Formalized land rights
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11b1_plantingw2.dta", clear

gen formal_land_rights=1 if s11b1q8>=1 | 	s11b1q10a>=1 | s11b1q10b>=1 | s11b1q10c>=1 | s11b1q10d>=1								// Note: Including anything other than "no documents" as formal
	
*Individual level (for women)
*Starting with first owner
preserve
	ren s11b1q6a indiv
	merge m:1 hhid indiv using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_person_ids.dta", nogen keep(3)		
...
preserve
	...
	save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_land_rights_ind.dta", replace
restore	
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_land_rights_hh.dta", replace


************************
*crop unit conversion factors
************************
use "${NGA_W2_raw_data}/w2agnsconversion", clear
ren cropcode crop_code
ren nscode unit_cd
drop if kg==0
ren conversion  conv_fact
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_ng3_cf.dta", replace
...
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11f_plantingw2.dta", clear
merge 1:1 hhid plotid cropcode cropid using"${NGA_W2_raw_data}\Post Harvest Wave 2\Agriculture\secta3_harvestw2.dta"
rename plotid plot_id
ren s11fq1a area_size
ren s11fq1b area_unit
recode cropcode (2170=2030) //recoding plantains as bananas for Nigeria
...
rename sa3q6a2 unit_cd
rename sa3q6a1 quantity_harvested


*merging in conversion factors
merge m:1 crop_code unit_cd   using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_ng3_cf.dta", gen(cf_merge)
 
gen quant_harv_kg= quantity_harvested*conv_fact

*Median conversion factors at lowest possible area to try and avoid missings; units/conversions seem somewhat stable across crops
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_`cn'_monocrop.dta", replace

*merge in plot decision makers
merge m:1 hhid plot_id using  "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_decision_makers", keep(3)
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_`cn'_monocrop_hh_area.dta", replace
...
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11i_plantingw2.dta", clear
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_TLU_Coefficients.dta", replace
...
use "${NGA_W2_raw_data}\Post Harvest Wave 2\Agriculture\secta3_harvestw2.dta", clear
rename cropname crop_name
rename cropcode crop_code
rename sa3q3 harvest_yesno
keep if harvest_yesno==1
rename sa3q6a1 quantity_harvested
rename sa3q6a2 quantity_harvested_unit
...
gen observation=1
merge m:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_weights.dta"
...
save  "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_crop_prices_median_state.dta", replace
...
rename quantity_harvested_unit unit
save  "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_crop_prices_median_zone.dta", replace
...
rename quantity_harvested_unit unit
save  "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_crop_prices_median_country.dta", replace
...
replace sa3q17=. if (sa3q10 == sa3q15a) & (sa3q12 == sa3q17)     
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_cropsales_value.dta", replace
...
merge m:1 state zone unit crop_code using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_crop_prices_median_state.dta", nogen keep(1 3)
merge m:1 zone unit crop_code using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_crop_prices_median_zone.dta", nogen keep(1 3) 
merge m:1 unit crop_code using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_crop_prices_median_country.dta", nogen keep(1 3) 
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_crop_values_tempfile.dta", replace

recode crop_code (2170=2030) //recoding plantains as bananas for Nigeria
collapse (sum) value_harvest , by (hhid crop_code)
save  "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_crop_values_production.dta", replace 
merge 1:1 hhid crop_code using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_cropsales_value.dta"
...
collapse (sum) value_crop_production , by (hhid crop_code)
merge 1:1 hhid crop_code using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_cropsales_value.dta"
replace value_crop_production = sales_value if sales_value>value_crop_production & sales_value!=. /* In a few cases, sales value reported exceeds the estimated value of crop harvest */
collapse (sum) value_crop_production sales_value, by (hhid)
lab var value_crop_production "Gross value of crop production for this household"
rename sales_value value_crop_sales
lab var value_crop_sales "Value of crops sold so far"
gen proportion_cropvalue_sold = value_crop_sales / value_crop_production
lab var proportion_cropvalue_sold "Proportion of crop value produced that has been sold"
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_crop_production.dta", replace

*Generating value of crop production at plot level
use "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_crop_values_tempfile.dta", clear
rename plotid plot_id
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_cropvalue.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_crop_prices_for_wages.dta", replace

*Expenses: Hired labor
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11c1_plantingw2.dta", clear
...
gen wages_paid_aglab_pp =  wages_paid_men + wages_paid_women + wages_paid_children


*Monocropped plots
foreach cn in $topcropname_area{
preserve
	ren wages_paid_aglab_pp wages_paid_pp
	ren plotid plot_id
	merge m:1 hhid plot_id using  "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_decision_makers", nogen keep(1 3) keepusing(dm_gender)
	foreach i in wages_paid_pp{
		gen `i'_`cn' = `i'
	...
	*merge in monocropped plots only
	merge m:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_`cn'_monocrop.dta", nogen assert(1 3) keep(3)
	collapse (sum) wages_paid_pp_`cn'*, by(hhid)		
	lab var wages_paid_pp_`cn' "Wages paid for hired labor (crops) in postplanting - Monocropped `cn' plots only"
	save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_wages_postplanting_`cn'.dta", replace
restore
}

collapse (sum) wages_paid_aglab_pp, by (hhid)
lab var wages_paid_aglab_pp "Wages paid for hired labor (crops), as captured in post-planting survey"
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_wages_postplanting.dta", replace

use "${NGA_W2_raw_data}\Post Harvest Wave 2\Agriculture\secta2_harvestw2.dta", clear
*Harvest
...
rename sa2q11c unit
merge m:1 hhid crop_code unit using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_crop_prices_for_wages.dta", nogen keep (1 3)
merge m:1 crop_code unit using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_crop_prices_median_country.dta", nogen keep (1 3)
...
replace wages_paid_aglabor_postharvest = wages_paid_aglabor_postharvest + inkind_payment

*Monocropped plots

foreach cn in $topcropname_area{
preserve
	rename wages_paid_aglabor_postharvest wages_paid_ph
	ren plotid plot_id
	*dissagregate by gender of plot manager 
	merge m:1 hhid plot_id using  "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_decision_makers", nogen keep(1 3) keepusing(dm_gender)
	foreach i in wages_paid_ph{
		gen `i'_`cn' = `i'
		gen `i'_`cn'_male = `i' if dm_gender==1 
		gen `i'_`cn'_female = `i' if dm_gender==2 
		gen `i'_`cn'_mixed = `i' if dm_gender==3 
	...
	*Merge in monocropped plots
	...
	lab var wages_paid_ph_`cn' "Wages paid for hired labor (crops) in postharvest - Monocropped `cn' plots only"
	save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_wages_postharvest_`cn'.dta", replace
restore
}
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_wages_postharvest.dta", replace


*Expenses: Inputs
*fertilizer 
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11d_plantingw2.dta", clear
gen type_inor_fer1=1 if s11dq15==1 | s11dq15==2 
replace type_inor_fer1=1 if s11dq15b=="201010" | s11dq15b=="20:10:10" | s11dq15b=="271313" | s11dq15b=="GOLDEN" | s11dq15b=="GOLDEN MIX" | s11dq15b=="LIQUID" | s11dq15b=="NPK/UREA"  | s11dq15b=="SPSS"  | s11dq15b=="SSP"  | s11dq15b=="SUPER"  | s11dq15b=="UREA"  | s11dq15b=="compound"   | s11dq15b=="AS ABOVE"  
gen value_fertilizer_1= s11dq19 if type_inor_fer1==1
gen type_inor_fer2=1 if s11dq27==1 | s11dq27==2
replace type_inor_fer2=1 if s11dq27b=="GOLDEN MIX FERTILIZER" 
gen value_fertilizer_2= s11dq29 if type_inor_fer2==1
gen type_free_fer=1 if s11dq7==1 | s11dq7==2 |  s11dq7b=="201010"
gen cost_transport_free_fert= s11dq10 if type_free_fer==1
gen cost_transport_fertilizer_1= s11dq17 if type_inor_fer1==1
gen cost_transport_fertilizer_2=s11dq31  if type_inor_fer2==1
recode value_fertilizer* cost_transpor*(.=0)
...
preserve
	...
	*dissagregate by gender of the plot manager 
	merge m:1 hhid plot_id using  "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_decision_makers"
	...
	*Merge in monocropped plots
	...
	save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_fertilizer_costs_`cn'.dta", replace
restore
}

collapse (sum) value_fertilizer cost_transport_fertilizer cost_transport_free_fert, by (hhid)
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_fertilizer_costs.dta", replace

*Other chemicals
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11c2_plantingw2.dta", clear
...
preserve
	ren plotid plot_id
	*disaggregate by the gender of the plot manager
	merge m:1 hhid plot_id using  "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_decision_makers"
	...
	*Merge in monocropped plots
	...
	save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_chemical_costs_`cn'.dta", replace
restore
}
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_chemical_costs.dta", replace

*Manure - calculated in above fertilizer section
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11d_plantingw2.dta", clear
gen type_inor_fer1=1 if s11dq15==1 | s11dq15==2 
replace type_inor_fer1=1 if s11dq15b=="201010" | s11dq15b=="20:10:10" | s11dq15b=="271313" | s11dq15b=="GOLDEN" | s11dq15b=="GOLDEN MIX" | s11dq15b=="LIQUID" | s11dq15b=="NPK/UREA"  | s11dq15b=="SPSS"  | s11dq15b=="SSP"  | s11dq15b=="SUPER"  | s11dq15b=="UREA"  | s11dq15b=="compound"   | s11dq15b=="AS ABOVE"  
gen value_manure_1= s11dq19 if type_inor_fer1==.
gen type_inor_fer2=1 if s11dq27==1 | s11dq27==2
replace type_inor_fer2=1 if s11dq27b=="GOLDEN MIX FERTILIZER" 
gen value_manure_2= s11dq29 if type_inor_fer2==.
gen type_free_fer=1 if s11dq7==1 | s11dq7==2 |  s11dq7b=="201010"
gen cost_transport_free_manure= s11dq10 if type_free_fer==.
gen cost_transport_manure_1= s11dq17 if type_inor_fer1==.
gen cost_transport_manure_2=s11dq31  if type_inor_fer2==.
recode value_manure* cost_transpor*(.=0)
gen value_manure = value_manure_1 + value_manure_2
gen cost_transport_manure = cost_transport_manure_1 + cost_transport_manure_2

*Costs for monocropped plots
foreach cn in $topcropname_area{
preserve
	rename value_manure value_manure_purch
	...
	*Merge in monocropped plots
	...
	save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_manure_costs_`cn'.dta", replace
restore
}

collapse (sum) value_manure cost_transport_manure cost_transport_free_manure, by (hhid)
lab var value_manure "Value of manure purchased (not necessarily the same as used)"
lab var cost_transport_free_manure "Cost of transportation associated with free manure"
lab var cost_transport_manure "Cost of transportation associated with purchased manure"
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_manure_costs.dta", replace


*Seed 
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11e_plantingw2.dta", clear
...
*Costs for maize plots
foreach cn in $topcropname_area{
preserve
	ren plotid plot_id
	ren cost_transportation_seed cost_trans_seed
	*disaggregate by gender of the plot manager
	merge m:1 hhid plot_id using  "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_decision_makers"
	...
	*Merge in monocropped plots
	...
	save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_seed_costs_`cn'.dta", replace
restore
}
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_seed_costs.dta", replace
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_land_rental_costs_`cn'.dta", replace
restore
}

collapse (sum) rental_cost_land, by (hhid)
lab var rental_cost_land "Rental costs paid for land"
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_land_rental_costs.dta", replace
...
rename plotid plot_id
merge 1:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_areas.dta" 
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_asset_rental_costs.dta", replace
...
*Expenses
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11j_plantingw2.dta", clear
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_livestock_expenses.dta", replace

use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11k_plantingw2.dta", clear
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_livestock_products.dta", replace

use "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_livestock_products", clear
merge m:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_weights.dta"
drop if _merge==2
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_livestock_products_prices_country.dta", replace
...
merge m:1 livestock_code unit using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_livestock_products_prices_country.dta", nogen keep(1 3) 
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_livestock_products.dta", replace
...
merge m:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_weights.dta", nogen keep(1 3) 
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_livestock_sales", replace

*Implicit prices (based on observed sales)
use "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_livestock_prices_ea.dta", replace
use "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_livestock_prices_lga.dta", replace
use "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_livestock_prices_state.dta", replace
use "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_livestock_prices_zone.dta", replace
use "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_livestock_prices_country.dta", replace

use "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_livestock_sales", clear
merge m:1 zone state lga ea livestock_code using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_livestock_prices_ea.dta", nogen 
merge m:1 zone state lga livestock_code using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_livestock_prices_lga.dta", nogen 
merge m:1 zone state livestock_code using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_livestock_prices_state.dta", nogen 
merge m:1 zone livestock_code using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_livestock_prices_zone.dta", nogen 
merge m:1 livestock_code using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_livestock_prices_country.dta", nogen 
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_livestock_sales.dta", replace
...
preserve
	...
	*Total livestock holding for large ruminants, small ruminants, and poultry
	...
	save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_herd_characteristics", replace
restore
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_TLU.dta", replace

***************
* FISH INCOME *
***************
	
use "${NGA_W2_raw_data}\Post Harvest Wave 2\Agriculture\secta9a2_harvestw2.dta", clear
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_fish_prices_1.dta", replace /* Caught fish */
...
rename price_per_unit price_per_unit_median
replace price_per_unit_median = . if fish_code==5 /* "Other */
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_fish_prices_2.dta", replace /* Harvested fish */
...
merge m:1 fish_code unit using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_fish_prices_1.dta", nogen keep(1 3)
...
merge m:1 fish_code unit using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_fish_prices_2.dta", nogen keep(1 3)
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_fish_income.dta", replace

use "${NGA_W2_raw_data}\Post Harvest Wave 2\Agriculture\secta9b2_harvestw2.dta", clear
...
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_fish_income.dta"
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_fishing_expenses_1.dta", replace

use "${NGA_W2_raw_data}\Post Harvest Wave 2\Agriculture\secta9b3_harvestw2.dta", clear
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_fishing_expenses_2.dta", replace
...
use "${NGA_W2_raw_data}\Post Harvest Wave 2\Household\sect9_harvestw2.dta", clear
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_self_employment_income.dta", replace
...
gen price_per_unit = value_harvested / quantity_harvested
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_crop_unit_values.dta", replace
**********************************************************************************
use "${NGA_W2_raw_data}\Post Harvest Wave 2\Agriculture\secta3_harvestw2.dta", clear
rename cropname crop_name
rename cropcode crop_code
rename sa3q9 sell_processedcrop_yesno
rename sa3q11a quant_processed_crop_sold
rename sa3q11b unit
gen quant_proccrop_sold_unit_other=.
rename sa3q12 value_processed_crop_sold
merge m:1 hhid crop_code unit using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_crop_unit_values.dta", nogen keep(1 3)
merge m:1 crop_code unit using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_crop_prices_median_country.dta", nogen keep(1 3)
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_agproduct_income.dta", replace


***************
*OFF-FARM HOURS
***************
use "${NGA_W2_raw_data}\Post Harvest Wave 2\Household\sect3a_harvestw2.dta", clear
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_off_farm_hours.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_wage_income.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_agwage_income.dta", replace 
...
use "${NGA_W2_raw_data}\Post Harvest Wave 2\Household\sect6_harvestw2.dta", clear
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_remittance_income.dta", replace

use "${NGA_W2_raw_data}\Post Harvest Wave 2\Household\sect13_harvestw2.dta", clear
append using "${NGA_W2_raw_data}\Post Harvest Wave 2\Household\sect14_harvestw2.dta"
append using "${NGA_W2_raw_data}\Post Harvest Wave 2\Agriculture\secta42_harvestw2.dta"
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_other_income.dta", replace
...
use "${NGA_W2_raw_data}\Post Harvest Wave 2\Agriculture\secta3_harvestw2.dta", clear
gen cultivated = 1
merge m:1 hhid plotid using "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11b1_plantingw2.dta"
rename s11b1q27 cultivated_this_year

preserve 
	use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11g_plantingw2.dta", clear
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_parcels_cultivated.dta", replace

use "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_areas.dta", clear
merge m:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_parcels_cultivated.dta"
keep if cultivated==1
collapse (sum) field_size, by (hhid plot_id)
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_sizes.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_land_size.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_parcels_agland.dta", replace


use "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_areas.dta", clear
merge 1:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_parcels_agland.dta", nogen
keep if agland==1
collapse (sum) field_size, by (hhid)
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_farmsize_all_agland.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_parcels_held.dta", replace

use "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_areas.dta", clear
merge 1:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_parcels_held.dta", nogen
keep if plot_held==1
collapse (sum) field_size, by (hhid)
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_land_size_all.dta", replace 
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_farmlabor_postplanting.dta", replace
collapse (sum) days_hired_postplant days_famlabor_postplant, by (hhid)
lab var days_hired_postplant "Workdays for hired labor (crops), as captured in post-planting survey"
lab var days_famlabor_postplant "Workdays for family labor (crops), as captured in post-planting survey"
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_farmlabor_postplanting.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_farmlabor_postharvest.dta", replace 
collapse (sum) days_hired_postharvest days_famlabor_postharvest days_exchange_labor_postharvest, by (hhid)
lab var days_hired_postharvest "Workdays for hired labor (crops), as captured in post-harvest survey"
lab var days_famlabor_postharvest "Workdays for family labor (crops), as captured in post-harvest survey"
lab var days_exchange_labor_postharvest "Workdays (lower-bound estimate) of exchange labor, as captured in post-harvest survey"
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_farmlabor_postharvest.dta", replace 

*labor 
use "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_farmlabor_postplanting.dta", clear
merge 1:1  hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_farmlabor_postharvest.dta", nogen
recode days*  (.=0)
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_family_hired_labor.dta", replace
recode labor_*  (.=0)
...
lab var labor_family "Total labor days (family) allocated to the farm in the past year"
lab var labor_total "Total labor days (hired +family) allocated to the farm in the past year" 
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_family_hired_labor.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_vaccine.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_farmer_vaccine.dta", replace
...
replace use_inorg_fert=1 if s11dq1==1 & (s11dq3==1 | s11dq3==2 | s11dq7==1 | s11dq7==2 | s11dq15==1 | s11dq15==2 | s11dq27==1 | s11dq27==2)
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_fert_use.dta", replace 
...
replace all_use_inorg_fert=1 if s11dq1==1 & (s11dq3==1 | s11dq3==2 | s11dq7==1 | s11dq7==8 | s11dq15==1 | s11dq15==2 | s11dq27==1 | s11dq27==2)
replace all_use_inorg_fert=0 if s11dq1==2

preserve
keep hhid s11b1q6a   all_use_inorg_fert 
ren s11b1q6a farmerid
tempfile farmer1
save `farmer1'
restore
preserve
keep hhid s11b1q6b all_use_inorg_fert 
ren s11b1q6b farmerid
tempfile farmer2
save `farmer2'
restore
...
gen indiv=farmerid
drop if indiv==.
merge 1:1 hhid indiv using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_gender_merge.dta", nogen
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_farmer_fert_use.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_improvedseed_use.dta", replace 

forvalues k=1/12 {
*Improved use by farmers ( a farmer is an individual listed as plot manager)
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11e_plantingw2.dta", clear
ren plotid plot_id
merge m:1 hhid plot_id using  "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_plot_areas.dta"
gen all_imprv_seed_use=0

*Adoption of improved seed by crop
	local c : word `k' of $topcrop_area
	local cn : word `k' of $topcropname_area
		gen all_imprv_seed_`cn'=all_imprv_seed_use if cropcode==`c' 
		gen all_hybrid_seed_`cn' =0  if cropcode==`c'   //  
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_farmer_improvedseed_use_temp_`cn'.dta", replace

}

*Combining all crop disaggregated files together
foreach v in $topcropname_area {
	merge 1:1 hhid farmerid all_imprv_seed_use using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_farmer_improvedseed_use_temp_`v'.dta", nogen
}
...
recode farm_manager (.=0)
lab var farm_manager "1=Indvidual is listed as a manager for at least one plot" 
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_farmer_improvedseed_use.dta", replace 
  

***************************
* REACHED BY AG EXTENSION *
***************************
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11l1_plantingw2.dta", clear
ren s11l1q1 receive_advice
ren s11l1q2 sourceid
preserve
use  "${NGA_W2_raw_data}\Post Harvest Wave 2\Agriculture\secta5a_harvestw2.dta", clear
...
gen advice_coop = (sourceid==4  | sourceid==5 & receive_advice==1)
**Radio
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_any_ext.dta", replace 
...
************************************
use "${NGA_W2_raw_data}\Post Planting Wave 2\Household\sect4a_plantingw2.dta", clear
append using "${NGA_W2_raw_data}\Post Planting Wave 2\Household\sect4b_plantingw2.dta" 
append using "${NGA_W2_raw_data}\Post Harvest Wave 2\Household\sect9_harvestw2.dta" 
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_fin_serv.dta", replace 
...
use "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_livestock_products.dta", clear
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_milk_animals.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_egg_animals.dta", replace
...
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11b1_plantingw2.dta", clear
ren plotid plot_id
merge 1:1 plot_id hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_areas", nogen keep(1 3)
merge 1:1 plot_id hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_decision_makers", nogen keep (1 3)
...
preserve
	...
	save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_rental_rate.dta", replace
restore
...
preserve
	...
	save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_cultivated_plots_ha.dta", replace
restore
...
preserve
	...
	drop field_size
	save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_rental_rate_hh.dta", replace	
restore
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_rental_rate.dta", replace
...
merge m:1 plot_id hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_plot_areas", nogen keep(1 3)
...
*Rescaling
merge m:1 plot_id hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_plot_areas", nogen keep(1 3)	
merge m:1 plot_id hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_decision_makers", nogen keep(1 3)
...
merge m:1 hhid plotid using "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11b1_plantingw2.dta", nogen keep(1 3)		
egen plot_rent = rowtotal(s11b1q13 s11b1q14)										// total paid for rent (on plot)
merge m:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_rental_rate_hh.dta", nogen keep(1 3)			// household's average rental rate (total rent paid divided by total ha rented at household level)
merge m:1 zone state lga sector using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_rental_rate.dta", nogen keep(1 3)	// aggregate rental rates
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_cost_land.dta", replace


*Prep labor costs
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11c1_plantingw2.dta", clear		// PREP LABOR
*Merging in gender of plot manager
rename plotid plot_id
merge m:1 plot_id hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_decision_makers", nogen keep(1 3) keepusing (dm_gender)
...
*Generating average wage at the  level
preserve
	...
	keep wage_*_hh hhid
	save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_wages_prep.dta", replace
restore
...
merge m:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_wages_prep.dta", nogen keep(1 3)		// merging in household-level wage rates; all matched
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_cost_prep_labor.dta", replace
...
preserve
	...
	keep wage_*_hh hhid
	save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_wages_harv.dta", replace
restore
...
*And here are the total costs
merge m:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_wages_harv.dta", nogen keep(1 3)	
...
preserve
	use "${NGA_W2_raw_data}/w2agnsconversion.dta", clear
	ren cropcode crop_code
	tempfile conversion
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_cost_seed.dta", replace
...
recode s11c2q2b (2=1) (4=3) 
gen pesticide_price = value_pesticide/s11c2q2a	
recode pesticide_price (0=.)	
gen value_pest_kg = value_pesticide if s11c2q2b==1
gen value_pest_l = value_pesticide if s11c2q2b==3
gen qty_pest_kg = s11c2q2a if s11c2q2b==1
gen qty_pest_l = s11c2q2a if s11c2q2b==3

*Constructing household values
preserve			
	replace qty_pest_kg = . if value_pest_kg==. | value_pest_kg==0
	replace qty_pest_l = . if value_pest_l==. | value_pest_l==0
	collapse (sum) value_pest_* qty_pest_*, by(hhid)
	gen pest_price_hh_kg = value_pest_kg/qty_pest_kg	// naira per kg
	gen pest_price_hh_l = value_pest_l/qty_pest_l		// naira per l
	save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_pest_price.dta", replace
restore
merge m:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_pest_price.dta", nogen
...
gen pest_price_kg = pest_price_sect if pest_count_sect>=10 & s11c2q2b==1
replace pest_price_kg = pest_price_lga if pest_count_lga>=10 & s11c2q2b==1 & pest_price_kg==.
replace pest_price_kg = pest_price_state if pest_count_state>=10 & s11c2q2b==1 & pest_price_kg==.
replace pest_price_kg = pest_price_zone if pest_count_zone>=10 & s11c2q2b==1 & pest_price_kg==.
replace pest_price_kg = pest_price_nat if s11c2q2b==1 & pest_price_kg==.
replace pest_price_kg = pest_price_hh_kg if pest_price_hh_kg!=. & pest_price_hh_kg!=0

gen pest_price_l = pest_price_sect if pest_count_sect>=10 & s11c2q2b==3
replace pest_price_l = pest_price_lga if pest_count_lga>=10 & s11c2q2b==3 & pest_price_l==.
replace pest_price_l = pest_price_state if pest_count_state>=10 & s11c2q2b==3 & pest_price_l==.
replace pest_price_l = pest_price_zone if pest_count_zone>=10 & s11c2q2b==3 & pest_price_l==.
replace pest_price_l = pest_price_nat if s11c2q2b==3 & pest_price_l==.
replace pest_price_l = pest_price_hh_l if pest_price_hh_l!=. & pest_price_hh_l!=0

gen value_pesticide_free = s11c2q2a*pest_price_kg if s11c2q2b==1			// for kg
replace value_pesticide_free = s11c2q2a*pest_price_l if s11c2q2b==3		// for l
...
preserve
	...
	save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_herb_price.dta", replace
restore
merge m:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_herb_price.dta", nogen
drop value_herb_*
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_cost_inputs.dta", replace
...
gen type_inor_fer1=1 if s11dq15==1 | s11dq15==2 
replace type_inor_fer1=1 if s11dq15b=="201010" | s11dq15b=="20:10:10" | s11dq15b=="271313" | s11dq15b=="GOLDEN" | s11dq15b=="GOLDEN MIX" | s11dq15b=="LIQUID" | s11dq15b=="NPK/UREA"  | s11dq15b=="SPSS"  | s11dq15b=="SSP"  | s11dq15b=="SUPER"  | s11dq15b=="UREA"  | s11dq15b=="compound"   | s11dq15b=="AS ABOVE"  
gen commercial_fert_total1=s11dq16 if  type_inor_fer1==1
gen commercial_fert_purchased1=s11dq19 if  type_inor_fer1==1

gen type_inor_fer2=1 if s11dq27==1 | s11dq27==2
replace type_inor_fer2=1 if s11dq27b=="GOLDEN MIX FERTILIZER" 
gen commercial_fert_total2=s11dq28 if  type_inor_fer2==1
gen commercial_fert_purchased2=s11dq29 if  type_inor_fer2==1

egen commercial_fert_total = rowtotal(commercial_fert_total1 commercial_fert_total2)	 
egen commercial_fert_purchased = rowtotal(commercial_fert_purchased1 commercial_fert_purchased2)		

gen fert_price = commercial_fert_purchased/commercial_fert_total
recode fert_price (0=.)
*Getting a household average price (summing across plots)
preserve
	gen fert_purchased = commercial_fert_total
	gen fert_paid = commercial_fert_purchased 		
	collapse (sum) fert_purchased fert_paid, by(hhid)
	gen fert_price_hh = fert_paid/fert_purchased				// total paid per unit
	save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_fert_price_hh.dta", replace
restore
*Merging prices back in immediately
merge m:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_fert_price_hh.dta", nogen assert(3)		// all matched
...
gen price = fert_price_sect if fert_count_sect>=10
replace price = fert_price_lga if fert_count_lga>=10 & price==.
replace price = fert_price_state if fert_count_state>=10 & price==.
replace price = fert_price_zone if fert_count_zone>=10 & price==.
replace price = fert_price_nat if price==.

*"Left over" fertilizer
gen left_fert = s11dq4 if s11dq3==1 | s11dq3==2 | s11dq3b=="SUPER"

gen value_fert_leftover = left_fert*price
...
*"Free" fertilizer
gen free_fert = s11dq8 if s11dq3==1 | s11dq3==2 | s11dq3b=="201010"

gen value_fert_free = free_fert*price		// kg
...
egen value_inorg_purchased = rowtotal(commercial_fert_purchased s11dq10 s11dq17 s11dq31)		// includes all payments (including transport for free fertilizer)
egen value_inorg_notpurchased = rowtotal(value_fert_left value_fert_free)

*Total inorganic fertilizer applied
*Commercial fertilizer
gen fert1_kg = s11dq16	 if  type_inor_fer1==1 
gen fert2_kg = s11dq28	  if  type_inor_fer2==1	
egen commercial_fert_kg= rowtotal(fert1 fert2)


*"Left over" fertilizer
gen left_fert_kg = s11dq4  if s11dq3==1 | s11dq3==2 | s11dq3b=="SUPER"

*"Free" fertilizer
gen free_fert_kg = s11dq8   if s11dq3==1 | s11dq3==2 | s11dq3b=="201010"

*Now getting total - four types of inorganic (commercial, leftover, free, and subsidy)
egen fert_inorg_kg = rowtotal(commercial_fert_kg left_fert_kg free_fert_kg)
...
*Organic Fertilizer
gen fert_org_kg1=  s11dq16	 if  type_inor_fer1!=1 
gen fert_org_kg2 = s11dq28	  if  type_inor_fer2!=1	
egen fert_org_kg =rowtotal(fert_org_kg1 fert_org_kg2)


*Purchased organic fert
gen commercial_org_total1=s11dq16 if  type_inor_fer1!=1
gen commercial_org_total2=s11dq28 if  type_inor_fer2!=1
egen commercial_org_total = rowtotal(commercial_org_total1 commercial_org_total2)	

gen commercial_org_purchased1=s11dq19 if  type_inor_fer1!=1
gen commercial_org_purchased2=s11dq29 if  type_inor_fer2!=1
...
preserve
	...
	save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_org_fert_price_hh.dta", replace
restore
*Immediately merging back in
merge m:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_org_fert_price_hh.dta", nogen assert(3)
...
gen value_org_leftover = left_org*price
replace value_org_leftover = left_org*org_price_hh if org_price_hh!=0 & org_price_hh!=.		// replacing with household value when available

*"Free" organic fert
gen free_org = s11dq8 if s11dq7==3 | s11dq7==4  

gen value_org_free = free_org*price		// kg
replace value_org_free = free_org*org_price_hh if org_price_hh!=0 & org_price_hh!=.			// replacing with household value when available
...
egen value_org_notpurchased = rowtotal(value_org_left value_org_free)

*Total inorganic organic fert applied
*Commercial organic org
gen org1_kg = s11dq16	 if  type_inor_fer1==1 
gen org2_kg = s11dq28	  if  type_inor_fer2==1	
egen commercial_org_kg= rowtotal(org1 org2)


*"Left over" organic fert
gen left_org_kg = s11dq4  if s11dq3==3 | s11dq3==4  

*"Free" organic fert
gen free_org_kg = s11dq8   if s11dq3==3 | s11dq3==4 

*Now getting total - four types of inorganic (commercial, leftover, free, and subsidy)
egen org_inorg_kg = rowtotal(commercial_org_kg left_org_kg free_org_kg) 
gen org_inorg_kg_male = org_inorg_kg if dm_gender==1
gen org_inorg_kg_female = org_inorg_kg if dm_gender==2
gen org_inorg_kg_mixed = org_inorg_kg if dm_gender==3
...
preserve
	...
	save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_fert.dta", replace
restore
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_cost_fert.dta", replace


use "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_cost_land.dta", clear
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_rental_rate.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_cost_prep_labor.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_cost_harv_labor.dta", nogen keep(1 3)		
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_cost_fert.dta", nogen keep(1 3)			
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_cost_inputs.dta", nogen keep(1 3)			
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_cost_seed.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_male_head.dta", nogen keep(1 3)


*Explicit and implicit costs at the plot level
egen cost_total = rowtotal(value_owned_land value_rented_land value_fam_labor value_hired_labor ///
value_fam_harv_labor value_hired_harv_labor value_inorg_notpurchased value_inorg_purchased value_org_notpurchased ///
...
foreach i in male female mixed{
	egen cost_total_`i' = rowtotal (value_owned_land_`i' value_rented_land_`i' value_fam_labor_`i' value_hired_labor_`i' ///
	value_fam_harv_labor_`i' value_hired_harv_labor_`i' value_inorg_notpurchased_`i' value_inorg_purchased_`i' value_org_notpurchased_`i' ///
...
egen cost_expli = rowtotal(value_rented_land value_hired_labor value_hired_harv_labor value_inorg_purchased value_org_purchased ///
...
*Creating total costs by gender 
foreach i in male female mixed{
	egen cost_expli_`i' = rowtotal(value_rented_land_`i' value_hired_labor_`i' value_hired_harv_labor_`i' value_inorg_purchased_`i' value_org_purchased_`i' ///
	value_herbicide_`i' value_pesticide value_animal_rent_`i' value_machine_rent_`i' value_seeds_purchased_`i' )
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_cropcosts.dta", replace
...
use "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_fert.dta", clear
merge m:1 hhid using  "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hhids.dta", keep (1 3) nogen
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_fert_use.dta", keep(1 3) nogen
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_fertilizer_application.dta", replace
...
use "${NGA_W2_raw_data}\Post Planting Wave 2\Household\sect7b_plantingw2.dta" , clear
keep zone state lga sector ea hhid item_cd item_desc s7bq1
gen survey="PP"
preserve
use "${NGA_W2_raw_data}\Post Harvest Wave 2\Household\sect10b_harvestw2.dta" , clear
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_household_diet.dta", replace
...
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11b1_plantingw2", clear
append using "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11d_plantingw2"
append using "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11e_plantingw2"
append using "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11h_plantingw2"
append using "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11i_plantingw2"
append using "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11k_plantingw2"
append using "${NGA_W2_raw_data}\Post Harvest Wave 2\Agriculture\secta1_harvestw2"
append using "${NGA_W2_raw_data}\Post Harvest Wave 2\Agriculture\secta3_harvestw2"
append using "${NGA_W2_raw_data}\Post Harvest Wave 2\Agriculture\secta6_harvestw2"
append using "${NGA_W2_raw_data}\Post Harvest Wave 2\Agriculture\secta8_harvestw2"
append using "${NGA_W2_raw_data}\Post Planting Wave 2\Household\sect3a_plantingw2"
append using "${NGA_W2_raw_data}\Post Planting Wave 2\Household\sect6_plantingw2"
append using "${NGA_W2_raw_data}\Post Planting Wave 2\Household\sect10_plantingw2"
append using "${NGA_W2_raw_data}\Post Harvest Wave 2\Household\sect3a_harvestw2", force
append using "${NGA_W2_raw_data}\Post Harvest Wave 2\Household\sect7_harvestw2", force
append using "${NGA_W2_raw_data}\Post Harvest Wave 2\Household\sect9_harvestw2", force
append using "${NGA_W2_raw_data}\Post Harvest Wave 2\Household\sect13_harvestw2", force
append using "${NGA_W2_raw_data}\Post Harvest Wave 2\Household\sect14_harvestw2", force
...
merge 1:1 hhid indiv using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_person_ids.dta", nogen
recode control_* (.=0)
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_control_income.dta", replace
...
* planting_input	
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11b1_plantingw2", clear
append using "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11a_plantingw2"
append using "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11d_plantingw2"
append using "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11e_plantingw2"
append using "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11h_plantingw2"
append using "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11i_plantingw2"
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_make_ag_decision.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_ownasset.dta", replace
...
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11c1_plantingw2.dta", clear
merge 1:1 hhid plotid using "${NGA_W2_raw_data}\Post Harvest Wave 2\Agriculture\secta2_harvestw2.dta", nogen
...
gen wage_paid_male=wage_paid_male_planting +wage_paid_male_harvest
gen hired_male=hired_male_planting +hired_male_harvest
gen wage_paid_aglabor_male=wage_paid_male/hired_male


gen wage_paid_female=wage_paid_female_planting +wage_paid_female_harvest
gen hired_female=hired_female_planting +hired_female_harvest
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_ag_wage.dta", replace
...
*CROP YIELDS
****************
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11f_plantingw2", clear
ren plotid plot_id
ren cropcode crop_code
...
rename crop_code cropcode
merge 1:1 hhid plotid cropid cropcode using "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11g_plantingw2", nogen keep(1 3)
//793 permanent crop observations matched, a lot of permanent crops are reported in the field crop section and vice versa. I think there is some overlap
...
preserve 
	...
	*Start by capping area planted of each individual crop at plot area if GPS measurements are available
	...
	//460 observations (4.2%) where ha_planted=0, there shouldn't be any of these - these are all missing an area or unit in the raw data

	//area rescaling for area planted
	...
	*Generating total percent of purestand and monocropped on a field
	...
	//about 63% of plots have a total intercropped sum greater than 1
...
*Dropping unnecessary raw variables
drop s11fq1a-s11fq4c s11fq6-s11fq12 s11aq5c-sa1q8 sa1q10c-sa1q38f s11gq1a-s11gq3 s11gq5a-s11gq8b

save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_crop_area_planted", replace
...
merge m:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_areas.dta", nogen keep(1 3)
*merging in planted areas
merge 1:1 hhid plot_id cropid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_crop_area_planted.dta",gen(plant_harv_merge) keep(1 3)
*There are 1,499 observations that are in the harvest file but not the planted file. We don't have intercropping information on these observations
...
*Kgs_harvest to be used in the estimation of harvest and sales disaggregated by crop
preserve
recode crop_code (2170=2030)  //recoding plantains as bananas for Nigeria
collapse (sum) kgs_harvest=quant_harv_kg, by(hhid crop_code)
lab var kgs_harvest "Kgs harvested of this crop"
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_crop_kgs_harvest", replace	
restore
 
*merging in gender variables
merge m:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_decision_makers", gen(_merge_gender)
drop if quant_harv_kg==. 
drop area_harv
...
save "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_area_planted_harvested_allcrops.dta", replace
restore
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_crop_harvest_area_yield.dta", replace



*Yield at the household level
use "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_crop_harvest_area_yield.dta", clear
*Value of crop production
merge 1:1 hhid crop_code using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_crop_values_production.dta", nogen keep(1 3)
ren value_crop_production value_harv
ren value_crop_sales value_sold
merge 1:1 hhid crop_code using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_crop_kgs_harvest.dta", nogen keep(1 3)
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_yield_hh_crop_level.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_adulteq.dta", replace 

use "${NGA_W2_raw_data}\cons_agg_wave2_visit1.dta", clear
merge 1:1 hhid using "${NGA_W2_raw_data}\cons_agg_wave2_visit2.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_adulteq.dta"

rename totcons percapita_cons
gen total_cons = percapita_cons*hhsize
gen daily_percap_cons = percapita_cons/365
la var daily_percap_cons "Household consumption per person per day"

gen peraeq_cons = (total_cons / adulteq)
gen daily_peraeq_cons = peraeq_cons/365

keep hhid percapita_cons total_cons daily_percap_cons peraeq_cons adulteq daily_peraeq_cons

save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_consumption.dta", replace


**************************
*HOUSEHOLD FOOD PROVISION*
**************************
use "${NGA_W2_raw_data}\Post Harvest Wave 2\Household\sect12_harvestw2.dta", clear
...
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_food_insecurity.dta", replace


******************
*HOUSEHOLD ASSETS*
******************
use "${NGA_W2_raw_data}\Post Planting Wave 2\Household\sect5b_plantingw2.dta", clear
ren s5q4 value_today
ren s5q3 age_item

collapse (sum) value_assets=value_today, by(hhid)
la var value_assets "Value of household assets"
save "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_assets.dta", replace 
...
use "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hhids.dta", clear

*Gross crop income 
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hh_crop_production.dta", nogen
recode value_crop_production (.=0)

*Crop costs
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_asset_rental_costs.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_land_rental_costs.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_seed_costs.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_manure_costs.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_chemical_costs.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_fertilizer_costs.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_wages_postplanting.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_wages_postharvest.dta", nogen
recode animal_rent_paid rental_cost_ag_assets rental_cost_land cost_seed cost_transportation_seed value_manure /*
*/ cost_transport_manure cost_transport_free_manure value_fertilizer cost_transport_fertilizer cost_transport_free_fert /*
*/ value_herbicide value_pesticide wages_paid_aglab_pp wages_paid_aglabor_postharvest (.=0)
...
*/ value_manure cost_transport_manure cost_transport_free_manure  value_fertilizer cost_transport_fertilizer /*
*/ cost_transport_free_fert value_herbicide value_pesticide wages_paid_aglab_pp wages_paid_aglabor_postharvest)
...
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_land_rental_costs_`c'.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_seed_costs_`c'.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_fertilizer_costs_`c'.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_chemical_costs_`c'.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_manure_costs_`c'.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_wages_postplanting_`c'.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_wages_postharvest_`c'.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_`c'_monocrop_hh_area.dta", nogen
}

foreach c in $topcropname_area{
	recode `c'_monocrop (.=0) 
	egen `c'_exp = rowtotal (rental_cost_land_`c' cost_seed_`c' value_fertilizer_`c' cost_trans_fert_`c' value_herbicide_`c' value_pesticide_`c' /*
	*/ value_manure_purch_`c' cost_trans_manure_`c' wages_paid_pp_`c' wages_paid_ph_`c')
	...
	*disaggregate by gender of plot manager
	foreach i in male female mixed {
		egen `c'_exp_`i' = rowtotal (rental_cost_land_`c'_`i' cost_seed_`c'_`i' value_fertilizer_`c'_`i' cost_trans_fert_`c'_`i' value_herbicide_`c' value_pesticide_`c'_`i' /*
		*/ value_manure_purch_`c'_`i' cost_trans_manure_`c'_`i' wages_paid_pp_`c'_`i' wages_paid_ph_`c'_`i')
...
*Land rights
merge 1:1 hhid using  "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_land_rights_hh.dta", nogen
la var formal_land_rights_hh "Household has documentation of land rights (at least one plot)"

*Fish income
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_fish_income.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_fishing_expenses_1.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_fishing_expenses_2.dta", nogen
...
*Livestock income
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_livestock_sales.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_livestock_expenses.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_livestock_products.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_TLU.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_herd_characteristics.dta", nogen
...
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_TLU_Coefficients.dta", nogen
...
*Self-employment income
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_self_employment_income.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_agproduct_income.dta", nogen
...
*Wage income
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_agwage_income.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_wage_income.dta", nogen
...
*Off-farm hours
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_off_farm_hours.dta", nogen

*Other income
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_other_income.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_remittance_income.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_other_income.dta", nogen
...
*Farm size
merge 1:1 hhid using  "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_land_size.dta", nogen
merge 1:1 hhid using  "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_land_size_all.dta", nogen
merge 1:1 hhid using  "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_farmsize_all_agland.dta", nogen
recode land_size (.=0)
...
*Labor
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_family_hired_labor.dta", nogen
recode labor_hired labor_family (.=0) 

*Household size
merge 1:1 hhid using  "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hhsize.dta", nogen
 
*Rates of vaccine usage, improved seeds, etc.
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_vaccine.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_fert_use.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_improvedseed_use.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_any_ext.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_fin_serv.dta", nogen
...
*Milk productivity
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_milk_animals.dta", nogen
gen costs_dairy = 0
gen costs_dairy_percow = 0


*Egg productivity
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_egg_animals.dta", nogen
...
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_cropcosts.dta", nogen
 
*Rate of fertilizer application 
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_fertilizer_application.dta", nogen

*Agricultural wage rate
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_ag_wage.dta", nogen

*Crop yields 
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_yield_hh_crop_level.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_area_planted_harvested_allcrops.dta", nogen
  
*Household diet
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_household_diet.dta", nogen

*Consumption
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_consumption.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_adulteq.dta", nogen

*Household assets
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_hh_assets.dta", nogen

*Food insecurity
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_food_insecurity.dta", nogen
...
*/ animals_lost_agseas* mean_agseas*  /*
*/ liters_milk_produced costs_dairy /*
*/ eggs_total_year value_eggs_produced value_milk_produced crop_production_expenses/*
*/ off_farm_hours livestock_expenses value_assets cost_expli_hh sales_livestock_products value_livestock_products value_livestock_sales
...
foreach c of global topcropname_area {
	...
	gen ar_hv_wgt_`c' =  weight*w_area_harv_`c'
	...
	foreach g of global allyield  {
		...
		gen ar_hv_wgt_`g'_`c' =  weight*w_area_harv_`g'_`c'
		lab var ar_hv_wgt_`g'_`c' "Harvested area-adjusted weight for `c' (`g')"
	}
}
...
foreach p of varlist $monetary_vars {
	gen `p'_1ppp = (1 + $GHSP_LSMS_ISA_W2_inflation) * `p' / $GHSP_LSMS_ISA_W2_cons_ppp_dollar
	gen `p'_2ppp = (1 + $GHSP_LSMS_ISA_W2_inflation) * `p' / $GHSP_LSMS_ISA_W2_gdp_ppp_dollar
	gen `p'_usd = (1 + $GHSP_LSMS_ISA_W2_inflation) * `p' / $GHSP_LSMS_ISA_W2_exchange_rate
	gen `p'_loc = (1 + $GHSP_LSMS_ISA_W2_inflation) * `p'
	local l`p' : var lab `p' 
	...
	lab var `p' "`l`p'' (NGN)"  
	gen w_`p'_1ppp = (1 + $GHSP_LSMS_ISA_W2_inflation) * w_`p' / $GHSP_LSMS_ISA_W2_cons_ppp_dollar
	gen w_`p'_2ppp = (1 + $GHSP_LSMS_ISA_W2_inflation) * w_`p' / $GHSP_LSMS_ISA_W2_gdp_ppp_dollar
	gen w_`p'_usd = (1 + $GHSP_LSMS_ISA_W2_inflation) * w_`p' / $GHSP_LSMS_ISA_W2_exchange_rate
	gen w_`p'_loc = (1 + $GHSP_LSMS_ISA_W2_inflation) * w_`p' 
...
*Second, we inflate the local currency to the year that this survey was carried out using the CPI inflation rate using https://data.worldbank.org/indicator/FP.CPI.TOTL?end=2017&locations=TZ&start=2003	
	*display (134.925-110.84)/110.84 // = .2172952
	*display 151.90421 * 1.2172952 //= 184.91227
...
gen poverty_under_1_9 = (daily_percap_cons<184.91227)
la var poverty_under_1_9 "Household has a percapita conumption of under $1.90 in 2011 $ PPP)"

drop *_inter_* *_usd //drop unnecessary variables
...
save "${NGA_W2_final_data}/Nigeria_GHSP_LSMS_ISA_W2_household_variables.dta", replace


**************
*INDIVIDUAL-LEVEL VARIABLES
**************
use "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_person_ids.dta", clear
merge 1:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_control_income.dta", nogen  keep(1 3)
merge 1:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_make_ag_decision.dta", nogen  keep(1 3)
merge 1:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_ownasset.dta", nogen  keep(1 3)
merge m:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hhsize.dta", nogen keep (1 3)
merge 1:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_farmer_fert_use.dta", nogen  keep(1 3)
merge 1:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_farmer_improvedseed_use.dta", nogen  keep(1 3)
merge 1:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHSP_LSMS_ISA_W2_farmer_vaccine.dta", nogen  keep(1 3)
merge m:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_hhids.dta", nogen keep (1 3)

*Land rights
merge 1:1 hhid indiv using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_land_rights_ind.dta", nogen
...
preserve
use "${NGA_W2_final_data}/Nigeria_GHSP_LSMS_ISA_W2_household_variables.dta", clear
keep hhid ag_hh
tempfile ag_hh
save `ag_hh'
restore
...
save "${NGA_W2_final_data}/Nigeria_GHSP_LSMS_ISA_W2_individual_variables.dta", replace
...
use "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_areas.dta", clear
merge m:1 hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_weights.dta", keep (1 3) nogen
merge 1:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_cropvalue.dta", keep (1 3) nogen
merge 1:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_decision_makers", keep (1 3) nogen // Bring in the gender file
merge 1:1 plot_id hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_farmlabor_postharvest.dta", keep (1 3) nogen
merge 1:1 plot_id  hhid using "${NGA_W2_created_data}\Nigeria_GHSP_LSMS_ISA_W2_plot_farmlabor_postplanting.dta", keep (1 3) nogen
keep if cultivate==1
ren field_size  area_meas_hectares
egen labor_total = rowtotal(days_hired_postplant days_famlabor_postplant days_hired_postharvest days_famlabor_postharvest days_exchange_labor_postharvest) 
...
save "${NGA_W2_final_data}\Nigeria_GHSP_LSMS_ISA_W2_gender_productivity_gap.dta", replace
...
global final_data_household  "${NGA_W2_final_data}/Nigeria_GHSP_LSMS_ISA_W2_household_variables.dta"  
global final_data_individual "${NGA_W2_final_data}/Nigeria_GHSP_LSMS_ISA_W2_individual_variables.dta"
global final_data_plot       "${NGA_W2_final_data}\Nigeria_GHSP_LSMS_ISA_W2_gender_productivity_gap.dta"
global final_outputfile      "${NGA_W2_final_data}\Nigeria_GHSP_LSMS_ISA_W2_summary_stats_XXXXXX.xlsx" //Update output file date

global topcropname_area_full  "maize rice wheat sorgum mill cowpea grdnt beans yam swtptt cassav banana cocoa soy" //adding beans and wheat becuase they are not included in Nigieria
...
gen grew_beans = 0 
gen grew_wheat = 0 
*disaggregating hh growing crop by farm size
...
recode hybrid_seed_maize (.=0) if grew_maize==1
...
foreach v of global final_indicator4 {
	tabstat w_yield_hv_`v' [aw=ar_hv_wgt_`v'] if rural==1, stat(mean sd p25 p50 p75  min max N) col(stat) save
	matrix temp4=r(StatTotal)'
	qui svyset clusterid [pweight=ar_hv_wgt_`v'], strata(strataid) singleunit(centered) // get standard errors of the mean	
...
replace w_cost_per_lit_milk_1ppp_fhh=0 
replace w_cost_per_lit_milk_2ppp_fhh=0 
replace w_cost_per_lit_milk_loc_fhh=0 
...
//missing observations. Change to fill the matrix with 0s
foreach i in 1ppp 2ppp loc {
	foreach x in mill_exp_female swtptt_exp_female banana_exp_female cocoa_exp_female cocoa_exp_mixed soy_exp_female{
		recode w_`x'_`i' (.=0)
		}
}
...
//missing observations. Change to fill the matrix with 0s
foreach i in 1ppp 2ppp loc {
	foreach x in mill_exp_ha_female swtptt_exp_ha_female banana_exp_ha_female cocoa_exp_ha_female cocoa_exp_ha_mixed soy_exp_ha_female{
		recode w_`x'_`i' (.=0)
		}
}
...
foreach i in 1ppp 2ppp loc {
	foreach v of global final_indicator9 {
		foreach x in $topcropname_area_full {
			tabstat w_`x'_exp_ha_`v'_`i' [aw=area_weight_`v']  if rural==1 & ag_hh==1, stat(mean sd p25 p50 p75  min max N) col(stat) save
...
//missing observations. Change to fill the matrix with 0s
foreach i in 1ppp 2ppp loc {
	foreach x in mill_exp_kg_female swtptt_exp_kg_female banana_exp_kg_female cocoa_exp_kg_female cocoa_exp_kg_mixed soy_exp_kg_female{
		recode w_`x'_`i' (.=0)
		}
}
...
foreach i in 1ppp 2ppp loc {
	foreach v of global final_indicator9 {
		foreach x in $topcropname_area_full {
			tabstat w_`x'_exp_kg_`v'_`i'  [aw=area_weight_`v']  if rural==1 & ag_hh==1, stat(mean sd p25 p50 p75  min max N) col(stat) save
...
foreach c in $tree_cropname{
	replace total_planted_area_`c' = 0 
	replace total_harv_area_`c' = 0
}
...
replace w_liters_milk_produced_fhh=0
foreach i in 1ppp 2ppp loc{
replace w_value_milk_produced_`i'_fhh=0
}

*replace missings with 0s to fill matrix
recode w_total_planted_area_cocoa_fhh (.=0)
recode w_total_harv_area_cocoa_fhh (.=0)
