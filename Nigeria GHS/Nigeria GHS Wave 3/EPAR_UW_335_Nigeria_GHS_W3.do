...
saveold "${Nigeria_GHS_W3_final_data}/Nigeria_GHS_W3_gender_productivity_gap.dta", replace
...
global final_data_household  "${Nigeria_GHS_W3_final_data}/Nigeria_GHS_W3_household_variables.dta"  
global final_data_individual "${Nigeria_GHS_W3_final_data}/Nigeria_GHS_W3_individual_variables.dta"
global final_data_plot       "${Nigeria_GHS_W3_final_data}/Nigeria_GHS_W3_gender_productivity_gap.dta"
global final_outputfile      "${Nigeria_GHS_W3_final_data}/Nigeria_GHS_W3_summary_stats_`c(current_date)'.xlsx" 		//Update output file date
