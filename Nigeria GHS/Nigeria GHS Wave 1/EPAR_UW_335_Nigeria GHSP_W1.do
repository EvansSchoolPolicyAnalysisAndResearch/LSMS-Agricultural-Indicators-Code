...
use "${Nigeria_GHS_W1_raw_data}/Post Planting Wave 1/Agriculture/sect11a1_plantingw1", clear
...
gen area_meas_hectare =area_meas_sqm2*0.0001
...
use "${Nigeria_GHS_W1_raw_data}/Post Harvest Wave 1\Agriculture\secta3_harvestw1.dta", clear
ren sa3q1 crop_name     //no finished harvest or quantity left to harvest questions
ren sa3q2 crop_code
ren sa3q3 harvest_yesno
ren sa3q6a quantity_harvested
ren sa3q6b quantity_harvested_unit
...
ren s11dq18 value_fertilizer_1
ren s11dq29 value_fertilizer_2
ren s11dq10 cost_transport_free_fert
ren s11dq16 cost_transport_fert_1
ren s11dq27 cost_transport_fert_2
...
ren s11eq20 cost_seed_1
ren s11eq31 cost_seed_2
ren s11eq18 cost_trans_seed_1
ren s11eq29 cost_trans_seed_2
...
ren s11bq9 rental_cost_cash 
ren s11bq10 rental_cost_inkind
...
use "${Nigeria_GHS_W1_raw_data}/Post Planting Wave 1\Agriculture\sect11c_plantingw1.dta", clear
ren s11cq21 days_oxen_rental
ren s11cq23a animal_rent_quantity
ren s11cq23b animal_rent_unit
ren s11cq24a animal_rent_inkind_quantity
ren s11cq24b animal_rent_inkind_unit
ren s11cq24c animal_rent_inkind_unit_other    
ren s11cq25 animal_rent_feeding_costs
ren s11cq32 rental_cost_ag_assets_cash
ren s11cq33 rental_cost_ag_assets_inkind
