...
*PLOT-LEVEL VARIABLES				Tanzania_NPS_W2_gender_productivity_gap.dta
...
global TZA_W2_raw_data 	    	"$directory\Tanzania NPS\Tanzania NPS Wave 2\Raw DTA Files"
...
************************
global NPS_LSMS_ISA_W2_exchange_rate 2158		  // https://www.bloomberg.com/quote/USDETB:CUR
global NPS_LSMS_ISA_W2_gdp_ppp_dollar 719.02      // https://data.worldbank.org/indicator/PA.NUS.PPP
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_hhids.dta", replace 
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_person_ids.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_hhsize.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_areas.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_gender_merge.dta", replace
...
merge m:1 y2_hhid personid using  "${TZA_W2_created_data}/Tanzania_NPS_W2_gender_merge.dta", gen(dm1_merge) keep(1 3)		// Dropping unmatched from using
...
merge m:1 y2_hhid personid using "${TZA_W2_created_data}/Tanzania_NPS_W2_gender_merge.dta", gen(dm2_merge) keep(1 3)		// Dropping unmatched from using
gen dm2_female = female
drop female personid
*Third
gen personid = ag3a_08_3
replace personid =ag3b_08_3 if personid==. &  ag3b_08_3!=.
merge m:1 y2_hhid personid using "${TZA_W2_created_data}/Tanzania_NPS_W2_gender_merge.dta", gen(dm3_merge) keep(1 3)		// Dropping unmatched from using
...
merge m:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_hhsize.dta", nogen 							
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_decision_makers.dta", replace
...
forvalues k=1(1)$len  {			
	...
	*qui tab zaocode, gen(crops_dummy)
	...
	merge m:1 y2_hhid plot_id using "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_areas.dta", nogen assert(2 3) keep(3)
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_`cn'_monocrop.dta", replace
}

forvalues k=1(1)$len  {		
	local c : word `k' of $topcrop_area
	local cn : word `k' of $topcropname_area
	use "${TZA_W2_created_data}/Tanzania_NPS_W2_`cn'_monocrop.dta", clear
	merge m:1 y2_hhid plot_id using "${TZA_W2_created_data}\Tanzania_NPS_W2_plot_decision_makers.dta"
	...
	*And now this code will indicate whether the HOUSEHOLD has at least one of these plots and the total area of monocropped maize plots
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_`cn'_monocrop_hh_area.dta", replace
}
...
drop if y2_hhid==""
save "${TZA_W2_created_data}\Tanzania_NPS_W2_TLU_Coefficients.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_tempcrop_harvest.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_tempcrop_sales.dta", replace
...
lab var kgs_harvest "Kgs harvested of this crop, summed over main and short season"
save "${TZA_W2_created_data}/Tanzania_NPS_W2_permcrop_harvest.dta", replace
...
gen price_kg = value_sold / quantity_sold
lab var price_kg "Price per kg sold"
save "${TZA_W2_created_data}/Tanzania_NPS_W2_permcrop_sales.dta", replace

*Prices of permanent and tree crops need to be imputed from sales
use "${TZA_W2_created_data}/Tanzania_NPS_W2_permcrop_sales.dta", clear
append using "${TZA_W2_created_data}/Tanzania_NPS_W2_tempcrop_sales.dta"
recode price_kg (0=.) 
merge m:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_hhids.dta", nogen keep(1 3)
save "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_sales.dta", replace

use "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_prices_ea.dta", replace
use "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_prices_ward.dta", replace
use "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_prices_district.dta", replace
use "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_prices_region.dta", replace
use "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_prices_country.dta", replace

*Pull prices into harvest estimates
use "${TZA_W2_created_data}/Tanzania_NPS_W2_tempcrop_harvest.dta", clear
append using "${TZA_W2_created_data}/Tanzania_NPS_W2_permcrop_harvest.dta"
merge m:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_hhids.dta", nogen keep(1 3)
merge m:1 y2_hhid crop_code using "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_sales.dta", nogen
merge m:1 region district ward ea crop_code using "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_prices_ea.dta", nogen
merge m:1 region district ward crop_code using "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_prices_ward.dta", nogen
merge m:1 region district crop_code using "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_prices_district.dta", nogen
merge m:1 region crop_code using "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_prices_region.dta", nogen
merge m:1 crop_code using "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_prices_country.dta", nogen
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_values_tempfile.dta", replace 
...
preserve
	...
	save "${TZA_W2_created_data}\Tanzania_NPS_W2_hh_crop_values_production.dta", replace
restore
...
save "${TZA_W2_created_data}\Tanzania_NPS_W2_hh_crop_production.dta", replace

*Plot value of crop production
use "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_values_tempfile.dta", clear
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_cropvalue.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_residues.dta", replace
...
duplicates drop
save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_crop_prices.dta", replace
...
merge 1:1 y2_hhid crop_code using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_crop_values_production.dta"
drop if _merge==2
...
save "${TZA_W2_created_data}\Tanzania_NPS_W2_crop_losses.dta", replace
...
preserve
	...
	*Merge in monocropped plots
	merge m:1 y2_hhid plot_id short using "${TZA_W2_created_data}/Tanzania_NPS_W2_`cn'_monocrop.dta", nogen assert(1 3) keep(3)		
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_wages_mainseason_`cn'.dta", replace
restore
} 
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_wages_mainseason.dta", replace
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_wages_shortseason_`cn'.dta", replace
restore
} 
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_wages_shortseason.dta", replace
...
preserve
	...
	merge m:1 y2_hhid indidy2 using "${TZA_W2_created_data}/Tanzania_NPS_W2_person_ids.dta", nogen keep(3)		// keep only matched
...
preserve
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_land_rights_ind.dta", replace
restore	
...
preserve
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_land_rights_hh.dta", replace
restore
...
preserve
	...
	*disaggregate by gender plot manager
	merge m:1 y2_hhid plot_id using "${TZA_W2_created_data}\Tanzania_NPS_W2_plot_decision_makers.dta"
	*Merge in monocropped plots
	merge m:1 y2_hhid plot_id short using "${TZA_W2_created_data}/Tanzania_NPS_W2_`cn'_monocrop.dta", nogen assert(1 3) keep(3)		// only in master and matched; keeping only matched, because these are the maize monocropped plots
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_fertilizer_costs_`cn'.dta", replace
restore
}
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_fertilizer_costs.dta", replace
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_seed_costs_`cn'.dta", replace
restore
}

collapse (sum) cost_seed, by (y2_hhid)
lab var cost_seed "Value of purchased seed for temporary crops"
save "${TZA_W2_created_data}/Tanzania_NPS_W2_seed_costs.dta", replace
...
preserve
	...
	*disaggregate by gender of plot manager
	merge m:1 y2_hhid plot_id using "${TZA_W2_created_data}\Tanzania_NPS_W2_plot_decision_makers.dta"
	*Merge in monocropped plots
	merge 1:1 y2_hhid plot_id short using "${TZA_W2_created_data}/Tanzania_NPS_W2_`cn'_monocrop.dta", nogen assert(1 3) keep(3)		// only in master and matched; keeping only matched, because these are the maize monocropped plots	
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_land_rental_costs_`cn'.dta", replace
restore
}
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_land_rental_costs.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_asset_rental_costs.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_transportation_cropsales.dta", replace


*Crop costs 
use "${TZA_W2_created_data}/Tanzania_NPS_W2_asset_rental_costs.dta", clear
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_land_rental_costs.dta", nogen
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_seed_costs.dta", nogen
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_fertilizer_costs.dta", nogen
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_wages_shortseason.dta", nogen
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_wages_mainseason.dta", nogen
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_transportation_cropsales.dta", nogen
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_expenses", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products_other", replace

use "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products_other", clear
merge m:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_hhids.dta"
drop if _merge==2
drop _merge
save "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products", replace

use "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products", clear
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products_prices_ea.dta", replace
use "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products_prices_ward.dta", replace
use "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products_prices_district.dta", replace
use "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products_prices_region.dta", replace
use "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products_prices_country.dta", replace

use "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products", clear
merge m:1 region district ward ea livestock_code using "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products_prices_ea.dta", nogen
merge m:1 region district ward livestock_code using "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products_prices_ward.dta", nogen
merge m:1 region district livestock_code using "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products_prices_district.dta", nogen
merge m:1 region livestock_code using "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products_prices_region.dta", nogen
merge m:1 livestock_code using "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_products_prices_country.dta", nogen
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_livestock_products", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_dung.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_livestock_sales", replace

*Implicit prices
use "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_livestock_sales", clear
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_prices_ea.dta", replace
use "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys region district ward livestock_code: egen obs_ward = count(observation)
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_prices_ward.dta", replace
use "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys region district livestock_code: egen obs_district = count(observation)
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_prices_district.dta", replace
use "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys region livestock_code: egen obs_region = count(observation)
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_prices_region.dta", replace
use "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys livestock_code: egen obs_country = count(observation)
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_prices_country.dta", replace

use "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_livestock_sales", clear
merge m:1 region district ward ea livestock_code using "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_prices_ea.dta", nogen
merge m:1 region district ward livestock_code using "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_prices_ward.dta", nogen
merge m:1 region district livestock_code using "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_prices_district.dta", nogen
merge m:1 region livestock_code using "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_prices_region.dta", nogen
merge m:1 livestock_code using "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_prices_country.dta", nogen
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_sales", replace
...
preserve
	...
	*any improved large ruminants, small ruminants, or poultry
	...
	save "${TZA_W2_created_data}\Tanzania_NPS_W2_herd_characteristics", replace
restore
...
drop if y2_hhid==""
save "${TZA_W2_created_data}/Tanzania_NPS_W2_TLU.dta", replace


*Livestock income
use "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_sales", clear
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_livestock_products", nogen
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_dung.dta", nogen
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_expenses", nogen
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_TLU.dta", nogen
merge 1:1 y2_hhid using "${TZA_W2_created_data}\Tanzania_NPS_W2_TLU_Coefficients.dta", nogen
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_weeks_fishing_highseason.dta", replace
...
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_weeks_fishing_highseason.dta"
drop _merge
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_weeks_fishing.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_fishing_expenses_labor_highseason.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_fishing_expenses_1-1.dta", replace 
...
merge m:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_weeks_fishing.dta"
...
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_fishing_expenses_1-1.dta"
drop _merge
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_fishing_expenses_1.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_fishing_expenses_2-1.dta", replace
...
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_fishing_expenses_2-1.dta"
gen cost_paid = cost_paid_ls + cost_paid_hs
keep y2_hhid cost_paid
save "${TZA_W2_created_data}/Tanzania_NPS_W2_fishing_expenses_2.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_fish_prices.dta", replace
...
merge m:1 fish_code unit using "${TZA_W2_created_data}/Tanzania_NPS_W2_fish_prices.dta"
drop if _merge==2
drop _merge
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_fish_income_1.dta", replace
...
merge 1:1 y2_hhid using  "${TZA_W2_created_data}/Tanzania_NPS_W2_fish_income_1.dta"
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_fish_income.dta", replace

*Fish income
use "${TZA_W2_created_data}/Tanzania_NPS_W2_fish_income.dta", clear
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_fishing_expenses_1.dta"
drop _merge
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_fishing_expenses_2.dta"
drop _merge
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_self_employment_income.dta", replace
...
merge m:1 y2_hhid crop_code using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_crop_prices.dta"
drop _merge
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_agproducts_profits.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_weeks_fish_trading.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_fish_trading_revenue-1.dta", replace
...
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_fish_trading_revenue-1.dta"
drop _merge
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_fish_trading_revenue.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_fish_trading_other_costs-1.dta", replace
...
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_fish_trading_other_costs-1.dta"
drop _merge
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_fish_trading_other_costs.dta", replace


use "${TZA_W2_created_data}/Tanzania_NPS_W2_weeks_fish_trading.dta", clear
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_fish_trading_revenue.dta" 
drop _merge
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_fish_trading_other_costs.dta"
drop _merge
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_fish_trading_income.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_wage_income.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_agwage_income.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_other_income.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_land_rental_income.dta", replace

*Other income
use "${TZA_W2_created_data}/Tanzania_NPS_W2_other_income.dta", clear
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_land_rental_income.dta"
...
save "${TZA_W2_created_data}\Tanzania_NPS_W2_crops_grown.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_parcels_cultivated.dta", replace

use "${TZA_W2_created_data}/Tanzania_NPS_W2_parcels_cultivated.dta", clear
merge 1:1 y2_hhid plot_id using "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_areas.dta"
drop if _merge==2
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_land_size.dta", replace
...
rename plotnum plot_id
drop if plot_id==""
merge m:1 y2_hhid plot_id using "${TZA_W2_created_data}\Tanzania_NPS_W2_crops_grown.dta", nogen
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_parcels_agland.dta", replace

use "${TZA_W2_created_data}/Tanzania_NPS_W2_parcels_agland.dta", clear
merge 1:1 y2_hhid plot_id using "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_areas.dta"
drop if _merge==2
replace area_acres_meas=. if area_acres_meas<0
replace area_acres_meas = area_acres_est if area_acres_meas==. 
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_farmsize_all_agland.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_parcels_held.dta", replace

use "${TZA_W2_created_data}/Tanzania_NPS_W2_parcels_held.dta", clear
merge 1:1 y2_hhid plot_id using "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_areas.dta"
drop if _merge==2
replace area_acres_meas=. if area_acres_meas<0
replace area_acres_meas = area_acres_est if area_acres_meas==. 
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_land_size_all.dta", replace
...
rename plotnum plot_id
drop if plot_id==""
merge m:1 y2_hhid plot_id using "${TZA_W2_created_data}\Tanzania_NPS_W2_plot_areas.dta", nogen keep(1 3)
replace area_acres_meas=. if area_acres_meas<0
replace area_acres_meas = area_acres_est if area_acres_meas==. 
replace area_acres_meas = area_acres_est if area_acres_meas==0 & (area_acres_est>0 & area_acres_est!=.)		
...
save "${TZA_W2_created_data}\Tanzania_NPS_W2_land_size_total.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_off_farm_hours.dta", replace
...
save "${TZA_W2_created_data}\Tanzania_NPS_W2_plot_farmlabor_mainseason.dta", replace
...
save "${TZA_W2_created_data}\Tanzania_NPS_W2_plot_farmlabor_shortseason.dta", replace

*Labor
use "${TZA_W2_created_data}\Tanzania_NPS_W2_plot_farmlabor_mainseason.dta", clear
merge 1:1 y2_hhid plot_id using "${TZA_W2_created_data}\Tanzania_NPS_W2_plot_farmlabor_shortseason.dta"
drop _merge
recode days*  (.=0)
...
save "${TZA_W2_created_data}\Tanzania_NPS_W2_plot_family_hired_labor.dta", replace
...
lab var labor_family "Total labor days (family) allocated to the farm"
lab var labor_total "Total labor days allocated to the farm" 
save "${TZA_W2_created_data}\Tanzania_NPS_W2_family_hired_labor.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_vaccine.dta", replace
...
drop if personid==.
merge 1:1 y2_hhid personid using "${TZA_W2_created_data}\Tanzania_NPS_W2_gender_merge.dta", nogen
...
save "${TZA_W2_created_data}\Tanzania_NPS_W2_farmer_vaccine.dta", replace
...
save "${TZA_W2_created_data}\Tanzania_NPS_W2_livestock_diseases.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_fert_use.dta", replace
...
save "${TZA_W2_created_data}\Tanzania_NPS_W2_farmer_fert_use.dta", replace 
...
save "${TZA_W2_created_data}\Tanzania_NPS_W2_improvedseed_use.dta", replace
...
save "${TZA_W2_created_data}\Tanzania_NPS_W2_farmer_improvedseed_use_temp.dta", replace


*adding other crops 
forvalues k=1/15 {
	use "${TZA_W2_created_data}\Tanzania_NPS_W2_farmer_improvedseed_use_temp.dta", clear
	local c : word `k' of $topcrop_area
	local cn : word `k' of $topcropname_area
	...
	*We also need a variable that indicates if farmer (plot manager) grows maize
	...
	save "${TZA_W2_created_data}\Tanzania_NPS_W2_farmer_improvedseed_use_temp_`cn'.dta", replace
}

*Combining all together
foreach v in $topcropname_area {
	merge 1:1 y2_hhid farmerid all_imprv_seed_use using "${TZA_W2_created_data}\Tanzania_NPS_W2_farmer_improvedseed_use_temp_`v'.dta", nogen
}
...
recode farm_manager (.=0)
lab var farm_manager "1=Indvidual is listed as a manager for at least one plot" 
save "${TZA_W2_created_data}\Tanzania_NPS_W2_farmer_improvedseed_use.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_any_ext.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_fin_serv.dta", replace
...
save "${TZA_W2_created_data}\Tanzania_NPS_W2_milk_animals.dta", replace
...
save "${TZA_W2_created_data}\Tanzania_NPS_W2_eggs_animals.dta", replace
...
ren plotnum plot_id
save "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_area_lrs.dta", replace
*Getting plot rental rate
use "${TZA_W2_raw_data}/Agriculture/AG_SEC3A.dta", clear
ren plotnum plot_id
merge 1:1 plot_id y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_area_lrs.dta" , nogen		
drop if plot_id==""
gen cultivated = ag3a_03==1
merge m:1 y2_hhid plot_id using  "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_decision_makers.dta", nogen keep (1 3)
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_rent_nomiss_lrs.dta", replace					
...
preserve
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_rental_rate_lrs.dta", replace
restore
...
preserve
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_rental_rate_hhid_lrs.dta", replace
restore
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_rental_rate_lrs.dta", replace
...
keep plot_ha plotnum y2_hhid
ren plotnum plot_id
save "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_area_srs.dta", replace
*Getting plot rental rate
use "${TZA_W2_raw_data}/Agriculture/AG_SEC3B.dta", clear
drop if plotnum==""
gen cultivated = ag3b_03==1
ren  plotnum plot_id
merge m:1 y2_hhid plot_id using  "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_decision_makers.dta", nogen 
merge 1:1 plot_id y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_area_lrs.dta", nogen					
merge 1:1 plot_id y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_area_srs.dta", nogen update replace		
*Total rent - rescaling to a YEARLY value
...
recode plot_rental_rate (0=.) 
save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_rent_nomiss_srs.dta", replace
preserve
	gen value_rented_land_male = plot_rental_rate if dm_gender==1
	gen value_rented_land_female = plot_rental_rate if dm_gender==2
	gen value_rented_land_mixed = plot_rental_rate if dm_gender==3
	collapse (sum) value_rented_land_* value_rented_land = plot_rental_rate, by(y2_hhid)
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_rental_rate_srs.dta", replace
restore
gen ha_rental_rate_hh = plot_rental_rate/plot_ha
recode ha_rental_rate_hh (0=.) 
...
preserve
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_rental_rate_hhid_srs.dta", replace
restore
*Merging in geographic variables
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_rental_rate_srs.dta", replace


*Now getting total ha of all plots that were cultivated at least once
use "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_rent_nomiss_lrs.dta", clear
append using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_rent_nomiss_srs.dta"
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_cultivated_plots_ha.dta", replace

use "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_rental_rate_lrs.dta", clear
append using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_rental_rate_srs.dta"
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_rental_rate.dta", replace
...
drop if plotnum==""
ren  plotnum plot_id
merge m:1 y2_hhid plot_id using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_rent_nomiss_lrs.dta", nogen keep(1 3)
*First rescaling
...
merge m:1 plot_id y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_area_lrs", nogen assert(2 3) keep(3)	
...
merge m:1 region district ward ea using "${TZA_W2_created_data}/Tanzania_NPS_W2_rental_rate_lrs", nogen assert(2 3) keep(3)		
*Now merging in rental costs of individual plots
merge m:1 y2_hhid plot_id using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_rent_nomiss_lrs.dta", nogen keep(1 3)
*Now merging in household rental rate
merge m:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_rental_rate_hhid_lrs.dta", nogen keep(1 3)
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_cost_land_lrs.dta", replace
...
drop if plotnum==""
ren plotnum plot_id 
merge m:1 y2_hhid plot_id using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_rent_nomiss_lrs.dta", nogen keep(1 3) keepusing(dm_gender)
merge m:1 y2_hhid plot_id using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_rent_nomiss_srs.dta", nogen keep(1 3) keepusing(dm_gender) update
*First rescaling
...
merge m:1 plot_id y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_area_lrs", nogen keep(1 3) keepusing(plot_ha)	
merge m:1 plot_id y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_area_srs", nogen keepusing(plot_ha) update	
gen ha_planted = percent_plot*plot_ha
gen ha_planted_male = ha_planted if dm_gender==1
gen ha_planted_female = ha_planted if dm_gender==2
gen ha_planted_mixed = ha_planted if dm_gender==3
...
*Now merging in household rental rate
merge m:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_rental_rate_hhid_lrs.dta", nogen keep(1 3)		
merge m:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_rental_rate_hhid_srs.dta", nogen	update			
gen value_owned_land = ha_planted*ha_rental_rate if ag3a_32==0 | ag3a_32==.	
replace value_owned_land = ha_planted*ha_rental_hh_lrs if ha_rental_hh_lrs!=0 & ha_rental_hh_lrs!=. & (ag3a_32==0 | ag3a_32==.)		
*Now creating gender value
gen value_owned_land_male = ha_planted*ha_rental_rate if (ag3a_32==0 | ag3a_32==.) & dm_gender==1
...
collapse (sum) value_owned_land* ha_planted*, by(y2_hhid plot_id)			// summing ha_planted across crops on same plot
append using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_cost_land_lrs.dta"						// appending LRS data
...
preserve
	*We also want to create a total area planted variable, double counting plots, for fertilizer application rate
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_ha_planted_total.dta", replace
restore
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_cost_land.dta", replace
...
preserve
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_fert_lrs.dta", replace
restore
...
preserve
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_org_fert_lrs.dta", replace
restore
merge m:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_org_fert_lrs.dta", nogen
...
preserve
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_wages_hh_lrs.dta", replace
restore

merge m:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_wages_hh_lrs.dta", nogen
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_cost_inputs_lrs.dta", replace
...
preserve
	...
	gen fert_inorg_kg_mixed = fert_inorg_kg if dm_gender==3
	collapse (sum) fert_org_kg fert_inorg_kg*, by(y2_hhid)
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_fert_srs.dta", replace
restore
...
preserve
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_org_fert_srs.dta", replace
restore
merge m:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_org_fert_srs.dta", nogen
...
preserve
	...
	gen harv_wage_hh = harv_labor_costs/harv_labor
	recode *wage* (0=.)
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_wages_hh_srs.dta", replace
restore
*Merging right back in
merge m:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_wages_hh_srs.dta", nogen
...
collapse (sum) value_*, by(y2_hhid)
save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_cost_inputs_srs.dta", replace

use  "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_cost_inputs_lrs.dta", clear
append using  "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_cost_inputs_srs.dta"
collapse (sum) value_*, by(y2_hhid)
...
preserve
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_seeds_hh_lrs.dta", replace
restore

merge m:1 y2_hhid zaocode using "${TZA_W2_created_data}/Tanzania_NPS_W2_seeds_hh_lrs.dta", nogen
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_cost_seed_lrs.dta", replace
...
preserve
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_seeds_hh_srs.dta", replace
restore
merge m:1 y2_hhid zaocode using "${TZA_W2_created_data}/Tanzania_NPS_W2_seeds_hh_srs.dta", nogen
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_cost_seed_srs.dta", replace
...
use "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_cost_land.dta", clear
append using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_rental_rate.dta"
append using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_cost_inputs_lrs.dta"
append using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_cost_inputs_srs.dta"
append using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_cost_seed_lrs.dta"
append using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_cost_seed_srs.dta"
append using "${TZA_W2_created_data}/Tanzania_NPS_W2_asset_rental_costs.dta"
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_cropcosts_total.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_ag_wage.dta", replace
...
use "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_cost_land.dta", clear
append using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_fert_lrs.dta"
append using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_fert_srs.dta"
collapse (sum) ha_planted* fert_org_kg* fert_inorg_kg*, by(y2_hhid)

merge m:1 y2_hhid using "${TZA_W2_created_data}\Tanzania_NPS_W2_hhids.dta", keep (1 3) nogen
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_fertilizer_application.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_household_diet.dta", replace
...
merge 1:1 y2_hhid indidy2  using  "${TZA_W2_created_data}/Tanzania_NPS_W2_person_ids.dta", nogen 
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_control_income.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_make_ag_decision.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_ownasset.dta", replace
...
merge m:1 y2_hhid plot_id using "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_areas.dta" , nogen keep(1 3)    // dropping those only in using
merge m:1 y2_hhid plot_id using "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_decision_makers" , nogen keep(1 3)
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_crop_area.dta", replace
...
merge m:1 y2_hhid plot_id zaocode using "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_crop_area.dta", nogen 
...
save "${TZA_W2_created_data}\Tanzania_NPS_W2_hh_crop_area_plan_LRS.dta", replace
...
preserve
	...
	save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_area_planted_harvested_allcrops_LRS.dta", replace
restore

keep if inlist( zaocode, $comma_topcrop_area)

save "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_harvest_area_yield_LRS.dta", replace
...
keep crop_area_planted* y2_hhid plot_id zaocode dm_* any_* pure_stand dm_gender  field_area us_* area_meas_hectares area_est_hectares	
save "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_crop_area_SRS.dta", replace
...
ren plotnum plot_id 
*Merging decision maker and intercropping variables
merge m:1 y2_hhid plot_id zaocode using "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_crop_area_SRS.dta", nogen 			
...
*Saving area planted for Shannon diversity index
save "${TZA_W2_created_data}\Tanzania_NPS_W2_hh_crop_area_plan_SRS.dta", replace

*Adding here total planted and harvested area summed across all plots, crops, and seasons.
preserve
collapse (sum) all_area_harvested=area_harv all_area_planted=area_plan, by(y2_hhid)
replace all_area_harvested=all_area_planted if all_area_harvested>all_area_planted & all_area_harvested!=.
save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_area_planted_harvested_allcrops_SRS.dta", replace
*Append LRS
append using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_area_planted_harvested_allcrops_LRS.dta"
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_area_planted_harvested_allcrops.dta", replace
restore
...
gen season="SRS"
save "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_harvest_area_yield_SRS.dta", replace
 
*Yield at the household level
use "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_harvest_area_yield_LRS.dta", clear
preserve
gen season="LRS"
append using "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_harvest_area_yield_SRS.dta"
...
merge 1:1 y2_hhid crop_code using "${TZA_W2_created_data}\Tanzania_NPS_W2_hh_crop_values_production.dta", nogen keep(1 3)
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_yield_hh_crop_level.dta", replace
...
use "${TZA_W2_created_data}\Tanzania_NPS_W2_hh_crop_area_plan_LRS.dta", clear
append using "${TZA_W2_created_data}\Tanzania_NPS_W2_hh_crop_area_plan_SRS.dta"
...
preserve 
	...
	save "${TZA_W2_created_data}\Tanzania_NPS_W2_hh_crop_area_plan_shannon.dta", replace
restore

merge m:1 y2_hhid using "${TZA_W2_created_data}\Tanzania_NPS_W2_hh_crop_area_plan_shannon.dta", nogen		//all matched
...
save "${TZA_W2_created_data}\Tanzania_NPS_W2_shannon_diversity_index.dta", replace
...
save "${TZA_W2_created_data}/Tanzania_NPS_W2_consumption.dta", replace
...
save "${TZA_W2_created_data}\Tanzania_NPS_W2_food_insecurity.dta", replace
...
************************
global empty_vars "" 
use "${TZA_W2_created_data}/Tanzania_NPS_W2_hhids.dta", clear

*Gross crop income 
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_crop_production.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_crop_losses.dta", nogen keep (1 3)
recode value_crop_production crop_value_lost (.=0)

*Crop costs
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_asset_rental_costs.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_land_rental_costs.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_seed_costs.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_fertilizer_costs.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_wages_shortseason.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_wages_mainseason.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_transportation_cropsales.dta", nogen keep (1 3)
recode rental_cost_animal_traction rental_cost_ag_asset rental_cost_tractor rental_cost_land cost_seed value_fertilizer /*
*/ value_herb_pest wages_paid_short wages_paid_main transport_costs_cropsales (.=0)
egen crop_production_expenses = rowtotal(rental_cost_animal_traction rental_cost_ag_asset rental_cost_tractor rental_cost_land cost_seed value_fertilizer /*
*/ value_herb_pest wages_paid_short wages_paid_main transport_costs_cropsales)
...
foreach c in $topcropname_area {
	merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_land_rental_costs_`c'.dta", nogen keep (1 3)
	merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_fertilizer_costs_`c'.dta", nogen keep (1 3)
	merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_`c'_monocrop_hh_area.dta", nogen keep (1 3)
}

foreach c in $topcropname_short{
	merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_wages_shortseason_`c'.dta", nogen keep (1 3)
}

foreach c in $topcropname_annual{
	merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_seed_costs_`c'.dta", nogen keep (1 3)
	merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_wages_mainseason_`c'.dta", nogen keep (1 3)
}
...
*land rights
merge 1:1 y2_hhid using  "${TZA_W2_created_data}/Tanzania_NPS_W2_land_rights_hh.dta", nogen keep (1 3)
la var formal_land_rights_hh "Household has documentation of land rights (at least one plot)"

*Livestock income
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_sales", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_livestock_products", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_dung.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_livestock_expenses", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_TLU.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}\Tanzania_NPS_W2_herd_characteristics", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}\Tanzania_NPS_W2_TLU_Coefficients.dta", nogen keep (1 3)
...
*Fish income
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_fish_income.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_fishing_expenses_1.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_fishing_expenses_2.dta", nogen keep (1 3)
gen fishing_income = value_fish_harvest - cost_fuel - rental_costs_fishing - cost_paid
lab var fishing_income "Net fish income"
drop cost_fuel rental_costs_fishing cost_paid

*Self-employment income
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_self_employment_income.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_fish_trading_income.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_agproducts_profits.dta", nogen keep (1 3)
...
*Wage income
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_wage_income.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_agwage_income.dta", nogen keep (1 3)
...
*off-farm hours
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_off_farm_hours.dta", nogen keep (1 3)

*Other income
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_other_income.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_land_rental_income.dta", nogen keep (1 3)
...
*Farm size
merge 1:1 y2_hhid using  "${TZA_W2_created_data}/Tanzania_NPS_W2_land_size.dta", nogen keep (1 3)
merge 1:1 y2_hhid using  "${TZA_W2_created_data}/Tanzania_NPS_W2_land_size_all.dta", nogen keep (1 3)
merge 1:1 y2_hhid using  "${TZA_W2_created_data}/Tanzania_NPS_W2_farmsize_all_agland.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}\Tanzania_NPS_W2_land_size_total.dta", nogen
recode land_size (.=0)
...
*Labor
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_family_hired_labor.dta", nogen keep (1 3)
recode labor_hired labor_family (.=0) 
 
*Household size
merge 1:1 y2_hhid using  "${TZA_W2_created_data}/Tanzania_NPS_W2_hhsize.dta", nogen keep (1 3)
 
*Rates of vaccine usage, improved seeds, etc.
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_vaccine.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_fert_use.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_improvedseed_use.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_any_ext.dta", nogen keep (1 3)
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_fin_serv.dta", nogen keep (1 3)
...
*Milk productivity
merge 1:1 y2_hhid using "${TZA_W2_created_data}\Tanzania_NPS_W2_milk_animals.dta", nogen  keep (1 3)
gen costs_dairy = .
...
*Egg productivity
merge 1:1 y2_hhid using "${TZA_W2_created_data}\Tanzania_NPS_W2_eggs_animals.dta", nogen keep (1 3)
gen egg_poultry_year = . 
global empty_vars $empty_vars *egg_poultry_year


*Costs of crop production per hectare
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_cropcosts_total.dta", nogen keep (1 3)

*Rate of fertilizer application 
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_fertilizer_application.dta", nogen keep (1 3)

*Agricultural wage rate
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_ag_wage.dta", nogen keep (1 3)

*Crop yields 
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_yield_hh_crop_level.dta", nogen keep (1 3)

*total area planted and harvested accross all crops, plots, and seasons
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_hh_area_planted_harvested_allcrops.dta", nogen keep (1 3)

*household diet
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_household_diet.dta", nogen keep (1 3)

*Consumption
merge 1:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_consumption.dta", nogen keep (1 3)
...
*Household food provision
merge 1:1 y2_hhid using "${TZA_W2_created_data}\Tanzania_NPS_W2_food_insecurity.dta", nogen keep (1 3)
gen hhs_little = . 
gen hhs_moderate = . 
gen hhs_severe = . 
gen hhs_total = . 
...
*Livestock health
merge 1:1 y2_hhid using "${TZA_W2_created_data}\Tanzania_NPS_W2_livestock_diseases.dta", nogen
...
*Shannon diversity index
merge 1:1 y2_hhid using "${TZA_W2_created_data}\Tanzania_NPS_W2_shannon_diversity_index.dta", nogen
...
gen ccf_usd = (1+$NPS_LSMS_ISA_W2_inflation) / $NPS_LSMS_ISA_W2_exchange_rate 
lab var ccf_usd "currency conversion factor - 2016 $USD"
gen ccf_1ppp = (1+$NPS_LSMS_ISA_W2_inflation) / $NPS_LSMS_ISA_W2_cons_ppp_dollar 
lab var ccf_1ppp "currency conversion factor - 2016 $Private Consumption PPP"
gen ccf_2ppp = (1+$NPS_LSMS_ISA_W2_inflation) / $NPS_LSMS_ISA_W2_gdp_ppp_dollar
...
save "${TZA_W2_final_data}/Tanzania_NPS_W2_household_variables.dta", replace
...
**************
use "${TZA_W2_created_data}/Tanzania_NPS_W2_person_ids.dta", clear
merge m:1 y2_hhid   using "${TZA_W2_created_data}/Tanzania_NPS_W2_household_diet.dta", nogen
merge 1:1 y2_hhid indidy2 using "${TZA_W2_created_data}/Tanzania_NPS_W2_control_income.dta", nogen  keep(1 3)
merge 1:1 y2_hhid indidy2 using "${TZA_W2_created_data}/Tanzania_NPS_W2_make_ag_decision.dta", nogen  keep(1 3)
merge 1:1 y2_hhid indidy2 using "${TZA_W2_created_data}/Tanzania_NPS_W2_ownasset.dta", nogen  keep(1 3)
merge m:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_hhsize.dta", nogen keep (1 3)
merge 1:1 y2_hhid indidy2 using "${TZA_W2_created_data}/Tanzania_NPS_W2_farmer_fert_use.dta", nogen  keep(1 3)
merge 1:1 y2_hhid indidy2 using "${TZA_W2_created_data}/Tanzania_NPS_W2_farmer_improvedseed_use.dta", nogen  keep(1 3)
merge 1:1 y2_hhid indidy2 using "${TZA_W2_created_data}/Tanzania_NPS_W2_farmer_vaccine.dta", nogen  keep(1 3)
merge m:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_hhids.dta", nogen keep (1 3)

*Adding land rights
merge 1:1 y2_hhid indidy2 using "${TZA_W2_created_data}/Tanzania_NPS_W2_land_rights_ind.dta", nogen
...
preserve
	use "${TZA_W2_final_data}/Tanzania_NPS_W2_household_variables.dta", clear
	keep hhid ag_hh
	tempfile ag_hh
	save `ag_hh'
restore
...
save "${TZA_W2_final_data}/Tanzania_NPS_W2_individual_variables.dta", replace
...
use "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_cropvalue.dta", clear
merge 1:1 y2_hhid plot_id using "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_areas.dta", keep (1 3) nogen
merge 1:1 y2_hhid plot_id  using  "${TZA_W2_created_data}/Tanzania_NPS_W2_plot_decision_makers.dta", keep (1 3) nogen
merge m:1 y2_hhid using "${TZA_W2_created_data}/Tanzania_NPS_W2_hhids.dta", keep (1 3) nogen
merge 1:1 y2_hhid plot_id using "${TZA_W2_created_data}\Tanzania_NPS_W2_plot_family_hired_labor.dta", keep (1 3) nogen
...
save "${TZA_W2_final_data}\Tanzania_NPS_W2_gender_productivity_gap.dta", replace
...
global final_data_household  "${TZA_W2_final_data}/Tanzania_NPS_W2_household_variables.dta"  
global final_data_individual "${TZA_W2_final_data}/Tanzania_NPS_W2_individual_variables.dta"
global final_data_plot       "${TZA_W2_final_data}\Tanzania_NPS_W2_gender_productivity_gap.dta"
global final_outputfile      "${TZA_W2_final_data}\Tanzania_NPS_W2_summary_stats_`c(current_date)'.xlsx"
...
*/ cost_per_lit_milk* sales_livestock_products value_livestock_products value_assets value_livestock_sales costs_dairy costs_dairy_percow /*
*/ $topcrop_monetary 
