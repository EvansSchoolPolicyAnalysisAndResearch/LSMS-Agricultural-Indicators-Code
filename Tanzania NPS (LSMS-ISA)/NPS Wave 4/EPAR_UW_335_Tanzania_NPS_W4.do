...
*-------------------------------------------------------------------------------------
*HOUSEHOLD IDS						Tanzania_NPS_W4_hhids.dta
*INDIVIDUAL IDS						Tanzania_NPS_W4_person_ids.dta
*HOUSEHOLD SIZE						Tanzania_NPS_W4_hhsize.dta
*PLOT AREAS							Tanzania_NPS_W4_plot_areas.dta
*PLOT-CROP DECISION MAKERS			Tanzania_NPS_W4_plot_decision_makers.dta

*MONOCROPPED PLOTS					Tanzania_NPS_W4_[CROP]_monocrop_hh_area.dta
									
*TLU (Tropical Livestock Units)		Tanzania_NPS_W4_TLU_Coefficients.dta

*GROSS CROP REVENUE					Tanzania_NPS_W4_tempcrop_harvest.dta
									Tanzania_NPS_W4_tempcrop_sales.dta
									Tanzania_NPS_W4_permcrop_harvest.dta
									Tanzania_NPS_W4_permcrop_sales.dta
									Tanzania_NPS_W4_hh_crop_production.dta
									Tanzania_NPS_W4_plot_cropvalue.dta
									Tanzania_NPS_W4_crop_residues.dta
									Tanzania_NPS_W4_hh_crop_prices.dta
									Tanzania_NPS_W4_crop_losses.dta

*CROP EXPENSES						Tanzania_NPS_W4_wages_mainseason.dta
									Tanzania_NPS_W4_wages_shortseason.dta
									Tanzania_NPS_W4_fertilizer_costs.dta
									Tanzania_NPS_W4_seed_costs.dta
									Tanzania_NPS_W4_land_rental_costs.dta
									Tanzania_NPS_W4_asset_rental_costs.dta
									Tanzania_NPS_W4_transportation_cropsales.dta
									
*CROP INCOME						Tanzania_NPS_W4_crop_income.dta
									
*LIVESTOCK INCOME					Tanzania_NPS_W4_livestock_expenses.dta
									Tanzania_NPS_W4_hh_livestock_products.dta
									Tanzania_NPS_W4_dung.dta
									Tanzania_NPS_W4_livestock_sales.dta
									Tanzania_NPS_W4_TLU.dta
									Tanzania_NPS_W4_livestock_income.dta

*FISH INCOME						Tanzania_NPS_W4_fishing_expenses_1.dta
									Tanzania_NPS_W4_fishing_expenses_2.dta
									Tanzania_NPS_W4_fish_income.dta
																	
*SELF-EMPLOYMENT INCOME				Tanzania_NPS_W4_self_employment_income.dta
									Tanzania_NPS_W4_agproducts_profits.dta
									Tanzania_NPS_W4_fish_trading_revenue.dta
									Tanzania_NPS_W4_fish_trading_other_costs.dta
									Tanzania_NPS_W4_fish_trading_income.dta
									
*WAGE INCOME						Tanzania_NPS_W4_wage_income.dta
									Tanzania_NPS_W4_agwage_income.dta

*OTHER INCOME						Tanzania_NPS_W4_other_income.dta
									Tanzania_NPS_W4_land_rental_income.dta
									
*FARM SIZE / LAND SIZE				Tanzania_NPS_W4_land_size.dta
									Tanzania_NPS_W4_farmsize_all_agland.dta
									Tanzania_NPS_W4_land_size_all.dta
									Tanzania_NPS_W4_land_size_total.dta

*OFF-FARM HOURS						Tanzania_NPS_W4_off_farm_hours.dta

*FARM LABOR							Tanzania_NPS_W4_farmlabor_mainseason.dta
									Tanzania_NPS_W4_farmlabor_shortseason.dta
									Tanzania_NPS_W4_family_hired_labor.dta
									
*VACCINE USAGE						Tanzania_NPS_W4_vaccine.dta
									Tanzania_NPS_W4_farmer_vaccine.dta
									
*ANIMAL HEALTH						Tanzania_NPS_W4_livestock_diseases.dta
									Tanzania_NPS_W4_livestock_feed_water_house.dta

*USE OF INORGANIC FERTILIZER		Tanzania_NPS_W4_fert_use.dta
									Tanzania_NPS_W4_farmer_fert_use.dta

*USE OF IMPROVED SEED				Tanzania_NPS_W4_improvedseed_use.dta
									Tanzania_NPS_W4_farmer_improvedseed_use.dta

*REACHED BY AG EXTENSION			Tanzania_NPS_W4_any_ext.dta
*USE OF FORMAL FINANACIAL SERVICES	Tanzania_NPS_W4_fin_serv.dta
*MILK PRODUCTIVITY					Tanzania_NPS_W4_milk_animals.dta
*EGG PRODUCTIVITY					Tanzania_NPS_W4_eggs_animals.dta

*CROP PRODUCTION COSTS PER HECTARE	Tanzania_NPS_W4_hh_rental_rate.dta
									Tanzania_NPS_W4_hh_cost_land.dta
									Tanzania_NPS_W4_hh_cost_inputs_lrs.dta
									Tanzania_NPS_W4_hh_cost_inputs_srs.dta
									Tanzania_NPS_W4_hh_cost_seed_lrs.dta
									Tanzania_NPS_W4_hh_cost_seed_srs.dta
									Tanzania_NPS_W4_asset_rental_costs.dta
									Tanzania_NPS_W4_cropcosts_total.dta
									
*AGRICULTURAL WAGES					Tanzania_NPS_W4_ag_wage.dta

*RATE OF FERTILIZER APPLICATION		Tanzania_NPS_W4_fertilizer_application.dta
*HOUSEHOLD'S DIET DIVERSITY SCORE	Tanzania_NPS_W4_household_diet.dta

*WOMEN'S CONTROL OVER INCOME		Tanzania_NPS_W4_control_income.dta
*WOMEN'S AG DECISION-MAKING			Tanzania_NPS_W4_make_ag_decision.dta
*WOMEN'S ASSET OWNERSHIP			Tanzania_NPS_W4_ownasset.dta

*CROP YIELDS						Tanzania_NPS_W4_yield_hh_crop_level.dta
*SHANNON DIVERSITY INDEX			Tanzania_NPS_W4_shannon_diversity_index.dta
*CONSUMPTION						Tanzania_NPS_W4_consumption.dta
*HOUSEHOLD FOOD PROVISION			Tanzania_NPS_W4_food_insecurity.dta
*HOUSEHOLD ASSETS					Tanzania_NPS_W4_hh_assets.dta
...
*PLOT-LEVEL VARIABLES				Tanzania_NPS_W4_gender_productivity_gap.dta
...
global TZA_W4_created_data 		"$directory\Tanzania NPS\Tanzania NPS Wave 4\Final DTA files\created_data"
global TZA_W4_final_data  		"$directory\Tanzania NPS\Tanzania NPS Wave 4\Final DTA files"


************************
*EXCHANGE RATE AND INFLATION FOR CONVERSION IN SUD IDS
************************
global NPS_LSMS_ISA_W4_exchange_rate 2158			// https://www.bloomberg.com/quote/USDETB:CUR
global NPS_LSMS_ISA_W4_gdp_ppp_dollar 719.023   	// https://data.worldbank.org/indicator/PA.NUS.PPP
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_hhids.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_person_ids.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_hhsize.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_areas.dta", replace
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_gender_merge.dta", replace
...
merge m:1 y4_hhid personid using  "${TZA_W4_created_data}/Tanzania_NPS_W4_gender_merge.dta", gen(dm1_merge) keep(1 3)		// Dropping unmatched from using
...
merge m:1 y4_hhid personid using "${TZA_W4_created_data}/Tanzania_NPS_W4_gender_merge.dta", gen(dm2_merge) keep(1 3)		// Dropping unmatched from using
gen dm2_female = female
drop female personid
*Third
gen personid = ag3a_08_3
replace personid =ag3b_08_3 if personid==. &  ag3b_08_3!=.
merge m:1 y4_hhid personid using "${TZA_W4_created_data}/Tanzania_NPS_W4_gender_merge.dta", gen(dm3_merge) keep(1 3)		// Dropping unmatched from using
...
merge m:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_hhsize.dta", nogen 								
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_decision_makers.dta", replace
...
forvalues k=1(1)$len  {		
	...
	*not sure if we want to include this (perm and fruit crops). We can't calculate an area planted anyways which is the denominator for most of our indicators
	...
	merge m:1 y4_hhid plot_id using "${TZA_W4_created_data}/Tanzania_NPS_W4_plot_areas.dta", nogen assert(2 3) keep(3)
	...
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_`cn'_monocrop.dta", replace
}
...
forvalues k=1(1)$len  {		
	local c : word `k' of $topcrop_area
	local cn : word `k' of $topcropname_area
	use "${TZA_W4_created_data}/Tanzania_NPS_W4_`cn'_monocrop.dta", clear
	merge m:1 y4_hhid plot_id using "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_decision_makers.dta"
	...
	*And now this code will indicate whether the HOUSEHOLD has at least one of these plots and the total area of monocropped maize plots
	...
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_`cn'_monocrop_hh_area.dta", replace
}
...
drop if y4_hhid==""
save "${TZA_W4_created_data}\Tanzania_NPS_W4_TLU_Coefficients.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_tempcrop_harvest.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_tempcrop_sales.dta", replace
...
lab var kgs_harvest "Kgs harvested of this crop, summed over main and short season"
save "${TZA_W4_created_data}\Tanzania_NPS_W4_permcrop_harvest.dta", replace
...
gen price_kg = value_sold / quantity_sold
lab var price_kg "Price per kg sold"
save "${TZA_W4_created_data}\Tanzania_NPS_W4_permcrop_sales.dta", replace

*Prices of permanent and tree crops need to be imputed from sales.
use "${TZA_W4_created_data}\Tanzania_NPS_W4_permcrop_sales.dta", clear
append using "${TZA_W4_created_data}\Tanzania_NPS_W4_tempcrop_sales.dta"
recode price_kg (0=.)
merge m:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_hhids.dta"
drop if _merge==2
drop _merge
save "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_sales.dta", replace

use "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_prices_ea.dta", replace
use "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_prices_ward.dta", replace
use "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_prices_district.dta", replace
use "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_prices_region.dta", replace
use "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_prices_country.dta", replace

*Pull prices into harvest estimates
use "${TZA_W4_created_data}\Tanzania_NPS_W4_tempcrop_harvest.dta", clear
append using "${TZA_W4_created_data}\Tanzania_NPS_W4_permcrop_harvest.dta"
merge m:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_hhids.dta", nogen keep(1 3)
merge m:1 y4_hhid crop_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_sales.dta", nogen
merge m:1 region district ward ea crop_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_prices_ea.dta", nogen
merge m:1 region district ward crop_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_prices_ward.dta", nogen
merge m:1 region district crop_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_prices_district.dta", nogen
merge m:1 region crop_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_prices_region.dta", nogen
merge m:1 crop_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_prices_country.dta", nogen
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_values_tempfile.dta", replace 
...
preserve
	...
	save "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_crop_values_production.dta", replace
restore
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_crop_production.dta", replace
 
*Plot value of crop production
use "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_values_tempfile.dta", clear
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_cropvalue.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_residues.dta", replace
...
duplicates drop
save "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_crop_prices.dta", replace
...
merge 1:1 y4_hhid crop_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_crop_values_production.dta"
drop if _merge==2
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_losses.dta", replace
...
preserve
	...
	*Merge in monocropped plots
	merge m:1 y4_hhid plot_id short using "${TZA_W4_created_data}/Tanzania_NPS_W4_`cn'_monocrop.dta", nogen assert(1 3) keep(3)		
	...
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_wages_mainseason_`cn'.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_wages_mainseason.dta", replace
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_wages_shortseason_`cn'.dta", replace
restore
} 
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_wages_shortseason.dta", replace
...
preserve
	...
	merge m:1 y4_hhid indidy4 using "${TZA_W4_created_data}/Tanzania_NPS_W4_person_ids.dta", nogen keep(3)		// keep only matched
...
preserve
	...
	merge m:1 y4_hhid indidy4 using "${TZA_W4_created_data}/Tanzania_NPS_W4_person_ids.dta", nogen keep(3)		// keep only matched (just 2)	
	...
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_land_rights_ind.dta", replace
restore	
...
preserve
	...
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_land_rights_hh.dta", replace
restore
...
preserve
	...
	*disaggregate by gender plot manager
	merge m:1 y4_hhid plot_id using "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_decision_makers.dta"
	*Merge in monocropped plots
	merge m:1 y4_hhid plot_id short using "${TZA_W4_created_data}/Tanzania_NPS_W4_`cn'_monocrop.dta", nogen assert(1 3) keep(3)		// only in master and matched; keeping only matched, because these are the maize monocropped plots
	...
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_fertilizer_costs_`cn'.dta", replace
restore
}
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_fertilizer_costs.dta", replace
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_seed_costs_`cn'.dta", replace
restore
}

collapse (sum) cost_seed, by (y4_hhid)
lab var cost_seed "Expenditures on seed for temporary crops"
save "${TZA_W4_created_data}\Tanzania_NPS_W4_seed_costs.dta", replace
...
preserve
	...
	*disaggregate by gender of plot manager
	merge m:1 y4_hhid plot_id using "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_decision_makers.dta"
	*Merge in monocropped plots
	merge 1:1 y4_hhid plot_id short using "${TZA_W4_created_data}/Tanzania_NPS_W4_`cn'_monocrop.dta", nogen assert(1 3) keep(3)		// only in master and matched; keeping only matched, because these are the maize monocropped plots	
	...
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_land_rental_costs_`cn'.dta", replace
restore
}

collapse (sum) rental_cost_land, by (y4_hhid)
lab var rental_cost_land "Rental costs paid for land"
save "${TZA_W4_created_data}\Tanzania_NPS_W4_land_rental_costs.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_asset_rental_costs.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_transportation_cropsales.dta", replace


*Crop costs 
use "${TZA_W4_created_data}\Tanzania_NPS_W4_asset_rental_costs.dta", clear
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_land_rental_costs.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_seed_costs.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_fertilizer_costs.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_wages_shortseason.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_wages_mainseason.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_transportation_cropsales.dta",nogen
...
save "$TZA_W4_created_data\Tanzania_NPS_W4_crop_income.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_lrum_expenses", replace
restore 
...
collapse (firstnm) *lrum *srum *pigs *equine *poultry, by(y4_hhid)
	...
	drop ls_exp_vac
	save "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_expenses_animal", replace
restore 
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_expenses", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products_milk", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products_other", replace

use "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products_milk", clear
append using "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products_other"
recode price_per_unit (0=.)
merge m:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_hhids.dta"
drop if _merge==2
drop _merge
replace price_per_unit = . if price_per_unit == 0 
save "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products", replace

use "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products", clear
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products_prices_ea.dta", replace
use "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products_prices_ward.dta", replace
use "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products_prices_district.dta", replace
use "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products_prices_region.dta", replace
use "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products_prices_country.dta", replace

use "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products", clear
merge m:1 region district ward ea livestock_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products_prices_ea.dta", nogen
merge m:1 region district ward livestock_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products_prices_ward.dta", nogen
merge m:1 region district livestock_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products_prices_district.dta", nogen
merge m:1 region livestock_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products_prices_region.dta", nogen
merge m:1 livestock_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_products_prices_country.dta", nogen
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_livestock_products", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_dung.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_livestock_sales", replace

*Implicit prices
use "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_livestock_sales", clear
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_prices_ea.dta", replace
use "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys region district ward livestock_code: egen obs_ward = count(observation)
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_prices_ward.dta", replace
use "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys region district livestock_code: egen obs_district = count(observation)
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_prices_district.dta", replace
use "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys region livestock_code: egen obs_region = count(observation)
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_prices_region.dta", replace
use "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys livestock_code: egen obs_country = count(observation)
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_prices_country.dta", replace

use "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_livestock_sales", clear
merge m:1 region district ward ea livestock_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_prices_ea.dta", nogen
merge m:1 region district ward livestock_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_prices_ward.dta", nogen
merge m:1 region district livestock_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_prices_district.dta", nogen
merge m:1 region livestock_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_prices_region.dta", nogen
merge m:1 livestock_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_prices_country.dta", nogen
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_sales", replace
...
preserve
	...
	*any improved large ruminants, small ruminants, or poultry
	...
	save "${TZA_W4_created_data}\Tanzania_NPS_W4_herd_characteristics", replace
restore
...
drop if y4_hhid==""
save "${TZA_W4_created_data}\Tanzania_NPS_W4_TLU.dta", replace


*Livestock income
use "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_sales", clear
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_livestock_products", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_dung.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_expenses", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_TLU.dta", nogen
...
save "$TZA_W4_created_data\Tanzania_NPS_W4_livestock_income", replace
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_weeks_fishing.dta", replace
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_fishing_expenses_1.dta", replace

use "${TZA_W4_raw_data}\Livestock and Fisheries\lf_sec_11b.dta", clear
merge m:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_weeks_fishing.dta"
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_fishing_expenses_2.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_fish_prices.dta", replace
...
merge m:1 fish_code unit using "${TZA_W4_created_data}\Tanzania_NPS_W4_fish_prices.dta"
drop if _merge==2
drop _merge
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_fish_income.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_self_employment_income.dta", replace
...
merge m:1 y4_hhid crop_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_crop_prices.dta"
drop _merge
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_agproducts_profits.dta", replace
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_weeks_fish_trading.dta", replace
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_fish_trading_revenue.dta", replace
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_fish_trading_other_costs.dta", replace

use "${TZA_W4_created_data}/Tanzania_NPS_W4_weeks_fish_trading.dta", clear
merge 1:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_fish_trading_revenue.dta" 
drop _merge
merge 1:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_fish_trading_other_costs.dta"
drop _merge
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_fish_trading_income.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_wage_income.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_agwage_income.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_other_income.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_land_rental_income.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_crops_grown.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_parcels_cultivated.dta", replace

use "${TZA_W4_created_data}\Tanzania_NPS_W4_parcels_cultivated.dta", clear
merge 1:1 y4_hhid plot_id using "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_areas.dta"
drop if _merge==2
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_land_size.dta", replace
...
rename plotnum plot_id
drop if plot_id==""
merge m:1 y4_hhid plot_id using "${TZA_W4_created_data}\Tanzania_NPS_W4_crops_grown.dta", nogen
*6,862 matched
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_parcels_agland.dta", replace

use "${TZA_W4_created_data}\Tanzania_NPS_W4_parcels_agland.dta", clear
merge 1:1 y4_hhid plot_id using "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_areas.dta"
drop if _merge==2
replace area_acres_meas=. if area_acres_meas<0
replace area_acres_meas = area_acres_est if area_acres_meas==. 
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_farmsize_all_agland.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_parcels_held.dta", replace

use "${TZA_W4_created_data}\Tanzania_NPS_W4_parcels_held.dta", clear
merge 1:1 y4_hhid plot_id using "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_areas.dta"
drop if _merge==2
replace area_acres_meas=. if area_acres_meas<0
replace area_acres_meas = area_acres_est if area_acres_meas==. 
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_land_size_all.dta", replace
...
rename plotnum plot_id
drop if plot_id==""
merge m:1 y4_hhid plot_id using "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_areas.dta", nogen keep(1 3)
replace area_acres_meas=. if area_acres_meas<0
replace area_acres_meas = area_acres_est if area_acres_meas==. 
replace area_acres_meas = area_acres_est if area_acres_meas==0 & (area_acres_est>0 & area_acres_est!=.)	
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_land_size_total.dta", replace
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_off_farm_hours.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_farmlabor_mainseason.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_farmlabor_shortseason.dta", replace


*Hired Labor
use "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_farmlabor_mainseason.dta", clear
merge 1:1 y4_hhid plot_id using "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_farmlabor_shortseason.dta"
drop _merge
recode days*  (.=0)
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_family_hired_labor.dta", replace
collapse (sum) labor_*, by(y4_hhid)
lab var labor_total "Total labor days (family, hired, or other) allocated to the farm"
lab var labor_hired "Total labor days (hired) allocated to the farm"
lab var labor_family "Total labor days (family) allocated to the farm"
lab var labor_total "Total labor days allocated to the farm" 
save "${TZA_W4_created_data}\Tanzania_NPS_W4_family_hired_labor.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_vaccine.dta", replace
...
drop if personid==.
merge 1:1 y4_hhid personid using "${TZA_W4_created_data}\Tanzania_NPS_W4_gender_merge.dta", nogen
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_farmer_vaccine.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_diseases.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_feed_water_house.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_fert_use.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_farmer_fert_use.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_improvedseed_use.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_farmer_improvedseed_use_temp.dta", replace

*Use of seed by crop
forvalues k=1/15 {
	use "${TZA_W4_created_data}\Tanzania_NPS_W4_farmer_improvedseed_use_temp.dta", clear
	local c : word `k' of $topcrop_area
	local cn : word `k' of $topcropname_area
	...
	*We also need a variable that indicates if farmer (plot manager) grows crop
	...
	save "${TZA_W4_created_data}\Tanzania_NPS_W4_farmer_improvedseed_use_temp_`cn'.dta", replace
}

*Combining all crop disaggregated files together
foreach v in $topcropname_area {
	merge 1:1 y4_hhid farmerid all_imprv_seed_use using "${TZA_W4_created_data}\Tanzania_NPS_W4_farmer_improvedseed_use_temp_`v'.dta", nogen
}
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_farmer_improvedseed_use.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_any_ext.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_fin_serv.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_milk_animals.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_eggs_animals.dta", replace
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_plot_area_lrs.dta", replace
*Getting plot rental rate
use "${TZA_W4_raw_data}/Agriculture/ag_sec_3a.dta", clear
ren plotnum plot_id
merge 1:1 plot_id y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_plot_area_lrs.dta" , nogen		
drop if plot_id==""
gen cultivated = ag3a_03==1
merge m:1 y4_hhid plot_id using  "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_decision_makers.dta", nogen keep (1 3)
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_rent_nomiss_lrs.dta", replace					
...
preserve
	...
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_rental_rate_lrs.dta", replace
restore
...
preserve
	...
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_rental_rate_hhid_lrs.dta", replace
restore
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_rental_rate_lrs.dta", replace
...
keep plot_ha plotnum y4_hhid
ren plotnum plot_id
save "${TZA_W4_created_data}/Tanzania_NPS_W4_plot_area_srs.dta", replace
*Getting plot rental rate
use "${TZA_W4_raw_data}/Agriculture/ag_sec_3b.dta", clear
drop if plotnum==""
gen cultivated = ag3b_03==1
ren  plotnum plot_id
merge m:1 y4_hhid plot_id using  "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_decision_makers.dta", nogen 
merge 1:1 plot_id y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_plot_area_lrs.dta", nogen					
merge 1:1 plot_id y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_plot_area_srs.dta", nogen update replace		
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_rent_nomiss_srs.dta", replace
preserve
	gen value_rented_land_male = plot_rental_rate if dm_gender==1
	gen value_rented_land_female = plot_rental_rate if dm_gender==2
	gen value_rented_land_mixed = plot_rental_rate if dm_gender==3
	...
	lab var value_rented_land_mixed "Value of rented land (mixed-managed plot)	
	collapse (sum) value_rented_land_* value_rented_land = plot_rental_rate, by(y4_hhid)
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_rental_rate_srs.dta", replace
restore
gen ha_rental_rate_hh = plot_rental_rate/plot_ha
preserve
	keep if plot_rental_rate!=. & plot_rental_rate!=0			
	...
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_rental_rate_hhid_srs.dta", replace
restore
*Merging in geographic variables
merge m:1 y4_hhid using "${TZA_W4_raw_data}/Household/hh_sec_a.dta", nogen assert(2 3) keep(3)		
*Geographic medians
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_rental_rate_srs.dta", replace


*Now getting total ha of all plots that were cultivated at least once
use "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_rent_nomiss_lrs.dta", clear
append using "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_rent_nomiss_srs.dta"
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_cultivated_plots_ha.dta", replace

use "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_rental_rate_lrs.dta", clear
append using "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_rental_rate_srs.dta"
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_rental_rate.dta", replace
...
drop if plotnum==""
ren  plotnum plot_id
merge m:1 y4_hhid plot_id using "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_rent_nomiss_lrs.dta", nogen keep(1 3)
*First rescaling
...
merge m:1 plot_id y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_plot_area_lrs", nogen assert(2 3) keep(3)			
...
merge m:1 hh_a01_1 hh_a02_1 hh_a03_1 hh_a03_3a using "${TZA_W4_created_data}/Tanzania_NPS_W4_rental_rate_lrs", nogen assert(2 3) keep(3)			
*Now merging in rental costs of individual plots
merge m:1 y4_hhid plot_id using "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_rent_nomiss_lrs.dta", nogen keep(1 3)
*Now merging in household rental rate
merge m:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_rental_rate_hhid_lrs.dta", nogen keep(1 3)
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_cost_land_lrs.dta", replace
...
drop if plotnum==""
ren plotnum plot_id 
merge m:1 y4_hhid plot_id using "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_rent_nomiss_lrs.dta", nogen keep(1 3) keepusing(dm_gender)
merge m:1 y4_hhid plot_id using "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_rent_nomiss_srs.dta", nogen keep(1 3) keepusing(dm_gender) update
*First rescaling
...
merge m:1 plot_id y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_plot_area_lrs", nogen keep(1 3) keepusing(plot_ha)						
merge m:1 plot_id y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_plot_area_srs", nogen keepusing(plot_ha) update							
gen ha_planted = percent_plot*plot_ha
gen ha_planted_male = ha_planted if dm_gender==1
gen ha_planted_female = ha_planted if dm_gender==2
gen ha_planted_mixed = ha_planted if dm_gender==3
...
*Now merging in household rental rate
merge m:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_rental_rate_hhid_lrs.dta", nogen keep(1 3)		
merge m:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_rental_rate_hhid_srs.dta", nogen	update			
gen value_owned_land = ha_planted*ha_rental_rate if ag3a_33==0 | ag3a_33==.		
replace value_owned_land = ha_planted*ha_rental_hh_lrs if ha_rental_hh_lrs!=0 & ha_rental_hh_lrs!=. & (ag3a_33==0 | ag3a_33==.)		
*Now creating gender value
gen value_owned_land_male = ha_planted*ha_rental_rate if (ag3a_33==0 | ag3a_33==.) & dm_gender==1
...
append using "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_cost_land_lrs.dta"						

preserve
	collapse (sum) ha_planted*, by(y4_hhid)
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_ha_planted_total.dta", replace
restore
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_cost_land.dta", replace
...
preserve
	...
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_fert_lrs.dta", replace
restore
...
preserve
	...
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_org_fert_lrs.dta", replace
restore
merge m:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_org_fert_lrs.dta", nogen
...
preserve
	...
	recode *wage* (0=.)			
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_wages_hh_lrs.dta", replace
restore
*Merging right back in
merge m:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_wages_hh_lrs.dta", nogen
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_cost_inputs_lrs.dta", replace
...
preserve
	...
	gen fert_inorg_kg_mixed = fert_inorg_kg if dm_gender==3
	collapse (sum) fert_org_kg fert_inorg_kg*, by(y4_hhid)
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_fert_srs.dta", replace
restore
...
preserve
	...
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_org_fert_srs.dta", replace
restore
merge m:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_org_fert_srs.dta", nogen
...
preserve
	...
	gen harv_wage_hh = harv_labor_costs/harv_labor
	recode *wage* (0=.)
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_wages_hh_srs.dta", replace
restore

merge m:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_wages_hh_srs.dta", nogen
...
collapse (sum) value_*, by(y4_hhid)
save "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_cost_inputs_srs.dta", replace

use  "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_cost_inputs_lrs.dta", clear
append using  "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_cost_inputs_srs.dta"
collapse (sum) value_*, by(y4_hhid)
...
preserve
	...
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_seeds_hh_lrs.dta", replace
restore
merge m:1 y4_hhid zaocode using "${TZA_W4_created_data}/Tanzania_NPS_W4_seeds_hh_lrs.dta", nogen
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_cost_seed_lrs.dta", replace
...
preserve
	...
	save "${TZA_W4_created_data}/Tanzania_NPS_W4_seeds_hh_srs.dta", replace
restore
merge m:1 y4_hhid zaocode using "${TZA_W4_created_data}/Tanzania_NPS_W4_seeds_hh_srs.dta", nogen
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_cost_seed_srs.dta", replace
...
use "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_cost_land.dta", clear
append using "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_rental_rate.dta"
append using "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_cost_inputs_lrs.dta"
append using "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_cost_inputs_srs.dta"
append using "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_cost_seed_lrs.dta"
append using "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_cost_seed_srs.dta"
append using "${TZA_W4_created_data}/Tanzania_NPS_W4_asset_rental_costs.dta"
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_cropcosts_total.dta", replace
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_ag_wage.dta", replace
...
************
use "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_cost_land.dta", clear
append using "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_fert_lrs.dta"
append using "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_fert_srs.dta"
collapse (sum) ha_planted* fert_org_kg* fert_inorg_kg*, by(y4_hhid)
merge m:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_hhids.dta", keep (1 3) nogen
drop ha_planted*
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_fertilizer_application.dta", replace
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_household_diet.dta", replace
...
merge 1:1 y4_hhid indidy4  using  "${TZA_W4_created_data}\Tanzania_NPS_W4_person_ids.dta", nogen 
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_control_income.dta", replace
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_make_ag_decision.dta", replace
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_ownasset.dta", replace
...
merge m:1 y4_hhid plot_id using "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_areas.dta" , nogen keep(1 3)  
merge m:1 y4_hhid plot_id using "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_decision_makers" , nogen keep(1 3)
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_plot_crop_area.dta", replace
...
merge m:1 y4_hhid plot_id zaocode using "${TZA_W4_created_data}/Tanzania_NPS_W4_plot_crop_area.dta", nogen /*keep(1 3)*/ // we still want to keep those that report an area planted but no harvest		

//Add production of permanent crops (cassava and banana)
preserve
use "${TZA_W4_raw_data}/Agriculture/ag_sec_6b.dta", clear
append using "${TZA_W4_raw_data}/Agriculture/ag_sec_6a.dta"		// include fruit crops 
...
//Oversize Plots
generate oversize_plot = total_area_mono_hv > field_area & total_area_mono_hv!=. 	
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_crop_area_plan_LRS.dta", replace
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_area_planted_harvested_allcrops_LRS.dta", replace
restore

keep if inlist(zaocode, $comma_topcrop_area)
save "${TZA_W4_created_data}/Tanzania_NPS_W4_crop_harvest_area_yield_LRS.dta", replace
...
replace intercropped_yn =0 if ag4b_04 == 2 
gen mono_field = percent_field if intercropped_yn==0 //not intercropped 
gen int_field = percent_field if intercropped_yn==1 
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_plot_crop_area_SRS.dta", replace
...
ren plotnum plot_id 
*Merging decision maker and intercropping variables
merge m:1 y4_hhid plot_id zaocode using "${TZA_W4_created_data}/Tanzania_NPS_W4_plot_crop_area_SRS.dta", nogen /*keep(1 3)*/ //we still want to keep those that report an area planted but no harvest			
...
*Saving area planted for Shannon diversity index
save "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_crop_area_plan_SRS.dta", replace
 

preserve
collapse (sum) all_area_harvested=area_harv all_area_planted=area_plan, by(y4_hhid)
replace all_area_harvested=all_area_planted if all_area_harvested>all_area_planted & all_area_harvested!=.
save "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_area_planted_harvested_allcrops_SRS.dta", replace
*Append LRS
append using "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_area_planted_harvested_allcrops_LRS.dta"
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_area_planted_harvested_allcrops.dta", replace
restore
...
keep if inlist(zaocode, $comma_topcrop_area)
gen season="SRS"
save "${TZA_W4_created_data}/Tanzania_NPS_W4_crop_harvest_area_yield_SRS.dta", replace


*Yield at the household level
use "${TZA_W4_created_data}/Tanzania_NPS_W4_crop_harvest_area_yield_LRS.dta", clear
preserve
gen season="LRS"
append using "${TZA_W4_created_data}/Tanzania_NPS_W4_crop_harvest_area_yield_SRS.dta"
...
merge 1:1 y4_hhid crop_code using "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_crop_values_production.dta", nogen keep(1 3)
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_yield_hh_crop_level.dta", replace
...
use "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_crop_area_plan_LRS.dta", clear
append using "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_crop_area_plan_SRS.dta"
//we don't want to count crops that are grown in the SRS and LRS as different.
collapse (sum) area_plan*, by(y4_hhid zaocode)
...
preserve 
	...
	save "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_crop_area_plan_shannon.dta", replace
restore

merge m:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_crop_area_plan_shannon.dta", nogen		//all matched
...
bysort y4_hhid zaocode : gen nvals_tot = _n==1
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_shannon_diversity_index.dta", replace
...
save "${TZA_W4_created_data}/Tanzania_NPS_W4_consumption.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_food_insecurity.dta", replace
...
save "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_assets.dta", replace 
...
************************
global empty_vars ""
use "${TZA_W4_created_data}\Tanzania_NPS_W4_hhids.dta", clear

*Gross crop income 
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_crop_production.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_crop_losses.dta", nogen
recode value_crop_production crop_value_lost (.=0)
*Variables: value_crop_production crop_value_lost

*Crop costs
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_asset_rental_costs.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_land_rental_costs.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_seed_costs.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_fertilizer_costs.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_wages_shortseason.dta", nogen
...
foreach c in $topcropname_area {
	merge 1:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_land_rental_costs_`c'.dta", nogen
	merge 1:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_fertilizer_costs_`c'.dta", nogen
	merge 1:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_`c'_monocrop_hh_area.dta", nogen
}
*top crop costs that are only present in short season
foreach c in $topcropname_short{
	merge 1:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_wages_shortseason_`c'.dta", nogen
}
*costs that only include annual crops (seed costs and mainseason wages)
foreach c in $topcropname_annual {
	merge 1:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_seed_costs_`c'.dta", nogen
	merge 1:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_wages_mainseason_`c'.dta", nogen
}
...
*land rights
merge 1:1 y4_hhid using  "${TZA_W4_created_data}/Tanzania_NPS_W4_land_rights_hh.dta", nogen
la var formal_land_rights_hh "Household has documentation of land rights (at least one plot)"

*Livestock income
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_sales", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_livestock_products", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_dung.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_expenses", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_TLU.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_herd_characteristics", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_TLU_Coefficients.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_expenses_animal.dta", nogen 
...
*Fish income
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_fish_income.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_fishing_expenses_1.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_fishing_expenses_2.dta", nogen
...
*Self-employment income
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_self_employment_income.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_fish_trading_income.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_agproducts_profits.dta", nogen
...
*Wage income
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_wage_income.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_agwage_income.dta", nogen
...
*Off-farm hours
merge 1:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_off_farm_hours.dta", nogen


*Other income
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_other_income.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_land_rental_income.dta", nogen
...
*Farm size
merge 1:1 y4_hhid using  "${TZA_W4_created_data}\Tanzania_NPS_W4_land_size.dta", nogen
merge 1:1 y4_hhid using  "${TZA_W4_created_data}\Tanzania_NPS_W4_land_size_all.dta", nogen
merge 1:1 y4_hhid using  "${TZA_W4_created_data}\Tanzania_NPS_W4_farmsize_all_agland.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_land_size_total.dta", nogen
recode land_size (.=0)
...
*Labor
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_family_hired_labor.dta", nogen
recode   labor_hired labor_family (.=0)
  
*Household size
merge 1:1 y4_hhid using  "${TZA_W4_created_data}\Tanzania_NPS_W4_hhsize.dta", nogen

*Rates of vaccine usage, improved seeds, etc.
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_vaccine.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_fert_use.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_improvedseed_use.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_any_ext.dta", nogen
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_fin_serv.dta", nogen
...
*Milk productivity
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_milk_animals.dta", nogen
...
*Dairy costs 
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_lrum_expenses", nogen
...
*Egg productivity
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_eggs_animals.dta", nogen
...
merge 1:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_cropcosts_total.dta", nogen

*Rate of fertilizer application 
merge 1:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_fertilizer_application.dta", nogen

*Agricultural wage rate
merge 1:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_ag_wage.dta", nogen

*Crop yields 
merge 1:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_yield_hh_crop_level.dta", nogen

*Total area planted and harvested accross all crops, plots, and seasons
merge 1:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_hh_area_planted_harvested_allcrops.dta", nogen

*Household diet
merge 1:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_household_diet.dta", nogen

*Consumption
merge 1:1 y4_hhid using "${TZA_W4_created_data}/Tanzania_NPS_W4_consumption.dta", nogen

*Household assets
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_hh_assets.dta", nogen

*Food insecurity
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_food_insecurity.dta", nogen
gen hhs_little = . 
gen hhs_moderate = . 
gen hhs_severe = . 
gen hhs_total = . 
...
*Livestock health
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_diseases.dta", nogen

*livestock feeding, water, and housing
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_livestock_feed_water_house.dta", nogen
 
*Shannon diversity index
merge 1:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_shannon_diversity_index.dta", nogen
...
gen ccf_loc = (1+$NPS_LSMS_ISA_W4_inflation) 
lab var ccf_loc "currency conversion factor - 2016 $TSH"
gen ccf_usd = (1+$NPS_LSMS_ISA_W4_inflation) / $NPS_LSMS_ISA_W4_exchange_rate 
lab var ccf_usd "currency conversion factor - 2016 $USD"
gen ccf_1ppp = (1+$NPS_LSMS_ISA_W4_inflation) / $NPS_LSMS_ISA_W4_cons_ppp_dollar 
lab var ccf_1ppp "currency conversion factor - 2016 $Private Consumption PPP"
gen ccf_2ppp = (1+$NPS_LSMS_ISA_W4_inflation) / $NPS_LSMS_ISA_W4_gdp_ppp_dollar
...
save "${TZA_W4_final_data}/Tanzania_NPS_W4_household_variables.dta", replace


**************
*INDIVIDUAL-LEVEL VARIABLES
**************
use "${TZA_W4_created_data}\Tanzania_NPS_W4_person_ids.dta", clear
merge m:1 y4_hhid   using "${TZA_W4_created_data}/Tanzania_NPS_W4_household_diet.dta", nogen
merge 1:1 y4_hhid indidy4 using "${TZA_W4_created_data}/Tanzania_NPS_W4_control_income.dta", nogen  keep(1 3)
merge 1:1 y4_hhid indidy4 using "${TZA_W4_created_data}/Tanzania_NPS_W4_make_ag_decision.dta", nogen  keep(1 3)
merge 1:1 y4_hhid indidy4 using "${TZA_W4_created_data}/Tanzania_NPS_W4_ownasset.dta", nogen  keep(1 3)
merge m:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_hhsize.dta", nogen keep (1 3)
merge 1:1 y4_hhid indidy4 using "${TZA_W4_created_data}/Tanzania_NPS_W4_farmer_fert_use.dta", nogen  keep(1 3)
merge 1:1 y4_hhid indidy4 using "${TZA_W4_created_data}/Tanzania_NPS_W4_farmer_improvedseed_use.dta", nogen  keep(1 3)
merge 1:1 y4_hhid indidy4 using "${TZA_W4_created_data}/Tanzania_NPS_W4_farmer_vaccine.dta", nogen  keep(1 3)
merge m:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_hhids.dta", nogen keep (1 3)


*land rights
merge 1:1 y4_hhid indidy4 using "${TZA_W4_created_data}/Tanzania_NPS_W4_land_rights_ind.dta", nogen
...
preserve
use "${TZA_W4_final_data}/Tanzania_NPS_W4_household_variables.dta", clear
keep hhid ag_hh
tempfile ag_hh
save `ag_hh'
restore
...
save "${TZA_W4_final_data}/Tanzania_NPS_W4_individual_variables.dta", replace
...
use "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_cropvalue.dta", clear
merge 1:1 y4_hhid plot_id using "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_areas.dta", keep (1 3) nogen
merge 1:1 y4_hhid plot_id  using  "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_decision_makers.dta", keep (1 3) nogen
merge m:1 y4_hhid using "${TZA_W4_created_data}\Tanzania_NPS_W4_hhids.dta", keep (1 3) nogen
merge 1:1 y4_hhid plot_id using "${TZA_W4_created_data}\Tanzania_NPS_W4_plot_family_hired_labor.dta", keep (1 3) nogen
...
save "${TZA_W4_final_data}\Tanzania_NPS_W4_gender_productivity_gap.dta", replace
...
global final_data_household  "${TZA_W4_final_data}/Tanzania_NPS_W4_household_variables.dta"  
global final_data_individual "${TZA_W4_final_data}/Tanzania_NPS_W4_individual_variables.dta"
global final_data_plot       "${TZA_W4_final_data}\Tanzania_NPS_W4_gender_productivity_gap.dta"
global final_outputfile      "$TZA_W4_final_data\Tanzania_NPS_W4_summary_stats_`c(current_date)'.xlsx"
