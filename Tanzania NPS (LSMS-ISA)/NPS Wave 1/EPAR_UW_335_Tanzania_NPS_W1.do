...
*Date			: This  Version - 10 July 2019
----------------------------------------------------------------------------------------------------------------------------------------------------*/
...
*PLOT-LEVEL VARIABLES				Tanzania_NPS_W1_gender_productivity_gap.dta
...
global TZA_W1_raw_data 	   	 	"$directory\Tanzania NPS\Tanzania NPS Wave 1\Raw DTA Files"
global TZA_W1_created_data  	"$directory\Tanzania NPS\Tanzania NPS Wave 1\Final DTA Files\created_data"
global TZA_W1_final_data  		"$directory\Tanzania NPS\Tanzania NPS Wave 1\Final DTA Files"


************************
*EXCHANGE RATE AND INFLATION FOR CONVERSION IN SUD IDS
************************
global NPS_LSMS_ISA_W1_exchange_rate 2158		  // https://www.bloomberg.com/quote/USDETB:CUR
global NPS_LSMS_ISA_W1_gdp_ppp_dollar 719.02      // https://data.worldbank.org/indicator/PA.NUS.PPP
...
drop sbq2 sbq4 sbq5
save "${TZA_W1_created_data}\Tanzania_NPS_W1_person_ids.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_hhsize.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_areas.dta", replace
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_gender_merge.dta", replace
...
merge m:1 hhid personid using  "${TZA_W1_created_data}/Tanzania_NPS_W1_gender_merge.dta", gen(dm1_merge) keep(1 3)		// Dropping unmatched from using
...
merge m:1 hhid personid using "${TZA_W1_created_data}/Tanzania_NPS_W1_gender_merge.dta", gen(dm2_merge) keep(1 3)		// Dropping unmatched from using
gen dm2_female = female
drop female personid
*Third
gen personid = s3aq6_3
replace personid =s3bq6_3 if personid==. &  s3bq6_3!=.
merge m:1 hhid personid using "${TZA_W1_created_data}/Tanzania_NPS_W1_gender_merge.dta", gen(dm3_merge) keep(1 3)		// Dropping unmatched from using
...
merge m:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_hhsize.dta", nogen 								// all matched
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_decision_makers.dta", replace
...
forvalues k=1(1)$len {
	...
	*/"${TZA_W1_created_data}\Tanzania_NPS_W1_plot_areas.dta", nogen /* 
	*/assert (2 3) keep(3)
	...
	save "${TZA_W1_created_data}\Tanzania_NPS_W1_`cn'_monocrop.dta", /*
	*/replace
}
...
forvalues k=1(1)$len {
	local c : word `k' of $topcrop_area
	local cn: word `k' of $topcropname_area
	use "${TZA_W1_created_data}\Tanzania_NPS_W1_`cn'_monocrop.dta", clear
	merge m:1 hhid plot_id using "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_decision_makers.dta"
	...
	save "${TZA_W1_created_data}\Tanzania_NPS_W1_`cn'_monocrop_hh_area.dta", replace
...
drop if hhid==""
save "${TZA_W1_created_data}\Tanzania_NPS_W1_TLU_Coefficients.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_tempcrop_harvest.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_tempcrop_sales.dta", replace
...
lab var kgs_harvest "Kgs harvested of this crop, summed over main and short season"
save "${TZA_W1_created_data}\Tanzania_NPS_W1_permcrop_harvest.dta", replace
...
gen price_kg = value_sold / quantity_sold
lab var price_kg "Price per kg sold"				
save "${TZA_W1_created_data}\Tanzania_NPS_W1_permcrop_sales.dta", replace

*Prices of permanent and tree crops need to be imputed from sales.				
use "${TZA_W1_created_data}\Tanzania_NPS_W1_permcrop_sales.dta", clear
append using "${TZA_W1_created_data}\Tanzania_NPS_W1_tempcrop_sales.dta"
recode price_kg (0=.)
merge m:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_hhids.dta"
drop if _merge==2
drop _merge
save "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_sales.dta", replace

use "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_prices_ea.dta", replace
use "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_prices_ward.dta", replace
use "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_prices_district.dta", replace
use "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_prices_region.dta", replace
use "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_sales.dta", clear
gen observation = 1
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_prices_country.dta", replace

*Pull prices into harvest estimates
use "${TZA_W1_created_data}\Tanzania_NPS_W1_tempcrop_harvest.dta", clear
append using "${TZA_W1_created_data}\Tanzania_NPS_W1_permcrop_harvest.dta"
merge m:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_hhids.dta", nogen keep(1 3)
merge m:1 hhid crop_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_sales.dta", nogen
merge m:1 region district ward ea crop_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_prices_ea.dta", nogen
merge m:1 region district ward crop_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_prices_ward.dta", nogen
merge m:1 region district crop_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_prices_district.dta", nogen
merge m:1 region crop_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_prices_region.dta", nogen
merge m:1 crop_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_prices_country.dta", nogen
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_values_tempfile.dta", replace 
...
preserve
	...
	save "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_crop_values_production.dta", replace
restore
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_crop_production.dta", replace				

*Plot value of crop production
use "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_values_tempfile.dta", clear
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_cropvalue.dta", replace	
...
duplicates drop
save "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_crop_prices.dta", replace
...
merge 1:1 hhid crop_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_crop_values_production.dta"
drop if _merge==2
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_losses.dta", replace
...
foreach cn in $topcropname_annual {
	preserve
		...
		*Merge in monocropped plots
		merge m:1 hhid plot_id short using "${TZA_W1_created_data}/Tanzania_NPS_W1_`cn'_monocrop.dta", nogen assert(1 3) keep(3)		// only in master and matched; keeping only matched, because these are the maize monocropped plots
		...
		// Save the Data
		save "${TZA_W1_created_data}/Tanzania_NPS_W1_wages_mainseason_`cn'.dta", replace
	restore
}
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_wages_mainseason.dta", replace
...
foreach cn in $topcropname_short {
	preserve
		...
		*Merge in monocropped plots
		merge m:1 hhid plot_id short using "${TZA_W1_created_data}/Tanzania_NPS_W1_`cn'_monocrop.dta", nogen assert(1 3) keep(3)		
		...
		save "${TZA_W1_created_data}/Tanzania_NPS_W1_wages_shortseason_`cn'.dta", replace
	restore
}

collapse (sum) wages_paid_short, by (hhid)
lab var wages_paid_short  "Wages paid for hired labor (crops) in short growing season"
save "${TZA_W1_created_data}\Tanzania_NPS_W1_wages_shortseason.dta", replace
...
preserve
	...
	merge m:1 hhid sbmemno using "${TZA_W1_created_data}/Tanzania_NPS_W1_person_ids.dta", nogen keep(3)		
...
preserve
	...
	save "${TZA_W1_created_data}/Tanzania_NPS_W1_land_rights_ind.dta", replace
restore	
...
preserve
	...
	save "${TZA_W1_created_data}/Tanzania_NPS_W1_land_rights_hh.dta", replace
restore
...
foreach cn in $topcropname_area {
	preserve
		...
		*disaggregate by gender plot manager
		merge m:1 hhid plot_id using "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_decision_makers.dta"
		merge m:1 hhid plot_id short using "${TZA_W1_created_data}/Tanzania_NPS_W1_`cn'_monocrop.dta", nogen assert(1 3) keep(3)		// only in master and matched; keeping only matched, because these are the top crop monocropped plots
		...
		*Merge in monocropped plots
		...
		save "${TZA_W1_created_data}/Tanzania_NPS_W1_fertilizer_costs_`cn'.dta", replace
	restore
}
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_fertilizer_costs.dta", replace
...
foreach cn in $topcropname_annual {
	preserve
		...
		*Merge in monocropped plots
		...
		save "${TZA_W1_created_data}/Tanzania_NPS_W1_seed_costs_`cn'.dta", replace
	restore
}

collapse (sum) cost_seed, by (hhid)
lab var cost_seed "Expenditures on seed for temporary crops"
save "${TZA_W1_created_data}\Tanzania_NPS_W1_seed_costs.dta", replace
...
foreach cn in $topcropname_area {
	preserve
		...
		*disaggregate by gender plot manager
		merge m:1 hhid plot_id using "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_decision_makers.dta"
		*Merge in monocropped plots
		merge 1:1 hhid plot_id short using "${TZA_W1_created_data}/Tanzania_NPS_W1_`cn'_monocrop.dta", nogen assert(1 3) keep(3)		// only in master and matched; keeping only matched, because these are the top crop monocropped plots
		...
		save "${TZA_W1_created_data}/Tanzania_NPS_W1_land_rental_costs_`cn'.dta", replace
	restore
}
collapse (sum) rental_cost_land, by (hhid)
lab var rental_cost_land "Rental costs paid for land"
save "${TZA_W1_created_data}\Tanzania_NPS_W1_land_rental_costs.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_asset_rental_costs.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_transportation_cropsales.dta", replace


*Crop costs 
use "${TZA_W1_created_data}\Tanzania_NPS_W1_asset_rental_costs.dta", clear
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_land_rental_costs.dta", nogen
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_seed_costs.dta", nogen
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_fertilizer_costs.dta", nogen
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_wages_shortseason.dta", nogen
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_wages_mainseason.dta", nogen
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_transportation_cropsales.dta", nogen
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_income.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_expenses", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products_other", replace

use "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products_other"
merge m:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_hhids.dta"
drop if _merge==2
drop _merge
replace price_per_unit = . if price_per_unit == 0 
save "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products", replace

use "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products", clear
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products_prices_ea.dta", replace
use "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products_prices_ward.dta", replace
use "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products_prices_district.dta", replace
use "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products_prices_region.dta", replace
use "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products_prices_country.dta", replace

use "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products", clear
merge m:1 region district ward ea livestock_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products_prices_ea.dta", nogen
merge m:1 region district ward livestock_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products_prices_ward.dta", nogen
merge m:1 region district livestock_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products_prices_district.dta", nogen
merge m:1 region livestock_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products_prices_region.dta", nogen
merge m:1 livestock_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_products_prices_country.dta", nogen
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_livestock_products", replace 		
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_livestock_sales", replace

*Implicit prices
use "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_livestock_sales", clear
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_prices_ea.dta", replace
use "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys region district ward livestock_code: egen obs_ward = count(observation)
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_prices_ward.dta", replace
use "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys region district livestock_code: egen obs_district = count(observation)
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_prices_district.dta", replace
use "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys region livestock_code: egen obs_region = count(observation)
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_prices_region.dta", replace
use "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys livestock_code: egen obs_country = count(observation)
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_prices_country.dta", replace

use "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_livestock_sales", clear
merge m:1 region district ward ea livestock_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_prices_ea.dta", nogen
merge m:1 region district ward livestock_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_prices_ward.dta", nogen
merge m:1 region district livestock_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_prices_district.dta", nogen
merge m:1 region livestock_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_prices_region.dta", nogen
merge m:1 livestock_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_prices_country.dta", nogen
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_sales", replace
...
preserve
	...
	*any improved large ruminants, small ruminants, or poultry
	...
	save "${TZA_W1_created_data}\Tanzania_NPS_W1_herd_characteristics", replace
restore
...
drop if hhid==""
save "${TZA_W1_created_data}\Tanzania_NPS_W1_TLU.dta", replace


*Livestock income
use "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_sales", clear
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_livestock_products", nogen
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_expenses", nogen
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_TLU.dta", nogen
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_TLU_Coefficients.dta", nogen
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_income", replace
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_fishing_expenses_1.dta", replace
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_fishing_expenses_2.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_fish_prices.dta", replace
...
rename s12q15 earnings_perday
merge m:1 itemcode using "${TZA_W1_created_data}\Tanzania_NPS_W1_fish_prices.dta"
drop if _merge==2
drop _merge
gen price_per_kg = earnings_perday/kgs_sold_perday
recode price_per_kg (0=.) 
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_fish_income.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_self_employment_income.dta", replace				
...
merge m:1 hhid crop_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_crop_prices.dta"
drop _merge
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_agproducts_profits.dta", replace
...
*/
global TZA_W2_raw_data 	    "\\netid.washington.edu\wfs\EvansEPAR\Project\EPAR\Working Files\335 - Ag Team Data Support\Waves\Tanzania NPS\Tanzania NPS Wave 2\Raw DTA Files"
global TZA_W2_created_data  "\\netid.washington.edu\wfs\EvansEPAR\Project\EPAR\Working Files\335 - Ag Team Data Support\Waves\Tanzania NPS\Tanzania NPS Wave 2\Final DTA Files\created_data"
global TZA_W2_final_data  	"\\netid.washington.edu\wfs\EvansEPAR\Project\EPAR\Working Files\335 - Ag Team Data Support\Waves\Tanzania NPS\Tanzania NPS Wave 2\Final DTA Files"
  

use   "${TZA_W2_raw_data}\Household\HH_SEC_E1.dta", clear
merge m:1 y2_hhid using  "${TZA_W2_raw_data}\Household\HH_SEC_A.dta"
...
sort urbrur2 industry
save "${TZA_W1_created_data}\Tanzania_NPS_W1_wage_hours_imputation_urban.dta", replace
restore
sort industry
collapse (median) weeks, by(industry)
sort industry
save "${TZA_W1_created_data}\Tanzania_NPS_W1_wage_hours_imputation.dta", replace


//Use Wave 1 income
use "${TZA_W1_raw_data}\Household\SEC_B_C_D_E1_F_G1_U.dta", clear
merge m:1 hhid using "${TZA_W1_raw_data}\Household\SEC_A_T.dta"
drop _m
...
sort urbrur2 industry
merge m:1 urbrur2 industry using "${TZA_W1_created_data}\Tanzania_NPS_W1_wage_hours_imputation_urban.dta"
drop if _m==2
drop _m
ren weeks weeks_urban

sort industry
merge m:1 industry using "${TZA_W1_created_data}\Tanzania_NPS_W1_wage_hours_imputation.dta"
tab _m
drop if _m==2
drop _m
...
//Wage Income
rename seq18_1 most_recent_payment
replace most_recent_payment = . if industry == 1 // We do not want agriculture in this category
rename seq18_2 payment_period
rename seq21_1 most_recent_payment_other
rename seq21_2 payment_period_other
rename seq19 wage_hours_week
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_wage_income.dta", replace
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_agwage_income.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_other_income.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_land_rental_income.dta", replace

*Other income
use "${TZA_W1_created_data}\Tanzania_NPS_W1_other_income.dta", clear
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_land_rental_income.dta"
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_crops_grown.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_parcels_cultivated.dta", replace

use "${TZA_W1_created_data}\Tanzania_NPS_W1_parcels_cultivated.dta", clear
merge 1:1 hhid plot_id using "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_areas.dta"
drop if _merge==2
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_land_size.dta", replace
...
rename plotnum plot_id
drop if plot_id==""
merge m:1 hhid plot_id using "${TZA_W1_created_data}\Tanzania_NPS_W1_crops_grown.dta", nogen
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_parcels_agland.dta", replace

use "${TZA_W1_created_data}\Tanzania_NPS_W1_parcels_agland.dta", clear
merge 1:1 hhid plot_id using "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_areas.dta"
drop if _merge == 2
replace area_acres_meas=. if area_acres_meas<0
replace area_acres_meas = area_acres_est if area_acres_meas==. 
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_farmsize_all_agland.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_parcels_held.dta", replace

use "${TZA_W1_created_data}\Tanzania_NPS_W1_parcels_held.dta", clear
merge 1:1 hhid plot_id using "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_areas.dta"
drop if _merge==2
replace area_acres_meas=. if area_acres_meas<0
replace area_acres_meas = area_acres_est if area_acres_meas==. 
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_land_size_all.dta", replace
...
rename plotnum plot_id
drop if plot_id==""
merge m:1 hhid plot_id using "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_areas.dta", nogen keep(1 3)
replace area_acres_meas=. if area_acres_meas<0
replace area_acres_meas = area_acres_est if area_acres_meas==. 
replace area_acres_meas = area_acres_est if area_acres_meas==0 & (area_acres_est>0 & area_acres_est!=.)		
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_land_size_total.dta", replace
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_off_farm_hours.dta", replace
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_plot_farmlabor_mainseason.dta", replace
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_plot_farmlabor_shortseason.dta", replace


*Labor
use "${TZA_W1_created_data}/Tanzania_NPS_W1_plot_farmlabor_mainseason.dta", clear
merge 1:1 hhid plot_id using "${TZA_W1_created_data}/Tanzania_NPS_W1_plot_farmlabor_shortseason.dta"
drop _merge
recode days*  (.=0)
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_family_hired_labor.dta", replace
collapse (sum) labor_*, by(hhid)
lab var labor_total "Total labor days (family, hired, or other) allocated to the farm"
lab var labor_hired "Total labor days (hired) allocated to the farm"
lab var labor_family "Total labor days (family) allocated to the farm"
lab var labor_total "Total labor days (hired +family) allocated to the farm" 
save "${TZA_W1_created_data}\Tanzania_NPS_W1_family_hired_labor.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_vaccine.dta", replace
...
drop if personid==.
merge 1:1 hhid personid using "${TZA_W1_created_data}\Tanzania_NPS_W1_gender_merge.dta", nogen
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_farmer_vaccine.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_diseases.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_fert_use.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_farmer_fert_use.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_improvedseed_use.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_farmer_improvedseed_use_temp.dta", replace
*adoption of improved top crop seeds
forvalues k=1/15 {
	use "${TZA_W1_created_data}\Tanzania_NPS_W1_farmer_improvedseed_use_temp.dta", clear
	...
	save "${TZA_W1_created_data}\Tanzania_NPS_W1_farmer_improvedseed_use_temp_`cn'.dta", replace
}

// Combining all crip disaggregated files together.
foreach v in $topcropname_area {
	merge 1:1 hhid farmerid all_imprv_seed_use using "${TZA_W1_created_data}\Tanzania_NPS_W1_farmer_improvedseed_use_temp_`v'.dta", nogen
}
...
recode farm_manager (.=0)
lab var farm_manager "1=Indvidual is listed as a manager for at least one plot" 
save "${TZA_W1_created_data}\Tanzania_NPS_W1_farmer_improvedseed_use.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_any_ext.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_fin_serv.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_milk_animals.dta", replace
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_eggs_animals.dta", replace
...
ren plotnum plot_id
save "${TZA_W1_created_data}/Tanzania_NPS_W1_plot_area_lrs.dta", replace
*Getting plot rental rate
use "${TZA_W1_raw_data}/Agriculture/SEC_3A.dta", clear
ren plotnum plot_id
merge 1:1 plot_id hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_plot_area_lrs.dta" , nogen		
drop if plot_id==""
gen cultivated = s3aq3==1
merge m:1 hhid plot_id using  "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_decision_makers.dta", nogen keep (1 3)
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_rent_nomiss_lrs.dta", replace				
...
preserve
	...
	save "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_rental_rate_lrs.dta", replace
restore
...
preserve
	...
	save "${TZA_W1_created_data}/Tanzania_NPS_W1_rental_rate_hhid_lrs.dta", replace
restore
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_rental_rate_lrs.dta", replace
...
keep plot_ha plotnum hhid
ren plotnum plot_id
save "${TZA_W1_created_data}/Tanzania_NPS_W1_plot_area_srs.dta", replace
*Getting plot rental rate
use "${TZA_W1_raw_data}/Agriculture/SEC_3B.dta", clear
drop if plotnum==""
gen cultivated = s3bq3==1
ren  plotnum plot_id
merge m:1 hhid plot_id using  "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_decision_makers.dta", nogen 
merge 1:1 plot_id hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_plot_area_lrs.dta", nogen					
merge 1:1 plot_id hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_plot_area_srs.dta", nogen update replace		
*Total rent - rescaling to a YEARLY value
...
recode plot_rental_rate (0=.)
save "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_rent_nomiss_srs.dta", replace
preserve
	gen value_rented_land_male = plot_rental_rate if dm_gender==1
	gen value_rented_land_female = plot_rental_rate if dm_gender==2
	gen value_rented_land_mixed = plot_rental_rate if dm_gender==3
	collapse (sum) value_rented_land_* value_rented_land = plot_rental_rate, by(hhid)
	save "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_rental_rate_srs.dta", replace
restore
gen ha_rental_rate_hh = plot_rental_rate/plot_ha
recode ha_rental_rate_hh (0=.) 
preserve
	...
	save "${TZA_W1_created_data}/Tanzania_NPS_W1_rental_rate_hhid_srs.dta", replace
restore
*Merging in geographic variables
merge m:1 hhid using "${TZA_W1_raw_data}/Household/SEC_A_T.dta", nogen assert(2 3) keep(3)	
*Geographic medians
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_rental_rate_srs.dta", replace


*Now getting total ha of all plots that were cultivated at least once
use "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_rent_nomiss_lrs.dta", clear
append using "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_rent_nomiss_srs.dta"
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_cultivated_plots_ha.dta", replace

use "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_rental_rate_lrs.dta", clear
append using "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_rental_rate_srs.dta"
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_rental_rate.dta", replace
...
drop if plotnum==""
ren  plotnum plot_id
merge m:1 hhid plot_id using "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_rent_nomiss_lrs.dta", nogen keep(1 3)
*First rescaling
...
merge m:1 plot_id hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_plot_area_lrs", nogen assert(2 3) keep(3)		
...
merge m:1 region district ward using "${TZA_W1_created_data}/Tanzania_NPS_W1_rental_rate_lrs", nogen keep(3)	
*Now merging in rental costs of individual plots
merge m:1 hhid plot_id using "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_rent_nomiss_lrs.dta", nogen keep(1 3)
*Now merging in household rental rate
merge m:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_rental_rate_hhid_lrs.dta", nogen keep(1 3)
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_cost_land_lrs.dta", replace
...
drop if plotnum==""
ren plotnum plot_id 
merge m:1 hhid plot_id using "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_rent_nomiss_lrs.dta", nogen keep(1 3) keepusing(dm_gender)
merge m:1 hhid plot_id using "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_rent_nomiss_srs.dta", nogen keep(1 3) keepusing(dm_gender) update
*First rescaling
...
merge m:1 plot_id hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_plot_area_lrs", nogen keep(1 3) keepusing(plot_ha)						
merge m:1 plot_id hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_plot_area_srs", nogen keepusing(plot_ha) update							
gen ha_planted = percent_plot*plot_ha
gen ha_planted_male = ha_planted if dm_gender==1
gen ha_planted_female = ha_planted if dm_gender==2
gen ha_planted_mixed = ha_planted if dm_gender==3
...
*Now merging in household rental rate
merge m:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_rental_rate_hhid_lrs.dta", nogen keep(1 3)		
merge m:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_rental_rate_hhid_srs.dta", nogen	update			
gen value_owned_land = ha_planted*ha_rental_rate if s3aq30==0 | s3aq30==.		
replace value_owned_land = ha_planted*ha_rental_hh_lrs if ha_rental_hh_lrs!=0 & ha_rental_hh_lrs!=. & (s3aq30==0 | s3aq30==.)		
*Now creating gender value
gen value_owned_land_male = ha_planted*ha_rental_rate if (s3aq30==0 | s3aq30==.) & dm_gender==1
...
collapse (sum) value_owned_land* ha_planted*, by(hhid plot_id)			
append using "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_cost_land_lrs.dta"					
...
preserve
	*We also want to create a total area planted variable, double counting plots, for fertilizer application rate
	...
	save "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_ha_planted_total.dta", replace
restore
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_cost_land.dta", replace
...
preserve
	...
	save "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_fert_lrs.dta", replace
restore
...
preserve
	...
	save "${TZA_W1_created_data}/Tanzania_NPS_W1_org_fert_lrs.dta", replace
restore
merge m:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_org_fert_lrs.dta", nogen
...
preserve
	...
	recode *wage* (0=.)		
	save "${TZA_W1_created_data}/Tanzania_NPS_W1_wages_hh_lrs.dta", replace
restore

merge m:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_wages_hh_lrs.dta", nogen
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_cost_inputs_lrs.dta", replace
...
preserve
	...
	gen fert_inorg_kg_mixed = fert_inorg_kg if dm_gender==3
	collapse (sum) fert_org_kg fert_inorg_kg*, by(hhid)
	save "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_fert_srs.dta", replace
restore
...
preserve
	...
	save "${TZA_W1_created_data}/Tanzania_NPS_W1_org_fert_srs.dta", replace
restore
merge m:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_org_fert_srs.dta", nogen
...
preserve
	...
	gen harv_wage_hh = harv_labor_costs/harv_labor
	recode *wage* (0=.)
	save "${TZA_W1_created_data}/Tanzania_NPS_W1_wages_hh_srs.dta", replace
restore

merge m:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_wages_hh_srs.dta", nogen
...
collapse (sum) value_*, by(hhid)
save "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_cost_inputs_srs.dta", replace

use  "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_cost_inputs_lrs.dta", clear
append using  "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_cost_inputs_srs.dta"
collapse (sum) value_*, by(hhid)
...
preserve
	...
	save "${TZA_W1_created_data}/Tanzania_NPS_W1_seeds_hh_lrs.dta", replace
restore
merge m:1 hhid zaocode using "${TZA_W1_created_data}/Tanzania_NPS_W1_seeds_hh_lrs.dta", nogen
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_cost_seed_lrs.dta", replace
...
preserve
	...
	save "${TZA_W1_created_data}/Tanzania_NPS_W1_seeds_hh_srs.dta", replace
restore
merge m:1 hhid zaocode using "${TZA_W1_created_data}/Tanzania_NPS_W1_seeds_hh_srs.dta", nogen
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_cost_seed_srs.dta", replace
...
use "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_cost_land.dta", clear
append using "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_rental_rate.dta"
append using "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_cost_inputs_lrs.dta"
append using "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_cost_inputs_srs.dta"
append using "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_cost_seed_lrs.dta"
append using "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_cost_seed_srs.dta"
append using "${TZA_W1_created_data}/Tanzania_NPS_W1_asset_rental_costs.dta"
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_cropcosts_total.dta", replace
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_ag_wage.dta", replace
...
************
use "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_cost_land_lrs.dta", clear
append using "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_fert_lrs.dta"
append using "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_fert_srs.dta"
collapse (sum) ha_planted* fert_org_kg* fert_inorg_kg*, by(hhid)
merge m:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_hhids.dta", keep (1 3) nogen
drop ha_planted*
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_fertilizer_application.dta", replace
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_household_diet.dta", replace
...
merge 1:1 hhid sbmemno  using  "${TZA_W1_created_data}\Tanzania_NPS_W1_person_ids.dta", nogen 
recode control_* (.=0)
lab var control_businessincome "1=invidual has control over business income"
save "${TZA_W1_created_data}/Tanzania_NPS_W1_control_income.dta", replace
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_make_ag_decision.dta", replace
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_ownasset.dta", replace
...
merge m:1 hhid plot_id using "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_areas.dta" , nogen keep(1 3)   
merge m:1 hhid plot_id using "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_decision_makers" , nogen keep(1 3)
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_plot_crop_area.dta", replace
...
merge m:1 hhid plot_id zaocode using "${TZA_W1_created_data}/Tanzania_NPS_W1_plot_crop_area.dta", nogen 			
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_crop_area_plan_LRS.dta", replace
...
preserve
	...
	save "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_area_planted_harvested_allcrops_LRS.dta", replace
restore


keep if inlist( zaocode, $comma_topcrop_area)

save "${TZA_W1_created_data}/Tanzania_NPS_W1_crop_harvest_area_yield_LRS.dta", replace
...
keep crop_area_planted* hhid plot_id zaocode dm_* any_* pure_stand dm_gender  field_area us_* area_meas_hectares area_est_hectares 	
save "${TZA_W1_created_data}/Tanzania_NPS_W1_plot_crop_area_SRS.dta", replace
...
ren plotnum plot_id 
*Merging decision maker and intercropping variables
merge m:1 hhid plot_id zaocode using "${TZA_W1_created_data}/Tanzania_NPS_W1_plot_crop_area_SRS.dta", nogen 			
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_crop_area_plan_SRS.dta", replace
 
*total planted and harvested area summed accross all plots, crops, and seasons.
preserve
	collapse (sum) all_area_harvested=area_harv all_area_planted=area_plan, by(hhid)
	replace all_area_harvested=all_area_planted if all_area_harvested>all_area_planted & all_area_harvested!=.
	save "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_area_planted_harvested_allcrops_SRS.dta", replace
	append using "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_area_planted_harvested_allcrops_LRS.dta"
	...
	save "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_area_planted_harvested_allcrops.dta", replace
restore
...
gen season="SRS"
save "${TZA_W1_created_data}/Tanzania_NPS_W1_crop_harvest_area_yield_SRS.dta", replace
  
 
*Yield at the household level
use "${TZA_W1_created_data}/Tanzania_NPS_W1_crop_harvest_area_yield_LRS.dta", clear
preserve
	gen season="LRS"
	append using "${TZA_W1_created_data}/Tanzania_NPS_W1_crop_harvest_area_yield_SRS.dta"
...
merge 1:1 hhid crop_code using "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_crop_values_production.dta", nogen keep(1 3)
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_yield_hh_crop_level.dta", replace
...
use "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_crop_area_plan_LRS.dta", clear
append using "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_crop_area_plan_SRS.dta"
...
preserve 
	...
	save "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_crop_area_plan_shannon.dta", replace
restore

merge m:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_crop_area_plan_shannon.dta", nogen		//all matched
...
save "${TZA_W1_created_data}\Tanzania_NPS_W1_shannon_diversity_index.dta", replace
...
save "${TZA_W1_created_data}/Tanzania_NPS_W1_consumption.dta", replace
...
global empty_vars ""
use "${TZA_W1_created_data}\Tanzania_NPS_W1_hhids.dta", clear

*Gross crop income 
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_crop_production.dta", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_crop_losses.dta", nogen keep (1 3)
recode value_crop_production crop_value_lost (.=0)

*Crop costs
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_asset_rental_costs.dta", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_land_rental_costs.dta", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_seed_costs.dta", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_fertilizer_costs.dta", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_wages_shortseason.dta", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_wages_mainseason.dta", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_transportation_cropsales.dta", nogen keep (1 3)
recode rental_cost_animal_traction rental_cost_ag_asset rental_cost_tractor rental_cost_land cost_seed value_fertilizer /*
*/ value_herb_pest wages_paid_short wages_paid_main transport_costs_cropsales (.=0)
egen crop_production_expenses = rowtotal(rental_cost_animal_traction rental_cost_ag_asset rental_cost_tractor rental_cost_land cost_seed value_fertilizer /*
*/ value_herb_pest wages_paid_short wages_paid_main transport_costs_cropsales)
...
foreach cn in $topcropname_area {
	merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_land_rental_costs_`cn'.dta", nogen keep (1 3)
	merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_fertilizer_costs_`cn'.dta", nogen keep (1 3)
	merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_`cn'_monocrop_hh_area.dta", nogen keep (1 3)
}

// Separate loop for the short seasons as not all crops are planted in the
// short season
foreach cn in $topcropname_short {
	merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_wages_shortseason_`cn'.dta", nogen keep (1 3)
}

// Separate loop for annual crops as permanent crops versions of these dta
// files do not exist
foreach cn in $topcropname_annual {
	merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_seed_costs_`cn'.dta", nogen keep (1 3)
	merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_wages_mainseason_`cn'.dta", nogen keep (1 3)
...
*land rights
merge 1:1 hhid using  "${TZA_W1_created_data}/Tanzania_NPS_W1_land_rights_hh.dta", nogen keep (1 3)
la var formal_land_rights_hh "Household has documentation of land rights (at least one plot)"

*Livestock income
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_sales", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_hh_livestock_products", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_expenses", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_TLU.dta", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_herd_characteristics", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_TLU_Coefficients.dta", nogen keep (1 3)
gen ls_exp_vac = . 
...
*Fish income
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_fish_income.dta", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_fishing_expenses_1.dta", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_fishing_expenses_2.dta", nogen keep (1 3)
...
*Self-employment income
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_self_employment_income.dta", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_agproducts_profits.dta", nogen keep (1 3)
...
*wage income 
merge 1:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_wage_income.dta", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_agwage_income.dta", nogen keep (1 3)
...
*Off-farm hours
merge 1:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_off_farm_hours.dta", nogen keep (1 3)

*Other income
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_other_income.dta", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_land_rental_income.dta", nogen keep (1 3)
...
*Farm size
merge 1:1 hhid using  "${TZA_W1_created_data}\Tanzania_NPS_W1_land_size.dta", nogen keep (1 3)
merge 1:1 hhid using  "${TZA_W1_created_data}\Tanzania_NPS_W1_land_size_all.dta", nogen keep (1 3)
merge 1:1 hhid using  "${TZA_W1_created_data}\Tanzania_NPS_W1_farmsize_all_agland.dta", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_land_size_total.dta", nogen
recode land_size (.=0)
...
*Labor
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_family_hired_labor.dta", nogen keep (1 3)
recode   labor_hired labor_family (.=0)
 
*Household size
merge 1:1 hhid using  "${TZA_W1_created_data}\Tanzania_NPS_W1_hhsize.dta", nogen keep (1 3)

*Rates of vaccine usage, improved seeds, etc.
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_vaccine.dta", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_fert_use.dta", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_improvedseed_use.dta", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_any_ext.dta", nogen keep (1 3)
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_fin_serv.dta", nogen keep (1 3)
...
*Milk productivity
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_milk_animals.dta", nogen keep (1 3)
gen costs_dairy= .
...
*Egg productivity
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_eggs_animals.dta", nogen keep (1 3)
gen poultry_owned = . 
gen egg_poultry_year = . 
global empty_vars $empty_vars poultry_owned *egg_poultry_year

*Costs of crop production per hectare
merge 1:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_cropcosts_total.dta", nogen keep (1 3)

*Rate of fertilizer application 
merge 1:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_fertilizer_application.dta", nogen keep (1 3)

*Agricultural wage rate
merge 1:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_ag_wage.dta", nogen keep (1 3)

*Crop yields 
merge 1:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_yield_hh_crop_level.dta", nogen keep (1 3)

*Total area planted and harvested accross all crops, plots, and seasons
merge 1:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_hh_area_planted_harvested_allcrops.dta", nogen keep (1 3)

*Household diet
merge 1:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_household_diet.dta", nogen keep (1 3)

*Consumption
merge 1:1 hhid using "${TZA_W1_created_data}/Tanzania_NPS_W1_consumption.dta", nogen keep (1 3)
...
*Livestock health
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_livestock_diseases.dta", nogen
...
*Shannon diversity index
merge 1:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_shannon_diversity_index.dta", nogen
...
gen ccf_loc = (1+$NPS_LSMS_ISA_W1_inflation) 
lab var ccf_loc "currency conversion factor - 2016 $TSH"
gen ccf_usd = (1+$NPS_LSMS_ISA_W1_inflation) / $NPS_LSMS_ISA_W1_exchange_rate 
lab var ccf_usd "currency conversion factor - 2016 $USD"
gen ccf_1ppp = (1+$NPS_LSMS_ISA_W1_inflation) / $NPS_LSMS_ISA_W1_cons_ppp_dollar 
lab var ccf_1ppp "currency conversion factor - 2016 $Private Consumption PPP"
gen ccf_2ppp = (1+$NPS_LSMS_ISA_W1_inflation) / $NPS_LSMS_ISA_W1_gdp_ppp_dollar
...
save "${TZA_W1_final_data}/Tanzania_NPS_W1_household_variables.dta", replace
...
**************
global empty_vars ""
use "${TZA_W1_created_data}\Tanzania_NPS_W1_person_ids.dta", clear
merge 1:1 hhid sbmemno using "${TZA_W1_created_data}/Tanzania_NPS_W1_control_income.dta", nogen  keep(1 3)
merge 1:1 hhid sbmemno using "${TZA_W1_created_data}/Tanzania_NPS_W1_make_ag_decision.dta", nogen  keep(1 3)
merge 1:1 hhid sbmemno using "${TZA_W1_created_data}/Tanzania_NPS_W1_ownasset.dta", nogen  keep(1 3)
merge m:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_hhsize.dta", nogen keep (1 3)
merge 1:1 hhid sbmemno using "${TZA_W1_created_data}/Tanzania_NPS_W1_farmer_fert_use.dta", nogen  keep(1 3)
merge 1:1 hhid sbmemno using "${TZA_W1_created_data}/Tanzania_NPS_W1_farmer_improvedseed_use.dta", nogen  keep(1 3)
merge 1:1 hhid sbmemno using "${TZA_W1_created_data}/Tanzania_NPS_W1_farmer_vaccine.dta", nogen  keep(1 3)
merge m:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_hhids.dta", nogen keep (1 3)

*land rights
merge 1:1 hhid sbmemno using "${TZA_W1_created_data}/Tanzania_NPS_W1_land_rights_ind.dta", nogen
...
preserve
use "${TZA_W1_final_data}/Tanzania_NPS_W1_household_variables.dta", clear
keep hhid ag_hh
tempfile ag_hh
save `ag_hh'
restore
...
save "${TZA_W1_final_data}/Tanzania_NPS_W1_individual_variables.dta", replace
...
use "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_cropvalue.dta", clear
merge 1:1 hhid plot_id using "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_areas.dta", keep (1 3) nogen
merge 1:1 hhid plot_id  using  "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_decision_makers.dta", keep (1 3) nogen
merge m:1 hhid using "${TZA_W1_created_data}\Tanzania_NPS_W1_hhids.dta", keep (1 3) nogen
merge 1:1 hhid plot_id using "${TZA_W1_created_data}\Tanzania_NPS_W1_plot_family_hired_labor.dta", keep (1 3) nogen
replace area_meas_hectares=area_est_hectares if area_meas_hectares==.
...
save "${TZA_W1_final_data}\Tanzania_NPS_W1_gender_productivity_gap.dta", replace
...
global final_data_household  "${TZA_W1_final_data}/Tanzania_NPS_W1_household_variables.dta"  
global final_data_individual "${TZA_W1_final_data}/Tanzania_NPS_W1_individual_variables.dta"
global final_data_plot       "${TZA_W1_final_data}\Tanzania_NPS_W1_gender_productivity_gap.dta"
global final_outputfile      "$TZA_W1_final_data\Tanzania_NPS_W1_summary_stats_`c(current_date)'.xlsx"
