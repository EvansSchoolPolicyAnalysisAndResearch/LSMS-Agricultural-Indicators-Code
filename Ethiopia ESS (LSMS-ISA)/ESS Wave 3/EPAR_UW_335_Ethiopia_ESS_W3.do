...
*Set directories
global ETH_W3_raw_data			"$directory\Ethiopia ESS\Ethiopia ESS Wave 3\Raw DTA Files"
global ETH_W3_created_data		"$directory\Ethiopia ESS\Ethiopia ESS Wave 3\Final DTA Files\created_data"
global ETH_W3_final_data		"$directory\Ethiopia ESS\Ethiopia ESS Wave 3\Final DTA Files\final_data" 
...
************************
global ETH_LSMS_ISA_W3_exchange_rate 21.2389	// https://www.bloomberg.com/quote/USDETB:CUR
global ETH_LSMS_ISA_W3_gdp_ppp_dollar 8.668 	// https://data.worldbank.org/indicator/PA.NUS.PPP
global ETH_LSMS_ISA_W3_cons_ppp_dollar 8.674	// https://data.worldbank.org/indicator/PA.NUS.PRVT.PP
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_hhids.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_male_head.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_gender_merge_ph.dta", replace		
...
duplicates drop household_id2 personid, force
merge 1:1 household_id2 personid using "$ETH_W3_created_data/Ethiopia_ESS_W3_gender_merge_ph.dta", nogen 		
save "$ETH_W3_created_data/Ethiopia_ESS_W3_gender_merge_both.dta", replace

*Using household roster for missing gender 
use "$ETH_W3_raw_data/Household/sect1_hh_w3.dta", clear
rename hh_s1q00 personid
merge 1:1 household_id2 personid using "$ETH_W3_created_data/Ethiopia_ESS_W3_gender_merge_both.dta"	// 5,474 were in roster but not planting/harvesting modules
...
merge m:1 household_id2 personid using "$ETH_W3_created_data/Ethiopia_ESS_W3_gender_merge_both.dta", gen(dm1_merge) keep(1 3)			
...
merge m:1 household_id2 personid using "$ETH_W3_created_data/Ethiopia_ESS_W3_gender_merge_both.dta", gen(dm2_merge) keep(1 3)			
...
merge m:1 household_id2 personid using "$ETH_W3_created_data/Ethiopia_ESS_W3_gender_merge_both.dta", gen(dm3_merge) keep(1 3)			
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_field_gender_dm.dta", replace
...
preserve
	...
	merge m:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_hhids.dta"
	drop if _merge==2
	drop _merge
	...
	save "$ETH_W3_created_data/Ethiopia_ESS_W3_area_lookup_zone.dta", replace
restore
preserve
	replace area_sqmeters_gps=. if area_sqmeters_gps<0
	keep household_id2 parcel_id field_id area local_unit area_sqmeters_gps
	...
	save "$ETH_W3_created_data/Ethiopia_ESS_W3_area_lookup_region.dta", replace
restore
preserve
	replace area_sqmeters_gps=. if area_sqmeters_gps<0
	keep household_id2 parcel_id field_id area local_unit area_sqmeters_gps
	...
	save "$ETH_W3_created_data/Ethiopia_ESS_W3_area_lookup_country.dta", replace
restore
...
merge m:1 region zone local_unit using "$ETH_W3_created_data/Ethiopia_ESS_W3_area_lookup_zone.dta", nogen
replace area_meas_hectares = (area*(sqmeters_per_unit_zone/10000)) if local_unit!=11 & area_meas_hectares==. & obs_zone>=10		
merge m:1 region local_unit using "$ETH_W3_created_data/Ethiopia_ESS_W3_area_lookup_region.dta", nogen
replace area_meas_hectares = (area*(sqmeters_per_unit_region/10000)) if local_unit!=11 & area_meas_hectares==. & obs_region>=10
merge m:1 local_unit using "$ETH_W3_created_data/Ethiopia_ESS_W3_area_lookup_country.dta", nogen
...
merge 1:1 holder_id parcel_id field_id using "$ETH_W3_created_data/Ethiopia_ESS_W3_field_gender_dm.dta", nogen
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_field_area.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_parcel_area.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_household_area.dta", replace

*Cultivated (HH) area
use "$ETH_W3_created_data/Ethiopia_ESS_W3_field_area.dta", clear
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_farm_area.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_fields_agland.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_farmsize_all_agland.dta", replace
...
forvalues k=1(1)16 {
	...
	*merging in plot areas
	merge m:1 field_id parcel_id household_id2 holder_id using "${ETH_W3_created_data}/Ethiopia_ESS_W3_field_area.dta", nogen keep(1 3)
	...
	save "${ETH_W3_created_data}/Ethiopia_ESS_W3_`cn'_monocrop.dta", replace
	...
	save "${ETH_W3_created_data}/Ethiopia_ESS_W3_`cn'_monocrop_hh_area.dta", replace
}
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_sales_1.dta", replace
...
keep if sell_yesno==1 
drop if value_sold==0 | value_sold==.
save "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_sales_2.dta", replace

use "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_sales_1.dta", clear
append using "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_sales_2.dta"
...
merge m:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_hhids.dta", nogen keep(1 3)
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_sales.dta", replace 


use "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_sales.dta", clear
gen observation = 1
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_prices_ea.dta", replace
use "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_sales.dta", clear
gen observation = 1
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_prices_kebele.dta", replace
use "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_sales.dta", clear
gen observation = 1
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_prices_woreda.dta", replace
use "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_sales.dta", clear
gen observation = 1
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_prices_zone.dta", replace
use "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_sales.dta", clear
gen observation = 1
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_prices_region.dta", replace
use "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_sales.dta", clear
gen observation = 1
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_prices_country.dta", replace
...
merge 1:1 household_id2 crop_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_sales.dta", nogen


*Kebele and ea are the same thing.
merge m:1 region zone woreda kebele crop_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_prices_kebele.dta", nogen
merge m:1 region zone woreda crop_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_prices_woreda.dta", nogen
merge m:1 region zone crop_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_prices_zone.dta", nogen
merge m:1 region crop_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_prices_region.dta", nogen
merge m:1 crop_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_prices_country.dta", nogen
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_crop_values_production.dta", replace
...
save  "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_crop_production.dta", replace
...
merge m:1 household_id2 crop_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_sales.dta", nogen
merge m:1 region zone woreda kebele crop_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_prices_kebele.dta", nogen
merge m:1 region zone woreda crop_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_prices_woreda.dta", nogen
merge m:1 region zone crop_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_prices_zone.dta", nogen
merge m:1 region crop_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_prices_region.dta", nogen
...
preserve
	...
	drop if household_id2==""
	save "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_production_parcel.dta", replace
...
drop if household_id2==""
save "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_production_field.dta", replace

merge 1:1 household_id2 holder_id parcel_id field_id using "$ETH_W3_created_data/Ethiopia_ESS_W3_field_gender_dm.dta", nogen keep(1 3)
...
lab var value_crop_production "Gross value of crop production"
save "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_production_household.dta", replace
...
merge m:1 household_id2 crop_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_crop_values_production.dta"
drop if _merge==2
drop _merge
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_losses.dta", replace
...
foreach cn in $topcropname_area {
	preserve
		merge 1:1 household_id2 parcel_id field_id holder_id using "${ETH_W3_created_data}/Ethiopia_ESS_W3_`cn'_monocrop.dta", nogen assert(1 3) keep(3)	// only in master and matched; keeping only matched, because these are the monocropped plots
		...
		save "${ETH_W3_created_data}/Ethiopia_ESS_W3_wages_postplanting_`cn'.dta", replace
	restore
}
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_wages_postplanting.dta", replace
...
foreach cn in $topcropname_area {
	preserve 
		merge m:1 household_id2 parcel_id field_id holder_id using "${ETH_W3_created_data}/Ethiopia_ESS_W3_`cn'_monocrop.dta", nogen assert(1 3) keep(3)	// only in master and matched; keeping only matched, because these are the monocropped plots
		...
		save "${ETH_W3_created_data}/Ethiopia_ESS_W3_wages_postharvest_`cn'.dta", replace
	restore
}
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_wages_postharvest.dta", replace
...
foreach cn in $topcropname_area {
	preserve
		merge m:1 household_id2 parcel_id field_id holder_id using "${ETH_W3_created_data}/Ethiopia_ESS_W3_`cn'_monocrop.dta", nogen assert(1 3) keep(3)
		...
		merge 1:1 household_id2 holder_id parcel_id field_id using "$ETH_W3_created_data/Ethiopia_ESS_W3_field_gender_dm.dta", nogen keep(3)
		...
		save "${ETH_W3_created_data}\Ethiopia_ESS_W3_fertilizer_costs_`cn'.dta", replace
	restore
}
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_fertilizer_costs.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_seed_costs.dta", replace
...
preserve
	...
	merge m:1 household_id2 personid using "${ETH_W3_created_data}/Ethiopia_ESS_W3_gender_merge_both.dta", nogen keep(3)		//keep only matched
...
preserve
	...
	save "${ETH_W3_created_data}/Ethiopia_ESS_W3_land_rights_ind.dta", replace
restore
...
preserve
	...
	save "${ETH_W3_created_data}/Ethiopia_ESS_W3_land_rights_hh.dta", replace
restore


merge 1:1 household_id2 holder_id parcel_id using "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_production_parcel.dta", nogen keep(1 3)
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_land_rental_costs.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_transportation_cropsales.dta", replace
...
save "${ETH_W3_created_data}\Ethiopia_ESS_W3_lrum_expenses", replace
restore 
...
collapse (firstnm) *lrum *srum *pigs *equine *poultry, by(household_id2)
	...
	drop ls_exp_vac
	save "${ETH_W3_created_data}\Ethiopia_ESS_W3_livestock_expenses_animal", replace
restore 
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_expenses", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_livestock_products", replace

use "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_livestock_products", clear
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_products_prices_kebele.dta", replace
use "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_products_prices_woreda.dta", replace
use "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_products_prices_zone.dta", replace
use "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_products_prices_region.dta", replace
use "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_livestock_products", clear
keep if price_per_unit !=.
gen observation = 1
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_products_prices_country.dta", replace

use "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_livestock_products", clear
merge m:1 region zone woreda kebele livestock_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_products_prices_kebele.dta", nogen
merge m:1 region zone woreda livestock_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_products_prices_woreda.dta", nogen
merge m:1 region zone livestock_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_products_prices_zone.dta", nogen
merge m:1 region livestock_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_products_prices_region.dta", nogen
merge m:1 livestock_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_products_prices_country.dta", nogen
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_products", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_livestock_sales", replace

*Implicit prices
use "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_livestock_sales", clear
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_prices_kebele.dta", replace
use "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys region zone woreda livestock_code: egen obs_woreda = count(observation)
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_prices_woreda.dta", replace
use "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys region zone livestock_code: egen obs_zone = count(observation)
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_prices_zone.dta", replace
use "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys region livestock_code: egen obs_region = count(observation)
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_prices_region.dta", replace
use "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_livestock_sales", clear
keep if price_per_animal !=.
gen observation = 1
bys livestock_code: egen obs_country = count(observation)
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_prices_country.dta", replace

use "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_livestock_sales", clear
merge m:1 region zone woreda kebele livestock_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_prices_kebele.dta", nogen
merge m:1 region zone woreda livestock_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_prices_woreda.dta", nogen
merge m:1 region zone livestock_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_prices_zone.dta", nogen
merge m:1 region livestock_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_prices_region.dta", nogen
merge m:1 livestock_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_prices_country.dta", nogen
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_sales", replace
...
save "${ETH_W3_created_data}\Ethiopia_ESS_W3_TLU_Coefficients.dta", replace 
...
preserve
	...
	*Now dropping these missing variables, which we only used to construct the labels above
	...
	save "${ETH_W3_created_data}\Ethiopia_ESS_W3_herd_characteristics", replace
restore
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_TLU.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_self_employment_income.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_business_owners_ind.dta", replace
...
preserve
	...
	merge 1:1 household_id2 personid using "$ETH_W3_created_data/Ethiopia_ESS_W3_gender_merge_both.dta", nogen
	gen wage_worker = (annual_salary!=0 & annual_salary!=.)
	save "$ETH_W3_created_data/Ethiopia_ESS_W3_wage_worker.dta", replace
restore
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_wage_income.dta", replace
...
preserve
	...
	save "$ETH_W3_created_data/Ethiopia_ESS_W3_agworker.dta", replace
restore
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_agwage_income.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_other_income.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_assistance_income.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_land_rental_income.dta", replace
...
save "${ETH_W3_created_data}/Ethiopia_ESS_W3_off_farm_hours.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_plot_farmlabor_postplanting.dta", replace
...
lab var days_hired_postplant "Workdays for hired labor (crops), as captured in post-planting survey"
lab var days_otherlabor_postplant "Workdays for other labor (crops), as captured in post-planting survey"
save "$ETH_W3_created_data/Ethiopia_ESS_W3_farmlabor_postplanting.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_plot_farmlabor_postharvest.dta", replace


*Labor productivity at the plot level = total labor
append using "$ETH_W3_created_data/Ethiopia_ESS_W3_plot_farmlabor_postplanting.dta"
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_plot_family_hired_labor.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_farmlabor_all.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_parcels_cultivated.dta", replace
...
merge m:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_hhids.dta", nogen keep(1 3)
merge m:1 region zone woreda local_unit using "$ETH_W3_raw_data/Land Area Conversion Factor/ET_local_area_unit_conversion.dta", nogen keep(1 3)
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_plot_sizes.dta", replace
merge m:1 household_id2 parcel_id field_id using "$ETH_W3_created_data/Ethiopia_ESS_W3_parcels_cultivated.dta"
keep if cultivated==1
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_land_size.dta", replace
...
merge m:1 household_id2 parcel_id field_id using "$ETH_W3_created_data/Ethiopia_ESS_W3_parcels_cultivated.dta", nogen keep(1 3)
...
lab var agland "1= Plot was used for cultivated, pasture, or fallow"
save "$ETH_W3_created_data/Ethiopia_ESS_W3_parcels_agland.dta", replace

use "$ETH_W3_created_data/Ethiopia_ESS_W3_plot_sizes.dta", clear
merge 1:1 household_id2 parcel_id holder_id field_id using "$ETH_W3_created_data/Ethiopia_ESS_W3_parcels_agland.dta"
drop if _merge==1
collapse (sum) area_meas_hectares, by (household_id2)
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_land_size_all.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_vaccine.dta", replace
...
drop if personid==.
merge m:1 household_id2 personid using "$ETH_W3_created_data/Ethiopia_ESS_W3_gender_merge_both.dta", gen(f_merge)   keep(1 3)			
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_farmer_vaccine.dta", replace
...
save "${ETH_W3_created_data}\Ethiopia_ESS_W3_livestock_feed_water_house.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_fert_use.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_farmer_fert_use.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_improvedseed_use.dta", replace
...
recode farm_manager (.=0)
lab var farm_manager "1=Indvidual is listed as a manager for at least one plot" 
save "$ETH_W3_created_data/Ethiopia_ESS_W3_farmer_improvedseed_use.dta", replace
...
forvalues k=1(1)16 {
	...
	preserve
		...
		recode farm_manager (.=0)
		lab var farm_manager "1=Indvidual is listed as a manager for at least one plot" 
		save "$ETH_W3_created_data/Ethiopia_ESS_W3_farmer_improvedseed_use_`cn'.dta", replace
	restore
}
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_any_ext.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_fin_serv.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_milk_animals.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_eggs_animals.dta", replace
...
merge 1:1 holder_id parcel_id using "$ETH_W3_created_data/Ethiopia_ESS_W3_parcel_area.dta", nogen keep(1 3)
...
preserve
	...
	save "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_rental_parcel.dta", replace
restore
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_rental_rate.dta", replace

*Land value - rented land
*Starting at field area
use "$ETH_W3_created_data/Ethiopia_ESS_W3_field_area", clear
*Merging in gender
merge 1:1 holder_id parcel_id field_id using "$ETH_W3_created_data/Ethiopia_ESS_W3_field_gender_dm.dta", nogen
*Merging in rental costs paid
merge m:1 holder_id parcel_id using "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_rental_parcel.dta", nogen	
*Merging in parcel area ("land_size")
merge m:1 household_id2 holder_id parcel_id using "$ETH_W3_created_data/Ethiopia_ESS_W3_parcel_area.dta", nogen
...
forvalues k=1(1)16 {
	...
	local cnfull: word `k' of $topcropname_full
	preserve
		merge 1:1 household_id2 parcel_id field_id holder_id using "${ETH_W3_created_data}/Ethiopia_ESS_W3_`cn'_monocrop.dta", nogen assert(1 3) keep(3)	
		...
		save "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_rental_value_`cn'.dta", replace
	restore
}
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_rental_value.dta", replace
...
*Merging in area
merge m:1 holder_id parcel_id field_id using "$ETH_W3_created_data/Ethiopia_ESS_W3_field_area", nogen keep(1 3)	
*Merging in gender
merge m:1 holder_id parcel_id field_id using "$ETH_W3_created_data/Ethiopia_ESS_W3_field_gender_dm.dta", nogen
...
merge m:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_rental_rate.dta", nogen keep(1 3) keepusing(ha_rental_rate)
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_cost_land.dta", replace
...
preserve
	...
	* get average wage accross all plots and crops to obtain wage at household level by  activities
	...
	save "$ETH_W3_created_data/Ethiopia_ESS_W3_eth_labor_group1", replace
restore
...
foreach cn in $topcropname_area {
	preserve
		...
		save "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_pp_inputs_value_`cn'.dta", replace
	restore
}
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_pp_inputs_value.dta", replace
...
preserve
	...
	* get average wage accross all plots and crops to obtain wage at household level by  activities
	collapse (mean) wage_male wage_female all_wage, by(rural saq01 saq02 saq03 saq04 saq05 household_id2)
	lab var all_wage "Daily agricultural wage (local currency)"
	save "$ETH_W3_created_data/Ethiopia_ESS_W3_eth_labor_group2", replace
restore
...
foreach cn in $topcropname_area {
	preserve
		...
		save "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_cost_harv_labor_`cn'.dta", replace
	restore
}
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_cost_harv_labor.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_cost_seed.dta", replace
...
save "${ETH_W3_created_data}/Ethiopia_ESS_W3_ag_wage.dta", replace 
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_fertilizer_application.dta", replace
...
compress
save "$ETH_W3_created_data/Ethiopia_ESS_W3_household_diet.dta", replace
...
duplicates drop 
gen type_asset="land"
save "$ETH_W3_created_data/Ethiopia_ESS_W3_women_land_owner.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_women_livestock_owner.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_women_otherasset_owner.dta", replace

* Construct asset ownership variable
use "$ETH_W3_created_data/Ethiopia_ESS_W3_women_land_owner.dta", clear
append using "$ETH_W3_created_data/Ethiopia_ESS_W3_women_livestock_owner.dta"
append using "$ETH_W3_created_data/Ethiopia_ESS_W3_women_otherasset_owner.dta"
gen own_asset=1 
...
compress
save "$ETH_W3_created_data/Ethiopia_ESS_W3_women_asset.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_women_planting_input.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_women_control_annualsales.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_women_sales_annualcrop.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_women_control_permsales.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_women_sales_permcrop.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_women_control_harvest.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_women_control_annualharvest.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_women_manage_livestock.dta", replace


* Constructing decision-making ag variable *
use "$ETH_W3_created_data/Ethiopia_ESS_W3_women_planting_input.dta", clear
append using "$ETH_W3_created_data/Ethiopia_ESS_W3_women_control_harvest.dta"
append using "$ETH_W3_created_data/Ethiopia_ESS_W3_women_sales_annualcrop.dta"
append using "$ETH_W3_created_data/Ethiopia_ESS_W3_women_sales_permcrop.dta"
append using "$ETH_W3_created_data/Ethiopia_ESS_W3_women_manage_livestock.dta"
...
gen personid = hh_s1q00
compress
save "$ETH_W3_created_data/Ethiopia_ESS_W3_ag_decision.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_women_control_livestocksales.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_women_control_businessincome.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_women_control_otherincome.dta", replace


*Constructing decision-making final variable 
use "$ETH_W3_created_data/Ethiopia_ESS_W3_women_control_annualharvest.dta", clear
append using "$ETH_W3_created_data/Ethiopia_ESS_W3_women_control_annualsales.dta"
append using "$ETH_W3_created_data/Ethiopia_ESS_W3_women_control_permsales.dta"
append using "$ETH_W3_created_data/Ethiopia_ESS_W3_women_control_livestocksales.dta"
append using "$ETH_W3_created_data/Ethiopia_ESS_W3_women_control_businessincome.dta"
append using "$ETH_W3_created_data/Ethiopia_ESS_W3_women_control_otherincome.dta"
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_control_income.dta", replace
...
merge m:1 household_id2 holder_id parcel_id field_id using "$ETH_W3_created_data/Ethiopia_ESS_W3_field_area.dta", nogen keep(1 3)	// dropping those only in using
*4 not matched from master
*30,337 matched
...
save "${ETH_W3_created_data}/Ethiopia_ESS_W3_area_planted.dta", replace
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_cf.dta", replace
...
merge m:1 crop_code unit_cd region using "$ETH_W3_created_data/Ethiopia_ESS_W3_cf.dta", gen(cf_merge) 
*8,658 not matched
*21,664 matched
...
forvalues k=1(1)16 {
	local cn: word `k' of $topcropname_area
	preserve
		merge m:1 household_id2 parcel_id field_id holder_id using "${ETH_W3_created_data}/Ethiopia_ESS_W3_`cn'_monocrop.dta", nogen keep(3)
		gen kgs_harv_mono_`cn' = kgs_harvest 
		merge 1:1 household_id2 parcel_id field_id holder_id using "$ETH_W3_created_data/Ethiopia_ESS_W3_field_gender_dm.dta", nogen keep(3)
		...
		save "$ETH_W3_created_data/Ethiopia_ESS_W3_`cn'_harvest_monocrop", replace
	restore
}

keep crop_code holder_id parcel_id field_id kgs_harvest ph_s9q08 ph_s9q09 percent_area_harv
*Merging area
merge m:1 holder_id parcel_id field_id crop_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_area_planted", nogen 
...
save "$ETH_W3_created_data\Ethiopia_ESS_W3_hh_crop_area_plan_SDI.dta", replace
...
preserve
	...
	save "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_area_planted_harvested_allcrops.dta", replace
restore 

keep if inlist(crop_code, $comma_topcrop_area)

*Merging weights and survey variables
merge m:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_male_head.dta", nogen keep(1 3)
*3 not matched from master
*15,656 matched
rename pw_w3 weight

save "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_harvest_area_yield.dta", replace


*Yield at the household level
use "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_harvest_area_yield.dta", clear
gen total_planted_area = area_plan		
gen total_harv_area = area_harv	
merge 1:1 household_id2 crop_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_crop_values_production.dta", nogen keep(1 3)
merge 1:1 household_id2 crop_code using "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_sales.dta", nogen keep(1 3)
...
save "$ETH_W3_created_data/Ethiopia_ESS_W3_yield_hh_level.dta", replace
...
use "$ETH_W3_created_data\Ethiopia_ESS_W3_hh_crop_area_plan_SDI.dta", clear
...
preserve 
	...
	save "$ETH_W3_created_data\Ethiopia_ESS_W3_hh_crop_area_plan_shannon.dta", replace
restore

merge m:1 household_id2 using "$ETH_W3_created_data\Ethiopia_ESS_W3_hh_crop_area_plan_shannon.dta", nogen
...
save "$ETH_W3_created_data\Ethiopia_ESS_W3_shannon_diversity_index.dta", replace
...
save "${ETH_W3_created_data}/Ethiopia_ESS_W3_consumption.dta", replace
...
save "${ETH_W3_created_data}\Ethiopia_ESS_W3_food_insecurity.dta", replace
...
************************
global empty_vars ""
use "$ETH_W3_created_data/Ethiopia_ESS_W3_male_head.dta", clear	
drop pw_w3	
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_hhids.dta", nogen keep(1 3)

*Area dta files
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_household_area.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_farm_area.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_farmsize_all_agland.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_area_planted_harvested_allcrops.dta", nogen keep(1 3)

*Rental value, rent paid, and value of owned land
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_rental_rate.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_rental_value.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_cost_land.dta", nogen keep(1 3)

*Top crop costs
foreach cn in $topcropname_area {
	merge 1:1 household_id2 using "${ETH_W3_created_data}/Ethiopia_ESS_W3_`cn'_monocrop_hh_area.dta", nogen keep(1 3) 
	merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_`cn'_harvest_monocrop", nogen keep(1 3)
	merge 1:1 household_id2 using "${ETH_W3_created_data}\Ethiopia_ESS_W3_fertilizer_costs_`cn'.dta", nogen keep(1 3)	
	merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_rental_value_`cn'.dta", nogen keep(1 3)
	merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_pp_inputs_value_`cn'.dta", nogen keep(1 3)		
	merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_cost_harv_labor_`cn'.dta", nogen keep(1 3)		
}
...
*Land rights
merge 1:1 household_id2 using  "${ETH_W3_created_data}/Ethiopia_ESS_W3_land_rights_hh.dta", nogen keep(1 3) 
la var formal_land_rights_hh "Household has documentation of land rights (at least one plot)"

*Crop yields 
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_yield_hh_level.dta", nogen keep(1 3)
...
*Household diet
merge 1:1 household_id2 using "${ETH_W3_created_data}/Ethiopia_ESS_W3_household_diet.dta", nogen keep(1 3)

*Post-planting inputs
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_fertilizer_application.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_pp_inputs_value.dta", nogen keep(1 3)

*Post-harvest inputs
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_cost_harv_labor.dta", nogen keep(1 3)

*Other inputs
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_cost_seed.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_farmlabor_all.dta", nogen keep(1 3)

*Crop production and losses
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_hh_crop_production.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_losses.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_production_household.dta", nogen keep(1 3)

*Use variables
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_improvedseed_use.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_any_ext.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_vaccine.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_fin_serv.dta", nogen keep(1 3)
...
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_sales.dta", nogen keep(1 3) 
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_expenses.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_livestock_products.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_TLU.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_milk_animals.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_eggs_animals.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data\Ethiopia_ESS_W3_herd_characteristics.dta", nogen keep(1 3)
merge 1:1 household_id2 using "${ETH_W3_created_data}\Ethiopia_ESS_W3_TLU_Coefficients.dta", nogen keep(1 3)			
merge 1:1 household_id2 using "${ETH_W3_created_data}\Ethiopia_ESS_W3_livestock_expenses_animal.dta", nogen keep(1 3)
gen lost_disease = . 
...
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_wage_income.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_agwage_income.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_self_employment_income.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_other_income.dta", nogen keep(1 3)
merge 1:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_assistance_income.dta", nogen keep(1 3)
...
*Off-farm hours
merge 1:1 household_id2 using "${ETH_W3_created_data}/Ethiopia_ESS_W3_off_farm_hours.dta", nogen keep(1 3)
merge 1:1 household_id2 using "${ETH_W3_created_data}/Ethiopia_ESS_W3_ag_wage.dta", nogen keep(1 3)
...
*Dairy costs 
merge 1:1 household_id2 using "$ETH_W3_created_data\Ethiopia_ESS_W3_lrum_expenses", nogen keep (1 3)
...
*Consumption
merge 1:1 household_id2 using "${ETH_W3_created_data}/Ethiopia_ESS_W3_consumption.dta", nogen keep(1 3)
...
*Food security
merge 1:1 household_id2 using "${ETH_W3_created_data}\Ethiopia_ESS_W3_food_insecurity.dta", nogen keep(1 3)
gen hhs_little = . 
gen hhs_moderate = . 
gen hhs_severe = . 
gen hhs_total = . 
...
merge 1:1 household_id2 using "${ETH_W3_created_data}\Ethiopia_ESS_W3_shannon_diversity_index.dta", nogen
...
merge 1:1 household_id2 using "${ETH_W3_created_data}\Ethiopia_ESS_W3_livestock_feed_water_house.dta", nogen keep(1 3)
...
gen ccf_usd = 1 / $ETH_LSMS_ISA_W3_exchange_rate 
lab var ccf_usd "currency conversion factor - 2016 $USD"
gen ccf_1ppp = 1 / $ETH_LSMS_ISA_W3_cons_ppp_dollar
lab var ccf_1ppp "currency conversion factor - 2016 $Private Consumption PPP"
gen ccf_2ppp = 1 / $ETH_LSMS_ISA_W3_gdp_ppp_dollar
...
save "$ETH_W3_final_data/Ethiopia_ESS_W3_household_variables.dta", replace
...
use "$ETH_W3_created_data/Ethiopia_ESS_W3_crop_production_field.dta", clear
merge 1:1 household_id2 holder_id parcel_id field_id using "$ETH_W3_created_data/Ethiopia_ESS_W3_field_area.dta", nogen keep(1 3)
merge 1:1 household_id2 holder_id parcel_id field_id using "$ETH_W3_created_data/Ethiopia_ESS_W3_field_gender_dm.dta", nogen keep(1 3)
merge m:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_male_head.dta", nogen keep(1 3)		
merge m:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_hhids.dta", nogen

merge 1:1 household_id2 holder_id parcel_id field_id using "${ETH_W3_created_data}/Ethiopia_ESS_W3_plot_farmlabor_postplanting.dta", keep (1 3) nogen
merge 1:1 household_id2 holder_id parcel_id field_id using "${ETH_W3_created_data}/Ethiopia_ESS_W3_plot_farmlabor_postharvest.dta", keep (1 3) nogen
...
save "$ETH_W3_final_data/Ethiopia_ESS_W3_gender_productivity_gap.dta", replace
...
**************
use "$ETH_W3_created_data/Ethiopia_ESS_W3_control_income.dta", clear
merge 1:1 household_id2 personid using "$ETH_W3_created_data/Ethiopia_ESS_W3_ag_decision.dta", nogen keep(1 3)
merge 1:1 household_id2 personid using "$ETH_W3_created_data/Ethiopia_ESS_W3_women_asset.dta", nogen keep(1 3)
merge m:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_male_head.dta", nogen keep(1 3)
merge 1:1 household_id2 personid using "${ETH_W3_created_data}/Ethiopia_ESS_W3_farmer_fert_use.dta", nogen  keep(1 3)
merge 1:1 household_id2 personid using "${ETH_W3_created_data}/Ethiopia_ESS_W3_farmer_improvedseed_use.dta", nogen  keep(1 3)
merge 1:1 household_id2 personid using "${ETH_W3_created_data}/Ethiopia_ESS_W3_farmer_vaccine.dta", nogen  keep(1 3)
merge m:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_household_diet.dta", nogen
merge m:1 household_id2 using "$ETH_W3_created_data/Ethiopia_ESS_W3_hhids.dta", nogen
merge 1:1 household_id2 personid using "${ETH_W3_created_data}/Ethiopia_ESS_W3_land_rights_ind.dta", nogen
...
merge 1:1 household_id2 personid using "$ETH_W3_created_data/Ethiopia_ESS_W3_agworker.dta", nogen
merge 1:1 household_id2 personid using "$ETH_W3_created_data/Ethiopia_ESS_W3_business_owners_ind.dta", nogen
merge 1:1 household_id2 personid using "$ETH_W3_created_data/Ethiopia_ESS_W3_wage_worker.dta", nogen
...
preserve
	...
	save "$ETH_W3_created_data/Ethiopia_ESS_W3_female_manager_individual.dta", replace
	...
	*/ num_agworker_female_ad=agworker_female_adult num_wage_worker_female_ad= wage_worker_female_adult, by(household_id2)
	save "$ETH_W3_created_data/Ethiopia_ESS_W3_female_manager.dta", replace
restore

*Adding improved seed use by crop 
foreach cn in $topcropname_area {
	merge 1:1 household_id2 personid using "$ETH_W3_created_data/Ethiopia_ESS_W3_farmer_improvedseed_use_`cn'.dta", nogen
}
...
preserve
use "${ETH_W3_final_data}/Ethiopia_ESS_W3_household_variables.dta", clear
...
label define instrument 1 "Tanzania NPS Wave 1" 2 "Tanzania NPS Wave 2" 3 "Tanzania NPS Wave 3" 4 "Tanzania NPS Wave 4" /*
	...
	*/ 22 "Nigeria NIBAS AgDev (Niger)" 23 "Nigeria NIBAS AgDev (Kano)" 24 "Nigeria NIBAS AgDev (Katsina)" 
label values instrument instrument	
save "$ETH_W3_final_data/Ethiopia_ESS_W3_individual_variables.dta", replace
...
global final_data_household  "${ETH_W3_final_data}/Ethiopia_ESS_W3_household_variables.dta"  
global final_data_individual "${ETH_W3_final_data}/Ethiopia_ESS_W3_individual_variables.dta"
global final_data_plot       "$ETH_W3_final_data/Ethiopia_ESS_W3_gender_productivity_gap.dta"
global final_outputfile      "$ETH_W3_final_data/Ethiopia_ESS_W3_summary_stats_`c(current_date)'.xlsx"
