...
*Using data files from within the "Ethiopia ESS LSMS - ISA Wave 2 (2013-14)" folder within the "Raw DTA files" folder, 
*the do.file first constructs common and intermediate variables, saving dta files when appropriate 
*in the folder "\Ethiopia ESS LSMS - ISA Wave 2 (2013-14)\created_data" within the "Final DTA files" folder.
*These variables are then brought together at the household, plot, or individual level, saving dta files at each level when available 
*in the folder "Ethiopia ESS LSMS - ISA Wave 2 (2013-14)" within the "Final DTA files" folder.
...
*The results are outputted in the excel file "Ethiopia_ESS_LSMS_ISA_W2_summary_stats.rtf" in the "Ethiopia ESS LSMS - ISA Wave 3 (2015-16)" within the "Final DTA files" folder.
...
*-------------------------------------------------------------------------------------
*HOUSEHOLD IDS						Ethiopia_ESS_LSMS_ISA_W2_hhids.dta
*WEIGHTS AND GENDER OF HEAD			Ethiopia_ESS_LSMS_ISA_W2_male_head
*INDIVIDUAL GENDER					Ethiopia_ESS_LSMS_ISA_W2_gender_merge_both.dta
*PLOT-CROP DECISION MAKERS			Ethiopia_ESS_LSMS_ISA_W2_field_gender_dm.dta

*PLOT AREA							Ethiopia_ESS_LSMS_ISA_W2_field_area.dta
*AGRICULTURAL LAND DUMMY AND AREA 	Ethiopia_ESS_LSMS_ISA_W2_fields_agland.dta
*AG LAND AREA HOUSEHOLD				Ethiopia_ESS_LSMS_ISA_W2_farmsize_all_agland.dta

*GROSS CROP PRODUCTION				Ethiopia_ESS_LSMS_ISA_W2_crop_production_household.dta
	PARCEL							Ethiopia_ESS_LSMS_ISA_W2_crop_production_parcel.dta
	PLOT							Ethiopia_ESS_LSMS_ISA_W2_crop_production_field.dta
*CROP LOSSES						Ethiopia_ESS_LSMS_ISA_W2_crop_losses.dta

*CROP EXPENSES
	PLANTING LABOR					Ethiopia_ESS_LSMS_ISA_W2_wages_postplanting.dta
	HARVEST LABOR					Ethiopia_ESS_LSMS_ISA_W2_wages_postharvest.dta
	FERTILIZER						Ethiopia_ESS_LSMS_ISA_W2_fertilizer_costs.dta
	SEEDS							Ethiopia_ESS_LSMS_ISA_W2_seed_costs.dta
	LAND RENTAL						Ethiopia_ESS_LSMS_ISA_W2_land_rental_costs.dta
	CROP TRANSPORT					Ethiopia_ESS_LSMS_ISA_W2_transportation_cropsales.dta
	
*LIVESTOCK EXPENSES					Ethiopia_ESS_LSMS_ISA_W2_livestock_expenses.dta
*LIVESTOCK PRODUCTS					Ethiopia_ESS_LSMS_ISA_W2_livestock_products.dta
*LIVESTOCK SALES					Ethiopia_ESS_LSMS_ISA_W2_hh_livestock_sales.dta
*TROPICAL LIVESTOCK UNIT			Ethiopia_ESS_LSMS_ISA_W2_TLU.dta

*SELF EMPLOYMENT INCOME				Ethiopia_ESS_LSMS_ISA_W2_self_employment_income.dta
*WAGE INCOME						Ethiopia_ESS_LSMS_ISA_W2_wage_income.dta
*AG WAGE INCOME						Ethiopia_ESS_LSMS_ISA_W2_agwage_income.dta
*OTHER INCOME						Ethiopia_ESS_LSMS_ISA_W2_other_income.dta
*ASSISTANCE INCOME					Ethiopia_ESS_LSMS_ISA_W2_assistance_income.dta
*RENTAL INCOME						Ethiopia_ESS_LSMS_ISA_W2_land_rental_income.dta

*FARM SIZE							Ethiopia_ESS_LSMS_ISA_W2_land_size.dta
*LAND SIZE							Ethiopia_ESS_LSMS_ISA_W2_land_size_all.dta

*FAMILY PLANTING LABOR				Ethiopia_ESS_LSMS_ISA_W2_farmlabor_postplanting.dta
*FAMILY HARVEST LABOR				Ethiopia_ESS_LSMS_ISA_W2_farmlabor_postharvest.dta

*VACCINE USE						Ethiopia_ESS_LSMS_ISA_W2_vaccine.dta
*INORGANIC FERTILIZER USE			Ethiopia_ESS_LSMS_ISA_W2_fert_use.dta
*IMPROVED SEED USE					Ethiopia_ESS_LSMS_ISA_W2_improvedseed_use
*AG EXTENSION USE					Ethiopia_ESS_LSMS_ISA_W2_any_ext.dta
*FINANCIAL SERVICES USE				Ethiopia_ESS_LSMS_ISA_W2_fin_serv.dta

*MILK PRODUCTIVITY					Ethiopia_ESS_LSMS_ISA_W2_milk_animals.dta
*EGG PRODUCTIVITY					Ethiopia_ESS_LSMS_ISA_W2_eggs_animals.dta

*CROP PRODUCTION COSTS PER HECTARE
	LAND RENTAL VALUE				Ethiopia_ESS_LSMS_ISA_W2_hh_rental_value.dta
	VALUE OF OWNED LAND				Ethiopia_ESS_LSMS_ISA_W2_hh_cost_land.dta
	PLANTING INPUT COST				Ethiopia_ESS_LSMS_ISA_W2_hh_pp_inputs_value.dta
	HARVEST LABOR COST				Ethiopia_ESS_LSMS_ISA_W2_hh_cost_harv_labor.dta
	SEED COST						Ethiopia_ESS_LSMS_ISA_W2_hh_cost_seed.dta
	
*FERTILIZER APPLICATION RATE		Ethiopia_ESS_LSMS_ISA_W2_fertilizer_application.dta
*DIETARY DIVERSITY					Ethiopia_ESS_LSMS_ISA_W2_household_diet.dta

*WOMEN'S OWNERSHIP OF ASSETS		Ethiopia_ESS_LSMS_ISA_W2_women_asset.dta
*WOMNE'S CONTROL OF AG DECISION		Ethiopia_ESS_LSMS_ISA_W2_ag_decision.dta
*WOMEN'S CONTROL OF INCOME			Ethiopia_ESS_LSMS_ISA_W2_control_income.dta

*WAGE INCOME						Ethiopia_ESS_LSMS_ISA_W2_wage_income.dta
*CROP YIELDS						Ethiopia_ESS_LSMS_ISA_W2_yield_hh_level.dta
	
	
*FINAL FILES						MAIN FILES CREATED
*-------------------------------------------------------------------------------------
*HOUSEHOLD-LEVEL VARIABLES			Ethiopia_ESS_LSMS_ISA_W2_household_variables.dta
*FIELD-LEVEL VARIABLES				Ethiopia_ESS_LSMS_ISA_W2_field_variables.dta
*INDIVIDUAL-LEVEL VARIABLES			Ethiopia_ESS_LSMS_ISA_W2_individual_variables.dta	
*SUMMARY STATISTICS					Ethiopia_ESS_LSMS_ISA_W2_summary_stats.xlsx
...
global ETH_W2_raw_data 				"\\netid.washington.edu\wfs\EvansEPAR\Project\EPAR\Working Files\335 - Ag Team Data Support\Waves\Ethiopia\Ethiopia ESS Wave 2 2013-14 (LSMS-ISA)\Raw DTA Files"
global ETH_W2_created_data			"\\netid.washington.edu\wfs\EvansEPAR\Project\EPAR\Working Files\335 - Ag Team Data Support\Waves\Ethiopia\Ethiopia ESS Wave 2 2013-14 (LSMS-ISA)\Final DTA Files\created_data"
global ETH_W2_final_data			"\\netid.washington.edu\wfs\EvansEPAR\Project\EPAR\Working Files\335 - Ag Team Data Support\Waves\Ethiopia\Ethiopia ESS Wave 2 2013-14 (LSMS-ISA)\Final DTA Files\final_data"
...
************************
global ETH_LSMS_ISA_W2_exchange_rate 21.2389	//https://www.bloomberg.com/quote/USDETB:CUR
global ETH_LSMS_ISA_W2_gdp_ppp_dollar 8.678			// https://data.worldbank.org/indicator/PA.NUS.PPP
global ETH_LSMS_ISA_W2_cons_ppp_dollar 8.673			// https://data.worldbank.org/indicator/PA.NUS.PPP
global ETH_LSMS_ISA_W2_inflation 0.181363  		// inflation rate 2014-2016. Data was collectedduring oct2013-2013. We want to ajhust value to 2016


******************
*HOUSEHOLD IDS
******************
use "${ETH_W2_raw_data}/Household/sect_cover_hh_w2.dta", clear
rename saq01 region
rename saq02 zone
rename saq03 woreda
rename saq04 town
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hhids.dta", replace


******************
*WEIGHTS AND GENDER OF HEAD
******************
use "${ETH_W2_raw_data}/Household/sect1_hh_w2.dta", clear
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_male_head.dta", replace
...
use "${ETH_W2_raw_data}/Post-Harvest/sect1_ph_w2.dta", clear
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_gender_merge_ph.dta", replace		// only post-harvest

*Harvest
use "${ETH_W2_raw_data}/Post-Planting/sect1_pp_w2.dta", clear
ren pp_s1q00 personid
gen female =pp_s1q03==2	// NOTE: Assuming missings are MALE

duplicates drop household_id2 personid, force
merge 1:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_gender_merge_ph.dta", nogen // keeping ALL; this should be a list of every individual in any roster file
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_gender_merge_both.dta", replace
...
use "${ETH_W2_raw_data}/Post-Planting/sect3_pp_w2.dta", clear
gen cultivated = pp_s3q03==1			// if plot was cultivated

*First owner/decision maker
gen personid = pp_s3q10a
merge m:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_gender_merge_both.dta", gen(dm1_merge) keep(1 3)			// Dropping unmatched from using
...
merge m:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_gender_merge_both.dta", gen(dm2_merge) keep(1 3)			// Dropping unmatched from using
gen dm2_female = female
drop female personid

*Third
gen personid = pp_s3q10c_b
merge m:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_gender_merge_both.dta", gen(dm3_merge) keep(1 3)			// Dropping unmatched from using
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_field_gender_dm.dta", replace
...
preserve
	...
	merge m:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hhids.dta"
	drop if _merge==2
	drop _merge
	...
	save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_area_lookup_zone.dta", replace
restore
preserve
	replace area_sqmeters_gps=. if area_sqmeters_gps<0
	keep household_id2 parcel_id field_id area local_unit area_sqmeters_gps
	...
	save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_area_lookup_region.dta", replace
restore
preserve
	replace area_sqmeters_gps=. if area_sqmeters_gps<0
	keep household_id2 parcel_id field_id area local_unit area_sqmeters_gps
	...
	save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_area_lookup_country.dta", replace
restore
...
gen zone = saq02
gen woreda = saq03
merge m:1 region zone woreda local_unit using "${ETH_W2_raw_data}/Geodata/ET_local_area_unit_conversion.dta", gen(conversion_merge) keep(1 3)
...
merge m:1 region zone local_unit using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_area_lookup_zone.dta", nogen
replace area_meas_hectares = (area*(sqmeters_per_unit_zone/10000)) if local_unit!=11 & area_meas_hectares==. & obs_zone>=10
merge m:1 region local_unit using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_area_lookup_region.dta", nogen
replace area_meas_hectares = (area*(sqmeters_per_unit_region/10000)) if local_unit!=11 & area_meas_hectares==. & obs_region>=10
merge m:1 local_unit using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_area_lookup_country.dta", nogen
...
merge 1:1 holder_id parcel_id field_id using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_field_gender_dm.dta", nogen
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_field_area.dta", replace 
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_parcel_area.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_household_area.dta", replace

*Cultivated (HH) area
use "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_field_area.dta", clear
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_farm_area.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_fields_agland.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_farmsize_all_agland.dta", replace
...
global topcropname_area "maize rice wheat sorgum millet grdnt bean yam swtptt cassav banana teff barley coffee sesame hsbean nueg"		
...
global topcropname_full "maize rice wheat sorghum millet groundnut bean yam sweetpotato cassava banana teff barley coffee sesame horsebean nueg"

forvalues k=1(1)17 {
	local c: word `k' of $topcrop_area
	local cn: word `k' of $topcropname_area
	local cnfull: word `k' of $topcropname_full
	use "${ETH_W2_raw_data}/Post-Planting/sect4_pp_w2.dta", clear
	...
	*merging in plot areas
	merge m:1 field_id parcel_id household_id2 holder_id using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_field_area.dta", nogen keep(1 3)
	...
	save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_`cn'_monocrop.dta", replace
	...
	save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_`cn'_monocrop_hh_area.dta", replace
}


*TLU (Tropical Livestock Units)
use "${ETH_W2_raw_data}\Livestock\sect8a_ls_w2.dta", clear
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_TLU_Coefficients.dta", replace 
...
use "${ETH_W2_raw_data}\Post-Harvest\sect11_ph_w2.dta", clear
rename saq01 region
rename saq02 zone
rename saq03 woreda
rename saq04 kebele
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_sales_1.dta", replace

*Tree crops, vegetables, root crops
use "${ETH_W2_raw_data}\Post-Harvest\sect12_ph_w2.dta", clear
rename saq01 region
rename saq02 zone
rename saq03 woreda
rename saq04 kebele
...
keep if sell_yesno==1 
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_sales_2.dta", replace

*Appending all sales into a single file
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_sales_1.dta", clear
append using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_sales_2.dta"
...
merge m:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hhids.dta", nogen keep(1 3)
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_sales.dta", replace 

*Generating median prices
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_sales.dta", clear
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_2_crop_prices_ea.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_sales.dta", clear
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_prices_kebele.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_sales.dta", clear
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_prices_woreda.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_sales.dta", clear
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_prices_zone.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_sales.dta", clear
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_prices_region.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_sales.dta", clear
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_prices_country.dta", replace

	
use "${ETH_W2_raw_data}\Post-Harvest\sect9_ph_w2.dta", clear // This includes all crop harvest
...
collapse (sum) kgs_harvest, by (household_id2 region zone woreda kebele ea crop_code)	// Collapse to household/crop
merge 1:1 household_id2 crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_sales.dta", nogen

*Kebele and ea are the same thing.
merge m:1 region zone woreda kebele crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_prices_kebele.dta", nogen
merge m:1 region zone woreda crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_prices_woreda.dta", nogen
merge m:1 region zone crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_prices_zone.dta", nogen
merge m:1 region crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_prices_region.dta", nogen
merge m:1 crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_prices_country.dta", nogen
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_values_tempfile.dta", replace 
...
preserve
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hh_crop_values_production.dta", replace
restore
...
save  "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hh_crop_production.dta", replace   

*Value crop production by parcel
use "${ETH_W2_raw_data}\Post-Harvest\sect9_ph_w2.dta", clear
rename ph_s9q05 kgs_harvest
...
*Merging price data
merge m:1 household_id2 crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_sales.dta", nogen
merge m:1 region zone woreda kebele crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_prices_kebele.dta", nogen
merge m:1 region zone woreda crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_prices_woreda.dta", nogen
merge m:1 region zone crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_prices_zone.dta", nogen
merge m:1 region crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_prices_region.dta", nogen
...
preserve
	...
	drop if household_id2==""
	save  "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_production_parcel.dta", replace
...
restore
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_production_field.dta", replace

merge 1:1 household_id2 holder_id parcel_id field_id using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_field_gender_dm.dta", nogen keep(1 3)
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_production_household.dta", replace

*Crop losses and value of consumption
use "${ETH_W2_raw_data}\Post-Harvest\sect11_ph_w2.dta", clear
rename ph_s11q15_3 kgs_lost
rename ph_s11q15_4 percent_lost
append using "${ETH_W2_raw_data}\Post-Harvest\sect12_ph_w2.dta"
rename ph_s12q12 share_lost
rename ph_s12q13 value_lost 
replace percent_lost = share_lost if percent_lost==.
merge m:1 household_id2 crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hh_crop_values_production.dta", nogen keep(1 3)
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_losses.dta", replace
...
foreach cn in $topcropname_area {
	preserve
		merge 1:1 household_id2 parcel_id field_id holder_id using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_`cn'_monocrop.dta", nogen assert(1 3) keep(3)	// only in master and matched; keeping only matched, because these are the monocropped plots
		...
		save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_wages_postplanting_`cn'.dta", replace
	restore
}
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_wages_postplanting.dta", replace

use "${ETH_W2_raw_data}\Post-Harvest\sect10_ph_w2.dta", clear
...
foreach cn in $topcropname_area {
	preserve 
		merge m:1 household_id2 parcel_id field_id holder_id using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_`cn'_monocrop.dta", nogen assert(1 3) keep(3)	// only in master and matched; keeping only matched, because these are the monocropped plots
		...
		save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_wages_postharvest_`cn'.dta", replace
	restore
}
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_wages_postharvest.dta", replace
...
foreach cn in $topcropname_area {
	preserve
		merge m:1 household_id2 parcel_id field_id holder_id using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_`cn'_monocrop.dta", nogen assert(1 3) keep(3)
		...
		merge 1:1 household_id2 holder_id parcel_id field_id using "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_field_gender_dm.dta", nogen keep(3)
		...
		save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_fertilizer_costs_`cn'.dta", replace
	restore
}
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_fertilizer_costs.dta", replace

*Other chemicals, manure not captured in ESS


use "${ETH_W2_raw_data}\Post-Planting\sect5_pp_w2.dta", clear
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_seed_costs.dta", replace
*Value of seed purchased (not just improved seed) is also captured here.

*Land rental
use "${ETH_W2_raw_data}\Post-Planting\sect2_pp_w2.dta", clear
...
preserve
	...
	merge m:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_gender_merge_both.dta", nogen keep(3)		//keep only matched
...
preserve
	...
	save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_land_rights_ind.dta", replace
restore
...
preserve
	...
	save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_land_rights_hh.dta", replace
restore

merge 1:1 household_id2 holder_id parcel_id using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_production_parcel.dta", nogen keep(1 3)
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_land_rental_costs.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_transportation_cropsales.dta", replace
...
rename ls_s8aq64 cost_expenses_livestock
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_lrum_expenses", replace
restore 
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_expenses", replace

*Livestock products
use "${ETH_W2_raw_data}\Livestock\sect8c_ls_w2", clear
rename ls_s8cq06b byproduct_amount
rename ls_s8cq06a byproduct_unit
rename ls_s8cq00 livestock_product_code
rename ls_s8cq07b product_sold_amount
rename ls_s8cq07a product_sold_unit
...
merge m:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hhids.dta", nogen keep(1 3)
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hh_livestock_products", replace

*Creating aggregate prices for livestock
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hh_livestock_products", clear
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_products_prices_kebele.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hh_livestock_products", clear
	keep if price_per_unit !=.
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_products_prices_woreda.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hh_livestock_products", clear
	keep if price_per_unit !=.
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_products_prices_zone.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hh_livestock_products", clear
	keep if price_per_unit !=.
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_products_prices_region.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hh_livestock_products", clear
	keep if price_per_unit !=.
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_products_prices_country.dta", replace

*Livestock products
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hh_livestock_products", clear
*Merge in aggregate prices
merge m:1 region zone woreda kebele livestock_product_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_products_prices_kebele.dta", nogen
merge m:1 region zone woreda livestock_product_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_products_prices_woreda.dta", nogen
merge m:1 region zone livestock_product_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_products_prices_zone.dta", nogen
merge m:1 region livestock_product_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_products_prices_region.dta", nogen
merge m:1 livestock_product_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_products_prices_country.dta", nogen
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_products", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_sales", replace

*Implicit prices
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hh_livestock_sales", clear
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_prices_kebele.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hh_livestock_sales", clear
	keep if price_per_animal !=.
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_prices_woreda.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hh_livestock_sales", clear
	keep if price_per_animal !=.
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_prices_zone.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hh_livestock_sales", clear
	keep if price_per_animal !=.
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_prices_region.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hh_livestock_sales", clear
	keep if price_per_animal !=.
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_prices_country.dta", replace

*Livestock
use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hh_livestock_sales", clear
*Merging in prices
merge m:1 region zone woreda kebele livestock_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_prices_kebele.dta", nogen
merge m:1 region zone woreda livestock_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_prices_woreda.dta", nogen
merge m:1 region zone livestock_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_prices_zone.dta", nogen
merge m:1 region livestock_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_prices_region.dta", nogen
merge m:1 livestock_code using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_livestock_prices_country.dta", nogen
*Require at least ten price observations (except at country level)
...
collapse (sum) value_livestock_sales, by (household_id2)
...
preserve
	...
	*Now dropping these missing variables, which I only used to construct the labels above
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_herd_characteristics", replace
restore
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_TLU.dta", replace
...
use "${ETH_W2_raw_data}\Household\sect11b_hh_w2.dta", clear
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_self_employment_income.dta", replace
...
*OFF-FARM HOURS
***************
use "${ETH_W2_raw_data}\Household\sect4_hh_w2.dta", clear
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_off_farm_hours.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_wage_income.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_agwage_income.dta", replace
...
use "${ETH_W2_raw_data}\Household\sect12_hh_w2.dta", clear
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_other_income.dta", replace

use "${ETH_W2_raw_data}\Household\sect13_hh_w2.dta", clear
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_assistance_income.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_land_rental_income.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_parcels_cultivated.dta", replace
...
merge m:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_hhids.dta", nogen keep(1 3)
merge m:1 region zone woreda local_unit using "${ETH_W2_raw_data}\Geodata\ET_local_area_unit_conversion.dta", nogen keep(1 3)
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_plot_sizes.dta", replace
merge m:1 household_id2 parcel_id field_id using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_parcels_cultivated.dta"
keep if cultivated==1
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_land_size.dta", replace
...
lab var agland "1= Plot was used for cultivated, pasture, or fallow"
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_parcels_agland.dta", replace

use "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_plot_sizes.dta", clear
merge 1:1 household_id2 parcel_id holder_id field_id using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_parcels_agland.dta", nogen
collapse (sum) area_meas_hectares, by (household_id2)
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_land_size_all.dta", replace
...
rename pp_s3q27_z weeks_7
rename pp_s3q27_ca days_week_7
...
save "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_plot_farmlabor_postplanting.dta", replace
...
lab var days_hired_postplant_child "Workdays for hired child labor (crops), as captured in post-planting survey"
lab var days_otherlabor_postplant "Workdays for other labor (crops), as captured in post-planting survey"
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_farmlabor_postplanting.dta", replace
...
save "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_plot_farmlabor_postharvest.dta", replace
...
lab var days_famlabor_postharvest "Workdays for family labor (crops), as captured in post-harvest survey"
lab var days_otherlabor_postharvest "Workdays for other labor (crops), as captured in post-harvest survey"
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_farmlabor_postharvest.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_vaccine.dta", replace
...
merge m:1 household_id2 personid using "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_gender_merge_both.dta", gen(f_merge)   keep(1 3)
...
save "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_farmer_vaccine.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_fert_use.dta", replace
...
gen personid=farmerid
drop if personid==.
merge m:1 household_id2 personid using "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_gender_merge_both.dta", gen(f_merge)   keep(1 3)			// Dropping unmatched from using
...
save "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_farmer_fert_use.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_improvedseed_use.dta", replace
...
recode farm_manager (.=0)
lab var farm_manager "1=Indvidual is listed as a manager for at least one plot" 
save "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_farmer_improvedseed_use.dta", replace
...
forvalues k=1(1)17 {
	...
	preserve
		...
		recode farm_manager (.=0)
		lab var farm_manager "1=Indvidual is listed as a manager for at least one plot" 
		save "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_farmer_improvedseed_use_`cn'.dta", replace
	restore
}
...
***************************
use "${ETH_W2_raw_data}/Post-Planting/sect3_pp_w2.dta", clear
merge m:m household_id using "${ETH_W2_raw_data}/Post-Planting/sect5_pp_w2.dta", nogen
merge m:m household_id using "${ETH_W2_raw_data}/Post-Planting/sect7_pp_w2.dta", nogen
gen ext_reach_all=0
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_any_ext.dta", replace
...
use "${ETH_W2_raw_data}/Household/sect14b_hh_w2.dta", clear
merge m:m household_id2 using "${ETH_W2_raw_data}/Household/sect11b_hh_w2.dta", nogen
gen use_fin_serv=0
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_fin_serv.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_milk_animals.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_eggs_animals.dta", replace
...
merge 1:1 holder_id parcel_id using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_parcel_area.dta", nogen keep(1 3)
recode rental_cost_cash rental_cost_inkind (.=0)
gen rental_cost_land = rental_cost_cash + rental_cost_inkind
*Saving at parcel level with rental costs
preserve
	keep rental_cost_land holder_id parcel_id 
	save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hh_rental_parcel.dta", replace
restore
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hh_rental_rate.dta", replace

*Land value - rented land
*Starting at field area
use "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_field_area", clear
*Merging in gender
merge 1:1 holder_id parcel_id field_id using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_field_gender_dm.dta", nogen
*Merging in rental costs paid
merge m:1 holder_id parcel_id using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hh_rental_parcel.dta", nogen
*Merging in parcel area ("land_size")
merge m:1 household_id2 holder_id parcel_id using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_parcel_area.dta", nogen
...
forvalues k=1(1)17 {
	...
	local cnfull: word `k' of $topcropname_full
	preserve
		merge 1:1 household_id2 parcel_id field_id holder_id using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_`cn'_monocrop.dta", nogen assert(1 3) keep(3)	
		...
		save "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_hh_rental_value_`cn'.dta", replace
	restore
}
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hh_rental_value.dta", replace
...
*Merging in area
merge m:1 holder_id parcel_id field_id using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_field_area", nogen keep(1 3)	// dropping those only in using
*Merging in gender
merge m:1 holder_id parcel_id field_id using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_field_gender_dm.dta", nogen
...
merge m:1 holder_id parcel_id using "${ETH_W2_raw_data}/Post-Planting/sect2_pp_w2.dta", gen(sect2_merge) keep(1 3)
*Merging in rental rate
merge m:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hh_rental_rate.dta", nogen keep(1 3) keepusing(ha_rental_rate)
...
gen value_owned_land_male_pure = ha_rental_rate*ha_planted_male_pure if (pp_s2q07_a==. | pp_s2q07_a==0) & (pp_s2q07_b==. | pp_s2q07_b==0)
gen value_owned_land_female_pure=  ha_rental_rate*ha_planted_female_pure if (pp_s2q07_a==. | pp_s2q07_a==0) & (pp_s2q07_b==. | pp_s2q07_b==0)
gen value_owned_land_mixed_pure = ha_rental_rate*ha_planted_mixed_pure if (pp_s2q07_a==. | pp_s2q07_a==0) & (pp_s2q07_b==. | pp_s2q07_b==0)
gen value_owned_land_male_mixed = ha_rental_rate*ha_planted_male_mixed if (pp_s2q07_a==. | pp_s2q07_a==0) & (pp_s2q07_b==. | pp_s2q07_b==0)
gen value_owned_land_female_mixed = ha_rental_rate*ha_planted_female_mixed if (pp_s2q07_a==. | pp_s2q07_a==0) & (pp_s2q07_b==. | pp_s2q07_b==0)
gen value_owned_land_mixed_mixed = ha_rental_rate*ha_planted_mixed_mixed if (pp_s2q07_a==. | pp_s2q07_a==0) & (pp_s2q07_b==. | pp_s2q07_b==0)
*/
drop crop_code
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hh_cost_land.dta", replace
...
preserve
	...
	*gen  labor_group=1  //"pre-planting + planting + other non-harvesting"
	...
	save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_eth_labor_group1", replace
restore
...
foreach cn in $topcropname_area {
	preserve
		...
		save "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_hh_pp_inputs_value_`cn'.dta", replace
	restore
}
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hh_pp_inputs_value.dta", replace
...
preserve
	...
	*gen  labor_group=2  //"pre-planting + planting + other non-harvesting"
	lab var all_wage "Daily agricultural wage (local currency)"
	save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_eth_labor_group2", replace
restore
...
foreach cn in $topcropname_area {
	preserve
		...
		save "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_hh_cost_harv_labor_`cn'.dta", replace
	restore
}
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hh_cost_harv_labor.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hh_cost_seed.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_fertilizer_application.dta", replace
...
* DIETARY DIVERSITY
*************
use "${ETH_W2_raw_data}/Household/sect5a_hh_w2.dta" , clear
count
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_household_diet.dta", replace
...
duplicates drop 
gen type_asset="land"
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_land_owner.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_livestock_owner.dta", replace


* FEMALE OTHER ASSETS
use "${ETH_W2_raw_data}/Household/sect10_hh_w2.dta", clear
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_otherasset_owner.dta", replace

*Construct asset ownership variable 
use "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_land_owner.dta", clear
append using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_livestock_owner.dta"
append using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_otherasset_owner.dta"
gen own_asset=1 
...
merge 1:1 household_id2 hh_s1q00  using   "${ETH_W2_raw_data}/Household/sect1_hh_w2.dta"
...
compress
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_asset.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_planting_input.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_control_annualsales.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_sales_annualcrop.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_control_permsales.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_sales_permcrop.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_control_harvest.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_control_annualharvest.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_manage_livestock.dta", replace


* Constructing decision-making ag variable *
use "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_planting_input.dta", clear
append using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_control_harvest.dta"
append using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_sales_annualcrop.dta"
append using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_sales_permcrop.dta"
append using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_manage_livestock.dta"
...
gen personid = hh_s1q00
compress
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_ag_decision.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_control_livestocksales.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_control_businessincome.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_control_otherincome.dta", replace


* Constructing decision-making final variable *
use "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_control_annualharvest.dta", clear
append using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_control_annualsales.dta"
append using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_control_permsales.dta"
append using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_control_livestocksales.dta"
append using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_control_businessincome.dta"
append using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_control_otherincome.dta"
...
gen personid = hh_s1q00
compress
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_control_income.dta", replace
...
use "${ETH_W2_raw_data}/Post-Planting/sect3_pp_w2.dta", clear
append using "${ETH_W2_raw_data}/Post-Harvest/sect10_ph_w2.dta"
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_ag_wage.dta", replace 
...
*Merging in area
merge m:1 holder_id parcel_id field_id using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_field_area.dta", nogen keep(1 3)	// dropping those only in using
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_area_planted.dta", replace


*Before harvest, need to prepare the conversion factors
use "${ETH_W2_raw_data}/Geodata/Crop_CF_Wave2.dta", clear
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_cf.dta", replace
...
merge m:1 crop_code unit_cd region using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_cf.dta", gen(cf_merge) 
...
forvalues k=1(1)17 {
	local cn: word `k' of $topcropname_area
	preserve
		merge m:1 household_id2 parcel_id field_id holder_id using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_`cn'_monocrop.dta", nogen keep(3)
		gen kgs_harv_mono_`cn' = kg_harvest 
		merge 1:1 household_id2 parcel_id field_id holder_id using "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_field_gender_dm.dta", nogen keep(3)
		...
		save "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_`cn'_harvest_monocrop", replace
	restore
}


keep crop_code holder_id parcel_id field_id kg_harvest ph_s9q08 ph_s9q09
*Merging area
merge m:1 holder_id parcel_id field_id crop_code using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_area_planted" , nogen 
...
save "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_hh_area_planted_harvested_allcrops.dta", replace
restore


*Merging weights and survey variables
merge m:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_male_head.dta", nogen //keep(1 3)
rename pw2 weight

save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_crop_harvest_area_yield.dta", replace


*Yield at the household level
use "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_crop_harvest_area_yield.dta", clear
preserve 
recode area_harv (.=0)
...
merge 1:1 household_id2 crop_code using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hh_crop_values_production.dta", nogen keep(1 3)
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_yield_hh_level.dta", replace
...
use "${ETH_W2_raw_data}\Geodata\cons_agg_w2.dta", clear
...
save "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_consumption.dta", replace
...
use "${ETH_W2_raw_data}/Household/sect7_hh_w2.dta", clear
...
save "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_W2_food_insecurity.dta", replace
...
*HOUSEHOLD VARIABLES
************************
use "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_male_head.dta", clear		
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hhids.dta", nogen keep (1 3)

*Area files
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_household_area.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_farm_area.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_farmsize_all_agland.dta", nogen keep (1 3)
*Rental value, rent paid, and value of owned land
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hh_rental_rate.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hh_rental_value.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hh_cost_land.dta", nogen keep (1 3)


foreach cn in $topcropname_area {
	merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_`cn'_monocrop_hh_area.dta", nogen keep (1 3)
	merge 1:1 household_id2 using "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_`cn'_harvest_monocrop", nogen keep (1 3)
	merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_fertilizer_costs_`cn'.dta", nogen keep (1 3)	
	merge 1:1 household_id2 using "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_hh_rental_value_`cn'.dta", nogen keep (1 3)
	merge 1:1 household_id2 using "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_hh_pp_inputs_value_`cn'.dta", nogen keep (1 3)		
	merge 1:1 household_id2 using "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_hh_cost_harv_labor_`cn'.dta", nogen keep (1 3)	
}
...
*Land rights
merge 1:1 household_id2 using  "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_land_rights_hh.dta", nogen keep (1 3)
la var formal_land_rights_hh "Household has documentation of land rights (at least one plot)"

*Crop yields 
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_yield_hh_level.dta", nogen keep (1 3)
merge 1:1 household_id2 using "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_hh_area_planted_harvested_allcrops.dta", nogen keep (1 3)
drop ha_planted_purestand - ha_planted_mixed_mixed 

*Household diet
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_household_diet.dta", nogen keep (1 3)

*Post-planting inputs
*merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_eth_labor_group1", nogen
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hh_pp_inputs_value.dta", nogen keep (1 3)

*Post-harvest inputs
*merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_eth_labor_group2", nogen
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hh_cost_harv_labor.dta", nogen keep (1 3)

*Other inputs
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hh_cost_seed.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_fertilizer_application.dta", nogen keep (1 3)

*Crop production and losses
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hh_crop_production.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_crop_losses.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_crop_production_household.dta", nogen keep (1 3)

*Use variables
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_improvedseed_use.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_any_ext.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_vaccine.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_fin_serv.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_fert_use.dta", nogen keep (1 3)

*Livestock expenses and production
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_livestock_sales.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_livestock_expenses.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_livestock_products.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_TLU.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_milk_animals.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_eggs_animals.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_herd_characteristics", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_TLU_Coefficients", nogen keep (1 3)

*Non-agricultural income (plus agwages)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_wage_income.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_self_employment_income.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_other_income.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_assistance_income.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_agwage_income.dta", nogen keep (1 3)

*Labor
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_farmlabor_postplanting.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_farmlabor_postharvest.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_ag_wage.dta", nogen keep (1 3)

*Off-farm hours
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_off_farm_hours.dta", nogen keep (1 3)

*Consumption
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_consumption.dta", nogen keep (1 3)

*Food security
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_W2_food_insecurity.dta", nogen keep (1 3)
...
*Dairy costs 
merge 1:1 household_id2 using "$ETH_W2_created_data\Ethiopia_ESS_LSMS_ISA_W2_lrum_expenses", nogen keep (1 3)
...
foreach p of varlist $monetary_vars {
	gen `p'_1ppp = (1+$ETH_LSMS_ISA_W2_inflation) * `p' / $ETH_LSMS_ISA_W2_cons_ppp_dollar 
	gen `p'_2ppp = (1+$ETH_LSMS_ISA_W2_inflation) * `p' / $ETH_LSMS_ISA_W2_gdp_ppp_dollar 
	gen `p'_usd = (1+$ETH_LSMS_ISA_W2_inflation) * `p' / $ETH_LSMS_ISA_W2_exchange_rate 
	gen `p'_loc = (1+$ETH_LSMS_ISA_W2_inflation) * `p' 
	local l`p' : var lab `p' 
	...
	lab var `p' "`l`p'' (ETB)"  
	gen w_`p'_1ppp = (1+$ETH_LSMS_ISA_W2_inflation) * w_`p' / $ETH_LSMS_ISA_W2_cons_ppp_dollar 
	gen w_`p'_2ppp = (1+$ETH_LSMS_ISA_W2_inflation) * w_`p' / $ETH_LSMS_ISA_W2_gdp_ppp_dollar 
	gen w_`p'_usd = (1+$ETH_LSMS_ISA_W2_inflation) * w_`p' / $ETH_LSMS_ISA_W2_exchange_rate 
	gen w_`p'_loc = (1+$ETH_LSMS_ISA_W2_inflation) * w_`p' 
...
*Second, we inflate the local currency to the year that this survey was carried out using the CPI inflation rate using https://data.worldbank.org/indicator/FP.CPI.TOTL?end=2017&locations=TZ&start=2003	
	// ((191.991 - 133.25)/133.25) + 1 = 1.441
	// 10.388 * 1.441 = 14.967 ETB
...
save "${ETH_W2_final_data}/Ethiopia_ESS_LSMS_ISA_W2_household_variables.dta", replace
...
//               //
///////////////////
use "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_crop_production_field.dta", clear
merge 1:1 household_id2 holder_id parcel_id field_id using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_field_area.dta", nogen keep(1 3)
merge 1:1 household_id2 holder_id parcel_id field_id using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_field_gender_dm.dta", nogen keep(1 3)
merge m:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_male_head.dta", nogen keep(1 3)		// weights
merge m:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hhids.dta", nogen

merge 1:1 household_id2 holder_id parcel_id field_id using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_plot_farmlabor_postplanting.dta", keep (1 3) nogen
merge 1:1 household_id2 holder_id parcel_id field_id using "${ETH_W2_created_data}\Ethiopia_ESS_LSMS_ISA_W2_plot_farmlabor_postharvest.dta", keep (1 3) nogen
...
foreach p of global monetary_val {
	...
	gen w_`p'_usd=(1+$ETH_LSMS_ISA_W2_inflation) * w_`p' / $ETH_LSMS_ISA_W2_exchange_rate
	gen w_`p'_1ppp=(1+$ETH_LSMS_ISA_W2_inflation) * w_`p' / $ETH_LSMS_ISA_W2_cons_ppp_dollar
	gen w_`p'_2ppp=(1+$ETH_LSMS_ISA_W2_inflation) * `p' / $ETH_LSMS_ISA_W2_gdp_ppp_dollar
	gen w_`p'_loc = (1+$ETH_LSMS_ISA_W2_inflation) * w_`p' 
	local lw_`p' : var lab w_`p' 
	lab var w_`p'_1ppp "`lw_`p'' (2016 $ Private Consumption  PPP)"
...
save "${ETH_W2_final_data}/Ethiopia_ESS_LSMS_ISA_W2_field_variables.dta", replace
...
**************
use "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_control_income.dta", clear
merge 1:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_ag_decision.dta", nogen keep(1 3)
merge 1:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_women_asset.dta", nogen keep(1 3)
merge m:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_male_head.dta", nogen keep(1 3)
merge 1:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_farmer_fert_use.dta", nogen  keep(1 3)
merge 1:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_farmer_improvedseed_use.dta", nogen  keep(1 3)
merge 1:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_farmer_vaccine.dta", nogen  keep(1 3)
merge m:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_hhids.dta", nogen
merge 1:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_LSMS_ISA_W2_land_rights_ind.dta", nogen
...
foreach cn in $topcropname_area {
	merge 1:1 household_id2 personid using "$ETH_W2_created_data/Ethiopia_ESS_LSMS_ISA_W2_farmer_improvedseed_use_`cn'.dta", nogen
}
...
rename household_id2 hhid
preserve
use "${ETH_W2_final_data}/Ethiopia_ESS_LSMS_ISA_W2_household_variables.dta", clear
keep hhid ag_hh
tempfile ag_hh
save `ag_hh'
restore
...
label define instrument 1 "TZA NPS Wave 1" 2 "TZA NPS Wave 2" 3 "TZA NPS Wave 3" 4 "TZA NPS Wave 4" /*
	...
	*/ 22 "Nigeria NIBAS AgDev (Niger)" 23 "Nigeria NIBAS AgDev (Kano)" 24 "Nigeria NIBAS AgDev (Katsina)" 
label values instrument instrument	
save "${ETH_W2_final_data}/Ethiopia_ESS_LSMS_ISA_W2_individual_variables.dta", replace
...
global final_data_household  "${ETH_W2_final_data}/Ethiopia_ESS_LSMS_ISA_W2_household_variables.dta"  
global final_data_individual "${ETH_W2_final_data}/Ethiopia_ESS_LSMS_ISA_W2_individual_variables.dta"
global final_data_plot       "${ETH_W2_final_data}/Ethiopia_ESS_LSMS_ISA_W2_field_variables.dta"
global final_outputfile      "$ETH_W2_final_data/Ethiopia_ESS_LSMS_ISA_W2_summary_stats_XXXXXX.xlsx" //Update with correct date
...
recode imprv_seed_cowpea (.=0)
recode imprv_seed_cowpea_fhh (.=0)
recode imprv_seed_cowpea_mhh (.=0)
recode hybrid_seed_cowpea (.=0)
recode hybrid_seed_cowpea_fhh (.=0)
recode hybrid_seed_cowpea_mhh (.=0)
...
*Group 2: labor_productivity_1ppp and land_productivity_1ppp at the household level
...
*adding in purestand missing observations
foreach v in female_rice female_yam pure_female_rice pure_female_yam {
...
save "$ETH_W2_created_data/temprun.dta", replace
...
foreach x in 1ppp 2ppp loc {
	recode w_yam_exp_ha_female_`x' (.=0)
	recode w_rice_exp_ha_female_`x' (.=0) 
	recode w_yam_exp_female_`x' (.=0)
	recode w_rice_exp_female_`x' (.=0) 
	recode ar_pl_mono_wgt_yam_female (.=1)
	recode ar_pl_mono_wgt_rice_female (.=1)
	recode w_yam_exp_kg_female_`x' (.=0)
	recode w_rice_exp_kg_female_`x' (.=0)
}
recode kgs_harv_wgt_yam_female (0=1)
recode kgs_harv_wgt_rice_female (0=1)
...
* first report summary statistics
...
*since these are totals, we are just keeping the estimated total and its standard errors - there are no other meaningful statisitics
...
*Group 14 : individual level variables - womens controle over income, assets, and participation in agriculture
