...
*FIELD-LEVEL VARIABLES				Ethiopia_ESS_W2_field_variables.dta
...
global ETH_W2_raw_data 				"$directory\Ethiopia ESS\Ethiopia ESS Wave 2\Raw DTA Files"
global ETH_W2_created_data			"$directory\Ethiopia ESS\Ethiopia ESS Wave 2\Final DTA Files\created_data"
global ETH_W2_final_data			"$directory\Ethiopia ESS\Ethiopia ESS Wave 2\Final DTA Files\final_data"
...
global ETH_LSMS_ISA_W2_gdp_ppp_dollar 8.668		// https://data.worldbank.org/indicator/PA.NUS.PPP
global ETH_LSMS_ISA_W2_cons_ppp_dollar 8.674	// https://data.worldbank.org/indicator/PA.NUS.PPP
global ETH_LSMS_ISA_W2_inflation 0.181363  		// inflation rate 2014-2016. Data was collectedduring 2013-2013. We want to ajhust value to 2016
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_hhids.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_male_head.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_gender_merge_ph.dta", replace		// only post-harvest
...
duplicates drop household_id2 personid, force
merge 1:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_W2_gender_merge_ph.dta", nogen // keeping ALL; this should be a list of every individual in any roster file
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_gender_merge_both.dta", replace
...
merge m:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_W2_gender_merge_both.dta", gen(dm1_merge) keep(1 3)			// Dropping unmatched from using
...
merge m:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_W2_gender_merge_both.dta", gen(dm2_merge) keep(1 3)			// Dropping unmatched from using
gen dm2_female = female
drop female personid

*Third
gen personid = pp_s3q10c_b
merge m:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_W2_gender_merge_both.dta", gen(dm3_merge) keep(1 3)			// Dropping unmatched from using
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_field_gender_dm.dta", replace
...
preserve
	...
	merge m:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_hhids.dta"
	drop if _merge==2
	drop _merge
	...
	save "${ETH_W2_created_data}/Ethiopia_ESS_W2_area_lookup_zone.dta", replace
restore
preserve
	replace area_sqmeters_gps=. if area_sqmeters_gps<0
	keep household_id2 parcel_id field_id area local_unit area_sqmeters_gps
	...
	save "${ETH_W2_created_data}/Ethiopia_ESS_W2_area_lookup_region.dta", replace
restore
preserve
	replace area_sqmeters_gps=. if area_sqmeters_gps<0
	keep household_id2 parcel_id field_id area local_unit area_sqmeters_gps
	...
	save "${ETH_W2_created_data}/Ethiopia_ESS_W2_area_lookup_country.dta", replace
restore
...
merge m:1 region zone local_unit using "${ETH_W2_created_data}/Ethiopia_ESS_W2_area_lookup_zone.dta", nogen
replace area_meas_hectares = (area*(sqmeters_per_unit_zone/10000)) if local_unit!=11 & area_meas_hectares==. & obs_zone>=10
merge m:1 region local_unit using "${ETH_W2_created_data}/Ethiopia_ESS_W2_area_lookup_region.dta", nogen
replace area_meas_hectares = (area*(sqmeters_per_unit_region/10000)) if local_unit!=11 & area_meas_hectares==. & obs_region>=10
merge m:1 local_unit using "${ETH_W2_created_data}/Ethiopia_ESS_W2_area_lookup_country.dta", nogen
...
merge 1:1 holder_id parcel_id field_id using "${ETH_W2_created_data}/Ethiopia_ESS_W2_field_gender_dm.dta", nogen
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_field_area.dta", replace 
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_parcel_area.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_household_area.dta", replace

*Cultivated (HH) area
use "${ETH_W2_created_data}/Ethiopia_ESS_W2_field_area.dta", clear
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_farm_area.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_fields_agland.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_farmsize_all_agland.dta", replace
...
forvalues k=1(1)17 {
	...
	*merging in plot areas
	merge m:1 field_id parcel_id household_id2 holder_id using "${ETH_W2_created_data}/Ethiopia_ESS_W2_field_area.dta", nogen keep(1 3)
	...
	save "${ETH_W2_created_data}/Ethiopia_ESS_W2_`cn'_monocrop.dta", replace
	...
	save "${ETH_W2_created_data}/Ethiopia_ESS_W2_`cn'_monocrop_hh_area.dta", replace
}
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_sales_1.dta", replace
...
keep if sell_yesno==1 
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_sales_2.dta", replace

*Appending all sales into a single file
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_sales_1.dta", clear
append using "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_sales_2.dta"
...
merge m:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_W2_hhids.dta", nogen keep(1 3)
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_sales.dta", replace 

*Generating median prices
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_sales.dta", clear
	gen observation = 1
...
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_sales.dta", clear
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_prices_kebele.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_sales.dta", clear
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_prices_woreda.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_sales.dta", clear
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_prices_zone.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_sales.dta", clear
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_prices_region.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_sales.dta", clear
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_prices_country.dta", replace
...
merge 1:1 household_id2 crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_sales.dta", nogen

*Kebele and ea are the same thing.
merge m:1 region zone woreda kebele crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_prices_kebele.dta", nogen
merge m:1 region zone woreda crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_prices_woreda.dta", nogen
merge m:1 region zone crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_prices_zone.dta", nogen
merge m:1 region crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_prices_region.dta", nogen
merge m:1 crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_prices_country.dta", nogen
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_values_tempfile.dta", replace 
...
preserve
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_W2_hh_crop_values_production.dta", replace
restore
...
save  "${ETH_W2_created_data}\Ethiopia_ESS_W2_hh_crop_production.dta", replace   
...
*Merging price data
merge m:1 household_id2 crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_sales.dta", nogen
merge m:1 region zone woreda kebele crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_prices_kebele.dta", nogen
merge m:1 region zone woreda crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_prices_woreda.dta", nogen
merge m:1 region zone crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_prices_zone.dta", nogen
merge m:1 region crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_prices_region.dta", nogen
...
preserve
	...
	drop if household_id2==""
	save  "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_production_parcel.dta", replace
...
restore
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_production_field.dta", replace

merge 1:1 household_id2 holder_id parcel_id field_id using "${ETH_W2_created_data}/Ethiopia_ESS_W2_field_gender_dm.dta", nogen keep(1 3)
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_production_household.dta", replace
...
merge m:1 household_id2 crop_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_hh_crop_values_production.dta", nogen keep(1 3)
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_losses.dta", replace
...
foreach cn in $topcropname_area {
	preserve
		merge 1:1 household_id2 parcel_id field_id holder_id using "${ETH_W2_created_data}/Ethiopia_ESS_W2_`cn'_monocrop.dta", nogen assert(1 3) keep(3)	// only in master and matched; keeping only matched, because these are the monocropped plots
		...
		save "${ETH_W2_created_data}/Ethiopia_ESS_W2_wages_postplanting_`cn'.dta", replace
	restore
}
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_wages_postplanting.dta", replace
...
foreach cn in $topcropname_area {
	preserve 
		merge m:1 household_id2 parcel_id field_id holder_id using "${ETH_W2_created_data}/Ethiopia_ESS_W2_`cn'_monocrop.dta", nogen assert(1 3) keep(3)	// only in master and matched; keeping only matched, because these are the monocropped plots
		...
		save "${ETH_W2_created_data}/Ethiopia_ESS_W2_wages_postharvest_`cn'.dta", replace
	restore
}
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_wages_postharvest.dta", replace
...
foreach cn in $topcropname_area {
	preserve
		merge m:1 household_id2 parcel_id field_id holder_id using "${ETH_W2_created_data}/Ethiopia_ESS_W2_`cn'_monocrop.dta", nogen assert(1 3) keep(3)
		...
		merge 1:1 household_id2 holder_id parcel_id field_id using "$ETH_W2_created_data/Ethiopia_ESS_W2_field_gender_dm.dta", nogen keep(3)
		...
		save "${ETH_W2_created_data}\Ethiopia_ESS_W2_fertilizer_costs_`cn'.dta", replace
	restore
}
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_fertilizer_costs.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_seed_costs.dta", replace
...
preserve
	...
	merge m:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_W2_gender_merge_both.dta", nogen keep(3)		//keep only matched
...
preserve
	...
	save "${ETH_W2_created_data}/Ethiopia_ESS_W2_land_rights_ind.dta", replace
restore
...
preserve
	...
	save "${ETH_W2_created_data}/Ethiopia_ESS_W2_land_rights_hh.dta", replace
restore

merge 1:1 household_id2 holder_id parcel_id using "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_production_parcel.dta", nogen keep(1 3)
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_land_rental_costs.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_transportation_cropsales.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_lrum_expenses", replace
restore 
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_expenses", replace
...
merge m:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_W2_hhids.dta", nogen keep(1 3)
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_hh_livestock_products", replace

*Creating aggregate prices for livestock
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_hh_livestock_products", clear
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_products_prices_kebele.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_hh_livestock_products", clear
	keep if price_per_unit !=.
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_products_prices_woreda.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_hh_livestock_products", clear
	keep if price_per_unit !=.
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_products_prices_zone.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_hh_livestock_products", clear
	keep if price_per_unit !=.
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_products_prices_region.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_hh_livestock_products", clear
	keep if price_per_unit !=.
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_products_prices_country.dta", replace

*Livestock products
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_hh_livestock_products", clear
*Merge in aggregate prices
merge m:1 region zone woreda kebele livestock_product_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_products_prices_kebele.dta", nogen
merge m:1 region zone woreda livestock_product_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_products_prices_woreda.dta", nogen
merge m:1 region zone livestock_product_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_products_prices_zone.dta", nogen
merge m:1 region livestock_product_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_products_prices_region.dta", nogen
merge m:1 livestock_product_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_products_prices_country.dta", nogen
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_products", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_sales", replace

*Implicit prices
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_sales", clear
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_prices_kebele.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_sales", clear
	keep if price_per_animal !=.
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_prices_woreda.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_sales", clear
	keep if price_per_animal !=.
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_prices_zone.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_sales", clear
	keep if price_per_animal !=.
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_prices_region.dta", replace
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_sales", clear
	keep if price_per_animal !=.
	gen observation = 1
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_prices_country.dta", replace

*Livestock
use "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_sales", clear
*Merging in prices
merge m:1 region zone woreda kebele livestock_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_prices_kebele.dta", nogen
merge m:1 region zone woreda livestock_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_prices_woreda.dta", nogen
merge m:1 region zone livestock_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_prices_zone.dta", nogen
merge m:1 region livestock_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_prices_region.dta", nogen
merge m:1 livestock_code using "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_prices_country.dta", nogen
*Require at least ten price observations (except at country level)
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_TLU_Coefficients.dta", replace 
...
preserve
	...
	*Now dropping these missing variables, which I only used to construct the labels above
	...
	save "${ETH_W2_created_data}\Ethiopia_ESS_W2_herd_characteristics", replace
restore
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_TLU.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_self_employment_income.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_wage_income.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_agwage_income.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_other_income.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_assistance_income.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_land_rental_income.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_off_farm_hours.dta", replace
...
save "$ETH_W2_created_data/Ethiopia_ESS_W2_plot_farmlabor_postplanting.dta", replace
...
lab var days_hired_postplant_child "Workdays for hired child labor (crops), as captured in post-planting survey"
lab var days_otherlabor_postplant "Workdays for other labor (crops), as captured in post-planting survey"
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_farmlabor_postplanting.dta", replace
...
save "$ETH_W2_created_data/Ethiopia_ESS_W2_plot_farmlabor_postharvest.dta", replace
...
lab var days_famlabor_postharvest "Workdays for family labor (crops), as captured in post-harvest survey"
lab var days_otherlabor_postharvest "Workdays for other labor (crops), as captured in post-harvest survey"
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_farmlabor_postharvest.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_parcels_cultivated.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_plot_sizes.dta", replace
merge m:1 household_id2 parcel_id field_id using "${ETH_W2_created_data}\Ethiopia_ESS_W2_parcels_cultivated.dta"
keep if cultivated==1
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_land_size.dta", replace
...
merge m:1 household_id2 parcel_id field_id using "$ETH_W2_created_data/Ethiopia_ESS_W2_parcels_cultivated.dta", nogen keep(1 3)
replace agland=1 if cultivated==1

keep if agland==1
keep household_id2 parcel_id field_id holder_id agland
lab var agland "1= Plot was used for cultivated, pasture, or fallow"
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_parcels_agland.dta", replace

use "${ETH_W2_created_data}\Ethiopia_ESS_W2_plot_sizes.dta", clear
merge 1:1 household_id2 parcel_id holder_id field_id using "${ETH_W2_created_data}\Ethiopia_ESS_W2_parcels_agland.dta", nogen
collapse (sum) area_meas_hectares, by (household_id2)
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_land_size_all.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_vaccine.dta", replace
...
merge m:1 household_id2 personid using "$ETH_W2_created_data/Ethiopia_ESS_W2_gender_merge_both.dta", gen(f_merge)   keep(1 3)
...
save "$ETH_W2_created_data/Ethiopia_ESS_W2_farmer_vaccine.dta", replace
...
save "$ETH_W2_created_data/Ethiopia_ESS_W2_livestock_diseases.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_fert_use.dta", replace
...
gen personid=farmerid
drop if personid==.
merge m:1 household_id2 personid using "$ETH_W2_created_data/Ethiopia_ESS_W2_gender_merge_both.dta", gen(f_merge)   keep(1 3)			// Dropping unmatched from using
...
save "$ETH_W2_created_data/Ethiopia_ESS_W2_farmer_fert_use.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_improvedseed_use.dta", replace
...
recode farm_manager (.=0)
lab var farm_manager "1=Indvidual is listed as a manager for at least one plot" 
save "$ETH_W2_created_data/Ethiopia_ESS_W2_farmer_improvedseed_use.dta", replace
...
forvalues k=1(1)17 {
	...
	preserve
		...
		recode farm_manager (.=0)
		lab var farm_manager "1=Indvidual is listed as a manager for at least one plot" 
		save "$ETH_W2_created_data/Ethiopia_ESS_W2_farmer_improvedseed_use_`cn'.dta", replace
	restore
}
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_any_ext.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_fin_serv.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_milk_animals.dta", replace
...
save "${ETH_W2_created_data}\Ethiopia_ESS_W2_eggs_animals.dta", replace
...
merge 1:1 holder_id parcel_id using "${ETH_W2_created_data}/Ethiopia_ESS_W2_parcel_area.dta", nogen keep(1 3)
recode rental_cost_cash rental_cost_inkind (.=0)
gen rental_cost_land = rental_cost_cash + rental_cost_inkind
*Saving at parcel level with rental costs
preserve
	keep rental_cost_land holder_id parcel_id 
	save "${ETH_W2_created_data}/Ethiopia_ESS_W2_hh_rental_parcel.dta", replace
restore
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_hh_rental_rate.dta", replace

*Land value - rented land
*Starting at field area
use "${ETH_W2_created_data}/Ethiopia_ESS_W2_field_area", clear
*Merging in gender
merge 1:1 holder_id parcel_id field_id using "${ETH_W2_created_data}/Ethiopia_ESS_W2_field_gender_dm.dta", nogen
*Merging in rental costs paid
merge m:1 holder_id parcel_id using "${ETH_W2_created_data}/Ethiopia_ESS_W2_hh_rental_parcel.dta", nogen
*Merging in parcel area ("land_size")
merge m:1 household_id2 holder_id parcel_id using "${ETH_W2_created_data}/Ethiopia_ESS_W2_parcel_area.dta", nogen
...
forvalues k=1(1)17 {
	...
	local cnfull: word `k' of $topcropname_full
	preserve
		merge 1:1 household_id2 parcel_id field_id holder_id using "${ETH_W2_created_data}/Ethiopia_ESS_W2_`cn'_monocrop.dta", nogen assert(1 3) keep(3)	
		...
		save "$ETH_W2_created_data/Ethiopia_ESS_W2_hh_rental_value_`cn'.dta", replace
	restore
}
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_hh_rental_value.dta", replace
...
*Merging in area
merge m:1 holder_id parcel_id field_id using "${ETH_W2_created_data}/Ethiopia_ESS_W2_field_area", nogen keep(1 3)	// dropping those only in using
*Merging in gender
merge m:1 holder_id parcel_id field_id using "${ETH_W2_created_data}/Ethiopia_ESS_W2_field_gender_dm.dta", nogen
...
merge m:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_hh_rental_rate.dta", nogen keep(1 3) keepusing(ha_rental_rate)
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_hh_cost_land.dta", replace
...
preserve
	...
	** group activities
	...
	save "${ETH_W2_created_data}/Ethiopia_ESS_W2_eth_labor_group1", replace
restore
...
foreach cn in $topcropname_area {
	preserve
		...
		save "$ETH_W2_created_data/Ethiopia_ESS_W2_hh_pp_inputs_value_`cn'.dta", replace
	restore
}
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_hh_pp_inputs_value.dta", replace
...
preserve
	...
	** group activities
	lab var all_wage "Daily agricultural wage (local currency)"
	save "${ETH_W2_created_data}/Ethiopia_ESS_W2_eth_labor_group2", replace
restore
...
foreach cn in $topcropname_area {
	preserve
		...
		save "$ETH_W2_created_data/Ethiopia_ESS_W2_hh_cost_harv_labor_`cn'.dta", replace
	restore
}
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_hh_cost_harv_labor.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_hh_cost_seed.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_ag_wage.dta", replace 
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_fertilizer_application.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_household_diet.dta", replace
...
duplicates drop 
gen type_asset="land"
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_land_owner.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_livestock_owner.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_otherasset_owner.dta", replace

*Construct asset ownership variable 
use "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_land_owner.dta", clear
append using "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_livestock_owner.dta"
append using "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_otherasset_owner.dta"
gen own_asset=1 
...
compress
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_asset.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_planting_input.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_control_annualsales.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_sales_annualcrop.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_control_permsales.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_sales_permcrop.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_control_harvest.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_control_annualharvest.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_manage_livestock.dta", replace


* Constructing decision-making ag variable *
use "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_planting_input.dta", clear
append using "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_control_harvest.dta"
append using "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_sales_annualcrop.dta"
append using "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_sales_permcrop.dta"
append using "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_manage_livestock.dta"
...
gen personid = hh_s1q00
compress
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_ag_decision.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_control_livestocksales.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_control_businessincome.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_control_otherincome.dta", replace


* Constructing decision-making final variable *
use "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_control_annualharvest.dta", clear
append using "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_control_annualsales.dta"
append using "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_control_permsales.dta"
append using "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_control_livestocksales.dta"
append using "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_control_businessincome.dta"
append using "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_control_otherincome.dta"
...
gen personid = hh_s1q00
compress
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_control_income.dta", replace
...
*Merging in area
merge m:1 holder_id parcel_id field_id using "${ETH_W2_created_data}/Ethiopia_ESS_W2_field_area.dta", nogen keep(1 3)	// dropping those only in using
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_area_planted.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_cf.dta", replace
...
merge m:1 crop_code unit_cd region using "${ETH_W2_created_data}/Ethiopia_ESS_W2_cf.dta", gen(cf_merge) 
...
forvalues k=1(1)17 {
	local cn: word `k' of $topcropname_area
	preserve
		merge m:1 household_id2 parcel_id field_id holder_id using "${ETH_W2_created_data}/Ethiopia_ESS_W2_`cn'_monocrop.dta", nogen keep(3)
		gen kgs_harv_mono_`cn' = kg_harvest 
		merge 1:1 household_id2 parcel_id field_id holder_id using "$ETH_W2_created_data/Ethiopia_ESS_W2_field_gender_dm.dta", nogen keep(3)
		...
		save "$ETH_W2_created_data/Ethiopia_ESS_W2_`cn'_harvest_monocrop", replace
	restore
}
...
*Merging area
merge m:1 holder_id parcel_id field_id crop_code using "${ETH_W2_created_data}/Ethiopia_ESS_W2_area_planted" , nogen 
...
save "$ETH_W2_created_data\Ethiopia_ESS_W2_hh_crop_area_plan_SDI.dta", replace
...
save "$ETH_W2_created_data/Ethiopia_ESS_W2_hh_area_planted_harvested_allcrops.dta", replace
restore


*Merging weights and survey variables
merge m:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_male_head.dta", nogen //keep(1 3)
rename pw2 weight

save "${ETH_W2_created_data}/Ethiopia_ESS_W2_crop_harvest_area_yield.dta", replace


*Yield at the household level
use "${ETH_W2_created_data}/Ethiopia_ESS_W2_crop_harvest_area_yield.dta", clear
preserve 
recode area_harv (.=0)
...
merge 1:1 household_id2 crop_code using "${ETH_W2_created_data}/Ethiopia_ESS_W2_hh_crop_values_production.dta", nogen keep(1 3)
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_yield_hh_level.dta", replace
...
use "$ETH_W2_created_data\Ethiopia_ESS_W2_hh_crop_area_plan_SDI.dta", clear
...
preserve 
	...
	save "$ETH_W2_created_data\Ethiopia_ESS_W2_hh_crop_area_plan_shannon.dta", replace
restore

merge m:1 household_id2 using "$ETH_W2_created_data\Ethiopia_ESS_W2_hh_crop_area_plan_shannon.dta", nogen
...
save "$ETH_W2_created_data\Ethiopia_ESS_W2_shannon_diversity_index.dta", replace
...
save "${ETH_W2_created_data}/Ethiopia_ESS_W2_consumption.dta", replace
...
************************
global empty_vars ""
use "${ETH_W2_created_data}/Ethiopia_ESS_W2_male_head.dta", clear		
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_hhids.dta", nogen keep (1 3)

*Area files
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_household_area.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_farm_area.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_farmsize_all_agland.dta", nogen keep (1 3)
*Rental value, rent paid, and value of owned land
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_hh_rental_rate.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_hh_rental_value.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_hh_cost_land.dta", nogen keep (1 3)


foreach cn in $topcropname_area {
	merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_`cn'_monocrop_hh_area.dta", nogen keep (1 3)
	merge 1:1 household_id2 using "$ETH_W2_created_data/Ethiopia_ESS_W2_`cn'_harvest_monocrop", nogen keep (1 3)
	merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_W2_fertilizer_costs_`cn'.dta", nogen keep (1 3)	
	merge 1:1 household_id2 using "$ETH_W2_created_data/Ethiopia_ESS_W2_hh_rental_value_`cn'.dta", nogen keep (1 3)
	merge 1:1 household_id2 using "$ETH_W2_created_data/Ethiopia_ESS_W2_hh_pp_inputs_value_`cn'.dta", nogen keep (1 3)		
	merge 1:1 household_id2 using "$ETH_W2_created_data/Ethiopia_ESS_W2_hh_cost_harv_labor_`cn'.dta", nogen keep (1 3)	
}
...
*Land rights
merge 1:1 household_id2 using  "${ETH_W2_created_data}/Ethiopia_ESS_W2_land_rights_hh.dta", nogen keep (1 3)
la var formal_land_rights_hh "Household has documentation of land rights (at least one plot)"

*Crop yields 
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_yield_hh_level.dta", nogen keep (1 3)
merge 1:1 household_id2 using "$ETH_W2_created_data/Ethiopia_ESS_W2_hh_area_planted_harvested_allcrops.dta", nogen keep (1 3)
drop ha_planted_purestand - ha_planted_mixed_mixed 

*Household diet
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_household_diet.dta", nogen keep (1 3)

*Post-planting inputs
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_hh_pp_inputs_value.dta", nogen keep (1 3)

*Post-harvest inputs
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_hh_cost_harv_labor.dta", nogen keep (1 3)

*Other inputs
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_hh_cost_seed.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_fertilizer_application.dta", nogen keep (1 3)

*Crop production and losses
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_hh_crop_production.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_crop_losses.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_W2_crop_production_household.dta", nogen keep (1 3)

*Use variables
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_improvedseed_use.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_any_ext.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_vaccine.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_fin_serv.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_fert_use.dta", nogen keep (1 3)
...
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_livestock_sales.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_livestock_expenses.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_livestock_products.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_W2_TLU.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_W2_milk_animals.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_W2_eggs_animals.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_W2_herd_characteristics", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_W2_TLU_Coefficients", nogen keep (1 3)
gen ls_exp_vac = .
gen lost_disease = .  
...
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_wage_income.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_self_employment_income.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_other_income.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_assistance_income.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_W2_agwage_income.dta", nogen keep (1 3)
...
*Labor
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_W2_farmlabor_postplanting.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_W2_farmlabor_postharvest.dta", nogen keep (1 3)
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_ag_wage.dta", nogen keep (1 3)

*Off-farm hours
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_off_farm_hours.dta", nogen keep (1 3)

*Consumption
merge 1:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_consumption.dta", nogen keep (1 3)
...
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_W2_shannon_diversity_index.dta", nogen keep(1 3)

*Livestock health
merge 1:1 household_id2 using "${ETH_W2_created_data}\Ethiopia_ESS_W2_livestock_diseases.dta", nogen keep (1 3)
...
*Dairy costs 
merge 1:1 household_id2 using "$ETH_W2_created_data\Ethiopia_ESS_W2_lrum_expenses", nogen keep (1 3)
...
gen ccf_loc = (1+$ETH_LSMS_ISA_W2_inflation) 
lab var ccf_loc "currency conversion factor - 2016 $ETB"
gen ccf_usd = (1+$ETH_LSMS_ISA_W2_inflation) / $ETH_LSMS_ISA_W2_exchange_rate 
lab var ccf_usd "currency conversion factor - 2016 $USD"
gen ccf_1ppp = (1+$ETH_LSMS_ISA_W2_inflation) / $ETH_LSMS_ISA_W2_cons_ppp_dollar 
lab var ccf_1ppp "currency conversion factor - 2016 $Private Consumption PPP"
gen ccf_2ppp = (1+$ETH_LSMS_ISA_W2_inflation) / $ETH_LSMS_ISA_W2_gdp_ppp_dollar 
...
save "${ETH_W2_final_data}/Ethiopia_ESS_W2_household_variables.dta", replace
...
//               //
///////////////////
use "${ETH_W2_created_data}/Ethiopia_ESS_W2_crop_production_field.dta", clear
merge 1:1 household_id2 holder_id parcel_id field_id using "${ETH_W2_created_data}/Ethiopia_ESS_W2_field_area.dta", nogen keep(1 3)
merge 1:1 household_id2 holder_id parcel_id field_id using "${ETH_W2_created_data}/Ethiopia_ESS_W2_field_gender_dm.dta", nogen keep(1 3)
merge m:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_male_head.dta", nogen keep(1 3)		// weights
merge m:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_hhids.dta", nogen

merge 1:1 household_id2 holder_id parcel_id field_id using "${ETH_W2_created_data}\Ethiopia_ESS_W2_plot_farmlabor_postplanting.dta", keep (1 3) nogen
merge 1:1 household_id2 holder_id parcel_id field_id using "${ETH_W2_created_data}\Ethiopia_ESS_W2_plot_farmlabor_postharvest.dta", keep (1 3) nogen
...
save "${ETH_W2_final_data}/Ethiopia_ESS_W2_field_variables.dta", replace
...
**************
use "${ETH_W2_created_data}/Ethiopia_ESS_W2_control_income.dta", clear
merge 1:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_W2_ag_decision.dta", nogen keep(1 3)
merge 1:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_W2_women_asset.dta", nogen keep(1 3)
merge m:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_male_head.dta", nogen keep(1 3)
merge 1:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_W2_farmer_fert_use.dta", nogen  keep(1 3)
merge 1:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_W2_farmer_improvedseed_use.dta", nogen  keep(1 3)
merge 1:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_W2_farmer_vaccine.dta", nogen  keep(1 3)
merge m:1 household_id2 using "${ETH_W2_created_data}/Ethiopia_ESS_W2_hhids.dta", nogen
merge 1:1 household_id2 personid using "${ETH_W2_created_data}/Ethiopia_ESS_W2_land_rights_ind.dta", nogen
...
foreach cn in $topcropname_area {
	merge 1:1 household_id2 personid using "$ETH_W2_created_data/Ethiopia_ESS_W2_farmer_improvedseed_use_`cn'.dta", nogen
}
...
rename household_id2 hhid
preserve
use "${ETH_W2_final_data}/Ethiopia_ESS_W2_household_variables.dta", clear
keep hhid ag_hh
tempfile ag_hh
save `ag_hh'
restore
...
label define instrument 1 "Tanzania NPS Wave 1" 2 "Tanzania NPS Wave 2" 3 "Tanzania NPS Wave 3" 4 "Tanzania NPS Wave 4" /*
	...
	*/ 22 "Nigeria NIBAS AgDev (Niger)" 23 "Nigeria NIBAS AgDev (Kano)" 24 "Nigeria NIBAS AgDev (Katsina)" 
label values instrument instrument	
save "${ETH_W2_final_data}/Ethiopia_ESS_W2_individual_variables.dta", replace
...
global final_data_household  "${ETH_W2_final_data}/Ethiopia_ESS_W2_household_variables.dta"  
global final_data_individual "${ETH_W2_final_data}/Ethiopia_ESS_W2_individual_variables.dta"
global final_data_plot       "${ETH_W2_final_data}/Ethiopia_ESS_W2_field_variables.dta"
global final_outputfile      "$ETH_W2_final_data/Ethiopia_ESS_W2_summary_stats_`c(current_date)'.xlsx" 
...
*/ wage_paid_aglabor* fishing_income value_assets /*
