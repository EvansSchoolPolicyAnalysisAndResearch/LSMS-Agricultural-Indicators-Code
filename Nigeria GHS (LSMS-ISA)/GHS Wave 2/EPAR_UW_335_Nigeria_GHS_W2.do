...
*WEIGHTS							Nigeria_GHS_W2_weights.dta
...
*FORMALIZED LAND RIGHTS				Nigeria_GHS_W2_land_rights_hh.dta
*MONOCROPPED PLOTS					Nigeria_GHS_W2_[crop]_monocrop.dta
									Nigeria_GHS_W2_[crop]_monocrop_hh_area.dta
...
*GROSS CROP REVENUE					Nigeria_GHS_W2_cropsales_value.dta
									...
									Nigeria_GHS_W2_plot_cropvalue.dta
									Nigeria_GHS_W2_crop_losses.dta
*CROP EXPENSES						Nigeria_GHS_W2_wages_postplanting_[crop].dta
									Nigeria_GHS_W2_wages_postplanting.dta
									Nigeria_GHS_W2_wages_postharvest_[crop].dta
									Nigeria_GHS_W2_fertilizer_costs_[crop].dta
									Nigeria_GHS_W2_wages_postharvest.dta
									Nigeria_GHS_W2_fertilizer_costs_[crop].dta
									Nigeria_GHS_W2_fertilizer_costs.dta
									Nigeria_GHS_W2_chemical_costs_[crop]
									Nigeria_GHS_W2_chemical_costs.dta
									Nigeria_GHS_W2_manure_costs_[crop].dta
									Nigeria_GHS_W2_manure_costs.dta
									Nigeria_GHS_W2_seed_costs_[crop].dta
									Nigeria_GHS_W2_seed_costs.dta
									Nigeria_GHS_W2_land_rental_costs_[crop].dta
									Nigeria_GHS_W2_land_rental_costs.dta
									Nigeria_GHS_W2_asset_rental_costs.dta				

*LIVESTOCK INCOME					Nigeria_GHS_W2_livestock_expenses.dta
									Nigeria_GHS_W2_livestock_products.dta
									Nigeria_GHS_W2_livestock_sales.dta
									Nigeria_GHS_W2_herd_characteristics.dta
									Nigeria_GHS_W2_TLU.dta
									
*FISH INCOME						Nigeria_GHS_W2_fishing_expenses_1.dta
									Nigeria_GHS_W2_fishing_expenses_2.dta
									Nigeria_GHS_W2_fish_income.dta
																	
*SELF-EMPLOYMENT INCOME				Nigeria_GHS_W2_self_employment_income.dta
									Nigeria_GHS_W2_agproduct_income.dta
*OFF-FARM HOURS						Nigeria_GHS_W2_off_farm_hours.dta 			
...
*FARM LABOR							Nigeria_GHS_W2_family_hired_labor.dta
					
*VACCINE USAGE						Nigeria_GHS_W2_vaccine.dta
									Nigeria_GHS_W2_farmer_vaccine.dta
*ANIMAL HEALTH - DISEASES			Nigeria_GHS_W2_livestock_diseases.dta
*USE OF INORGANIC FERTILIZER		Nigeria_GHS_W2_fert_use.dta
*USE OF IMPROVED SEED				Nigeria_GHS_W2_improvedseed_use.dta
									Nigeria_GHS_W2_farmer_improvedseed_use.dta
*REACHED BY AG EXTENSION			Nigeria_GHS_W2_any_ext.dta
*USE OF FORMAL FINANACIAL SERVICES	Nigeria_GHS_W2_fin_serv.dta
*MILK PRODUCTIVITY					Nigeria_GHS_W2_milk_animals.dta
*EGG PRODUCTIVITY					Nigeria_GHS_W2_egg_animals.dta

*CROP PRODUCTION COSTS PER HECTARE	Nigeria_GHS_W2_hh_cost_land.dta
									Nigeria_GHS_W2_hh_cost_prep_labor.dta
									Nigeria_GHS_W2_hh_cost_mid_labor.dta
									Nigeria_GHS_W2_hh_cost_harv_labor.dta
									Nigeria_GHS_W2_hh_cost_seed.dta	
									Nigeria_GHS_W2_hh_cost_inputs.dta	
									Nigeria_GHS_W2_hh_cost_fert.dta
									Nigeria_GHS_W2_cropcosts.dta

*RATE OF FERTILIZER APPLICATION		Nigeria_GHS_W2_fertilizer_application.dta
...
*AGRICULTURAL WAGES					Nigeria_GHS_W2_ag_wage.dta
*CROP YIELDS						Nigeria_GHS_W2_yield_hh_crop_level.dta

*SHANNON DIVERSITY INDEX			Nigeria_GHS_W2_shannon_diversity_index.dta
*CONSUMPTION						Nigeria_GHS_W2_consumption.dta
*HOUSEHOLD FOOD PROVISION			Nigeria_GHS_W2_food_insecurity.dta
*HOUSEHOLD ASSETS					Nigeria_GHS_W2_hh_assets.dta
...
global NGA_W2_raw_data "$directory\Nigeria GHS\Nigeria GHS Wave 2\Raw DTA Files"
global NGA_W2_created_data  "$directory\Nigeria GHS\Nigeria GHS Wave 2\Final DTA Files\created_data"
global NGA_W2_final_data  "$directory\Nigeria GHS\Nigeria GHS Wave 2\Final DTA Files"
  

************************
*EXCHANGE RATE AND INFLATION FOR CONVERSION IN USD
************************
global NGA_GHS_W2_exchange_rate 199.04975		// https://www.bloomberg.com/quote/USDETB:CUR
global NGA_GHS_W2_gdp_ppp_dollar 93.915		// https://data.worldbank.org/indicator/PA.NUS.PPP
global NGA_GHS_W2_cons_ppp_dollar 123.639		// https://data.worldbank.org/indicator/PA.NUS.PRVT.P
global NGA_GHS_W2_inflation 0.362927552		// inflation rate 2013-2016. Data was collected during 2012-2013. We want to ajhust value to 2016
...
save  "${NGA_W2_created_data}\Nigeria_GHS_W2_hhids.dta", replace
...
keep hhid zone state lga ea wt_wave2 rural
rename wt_wave2 weight
save  "${NGA_W2_created_data}\Nigeria_GHS_W2_weights.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_person_ids.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_hhsize.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_male_head.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_areas.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_gender_merge_temp.dta", replace
...
duplicates drop hhid indiv, force
drop s1q36 s1q37b                
merge 1:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHS_W2_gender_merge_temp.dta", nogen 		
keep hhid indiv female age
save "${NGA_W2_created_data}/Nigeria_GHS_W2_gender_merge.dta", replace

*Using planting data 	
use "${NGA_W2_created_data}/Nigeria_GHS_W2_plot_areas.dta", clear 
	
//Post-Planting
*First manager 
gen indiv = s11aq6a
merge m:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHS_W2_gender_merge_temp.dta", gen(dm1_merge) keep(1 3) 
gen dm1_female = female if s11aq6a!=.
drop indiv 

*Second manager 
gen indiv = s11aq6b
merge m:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHS_W2_gender_merge_temp.dta", gen(dm2_merge) keep(1 3)			
...
*First manager 
gen indiv = sa1q11
merge m:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHS_W2_gender_merge_temp.dta", gen(dm4_merge) keep(1 3)			
gen dm3_female = female & sa1q11!=.
drop indiv 

*Second manager 
gen indiv = sa1q11b
merge m:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHS_W2_gender_merge_temp.dta", gen(dm5_merge) keep(1 3)			
...
merge m:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_hhsize.dta", nogen keep(1 3)
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_decision_makers", replace
...
preserve
	ren s11b1q6a indiv
	merge m:1 hhid indiv using "${NGA_W2_created_data}\Nigeria_GHS_W2_person_ids.dta", nogen keep(3)		
...
preserve
	...
	save "${NGA_W2_created_data}\Nigeria_GHS_W2_land_rights_ind.dta", replace
restore	
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_land_rights_hh.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_ng3_cf.dta", replace
...
merge m:1 crop_code unit_cd   using "${NGA_W2_created_data}/Nigeria_GHS_W2_ng3_cf.dta", gen(cf_merge)
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_`cn'_monocrop.dta", replace

*merge in plot decision makers
merge m:1 hhid plot_id using  "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_decision_makers", keep(3)
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_`cn'_monocrop_hh_area.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_TLU_Coefficients.dta", replace
...
gen observation=1
merge m:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_weights.dta"
...
save  "${NGA_W2_created_data}\Nigeria_GHS_W2_crop_prices_median_state.dta", replace
...
rename quantity_harvested_unit unit
save  "${NGA_W2_created_data}\Nigeria_GHS_W2_crop_prices_median_zone.dta", replace
...
rename quantity_harvested_unit unit
save  "${NGA_W2_created_data}\Nigeria_GHS_W2_crop_prices_median_country.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_cropsales_value.dta", replace
...
merge m:1 state zone unit crop_code using "${NGA_W2_created_data}\Nigeria_GHS_W2_crop_prices_median_state.dta", nogen keep(1 3)
merge m:1 zone unit crop_code using "${NGA_W2_created_data}\Nigeria_GHS_W2_crop_prices_median_zone.dta", nogen keep(1 3) 
merge m:1 unit crop_code using "${NGA_W2_created_data}\Nigeria_GHS_W2_crop_prices_median_country.dta", nogen keep(1 3) 
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_crop_values_tempfile.dta", replace

recode crop_code (2170=2030) //recoding plantains as bananas for Nigeria
collapse (sum) value_harvest , by (hhid crop_code)
save  "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_crop_values_production.dta", replace 
merge 1:1 hhid crop_code using "${NGA_W2_created_data}\Nigeria_GHS_W2_cropsales_value.dta"
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_crop_production.dta", replace

*Generating value of crop production at plot level
use "${NGA_W2_created_data}\Nigeria_GHS_W2_crop_values_tempfile.dta", clear
rename plotid plot_id
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_cropvalue.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_crop_prices_for_wages.dta", replace
...
preserve
	...
	ren plotid plot_id
	merge m:1 hhid plot_id using  "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_decision_makers", nogen keep(1 3) keepusing(dm_gender)
	...
	*merge in monocropped plots only
	merge m:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHS_W2_`cn'_monocrop.dta", nogen assert(1 3) keep(3)
	...
	save "${NGA_W2_created_data}\Nigeria_GHS_W2_wages_postplanting_`cn'.dta", replace
restore
}
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_wages_postplanting.dta", replace
...
rename sa2q11c unit
merge m:1 hhid crop_code unit using "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_crop_prices_for_wages.dta", nogen keep (1 3)
merge m:1 crop_code unit using "${NGA_W2_created_data}\Nigeria_GHS_W2_crop_prices_median_country.dta", nogen keep (1 3)
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${NGA_W2_created_data}\Nigeria_GHS_W2_wages_postharvest_`cn'.dta", replace
restore
}
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_wages_postharvest.dta", replace
...
preserve
	...
	*dissagregate by gender of the plot manager 
	merge m:1 hhid plot_id using  "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_decision_makers"
	...
	*Merge in monocropped plots
	...
	save "${NGA_W2_created_data}\Nigeria_GHS_W2_fertilizer_costs_`cn'.dta", replace
restore
}
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_fertilizer_costs.dta", replace
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${NGA_W2_created_data}\Nigeria_GHS_W2_chemical_costs_`cn'.dta", replace
restore
}
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_chemical_costs.dta", replace
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${NGA_W2_created_data}\Nigeria_GHS_W2_manure_costs_`cn'.dta", replace
restore
}
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_manure_costs.dta", replace
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${NGA_W2_created_data}\Nigeria_GHS_W2_seed_costs_`cn'.dta", replace
restore
}
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_seed_costs.dta", replace
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${NGA_W2_created_data}\Nigeria_GHS_W2_land_rental_costs_`cn'.dta", replace
restore
}

collapse (sum) rental_cost_land, by (hhid)
lab var rental_cost_land "Rental costs paid for land"
save "${NGA_W2_created_data}\Nigeria_GHS_W2_land_rental_costs.dta", replace
...
rename plotid plot_id
merge 1:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_areas.dta" 
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_asset_rental_costs.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_expenses.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_livestock_products.dta", replace

use "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_livestock_products", clear
merge m:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_weights.dta"
drop if _merge==2
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_products_prices_country.dta", replace
...
merge m:1 livestock_code unit using "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_products_prices_country.dta", nogen keep(1 3) 
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_products.dta", replace
...
merge m:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_weights.dta", nogen keep(1 3) 
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_livestock_sales", replace

*Implicit prices (based on observed sales)
use "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_prices_ea.dta", replace
use "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_prices_lga.dta", replace
use "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_prices_state.dta", replace
use "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_prices_zone.dta", replace
use "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_prices_country.dta", replace

use "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_livestock_sales", clear
merge m:1 zone state lga ea livestock_code using "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_prices_ea.dta", nogen 
merge m:1 zone state lga livestock_code using "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_prices_lga.dta", nogen 
merge m:1 zone state livestock_code using "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_prices_state.dta", nogen 
merge m:1 zone livestock_code using "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_prices_zone.dta", nogen 
merge m:1 livestock_code using "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_prices_country.dta", nogen 
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_sales.dta", replace
...
preserve
	...
	*Total livestock holding for large ruminants, small ruminants, and poultry
	...
	save "${NGA_W2_created_data}\Nigeria_GHS_W2_herd_characteristics", replace
restore
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_TLU.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_fish_prices_1.dta", replace /* Caught fish */
...
rename price_per_unit price_per_unit_median
replace price_per_unit_median = . if fish_code==5 /* "Other */
save "${NGA_W2_created_data}\Nigeria_GHS_W2_fish_prices_2.dta", replace /* Harvested fish */
...
merge m:1 fish_code unit using "${NGA_W2_created_data}\Nigeria_GHS_W2_fish_prices_1.dta", nogen keep(1 3)
...
merge m:1 fish_code unit using "${NGA_W2_created_data}\Nigeria_GHS_W2_fish_prices_2.dta", nogen keep(1 3)
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_fish_income.dta", replace
...
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_fish_income.dta"
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_fishing_expenses_1.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_fishing_expenses_2.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_self_employment_income.dta", replace
...
gen price_per_unit = value_harvested / quantity_harvested
save "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_crop_unit_values.dta", replace
**********************************************************************************
use "${NGA_W2_raw_data}\Post Harvest Wave 2\Agriculture\secta3_harvestw2.dta", clear
rename cropname crop_name
rename cropcode crop_code
...
merge m:1 hhid crop_code unit using "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_crop_unit_values.dta", nogen keep(1 3)
merge m:1 crop_code unit using "${NGA_W2_created_data}\Nigeria_GHS_W2_crop_prices_median_country.dta", nogen keep(1 3)
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_agproduct_income.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_off_farm_hours.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_wage_income.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_agwage_income.dta", replace 
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_remittance_income.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_other_income.dta", replace
...
merge m:1 plot_id hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_plot_areas.dta", nogen keep(1 3)
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_planted_areas.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_parcels_cultivated.dta", replace

use "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_areas.dta", clear
merge m:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHS_W2_parcels_cultivated.dta"
keep if cultivated==1
collapse (sum) field_size, by (hhid plot_id)
save "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_sizes.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_land_size.dta", replace
...
merge m:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHS_W2_parcels_cultivated.dta", nogen keep(1 3)
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_parcels_agland.dta", replace


use "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_areas.dta", clear
merge 1:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHS_W2_parcels_agland.dta", nogen
merge 1:m hhid plot_id using "${NGA_W2_created_data}/Nigeria_GHS_W2_planted_areas.dta", nogen	
keep if agland==1
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_farmsize_all_agland.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_land_size_total.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_parcels_held.dta", replace

use "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_areas.dta", clear
merge 1:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHS_W2_parcels_held.dta", nogen
keep if plot_held==1
collapse (sum) field_size, by (hhid)
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_land_size_all.dta", replace 
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_farmlabor_postplanting.dta", replace
collapse (sum) days_hired_postplant days_famlabor_postplant, by (hhid)
lab var days_hired_postplant "Workdays for hired labor (crops), as captured in post-planting survey"
lab var days_famlabor_postplant "Workdays for family labor (crops), as captured in post-planting survey"
save "${NGA_W2_created_data}\Nigeria_GHS_W2_farmlabor_postplanting.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_farmlabor_postharvest.dta", replace 
collapse (sum) days_hired_postharvest days_famlabor_postharvest days_exchange_labor_postharvest, by (hhid)
lab var days_hired_postharvest "Workdays for hired labor (crops), as captured in post-harvest survey"
lab var days_famlabor_postharvest "Workdays for family labor (crops), as captured in post-harvest survey"
lab var days_exchange_labor_postharvest "Workdays (lower-bound estimate) of exchange labor, as captured in post-harvest survey"
save "${NGA_W2_created_data}\Nigeria_GHS_W2_farmlabor_postharvest.dta", replace 

*labor 
use "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_farmlabor_postplanting.dta", clear
merge 1:1  hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_farmlabor_postharvest.dta", nogen
recode days*  (.=0)
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_family_hired_labor.dta", replace
recode labor_*  (.=0)
...
lab var labor_family "Total labor days (family) allocated to the farm in the past year"
lab var labor_total "Total labor days (hired +family) allocated to the farm in the past year" 
save "${NGA_W2_created_data}\Nigeria_GHS_W2_family_hired_labor.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_vaccine.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_farmer_vaccine.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_diseases.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_fert_use.dta", replace 
...
gen indiv=farmerid
drop if indiv==.
merge 1:1 hhid indiv using "${NGA_W2_created_data}\Nigeria_GHS_W2_gender_merge.dta", nogen
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_farmer_fert_use.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_improvedseed_use.dta", replace 

forvalues k=1/12 {
*Improved use by farmers ( a farmer is an individual listed as plot manager)
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11e_plantingw2.dta", clear
ren plotid plot_id
merge m:1 hhid plot_id using  "${NGA_W2_created_data}/Nigeria_GHS_W2_plot_areas.dta"
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_farmer_improvedseed_use_temp_`cn'.dta", replace

}

*Combining all crop disaggregated files together
foreach v in $topcropname_area {
	merge 1:1 hhid farmerid all_imprv_seed_use using "${NGA_W2_created_data}/Nigeria_GHS_W2_farmer_improvedseed_use_temp_`v'.dta", nogen
}
...
recode farm_manager (.=0)
lab var farm_manager "1=Indvidual is listed as a manager for at least one plot" 
save "${NGA_W2_created_data}/Nigeria_GHS_W2_farmer_improvedseed_use.dta", replace 
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_any_ext.dta", replace 
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_fin_serv.dta", replace 
...
use "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_livestock_products.dta", clear
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_milk_animals.dta", replace
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_egg_animals.dta", replace
...
use "${NGA_W2_raw_data}\Post Planting Wave 2\Agriculture\sect11b1_plantingw2.dta", clear
ren plotid plot_id
merge 1:1 plot_id hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_areas", nogen keep(1 3)
merge 1:1 plot_id hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_decision_makers", nogen keep (1 3)
...
preserve
	...
	save "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_rental_rate.dta", replace
restore
...
preserve
	...
	save "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_cultivated_plots_ha.dta", replace
restore
...
preserve
	...
	drop field_size
	save "${NGA_W2_created_data}/Nigeria_GHS_W2_rental_rate_hh.dta", replace	
restore
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_rental_rate.dta", replace
...
ren plotid plot_id
*Merging in gender of plot manager
merge m:1 plot_id hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_plot_areas", nogen keep(1 3)
...
*Rescaling
merge m:1 plot_id hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_plot_areas", nogen keep(1 3)	
merge m:1 plot_id hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_decision_makers", nogen keep(1 3)
...
merge m:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_rental_rate_hh.dta", nogen keep(1 3)			// household's average rental rate (total rent paid divided by total ha rented at household level)
merge m:1 zone state lga sector using "${NGA_W2_created_data}/Nigeria_GHS_W2_rental_rate.dta", nogen keep(1 3)	// aggregate rental rates
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_cost_land.dta", replace
...
*Merging in gender of plot manager
rename plotid plot_id
merge m:1 plot_id hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_decision_makers", nogen keep(1 3) keepusing (dm_gender)
...
preserve
	...
	keep wage_*_hh hhid
	save "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_wages_prep.dta", replace
restore
...
merge m:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_wages_prep.dta", nogen keep(1 3)		// merging in household-level wage rates; all matched
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_cost_prep_labor.dta", replace
...
preserve
	...
	keep wage_*_hh hhid
	save "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_wages_harv.dta", replace
restore
...
*And here are the total costs
merge m:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_wages_harv.dta", nogen keep(1 3)	
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_cost_harv_labor.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_cost_seed.dta", replace
...
preserve			
	...
	save "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_pest_price.dta", replace
restore
merge m:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_pest_price.dta", nogen
...
preserve
	...
	save "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_herb_price.dta", replace
restore
merge m:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_herb_price.dta", nogen
drop value_herb_*
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_cost_inputs.dta", replace
...
preserve
	...
	save "${NGA_W2_created_data}/Nigeria_GHS_W2_fert_price_hh.dta", replace
restore
*Merging prices back in immediately
merge m:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_fert_price_hh.dta", nogen assert(3)		// all matched
...
preserve
	...
	save "${NGA_W2_created_data}/Nigeria_GHS_W2_org_fert_price_hh.dta", replace
restore
*Immediately merging back in
merge m:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_org_fert_price_hh.dta", nogen assert(3)
...
preserve
	...
	save "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_fert.dta", replace
restore
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_cost_fert.dta", replace


use "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_cost_land.dta", clear
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_rental_rate.dta", nogen
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_cost_prep_labor.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_cost_harv_labor.dta", nogen keep(1 3)		
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_cost_fert.dta", nogen keep(1 3)			
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_cost_inputs.dta", nogen keep(1 3)			
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_cost_seed.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_male_head.dta", nogen keep(1 3)
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_cropcosts.dta", replace
...
use "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_fert.dta", clear
merge m:1 hhid using  "${NGA_W2_created_data}\Nigeria_GHS_W2_hhids.dta", keep (1 3) nogen
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_fert_use.dta", keep(1 3) nogen
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_fertilizer_application.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_household_diet.dta", replace
...
merge 1:1 hhid indiv using "${NGA_W2_created_data}\Nigeria_GHS_W2_person_ids.dta", nogen
recode control_* (.=0)
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_control_income.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_make_ag_decision.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_ownasset.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_ag_wage.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_crop_area_planted", replace
...
merge m:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_areas.dta", nogen keep(1 3)
*merging in planted areas
merge 1:1 hhid plot_id cropid using "${NGA_W2_created_data}\Nigeria_GHS_W2_crop_area_planted.dta",gen(plant_harv_merge) keep(1 3)
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_crop_kgs_harvest", replace	
restore
 
*merging in gender variables
merge m:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_decision_makers", gen(_merge_gender)
drop if quant_harv_kg==. 
drop area_harv
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_crop_area_plan.dta", replace
...
preserve
	...
	save "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_area_planted_harvested_allcrops.dta", replace
restore
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_crop_harvest_area_yield.dta", replace



*Yield at the household level
use "${NGA_W2_created_data}/Nigeria_GHS_W2_crop_harvest_area_yield.dta", clear
*Value of crop production
merge 1:1 hhid crop_code using "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_crop_values_production.dta", nogen keep(1 3)
ren value_crop_production value_harv
ren value_crop_sales value_sold
merge 1:1 hhid crop_code using "${NGA_W2_created_data}/Nigeria_GHS_W2_crop_kgs_harvest.dta", nogen keep(1 3)
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_yield_hh_crop_level.dta", replace
...
use "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_crop_area_plan.dta", clear
...
preserve 
	...
	save "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_crop_area_plan_shannon.dta", replace
restore

merge m:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_crop_area_plan_shannon.dta", nogen		//all matched
...
save "${NGA_W2_created_data}\Nigeria_GHS_W2_shannon_diversity_index.dta", replace 
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_adulteq.dta", replace 

use "${NGA_W2_raw_data}\cons_agg_w2.dta", clear
ren  hhtexp_dr_w2 total_cons  
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_adulteq.dta"
ren  pcexp_dr_w2 percapita_cons
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_consumption.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_food_insecurity.dta", replace
...
save "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_assets.dta", replace 
...
use "${NGA_W2_created_data}\Nigeria_GHS_W2_hhids.dta", clear

*Gross crop income 
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_hh_crop_production.dta", nogen keep(1 3)
recode value_crop_production (.=0)

*Crop costs
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_asset_rental_costs.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_land_rental_costs.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_seed_costs.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_manure_costs.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_chemical_costs.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_fertilizer_costs.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_wages_postplanting.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_wages_postharvest.dta", nogen keep(1 3)
...
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_land_rental_costs_`c'.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_seed_costs_`c'.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_fertilizer_costs_`c'.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_chemical_costs_`c'.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_manure_costs_`c'.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_wages_postplanting_`c'.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_wages_postharvest_`c'.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_`c'_monocrop_hh_area.dta", nogen keep(1 3)
}
...
drop rental_cost_land_* cost_seed_* value_fertilizer_* cost_trans_fert_* value_herbicide_* value_pesticide_* /*
	*/ value_manure_purch_* cost_trans_manure_* wages_paid_pp_* wages_paid_ph_*

*Land rights
merge 1:1 hhid using  "${NGA_W2_created_data}\Nigeria_GHS_W2_land_rights_hh.dta", nogen keep(1 3)
la var formal_land_rights_hh "Household has documentation of land rights (at least one plot)"

*Fish income
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_fish_income.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_fishing_expenses_1.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_fishing_expenses_2.dta", nogen keep(1 3)
...
*Livestock income
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_sales.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_expenses.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_livestock_products.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_TLU.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_herd_characteristics.dta", nogen keep(1 3)
...
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_TLU_Coefficients.dta", nogen keep(1 3)
...
*Self-employment income
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_self_employment_income.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_agproduct_income.dta", nogen keep(1 3)
...
*Wage income
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_agwage_income.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_wage_income.dta", nogen keep(1 3)
...
*Off-farm hours
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_off_farm_hours.dta", nogen keep(1 3)

*Other income
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_other_income.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_remittance_income.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_other_income.dta", nogen keep(1 3)
...
*Farm size
merge 1:1 hhid using  "${NGA_W2_created_data}\Nigeria_GHS_W2_land_size.dta", nogen keep(1 3)
merge 1:1 hhid using  "${NGA_W2_created_data}\Nigeria_GHS_W2_land_size_all.dta", nogen keep(1 3)
merge 1:1 hhid using  "${NGA_W2_created_data}\Nigeria_GHS_W2_farmsize_all_agland.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_land_size_total.dta", nogen
recode land_size (.=0)
...
*Labor
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_family_hired_labor.dta", nogen keep(1 3)
recode labor_hired labor_family (.=0) 

*Household size
merge 1:1 hhid using  "${NGA_W2_created_data}\Nigeria_GHS_W2_hhsize.dta", nogen keep(1 3)
 
*Rates of vaccine usage, improved seeds, etc.
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_vaccine.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_fert_use.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_improvedseed_use.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_any_ext.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_fin_serv.dta", nogen keep(1 3)
...
*Milk productivity
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_milk_animals.dta", nogen keep(1 3)
gen costs_dairy = .
...
*Egg productivity
merge 1:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_egg_animals.dta", nogen keep(1 3)
...
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_cropcosts.dta", nogen keep(1 3)
 
*Rate of fertilizer application 
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_fertilizer_application.dta", nogen keep(1 3)

*Agricultural wage rate
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_ag_wage.dta", nogen keep(1 3)

*Crop yields 
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_yield_hh_crop_level.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_area_planted_harvested_allcrops.dta", nogen keep(1 3)
  
*Household diet
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_household_diet.dta", nogen keep(1 3)

*Consumption
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_consumption.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_adulteq.dta", nogen keep(1 3)

*Household assets
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_hh_assets.dta", nogen keep(1 3)

*Food insecurity
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_food_insecurity.dta", nogen keep(1 3)
gen hhs_little = . 
gen hhs_moderate = . 
gen hhs_severe = . 
gen hhs_total = . 
...
*Shannon Diversity index
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_shannon_diversity_index.dta", nogen keep(1 3)

*Livestock health
merge 1:1 hhid using "${NGA_W2_created_data}/Nigeria_GHS_W2_livestock_diseases.dta", nogen keep(1 3)
...
*Second, we inflate the local currency to the year that this survey was carried out using the CPI inflation rate using https://data.worldbank.org/indicator/FP.CPI.TOTL?end=2017&locations=TZ&start=2003
	// 1+(134.925 - 110.84)/110.84 = 1.2172952	
	// 151.1089* 1.2172952 = 183.94414 N
...
gen poverty_under_1_9 = (daily_percap_cons<183.94414)
...
gen ccf_loc = (1 + $NGA_GHS_W2_inflation) 
lab var ccf_loc "currency conversion factor - 2016 $NGN"
gen ccf_usd = (1 + $NGA_GHS_W2_inflation)/$NGA_GHS_W2_exchange_rate 
lab var ccf_usd "currency conversion factor - 2016 $USD"
gen ccf_1ppp = (1 + $NGA_GHS_W2_inflation)/ $NGA_GHS_W2_cons_ppp_dollar
lab var ccf_1ppp "currency conversion factor - 2016 $Private Consumption PPP"
gen ccf_2ppp = (1 + $NGA_GHS_W2_inflation)/ $NGA_GHS_W2_gdp_ppp_dollar
...
*/ value_rented_land_* value_hired* value_fam* /*
...
save "${NGA_W2_final_data}/Nigeria_GHS_W2_household_variables.dta", replace

 
**************
*INDIVIDUAL-LEVEL VARIABLES
**************
use "${NGA_W2_created_data}\Nigeria_GHS_W2_person_ids.dta", clear
merge 1:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHS_W2_control_income.dta", nogen  keep(1 3)
merge 1:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHS_W2_make_ag_decision.dta", nogen  keep(1 3)
merge 1:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHS_W2_ownasset.dta", nogen  keep(1 3)
merge m:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_hhsize.dta", nogen keep (1 3)
merge 1:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHS_W2_farmer_fert_use.dta", nogen  keep(1 3)
merge 1:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHS_W2_farmer_improvedseed_use.dta", nogen  keep(1 3)
merge 1:1 hhid indiv using "${NGA_W2_created_data}/Nigeria_GHS_W2_farmer_vaccine.dta", nogen  keep(1 3)
merge m:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_hhids.dta", nogen keep (1 3)

*Land rights
merge 1:1 hhid indiv using "${NGA_W2_created_data}\Nigeria_GHS_W2_land_rights_ind.dta", nogen
...
preserve
use "${NGA_W2_final_data}/Nigeria_GHS_W2_household_variables.dta", clear
keep hhid ag_hh
tempfile ag_hh
save `ag_hh'
restore
...
save "${NGA_W2_final_data}/Nigeria_GHS_W2_individual_variables.dta", replace
...
use "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_areas.dta", clear
merge m:1 hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_weights.dta", keep (1 3) nogen
merge 1:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_cropvalue.dta", keep (1 3) nogen
merge 1:1 hhid plot_id using "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_decision_makers", keep (1 3) nogen // Bring in the gender file
merge 1:1 plot_id hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_farmlabor_postharvest.dta", keep (1 3) nogen
merge 1:1 plot_id  hhid using "${NGA_W2_created_data}\Nigeria_GHS_W2_plot_farmlabor_postplanting.dta", keep (1 3) nogen
keep if cultivate==1
...
foreach p of global monetary_val {
	gen `p'_1ppp = (1 + $NGA_GHS_W2_inflation) * `p' / $NGA_GHS_W2_cons_ppp_dollar
	gen `p'_2ppp = (1 + $NGA_GHS_W2_inflation) * `p' / $NGA_GHS_W2_gdp_ppp_dollar
	gen `p'_usd = (1 + $NGA_GHS_W2_inflation) * `p' / $NGA_GHS_W2_exchange_rate
	gen `p'_loc = (1 + $NGA_GHS_W2_inflation) * `p'
	local l`p' : var lab `p' 
	...
	lab var `p' "`l`p'' (NGN)"  
	gen w_`p'_1ppp = (1 + $NGA_GHS_W2_inflation) * w_`p' / $NGA_GHS_W2_cons_ppp_dollar
	gen w_`p'_2ppp = (1 + $NGA_GHS_W2_inflation) * w_`p' / $NGA_GHS_W2_gdp_ppp_dollar
	gen w_`p'_usd = (1 + $NGA_GHS_W2_inflation) * w_`p' / $NGA_GHS_W2_exchange_rate
	gen w_`p'_loc = (1 + $NGA_GHS_W2_inflation) * w_`p' 
...
save "${NGA_W2_final_data}\Nigeria_GHS_W2_gender_productivity_gap.dta", replace
...
global final_data_household  "${NGA_W2_final_data}/Nigeria_GHS_W2_household_variables.dta"  
global final_data_individual "${NGA_W2_final_data}/Nigeria_GHS_W2_individual_variables.dta"
global final_data_plot       "${NGA_W2_final_data}\Nigeria_GHS_W2_gender_productivity_gap.dta"
global final_outputfile      "${NGA_W2_final_data}\Nigeria_GHS_W2_summary_stats_XXXXXX.xlsx" //Update output file date
