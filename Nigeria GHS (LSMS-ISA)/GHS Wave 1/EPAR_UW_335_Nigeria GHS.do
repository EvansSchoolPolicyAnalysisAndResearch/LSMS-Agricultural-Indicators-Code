...
global NGA_W1_raw_data 		"$directory\Nigeria GHS\Nigeria GHS Wave 1\Raw DTA Files"
global NGA_W1_created_data  "$directory\Nigeria GHS\Nigeria GHS Wave 1\Final DTA Files\created_data"
global NGA_W1_final_data  	"$directory\Nigeria GHS\Nigeria GHS Wave 1\Final DTA Files"
    
  
************************
*EXCHANGE RATE AND INFLATION FOR CONVERSION IN USD
************************
global NGA_GHS_W1_exchange_rate 199.04975  		// https://www.bloomberg.com/quote/USDETB:CUR
global NGA_GHS_W1_gdp_ppp_dollar 93.915			// https://data.worldbank.org/indicator/PA.NUS.PRVT.P
global NGA_GHS_W1_cons_ppp_dollar 123.639			// https://data.worldbank.org/indicator/PA.NUS.PRVT.P
global NGA_GHS_W1_inflation 0.6591				// inflation rate 2011-2016. Data was collected during 2010-2011. We want to ajhust value to 2016
...
save  "${NGA_W1_created_data}\Nigeria_GHS_W1_hhids.dta", replace
...
keep hhid zone state lga ea wt_wave1 rural
rename wt_wave1 weight
save  "${NGA_W1_created_data}\Nigeria_GHS_W1_weights.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_person_ids.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_hhsize.dta", replace
...
save "$NGA_W1_created_data/Nigeria_GHS_W1_male_head.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_areas.dta", replace
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_gender_merge_temp.dta", replace
...
duplicates drop hhid indiv, force
merge 1:1 hhid indiv using "$NGA_W1_created_data/Nigeria_GHS_W1_gender_merge_temp.dta", nogen 	
keep hhid indiv female age
save "${NGA_W1_created_data}/Nigeria_GHS_W1_gender_merge.dta", replace

*Using planting data 	
use "${NGA_W1_created_data}/Nigeria_GHS_W1_plot_areas.dta", clear 
	
//Post-Planting
*First manager 
gen indiv = s11aq6
merge m:1 hhid indiv using "${NGA_W1_created_data}/Nigeria_GHS_W1_gender_merge_temp.dta", gen(dm1_merge) keep(1 3) 
...
*First manager 
gen indiv = sa1q11
merge m:1 hhid indiv using "${NGA_W1_created_data}/Nigeria_GHS_W1_gender_merge_temp.dta", gen(dm3_merge) keep(1 3)			
...
merge m:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_hhsize.dta", nogen keep(1 3)
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_decision_makers.dta", replace
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_ng1_cf.dta", replace
...
merge m:1 crop_code unit_cd using "${NGA_W1_created_data}/Nigeria_GHS_W1_ng1_cf.dta", gen(cf_merge)
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_`cn'_monocrop.dta", replace


*merge in plot decision makers
merge m:1 hhid plot_id using  "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_decision_makers", keep(3)
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_`cn'_monocrop_hh_area.dta", replace
}
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_TLU_Coefficients.dta", replace
...
gen observation=1
merge m:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_weights.dta"
...
save  "${NGA_W1_created_data}\Nigeria_GHS_W1_crop_prices_median_state.dta", replace
...
rename quantity_harvested_unit unit
save  "${NGA_W1_created_data}\Nigeria_GHS_W1_crop_prices_median_zone.dta", replace
...
rename quantity_harvested_unit unit
save  "${NGA_W1_created_data}\Nigeria_GHS_W1_crop_prices_median_country.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_cropsales_value.dta", replace
...
merge m:1 state zone unit crop_code using "${NGA_W1_created_data}\Nigeria_GHS_W1_crop_prices_median_state.dta", nogen keep(1 3) 
merge m:1 zone unit crop_code using "${NGA_W1_created_data}\Nigeria_GHS_W1_crop_prices_median_zone.dta", nogen keep(1 3)  
merge m:1 unit crop_code using "${NGA_W1_created_data}\Nigeria_GHS_W1_crop_prices_median_country.dta", nogen keep(1 3) 
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_crop_values_tempfile.dta", replace 

recode crop_code (2170=2030) //recoding plantains as bananas for Nigeria
collapse (sum) value_harvest , by (hhid crop_code)
save  "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_crop_values_production.dta", replace 
merge 1:1 hhid crop_code using "${NGA_W1_created_data}\Nigeria_GHS_W1_cropsales_value.dta"
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_crop_production.dta", replace



*Generating value of crop production at plot level
use "${NGA_W1_created_data}\Nigeria_GHS_W1_crop_values_tempfile.dta", clear
rename plotid plot_id
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_cropvalue.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_crop_prices_for_wages.dta", replace
...
rename sa2q11c unit
merge m:1 hhid crop_code unit using "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_crop_prices_for_wages.dta", nogen keep (1 3)
merge m:1 crop_code unit using "${NGA_W1_created_data}\Nigeria_GHS_W1_crop_prices_median_country.dta", nogen keep (1 3)
...
preserve
	...
	*disaggregate by gender of plot manager
	merge m:1 plot_id hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_decision_makers", nogen keep(1 3) keepusing(dm_gender)
	...
	*Merge in monocropped plots
	merge m:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHS_W1_`cn'_monocrop.dta", nogen assert(1 3) keep(3)
	...
	save "${NGA_W1_created_data}\Nigeria_GHS_W1_wages_postharvest_`cn'.dta", replace
restore
}
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_wages_postharvest.dta", replace
...
preserve
	...
	*Merge in monocropped plots
	merge 1:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHS_W1_`cn'_monocrop.dta", nogen assert(1 3) keep(3)		
	...
	save "${NGA_W1_created_data}\Nigeria_GHS_W1_fertilizer_costs_`cn'.dta", replace
restore
}
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_fertilizer_costs.dta", replace
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${NGA_W1_created_data}\Nigeria_GHS_W1_chemical_costs_`cn'.dta", replace
restore
}
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_chemical_costs.dta", replace
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${NGA_W1_created_data}\Nigeria_GHS_W1_seed_costs_`cn'.dta", replace
restore
}
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_seed_costs.dta", replace
...
preserve
	...
	*Merge in monocropped plots
	...
	save "${NGA_W1_created_data}\Nigeria_GHS_W1_land_rental_costs_`cn'.dta", replace
restore
}
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_land_rental_costs.dta", replace
...
rename plotid plot_id
merge 1:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_areas.dta" 
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_asset_rental_costs.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_expenses.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_livestock_products.dta", replace

use "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_livestock_products", clear
merge m:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_weights.dta"
drop if _merge==2
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_products_prices_country.dta", replace
...
merge m:1 livestock_code unit using "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_products_prices_country.dta", nogen keep(1 3) 
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_products.dta", replace
...
merge m:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_weights.dta", nogen keep(1 3) 
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_livestock_sales", replace
*Note that we could have used respondent estimates of the value of their livestock.

*Implicit prices (based on observed sales)
use "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_prices_ea.dta", replace
use "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_prices_lga.dta", replace
use "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_prices_state.dta", replace
use "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_prices_zone.dta", replace
use "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_livestock_sales", clear
gen observation = 1
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_prices_country.dta", replace

use "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_livestock_sales", clear
merge m:1 zone state lga ea livestock_code using "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_prices_ea.dta", nogen 
merge m:1 zone state lga livestock_code using "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_prices_lga.dta", nogen 
merge m:1 zone state livestock_code using "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_prices_state.dta", nogen 
merge m:1 zone livestock_code using "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_prices_zone.dta", nogen 
merge m:1 livestock_code using "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_prices_country.dta", nogen 
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_sales.dta", replace
...
preserve
	...
	*Now dropping these missing variables, which I only used to construct the labels above
	...
	save "${NGA_W1_created_data}\Nigeria_GHS_W1_herd_characteristics", replace
restore
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_TLU.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_fish_prices_1.dta", replace /* Caught fish */
...
rename price_per_unit price_per_unit_median
replace price_per_unit_median = . if fish_code==5 /* "Other */
save "${NGA_W1_created_data}\Nigeria_GHS_W1_fish_prices_2.dta", replace /* Harvested fish */
...
merge m:1 fish_code unit using "${NGA_W1_created_data}\Nigeria_GHS_W1_fish_prices_1.dta", nogen keep(1 3)
...
merge m:1 fish_code unit using "${NGA_W1_created_data}\Nigeria_GHS_W1_fish_prices_2.dta", nogen keep(1 3)
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_fish_income.dta", replace
...
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_fish_income.dta"
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_fishing_expenses_1.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_fishing_expenses_2.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_self_employment_income.dta", replace
...
gen price_per_unit = value_harvested / quantity_harvested
save "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_crop_unit_values.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_off_farm_hours.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_wage_income.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_agwage_income.dta", replace 
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_remittance_income.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_other_income.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_land_rental_income.dta", replace
...
merge m:1 plot_id hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_plot_areas", nogen keep(1 3)
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_planted_areas.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_parcels_cultivated.dta", replace

use "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_areas.dta", clear
//we want to report the plot is cultivated if it is cultivated in either section
rename cultivate cultivated_1
merge m:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHS_W1_parcels_cultivated.dta"
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_sizes.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_land_size.dta", replace
...
merge m:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHS_W1_parcels_cultivated.dta", nogen 
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_parcels_agland.dta", replace


use "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_areas.dta", clear
merge 1:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHS_W1_parcels_agland.dta", nogen
merge 1:m hhid plot_id using "${NGA_W1_created_data}/Nigeria_GHS_W1_planted_areas.dta", nogen
keep if agland==1
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_farmsize_all_agland.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_land_size_total.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_parcels_held.dta", replace

use "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_areas.dta", clear
merge 1:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHS_W1_parcels_held.dta", nogen
keep if plot_held==1
collapse (sum) field_size, by (hhid)
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_land_size_all.dta", replace 
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_farmlabor_postharvest.dta", replace 

*labor 
use "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_farmlabor_postharvest.dta", clear
recode days*  (.=0)
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_family_hired_labor.dta", replace
collapse (sum) labor_*, by(hhid)
lab var labor_total "Total labor days (family, hired, or other) allocated to the farm in the past year"
lab var labor_hired "Total labor days (hired) allocated to the farm in the past year"
lab var labor_family "Total labor days (family) allocated to the farm in the past year"
lab var labor_total "Total labor days (hired +family) allocated to the farm in the past year" 
save "${NGA_W1_created_data}\Nigeria_GHS_W1_family_hired_labor.dta", replace
...
lab var vac_animal "1= Household has an animal vaccinated"
save "${NGA_W1_created_data}/Nigeria_GHS_W1_vaccine.dta", replace
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_farmer_vaccine.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_diseases.dta", replace
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_fert_use.dta", replace 
...
gen indiv=farmerid
drop if indiv==.
merge 1:1 hhid indiv using "${NGA_W1_created_data}\Nigeria_GHS_W1_gender_merge.dta", nogen
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_farmer_fert_use.dta", replace  
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_any_ext.dta", replace 
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_fin_serv.dta", replace 
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_milk_animals.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_egg_animals.dta", replace
...
use "${NGA_W1_raw_data}\Post Planting Wave 1\Agriculture\sect11b_plantingw1.dta", clear
ren plotid plot_id
merge 1:1 plot_id hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_areas", nogen keep(1 3)
merge 1:1 plot_id hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_decision_makers", nogen keep (1 3)
...
preserve
	...
	save "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_rental_rate.dta", replace
restore
...
preserve
	...
	save "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_cultivated_plots_ha.dta", replace
restore
...
preserve
	...
	drop field_size
	save "${NGA_W1_created_data}/Nigeria_GHS_W1_rental_rate_hh.dta", replace	
restore
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_rental_rate.dta", replace
...
*Rescaling
merge m:1 plot_id hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_plot_areas", nogen keep(1 3)			
merge m:1 plot_id hhid using "$NGA_W1_created_data\Nigeria_GHS_W1_plot_decision_makers", nogen keep(1 3)
...
merge m:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_rental_rate_hh.dta", nogen keep(1 3)			// household's average rental rate (total rent paid divided by total ha rented at household level)
merge m:1 zone state lga sector using "${NGA_W1_created_data}/Nigeria_GHS_W1_rental_rate.dta", nogen keep(1 3)	// aggregate rental rates
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_cost_land.dta", replace
...
preserve
	...
	keep wage_*_hh hhid
	save "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_wages_harv.dta", replace
restore
...
merge m:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_wages_harv.dta", nogen keep(1 3)	
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_cost_harv_labor.dta", replace
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_cost_seed.dta", replace
...
preserve			// only doing for liters adn grams  (since majority free pesticide is reported)
	...
	save "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_pest_price.dta", replace
restore
merge m:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_pest_price.dta", nogen
...
preserve
	...
	save "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_herb_price.dta", replace
restore
merge m:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_herb_price.dta", nogen
drop value_herb_*
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_cost_inputs.dta", replace
...
preserve
	...
	save "${NGA_W1_created_data}/Nigeria_GHS_W1_fert_price_hh.dta", replace
restore
*Merging prices back in immediately
merge m:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_fert_price_hh.dta", nogen assert(3)		// all matched
...
preserve
	...
	save "${NGA_W1_created_data}/Nigeria_GHS_W1_org_fert_price_hh.dta", replace
restore
*Immediately merging back in
merge m:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_org_fert_price_hh.dta", nogen assert(3)
...
preserve
	...
	save "$NGA_W1_created_data/Nigeria_GHS_W1_hh_fert.dta", replace
restore
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_cost_fert.dta", replace


use "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_cost_land.dta", clear
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_rental_rate.dta", nogen
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_cost_harv_labor.dta", nogen keep(1 3)		
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_cost_fert.dta", nogen keep(1 3)			
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_cost_inputs.dta", nogen keep(1 3)			
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_male_head.dta", nogen keep(1 3)
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_cost_seed.dta", nogen keep(1 3)
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_cropcosts.dta", replace
...
use "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_fert.dta", clear

merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_hhids.dta", keep(1 3) nogen
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_fert_use.dta", keep(1 3) nogen
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_fertilizer_application.dta", replace
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_household_diet.dta", replace
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_control_income.dta", replace
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_make_ag_decision.dta", replace
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_make_ownasset.dta", replace
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_ag_wage.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_crop_area_planted", replace
...
merge m:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_areas.dta", nogen keep(1 3)
*There is one household that does not list the cropid
duplicates drop hhid plot_id cropid, force
merge 1:1 hhid plot_id cropid using "${NGA_W1_created_data}\Nigeria_GHS_W1_crop_area_planted",nogen keep(1 3)
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_crop_kgs_harvest", replace	
restore

*merging in gender variables
merge m:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_decision_makers", gen(_merge_gender)
drop if quant_harv_kg==. 
drop area_harv
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_crop_area_plan.dta", replace
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_area_planted_harvested_allcrops.dta", replace
restore 


keep if inlist(crop_code, $comma_topcrop_area)

save "${NGA_W1_created_data}/Nigeria_GHS_W1_crop_harvest_area_yield.dta", replace


*Yield at the household level
use "${NGA_W1_created_data}/Nigeria_GHS_W1_crop_harvest_area_yield.dta", clear
* Adding value of crop production
merge 1:1 hhid crop_code using "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_crop_values_production.dta", nogen keep(1 3)
ren value_crop_production value_harv
ren value_crop_sales value_sold
merge 1:1 hhid crop_code using "${NGA_W1_created_data}/Nigeria_GHS_W1_crop_kgs_harvest.dta", nogen keep(1 3)
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_yield_hh_crop_level.dta", replace
...
use "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_crop_area_plan.dta", clear
...
preserve 
	...
	save "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_crop_area_plan_shannon.dta", replace
restore

merge m:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_crop_area_plan_shannon.dta", nogen		//all matched
...
save "${NGA_W1_created_data}\Nigeria_GHS_W1_shannon_diversity_index.dta", replace
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_adulteq.dta", replace 

 

use "${NGA_W1_raw_data}\cons_agg_w1.dta", clear
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_adulteq.dta"
ren  hhtexp_dr_w1 total_cons  
ren  pcexp_dr_w1 percapita_cons
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_consumption.dta", replace
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_food_insecurity.dta", replace
...
save "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_assets.dta", replace 
...
use "${NGA_W1_created_data}\Nigeria_GHS_W1_hhids.dta", clear

*Gross crop income 
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_hh_crop_production.dta", nogen keep (1 3)
recode value_crop_production  (.=0)
*Variables: value_crop_production 

*Crop costs
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_asset_rental_costs.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_land_rental_costs.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_seed_costs.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_chemical_costs.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_fertilizer_costs.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_wages_postharvest.dta", nogen keep (1 3)
...
foreach c in $topcropname_area {
	merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_land_rental_costs_`c'.dta", nogen keep (1 3)
	merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_seed_costs_`c'.dta", nogen keep (1 3)
	merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_fertilizer_costs_`c'.dta", nogen keep (1 3)
	merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_chemical_costs_`c'.dta", nogen keep (1 3)
	merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_wages_postharvest_`c'.dta", nogen keep (1 3)
	merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_`c'_monocrop_hh_area.dta", nogen keep (1 3)
}
...
*Fish income
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_fish_income.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_fishing_expenses_1.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_fishing_expenses_2.dta", nogen keep (1 3)
...
*Livestock income
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_sales.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_expenses.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_livestock_products.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_TLU.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_herd_characteristics", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_TLU_Coefficients.dta", nogen keep (1 3)
...
*Self-employment income
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_self_employment_income.dta", nogen keep (1 3)
...
*Wage income
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_agwage_income.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_wage_income.dta", nogen keep (1 3)
...
*Off-farm hours
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_off_farm_hours.dta", nogen keep (1 3)

*Other income
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_other_income.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_remittance_income.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_other_income.dta", nogen keep (1 3)
...
*Farm size
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_land_size_all.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_farmsize_all_agland.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_land_size.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_land_size_total.dta", nogen
recode land_size (.=0)
...
*Labor
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_family_hired_labor.dta", nogen keep (1 3)
recode labor_hired labor_family (.=0) 

*Household size
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_hhsize.dta", nogen keep (1 3)

*Rates of vaccine, improved seeds, inorganic fertilizer, extensions, and formal financial services 
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_vaccine.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_fert_use.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_any_ext.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_fin_serv.dta", nogen keep (1 3)
...
*Milk productivity
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_milk_animals.dta", nogen keep (1 3)
gen costs_dairy = .
...
*Egg productivity
merge 1:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_egg_animals.dta", nogen keep (1 3)
...
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_cropcosts.dta", nogen keep (1 3)

*Rate of fertilizer application
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_fertilizer_application.dta", nogen keep (1 3)

*Agricultural wage rate
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_ag_wage.dta", nogen keep (1 3)

*Crop yields
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_yield_hh_crop_level.dta", nogen keep (1 3)
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_area_planted_harvested_allcrops.dta", nogen keep (1 3)

*Household diet
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_household_diet.dta", nogen keep (1 3)

*Consumption
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_consumption.dta", nogen keep (1 3)

*Household assets
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_hh_assets.dta", nogen keep (1 3)

*Food insecurity
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_food_insecurity.dta", nogen keep (1 3)
gen hhs_little = . 
gen hhs_moderate = . 
gen hhs_severe = . 
gen hhs_total = . 
...
*Shannon Diversity index
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_shannon_diversity_index.dta", nogen keep(1 3)

*Livestock health
merge 1:1 hhid using "${NGA_W1_created_data}/Nigeria_GHS_W1_livestock_diseases.dta", nogen keep (1 3)
...
gen ccf_loc = (1 + $NGA_GHS_W1_inflation) 
lab var ccf_loc "currency conversion factor - 2016 $NGN"
gen ccf_usd = (1 + $NGA_GHS_W1_inflation)/$NGA_GHS_W1_exchange_rate 
lab var ccf_usd "currency conversion factor - 2016 $USD"
gen ccf_1ppp = (1 + $NGA_GHS_W1_inflation)/ $NGA_GHS_W1_cons_ppp_dollar
lab var ccf_1ppp "currency conversion factor - 2016 $Private Consumption PPP"
gen ccf_2ppp = (1 + $NGA_GHS_W1_inflation)/ $NGA_GHS_W1_gdp_ppp_dollar
...
save "${NGA_W1_final_data}/Nigeria_GHS_W1_household_variables.dta", replace
...
**************
use "${NGA_W1_created_data}\Nigeria_GHS_W1_person_ids.dta", clear
use "${NGA_W1_created_data}/Nigeria_GHS_W1_gender_merge.dta", clear
merge 1:1 hhid indiv using "${NGA_W1_created_data}/Nigeria_GHS_W1_control_income.dta", nogen keep(1 3)
merge 1:1 hhid indiv using "${NGA_W1_created_data}/Nigeria_GHS_W1_make_ag_decision.dta", nogen  keep(1 3)
merge 1:1 hhid indiv using "${NGA_W1_created_data}/Nigeria_GHS_W1_make_ownasset.dta", nogen  keep(1 3)
merge m:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_hhsize.dta", nogen keep (1 3)
merge 1:1 hhid indiv using "${NGA_W1_created_data}/Nigeria_GHS_W1_farmer_fert_use.dta", nogen  keep(1 3)
merge 1:1 hhid indiv using "${NGA_W1_created_data}/Nigeria_GHS_W1_farmer_vaccine.dta", nogen  keep(1 3)
merge m:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_hhids.dta", nogen keep (1 3)


preserve
use "${NGA_W1_final_data}/Nigeria_GHS_W1_household_variables.dta", clear
keep hhid ag_hh
tempfile ag_hh
save `ag_hh'
restore
...
save "${NGA_W1_final_data}/Nigeria_GHS_W1_individual_variables.dta", replace
...
use "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_areas.dta", clear
merge m:1 hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_weights.dta", keep (1 3) nogen
merge 1:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_cropvalue.dta", keep (1 3) nogen
merge 1:1 hhid plot_id using "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_decision_makers", keep (1 3) nogen // Bring in the gender file
merge 1:1 plot_id hhid using "${NGA_W1_created_data}\Nigeria_GHS_W1_plot_farmlabor_postharvest.dta", keep (1 3) nogen
keep if cultivate==1
...
foreach p of varlist $monetary_val {
	gen `p'_1ppp = (1 + $NGA_GHS_W1_inflation ) * `p' / $NGA_GHS_W1_cons_ppp_dollar
	gen `p'_2ppp = (1 + $NGA_GHS_W1_inflation ) * `p' / $NGA_GHS_W1_gdp_ppp_dollar
	gen `p'_usd = (1+ $NGA_GHS_W1_inflation ) * `p' / $NGA_GHS_W1_exchange_rate   
	gen `p'_loc = (1+ $NGA_GHS_W1_inflation ) 
	local l`p' : var lab `p' 
	...
	lab var `p' "`l`p'' (NGN)"  
	gen w_`p'_1ppp = (1 + $NGA_GHS_W1_inflation ) * w_`p' / $NGA_GHS_W1_cons_ppp_dollar
	gen w_`p'_2ppp = (1 + $NGA_GHS_W1_inflation ) * w_`p' / $NGA_GHS_W1_gdp_ppp_dollar
	gen w_`p'_usd = (1 + $NGA_GHS_W1_inflation ) * w_`p' / $NGA_GHS_W1_exchange_rate
	gen w_`p'_loc = (1 + $NGA_GHS_W1_inflation )
...
save "${NGA_W1_final_data}\Nigeria_GHS_W1_gender_productivity_gap.dta", replace
...
global final_data_household  "${NGA_W1_final_data}/Nigeria_GHS_W1_household_variables.dta"  
global final_data_individual "${NGA_W1_final_data}/Nigeria_GHS_W1_individual_variables.dta"
global final_data_plot       "${NGA_W1_final_data}\Nigeria_GHS_W1_gender_productivity_gap.dta"
global final_outputfile      "${NGA_W1_final_data}/Nigeria_GHS_W1_summary_stats.xlsx" //Update date
...
foreach p of varlist $monetary_vars {
	...
	gen `p'_2ppp = (1 + $NGA_GHS_W1_inflation ) * `p' / $NGA_GHS_W1_gdp_ppp_dollar
	gen `p'_usd = (1+ $NGA_GHS_W1_inflation ) * `p' / $NGA_GHS_W1_exchange_rate   
	gen `p'_loc = (1+ $NGA_GHS_W1_inflation ) * `p'
	local l`p' : var lab `p' 
	lab var `p'_1ppp "`l`p'' (2016 $ Private Consumption PPP)"
	lab var `p'_2ppp "`l`p'' (2016 $ GDP PPP)"
	lab var `p'_usd "`l`p'' (2016 $ USD)"
	...
	gen w_`p'_2ppp = (1 + $NGA_GHS_W1_inflation ) * w_`p' / $NGA_GHS_W1_gdp_ppp_dollar
	gen w_`p'_usd = (1 + $NGA_GHS_W1_inflation ) * w_`p' / $NGA_GHS_W1_exchange_rate
	gen w_`p'_loc = (1 + $NGA_GHS_W1_inflation ) * `p'
	local lw_`p' : var lab w_`p'
	lab var w_`p'_1ppp "`lw_`p'' (2016 $ Private Consumption PPP)"
	lab var w_`p'_2ppp "`lw_`p'' (2016 $ GDP PPP)"
	lab var w_`p'_usd "`lw_`p'' (2016 $ USD)"
